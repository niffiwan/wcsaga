...
void vm_matrix_interpolate(matrix * goal_orient, matrix * start_orient,
                           vec3d * rotvel_in, float delta_t,
                           matrix * next_orient, vec3d * rotvel_out,
                           vec3d * rotvel_limit, vec3d * acc_limit,
                           int no_overshoot = 0);
...
void vm_forward_interpolate(vec3d * goal_fvec, matrix * orient,
                            vec3d * rotvel_in, float delta_t,
                            float delta_bank, matrix * next_orient,
                            vec3d * rotvel_out, vec3d * vel_limit,
                            vec3d * acc_limit, int no_overshoot = 0);
...
void vm_vec_random_cone(vec3d * out, vec3d * in, float max_angle,
                        matrix * orient = NULL);
                         ...
                         float max_angle, matrix * orient = NULL);
