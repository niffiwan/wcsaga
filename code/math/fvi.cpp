...
  float matrix_determinant_from_vectors(vec3d * v1, vec3d * v2,
                                           vec3d * v3) 
{
  ...
  vec3d delta_x;
    ...
    
    {
      ...
      float root1, root2;
        ...
        2 * ve_sqr * (delta_x_dot_ve * vs_sqr - delta_x_dot_vs * ve_dot_vs);
      C =
        2 * delta_x_dot_ve * delta_x_dot_vs * ve_dot_vs +
        Rs * Rs * ve_dot_vs * ve_dot_vs  -delta_x_sqr * ve_dot_vs *
        ve_dot_vs - delta_x_dot_ve * delta_x_dot_ve * vs_sqr;
                             ...
                             float sphere_r) 
{
  ...
   fvi_closest_point_on_line_segment(&closest_point, poly_center,
