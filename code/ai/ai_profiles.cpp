...
 void parse_ai_profiles_tbl(char *filename) 
{
    ...
    
    {
        ...
        
        {
            ...
            parse_float_list(profile->cmeasure_fire_chance,
                              NUM_SKILL_LEVELS);
            ...
            parse_int_list(profile->max_incoming_asteroids,
                            NUM_SKILL_LEVELS);
            ...
            
            {
                 ...
                 || optional_string("$AI Shield Manage Delays:"))
                              ...
                              ship_fire_secondary_delay_scale_hostile,
                              NUM_SKILL_LEVELS);
            ...
            parse_float_list(profile->delay_bomb_arm_timer,
                              NUM_SKILL_LEVELS);
            ...
            parse_float_list(profile->max_aim_update_delay,
                              NUM_SKILL_LEVELS);
