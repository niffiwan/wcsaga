      ...
      if (timestamp_elapsed(aip->path_subsystem_next_check))
        {
          ...
          model_find_world_point(&geye, &ep->pnt, pm->id, 0, &Pl_objp->orient,
                                 &Pl_objp->pos);
                          ...
                          else if (swip->wi_flags & WIF_BOMB)
                            {
                              float secondary_range_mult =
                                (aip->ai_bump_range_mult ==
                                 FLT_MIN) ? 0.75f : aip->ai_bump_range_mult;
                          ...
                          else
                            {
                              float secondary_range_mult =
                                (aip->ai_secondary_range_mult ==
                                 FLT_MIN) ? (float) (Game_skill_level + 1 +
                                                     (3 * aip->ai_class /
                                                      (Num_ai_classes -
                                                       1))) /
