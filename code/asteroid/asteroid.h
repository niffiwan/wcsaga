...
typedef struct asteroid_info
{
  ...
  int model_num[NUM_DEBRIS_POFS];
    ...
    asteroid_info():num_detail_levels(0),
    max_speed(0),
    damage_type_idx(-1),
    inner_rad(0),
    outer_rad(0), damage(0), blast(0), initial_asteroid_strength(0)
  {
    name[0] = NULL;
...
int asteroid_check_collision(object * asteroid_objp, object * other_obj,
                             ...
                             NULL);
void asteroid_hit(object * asteroid_objp, object * other_objp, vec3d * hitpos,
                  float damage);
int asteroid_count();
