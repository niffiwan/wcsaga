...
int iff_init_color(int r, int g, int b) 
{
  typedef struct temp_color_t 
  {
    ...
    // init it
    gr_init_alphacolor(&Iff_colors[idx][0], r, g, b,
                       iff_get_alpha_value(false));
  gr_init_alphacolor(&Iff_colors[idx][1], r, g, b,
                      iff_get_alpha_value(true));
...
void iff_init() 
{
  ...
  int a_bright, a_dim;
    ...
    {
      parse_string_flag_list((int *) &radar_target_id_flags, rti_flags,
                              Num_rti_flags);
    ...
    
    {
        ...
        
        {
            ...
            // get iff observed
            stuff_string_until(observed_color_table[cur_iff]
                               [num_observed_colors[cur_iff]].iff_name, "As:",
                               NAME_LENGTH);
        ...
        
        {
            ...
            
            {
                ...
                if (!stricmp(NOX("orders hidden"), flag_strings[string_idx]))
                iff->flags |= IFFF_ORDERS_HIDDEN;
              
              else
                if (!stricmp(NOX("orders shown"), flag_strings[string_idx]))
                iff->flags |= IFFF_ORDERS_SHOWN;
              
              else
                if (!stricmp
                    (NOX("wing name hidden"), flag_strings[string_idx]))
        ...
        
        {
            ...
            stuff_string_list(flag_strings, MAX_PARSE_OBJECT_FLAGS);
        ...
        
        {
            ...
            stuff_string_list(flag_strings, MAX_PARSE_OBJECT_FLAGS_2);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                // find out who
              int target_iff =
                iff_lookup(observed_color_table[cur_iff][list_index].
                           iff_name);
               
                // valid?
                if (target_iff >= 0)
                iff->observed_color_index[target_iff] =
                  observed_color_table[cur_iff][list_index].color_index;
        ...
        
        {
            ...
            
            {
                ...
                // skip anyone exempt
                if (Iff_info[other_iff].
                    flags & IFFF_EXEMPT_FROM_ALL_TEAMS_AT_WAR)
...
// this one for the function calls that include some - any - of object
  color * iff_get_color_by_team_and_object(int team, int seen_from_team,
