...
//
                                                 ...
                                                 LPVOID);
     extern HRESULT WINAPI DirectSoundCreate(LPGUID, LPDIRECTSOUND *,
                                               LPUNKNOWN);
...
// IDirectSoundCapture
//
    DEFINE_GUID(IID_IDirectSoundCapture, 0xb0210781, 0x89cd, 0x11d0, 0xaf,
...
//
    DEFINE_GUID(IID_IDirectSoundCaptureBuffer, 0xb0210782, 0x89cd, 0x11d0,
...
#define INTERFACE IDirectSoundCaptureBuffer
    DECLARE_INTERFACE_(IDirectSoundCaptureBuffer, IUnknown) 
  {
    ...
    STDMETHOD(Initialize) (THIS_ LPDIRECTSOUNDCAPTURE,
                            LPCDSCBUFFERDESC) PURE;
...
// IDirectSoundNotify
//
    DEFINE_GUID(IID_IDirectSoundNotify, 0xb0210783, 0x89cd, 0x11d0, 0xaf,
                 0x8, 0x0, 0xa0, 0xc9, 0x25, 0xcd, 0x16);
