...
typedef HRESULT(WINAPI * LPD3DVALIDATECALLBACK) (LPVOID lpUserArg,
                                                  DWORD dwOffset);
typedef HRESULT(WINAPI *
                 LPD3DENUMTEXTUREFORMATSCALLBACK) (LPDDSURFACEDESC lpDdsd,
                                                   LPVOID lpContext);
...
public: 
   ...
   _D3DVECTOR()
  {
    ...
    friend _D3DVECTOR operator +(const _D3DVECTOR & v1,
                                 const _D3DVECTOR & v2);
  ...
  friend _D3DVECTOR CrossProduct(const _D3DVECTOR & v1,
                                  const _D3DVECTOR & v2);
...
typedef struct _D3DVERTEX 
{
   ...
   union 
  {
    ...
    _D3DVERTEX()
  {
  } _D3DVERTEX(const D3DVECTOR & v, const D3DVECTOR & n, float _tu,
                float _tv, float _tu2 = _tu, float _tv2 = _tv) 
  {
...
typedef struct _D3DMATRIX 
{
   ...
   _D3DMATRIX()
  {
                ...
                D3DVALUE _m30, D3DVALUE _m31, D3DVALUE _m32,
                D3DVALUE _m33 ) 
  {
