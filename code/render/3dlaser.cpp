                    ...
                    float tail_width, uint tmap_flags, float max_len) 
{
    ...
    {
      return g3_draw_laser_htl(headp, head_width, tailp, tail_width, 255,
                                255, 255, tmap_flags | TMAP_HTL_3D_UNLIT);
                        ...
                        uint tmap_flags, float max_len) 
{
    ...
    
    {
        ...
        return g3_draw_laser_htl(headp, head_width, tailp, tail_width, r, g,
                                  b, tmap_flags | TMAP_HTL_3D_UNLIT);
