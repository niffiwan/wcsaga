...
//
     void anim_play_init(anim_play_struct * aps, anim * a_info, int x,
                         int y) 
{
  ...
  anim_instance * anim_play(anim_play_struct * aps) 
{
    ...
    (ubyte *) vm_malloc(instance->parent->width * instance->parent->height *
                        2);
  Assert(instance->frame != NULL);
  memset(instance->frame, 0,
...
{
  int bitmap_id, bitmap_flags = 0, new_frame_num, frame_diff =
    0, i, n_frames = 0, frame_save;
    ...
    if (instance->direction == ANIM_DIRECT_FORWARD)
      ...
      instance->start_at - 1 + fl2i(percent_through * n_frames + 0.5f);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    unpack_frame_from_file(instance, instance->frame,
                                           instance->parent->width *
                                           instance->parent->height,
                                           instance->parent->
                                           palette_translation, aabitmap,
                                           bpp);
            ...
            
            {
                ...
                
                {
                    ...
                    unpack_frame(instance, instance->data, instance->frame,
                                 instance->parent->width *
                                 instance->parent->height,
                                 instance->parent->palette_translation,
                                 aabitmap, bpp);
                ...
                
                {
                    ...
                    unpack_frame(instance, instance->data, instance->frame,
                                 instance->parent->width *
                                 instance->parent->height, NULL, aabitmap,
                                 bpp);
    ...
    
    {
        ...
        bm_create(16, instance->parent->width, instance->parent->height,
...
 void anim_reverse_direction(anim_instance * ai) 
{
    ...
    
    {
        ...
        ((float) ai->frame_num - (float) ai->start_at -
         1.0f) / (float) ai->parent->fps;
    ...
    
    {
        ...
        ((float) ai->start_at - (float) ai->frame_num -
         1.0f) / (float) ai->parent->fps;
