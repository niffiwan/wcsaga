               ...
               float emp_intensity, float emp_time) 
{
    ...
    
    {
        ...
        wip_target =
        &Weapon_info[Weapons[target->instance].weapon_info_index];
      if ((wip_target->weapon_hitpoints > 0)
           && !(wip_target->wi_flags2 & WIF2_NO_EMP_KILL))
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    // disrupt the turret
                    ship_subsys_set_disrupted(moveup,
                                              (int) (MAX_TURRET_DISRUPT_TIME *
                                                     scale_factor));
        ...
        
        {
            ...
            
            {
              ...
              send_emp_effect(target->net_signature, actual_intensity,
                               actual_time);
...
void emp_process_ship(ship * shipp) 
{
  ...
  aip->ai_flags &= ~AIF_SEEK_LOCK;
    ...
    if (((int) f2fl(Missiontime) +
         (int) (EMP_INTENSITY_MAX * shipp->emp_intensity)) % mod_val == 0)
...
void emp_process_local() 
{
    ...
    
    {
        ...
        // reset the timestamp
        Emp_wacky_target_timestamp =
        timestamp((int) frand_range(100.0f, 750.0f * (1.0f - Emp_intensity)));
...
void emp_maybe_reformat_text(char *text, int max_len, int gauge_id) 
{
    ...
    
    {
        ...
        case EG_WEAPON_S2:
            ...
            (int) frand_range(0.0f, (float) (MAX_WEAPON_TYPES - 1));
          strcpy_s(wt->str,
                    Weapon_info[wep_index >=
                                MAX_WEAPON_TYPES ? 0 : wep_index].name);
