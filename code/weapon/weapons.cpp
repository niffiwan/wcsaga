...
"random length", WBF_RANDOM_LENGTH, 0} };
  ...
  sizeof(Burst_fire_flags) / sizeof(flag_def_list);
...
 int weapon_explosions::Load(char *filename, int expected_lods) 
{
  ...
  int idx = GetIndex(filename);
  ...
  new_wei.lod[0].bitmap_id =
    bm_load_animation(filename, &new_wei.lod[0].num_frames,
                      &new_wei.lod[0].fps, NULL, 1);
   if (new_wei.lod[0].bitmap_id < 0)
    
    {
      Warning(LOCATION, "Weapon explosion '%s' does not have an LOD0 anim!",
               filename);
    ...
    
    {
        ...
        
        {
            ...
            bm_load_animation(name_tmp, &nframes, &nfps, NULL, 1);
        ...
        Warning(LOCATION, "For '%s', %i of %i LODs are missing!", filename,
    ...
    {
      Warning(LOCATION, "Filename '%s' is too long to have any LODs.",
               filename);
...
}  void weapon_explosions::PageIn(int idx) 
{
    ...
    
    {
        ...
        {
          bm_page_in_xparent_texture(wei->lod[i].bitmap_id,
                                      wei->lod[i].num_frames);
        }
    }
}

 int weapon_explosions::GetAnim(int weapon_expl_index, vec3d * pos,
                                  float size) 
{
...
void parse_wi_flags(weapon_info * weaponp, int wi_flags, int wi_flags2) 
{
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    (char **) vm_realloc(Spawn_names,
                                         (Num_spawn_types +
                                          10) * sizeof(*Spawn_names));
                ...
                strlen(NOX("Spawn")) +
                strspn(&temp_string[strlen(NOX("Spawn"))], NOX(" \t"));
                ...
                vm_strndup(&weapon_strings[i][skip_length], name_length);
            ...
            
            {
                       ...
                       "Illegal to have more than %d spawn types for one weapon.\nIgnoring weapon %s",
        ...
        
        {
            ...
            
            {
                       ...
                       "Weapon %s is not a bomb but has \"no radius doubling\" set. Ignoring this flag",
                       weaponp->name);
    ...
    
    {
           ...
           || (weaponp->subtype != WP_MISSILE))
        
        {
          Warning(LOCATION, "local ssm must be guided missile: %s",
                   weaponp->name);
        }
    }
   if ((weaponp->wi_flags2 & WIF2_SMALL_ONLY)
         && (weaponp->wi_flags & WIF_HUGE))
  ...
   if ((weaponp->wi_flags2 & WIF2_INHERIT_PARENT_TARGET)
         && (!(weaponp->wi_flags & WIF_CHILD)))
...
int parse_weapon(int subtype, bool replace) 
{
    ...
    
    {
        ...
        
        {
                   ...
                   "Too many weapon classes before '%s'; maximum is %d, so only the first %d will be used",
    ...
    
    {
        ...
        
        {
                   ...
                   "Type of weapon %s entry does not agree with original entry type.",
                   wip->name);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                (float) cos((float) (ANG_TO_RAD(view_cone_angle / 2.0f)));
  ...
  int s_count;
    ...
    
    {
        ...
        
        {
                   ...
                   "$FlyBySnd: flag found on %s, but is not used with primary weapons; ignoring...",
                   wip->name);
    ...
    
    {
             ...
             && MinRange < MIN(wip->max_speed * wip->lifetime,
                               wip->weapon_range))
        ...
        
        {
                   ...
                   "Invalid minimum range on weapon %s; setting to 0",
                   wip->name);
    ...
    
    {
        ...
        wip->piercing_impact_weapon_expl_index =
          Weapon_explosions.Load(fname);
    ...
    
    {
        ...
        
        {
            ...
            Warning(LOCATION,
                    "+Engine multiplier may only be used with new style electronics");
        ...
        
        {
            ...
            Warning(LOCATION,
                    "+Weapon multiplier may only be used with new style electronics");
        ...
        
        {
            ...
            Warning(LOCATION,
                    "+Beam turret multiplier may only be used with new style electronics");
        ...
        
        {
            ...
            Warning(LOCATION,
                    "+Sensors multiplier may only be used with new style electronics");
  ...
  int num_spawn_angs_defined = 0;
    ...
    
    {
        ...
        // warmup sound
        parse_sound("+WarmupSound:", &wip->b_info.beam_warmup_sound,
                    wip->name);
       
        // warmdown sound
        parse_sound("+WarmdownSound:", &wip->b_info.beam_warmdown_sound,
                    wip->name);
        ...
        
        {
            ...
            wip->flash_impact_weapon_expl_index =
              Weapon_explosions.Load(fname);
                ...
                
                {
                    ...
                    
                    {
                        ...
                        
                        {
                            ...
                            &wip->b_info.sections[wip->b_info.
                                                  beam_num_sections++];
    ...
    
    {
        ...
        
        {
                   ...
                   "WARNING:  Alpha is set to 0 or a negative value for '%s'!  Defaulting to 1.0!",
                   wip->name);
        ...
        
        {
                     ...
                     "WARNING:  Alpha is set to cycle for '%s', but max and min values are the same!",
                     wip->name);
    ...
    {
      parse_string_flag_list((int *) &wip->burst_flags, Burst_fire_flags,
                              Num_burst_fire_flags);
...
 void parse_weaponstbl(char *filename) 
{
    ...
    
    {
        ...
        stuff_int_list(Player_weapon_precedence, MAX_WEAPON_TYPES,
                       WEAPON_LIST_TYPE);
...
{
  weapon_info * lasers = NULL, *big_lasers = NULL, *beams = NULL, *missiles =
    NULL, *big_missiles = NULL, *child_weapons = NULL;
  int num_lasers = 0, num_big_lasers = 0, num_beams = 0, num_missiles =
    0, num_big_missiles = 0, num_child = 0;
          ...
          int removed = 0;
            ...
            
            {
                ...
                
                {
                    ...
                    {
                      memcpy(&wip->b_info.sections[new_idx - 1],
...
 void weapon_load_bitmaps(int weapon_index) 
{
    ...
    
    {
        ...
        
        {
            ...
            
            {
                       ...
                       "Could not find a usable glow bitmap (%s) for weapon '%s'!\n",
        ...
        
        {
            ...
            
            {
                ...
                
                {
                           ...
                           "Could not find a usable muzzle glow bitmap (%s) for weapon '%s'!\n",
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                               ...
                               "Could not find a usable beam section (%i) bitmap (%s) for weapon '%s'!\n",
    ...
    {
       wip->particle_spew_anim.first_frame =
        bm_load(wip->particle_spew_anim.filename);
        ...
        
        {
                   ...
                   "Could not find a usable particle spew bitmap (%s) for weapon '%s'!\n",
                   wip->particle_spew_anim.filename, wip->name);
        }
    }
   if ((wip->decal_texture.bitmap_id < 0)
         && strlen(wip->decal_texture.filename))
...
 void weapon_do_post_parse() 
{
  ...
  weapon_create_names();
    ...
    
    {
        ...
        if (!(wip->wi_flags & WIF_PLAYER_ALLOWED)
            && stristr(wip->name, "#weak"))
        
        {
            ...
            if ((idx >= 0)
                && (Weapon_info[idx].wi_flags & WIF_PLAYER_ALLOWED))
...
 void weapon_expl_info_init() 
{
    ...
    {
      Weapon_explosions.Load(LOD_checker[i].filename,
                              LOD_checker[i].num_lods);
     ...
     void weapon_render(object * obj) 
{
    ...
    
    {
      ...
      
      {
          ...
          
          {
              ...
              
              {
                ...
                 while (wp->laser_bitmap_frame >
                          wip->laser_bitmap.total_time)
                  wp->laser_bitmap_frame -= wip->laser_bitmap.total_time;
                 framenum =
                  fl2i((wp->laser_bitmap_frame *
                        wip->laser_bitmap.num_frames) /
                       wip->laser_bitmap.total_time);
            ...
            vm_vec_scale_add(&headp, &obj->pos, &obj->orient.vec.fvec,
                              wip->laser_length);
          ...
          
          {
              ...
              vec3d headp2, tailp;
             vm_vec_scale_add(&headp2, &obj->pos, &obj->orient.vec.fvec,
              ...
              
              {
                  ...
                  fl2i((wp->laser_glow_bitmap_frame *
            ...
             batch_add_laser(wip->laser_glow_bitmap.first_frame + framenum,
                               &headp2,
      ...
      
      {
        ...
         if (Cmdline_missile_lighting
               && !(wip->wi_flags2 & WIF2_MR_NO_LIGHTING))
        ...
          model_render(wip->model_num, &obj->orient, &obj->pos,
                          render_flags);
            ...
            
            {
                ...
                
                {
                    ...
                    if ((wip->wi_flags & WIF_HUGE) && 
                        (sip->
                         flags & (SIF_SMALL_SHIP | SIF_NOT_FLYABLE |
                                  SIF_HARMLESS)))
                    ...
                    if (sp->flags2 & SF2_STEALTH
                        && (The_mission.ai_profile->
                            flags & AIPF_FIX_HEAT_SEEKER_STEALTH_BUG))
                    ...
                    
                    {
                        ...
                        ship_get_closest_subsys_in_sight(sp, SUBSYSTEM_ENGINE,
                                                         &weapon_objp->pos);
                ...
                vm_vec_normalized_dir(&vec_to_object, &objp->pos,
                                      &weapon_objp->pos);
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        chance =
                        cm_wip->cm_aspect_effectiveness /
                        wip->seeker_strength;
                    ...
                    
                    {
                        ...
                        chance =
                        cm_wip->cm_heat_effectiveness / wip->seeker_strength;
                    ...
                    
                    {
                        ...
                        vm_vec_dot(&vec_to_object,
                                   &weapon_objp->orient.vec.fvec);
...
void weapon_home(object * obj, int num, float frame_time) 
{
    ...
    
    {
      ...
      else if (MULTIPLAYER_MASTER && (wip->wi_flags & WIF_LOCKED_HOMING)
        ...
        
        {
          ...
          vm_vec_copy_scale(&obj->phys_info.desired_vel,
                             &obj->orient.vec.fvec, obj->phys_info.speed);
        }
      
      else if ((obj->phys_info.speed < max_speed / 4)
               && (wip->wi_flags & WIF_HOMING_HEAT))
    ...
    
    {
        ...
        ship_get_closest_subsys_in_sight(enemy, SUBSYSTEM_ENGINE,
                                         &Objects[wp->objnum].pos);
    ...
    
    {
        ...
        if (Weapon_info[Weapons[hobjp->instance].weapon_info_index].
            wi_flags & WIF_CMEASURE)
        break;
       
        // only allowed to home on bombs
        Assert(Weapon_info[Weapons[hobjp->instance].weapon_info_index].
               wi_flags & WIF_BOMB);
    ...
    
    {
        ...
        if ((wp->homing_subsys != NULL)
            && !(wip->wi_flags2 & WIF2_NON_SUBSYS_HOMING))
      ...
      float dist_to_target, time_to_target;
        ...
        
        {
          ...
          if ((wip->fov < 0.95f)
                && !(wip->wi_flags2 & WIF2_NO_LIFE_LOST_IF_MISSED))
      ...
       vm_vec_copy_scale(&obj->phys_info.desired_vel, &obj->orient.vec.fvec,
                           obj->phys_info.speed);
        ...
        
        {
            ...
            ai_turn_towards_vector(&target_pos, obj, frame_time,
                                   wip->turn_time, NULL, NULL, 0.0f, 0, NULL);
          vel = vm_vec_mag(&obj->phys_info.desired_vel);
           vm_vec_copy_scale(&obj->phys_info.desired_vel,
                               &obj->orient.vec.fvec, vel);
  ...
  int objnum;
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
               vm_vec_normalized_dir(&tvec, &v0,
                                       &Objects[wp->target_num].pos);
              dot =
                vm_vec_dot(&tvec, &Objects[wp->target_num].orient.vec.fvec);
    ...
    
    {
        ...
        
        {
            ...
            fireball_create(&warpout, FIREBALL_WARP, FIREBALL_WARP_EFFECT, -1,
                            obj->radius * 1.5f, 1, &vmd_zero_vector,
                            wp->lssm_warp_time, 0, &obj->orient);
        ...
        
        {
            ...
            vm_vec_scale_add(&wp->lssm_target_pos,
                             &Objects[wp->target_num].pos,
        ...
        
        {
            ...
            vm_vec_random_in_circle(&warpin, &wp->lssm_target_pos,
                                    &target_objp->orient,
                                    wip->lssm_warpin_radius +
            ...
            wp->lssm_warp_idx =
            fireball_create(&warpin, FIREBALL_WARP, FIREBALL_WARP_EFFECT, -1,
                            obj->radius * 1.5f, 0, &vmd_zero_vector,
                            wp->lssm_warp_time, 0, &orient);
        ...
        
        {
                             ...
                             &obj->orient.vec.fvec, wip->lssm_stage5_vel);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    ship_get_closest_subsys_in_sight(target_ship,
                                                     SUBSYSTEM_ENGINE,
            ...
            
            {
                ...
                if ((target_objnum != -1)
                    && !(wip->wi_flags2 & WIF2_UNTARGETED_HEAT_SEEKER))
...
int Weapons_created = 0;
                   ...
                   int parent_objnum, int group_id, int is_locked,
                   int is_spawned) 
{
    ...
    obj_create(OBJ_WEAPON, parent_objnum, n, orient, pos, 2.0f,
  ...
  float rand_val;
    ...
    
    {
        ...
        (rand_val) * (wip->life_max - wip->life_min) / wip->life_min;
           ...
           && (parent_objp->flags & OF_PLAYER_SHIP))
        ...
        wip->life_min + wp->lifeleft * (wip->life_max - wip->life_min);
    ...
    if (parent_objp != NULL && !(parent_objp->flags & OF_PLAYER_SHIP)
    ...
    
    {
        ...
        {
          vm_vec_copy_scale(&objp->phys_info.desired_vel,
                             &objp->orient.vec.fvec,
    ...
    if ((parent_objp != NULL)
        && (The_mission.ai_profile->
            flags & AIPF_USE_ADDITIVE_WEAPON_VELOCITY))
...
void spawn_child_weapons(object * objp) 
{
    ...
    
    {
      ...
      multi_set_network_signature(objp->net_signature,
                                   MULTI_SIG_NON_PERMANENT);
    ...
    
    {
        ...
        
        {
            ...
            {
              static_rand_cone(objp->net_signature + j, &tvec,
                                &objp->orient.vec.fvec,
            ...
            {
              vm_vec_random_cone(&tvec, &objp->orient.vec.fvec,
                                  wip->spawn_info[i].spawn_angle);
            }
          vm_vec_scale_add(&pos, &objp->pos, &tvec, objp->radius);
           vm_vector_2_matrix(&orient, &tvec, NULL, NULL);
          weapon_objnum =
            weapon_create(&pos, &orient, child_id, parent_num, -1,
            ...
            if ((child_wip->wi_flags2 & WIF2_INHERIT_PARENT_TARGET)
                && (wp->homing_object != &obj_used_list))
            
            {
              weapon_set_tracking_info(weapon_objnum, parent_num,
                                        wp->target_num, 1, wp->homing_subsys);
...
void weapon_play_impact_sound(weapon_info * wip, vec3d * hitpos,
                              bool is_armed) 
{
    ...
    
    {
        ...
        {
          snd_play_3d(&Snds[wip->disarmed_impact_snd], hitpos,
                       &Eye_position);
...
void weapon_do_electronics_effect(object * ship_objp, vec3d * blast_pos,
                                  int wi_index) 
{
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    if ((psub->type == SUBSYSTEM_TURRET)
                        && turret_weapon_has_flags(&ss->weapons, WIF_BEAM))
...
//                  damage occured          =>      0
//
int weapon_area_calc_damage(object * objp, vec3d * pos, float inner_rad,
                            float outer_rad, float max_blast,
                            float max_damage, float *blast, float *damage,
                            float limit) 
{
    ...
    
    {
      ...
      dist_to_outer_rad_squared =
        (outer_rad - min_dist) * (outer_rad - min_dist);
...
//
void weapon_area_apply_blast(vec3d * force_apply_pos, object * ship_obj,
                             vec3d * blast_pos, float blast,
                             int make_shockwave) 
{
...
//
void weapon_do_area_effect(object * wobjp, shockwave_create_info * sci,
                           vec3d * pos, object * other_obj) 
{
    ...
    
    {
        ...
        {
          weapon_do_electronics_effect(other_obj, pos,
                                        Weapons[wobjp->instance].
                                        weapon_info_index);
                ...
                int quadrant) 
{
    ...
    
    {
        ...
        Weapon_explosions.GetAnim(wip->impact_weapon_expl_index, hitpos,
                                  wip->impact_explosion_radius);
      particle_create(hitpos, &vmd_zero_vector, 0.0f,
                       wip->impact_explosion_radius,
                       PARTICLE_BITMAP_PERSISTENT, expl_ani_handle);
    ...
    
    {
        ...
        Weapon_explosions.GetAnim(wip->dinky_impact_weapon_expl_index, hitpos,
                                  wip->dinky_impact_explosion_radius);
      particle_create(hitpos, &vmd_zero_vector, 0.0f,
                       wip->dinky_impact_explosion_radius,
                       PARTICLE_BITMAP_PERSISTENT, expl_ani_handle);
    }
   if ((other_obj != NULL) && (quadrant == -1)
         && (wip->piercing_impact_weapon_expl_index > -1 && armed_weapon))
    
    {
        ...
        
        {
            ...
            
            {
                ...
                Ship_info[shipp->ship_info_index].piercing_damage_draw_limit;
            ...
            
            {
                ...
                Weapon_explosions.GetAnim(wip->
                                          piercing_impact_weapon_expl_index,
                                          hitpos,
                                          wip->
                                          piercing_impact_explosion_radius);
                ...
                
                {
                    ...
                    2.0f * wip->piercing_impact_particle_back_velocity;
                  pe.min_vel =
                    0.5f * wip->piercing_impact_particle_back_velocity;
                  pe.num_high /= 2;
                  pe.num_low /= 2;
                   particle_emit(&pe, PARTICLE_BITMAP, expl_ani_handle,
                                   10.0f);
  ...
  int sw_flag = SW_WEAPON;
    ...
    {
      emp_apply(&weapon_obj->pos, wip->shockwave.inner_rad,
...
void weapon_get_laser_color(color * c, object * objp) 
{
    ...
    
    {
        ...
        fl2i((winfo->laser_color_2.green - winfo->laser_color_1.green) * pct);
      b +=
        fl2i((winfo->laser_color_2.blue - winfo->laser_color_1.blue) * pct);
...
void weapon_maybe_spew_particle(object * obj) 
{
    ...
    
    {
        ...
        
        {
            ...
            particle_create(&particle_pos, &vel, wip->particle_spew_lifetime,
                             wip->particle_spew_radius, PARTICLE_SMOKE);
          
          else
            particle_create(&particle_pos, &vel, wip->particle_spew_lifetime,
                             wip->particle_spew_radius, PARTICLE_BITMAP,
                             wip->particle_spew_anim.first_frame);
...
float weapon_get_damage_scale(weapon_info * wip, object * wep,
                              object * target) 
{
    ...
    if ((target->type == OBJ_SHIP)
        && !(The_mission.ai_profile->
              flags & AIPF_DISABLE_WEAPON_DAMAGE_SCALING)
        && !(Ship_info[Ships[target->instance].ship_info_index].
              flags2 & SIF2_DISABLE_WEAPON_DAMAGE_SCALING) )
