...
void swarm_update_direction(object * objp, float frametime) 
{
    ...
    
    {
        ...
        
        {
            ...
            (float) (asin(SWARM_DIST_OFFSET / missile_dist));
        ...
        
        {
          ...
          if (swarmp->flags & SWARM_POSITIVE_PATH)
            ...
            vm_vec_copy_scale(&uvec_component, &swarmp->circle_uvec,
                               -radius);
          ...
          if (swarmp->flags & SWARM_POSITIVE_PATH)
            ...
            vm_vec_copy_scale(&rvec_component, &swarmp->circle_rvec,
                               -radius);
...
 swarm_new_target_calced: ai_turn_towards_vector(&swarmp->new_target, objp, frametime,
                            wip->turn_time, NULL, NULL, 0.0f,
                            0);
...
void turret_swarm_set_up_info(int parent_objnum, ship_subsys * turret,
                              weapon_info * wip, int weapon_num) 
{
  ...
   if (!((wip->wi_flags & WIF_SWARM) || (wip->wi_flags & WIF_CORKSCREW))
         || ((wip->wi_flags & WIF_SWARM) && (wip->swarm_count <= 0))
         || ((wip->wi_flags & WIF_CORKSCREW) && (wip->cs_num_fired <= 0)))
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                // get turret_swarm_info
                Assert((turret_tsi >= 0)
                       && (turret_tsi < MAX_TURRET_SWARM_INFO));
                ...
                
                {
                    ...
                    
                    {
                        ...
                        // *Get timestamp from weapon info's -Et1
                        tsi->time_to_fire =
                        timestamp(Weapon_info[tsi->weapon_class].SwarmWait);
                        ...
                        
                        {
                            ...
                            if (subsys->turret_animation_position ==
                                MA_POS_READY)
                            subsys->turret_animation_done_time =
                              timestamp(Weapon_info[tsi->weapon_class].
                                        SwarmWait * 3);
                           shipp->num_turret_swarm_info--;
                          subsys->turret_swarm_num--;
                          turret_swarm_delete(subsys->
                                               turret_swarm_info_index[k]);
