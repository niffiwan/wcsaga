...
void trail_calc_facing_pts(vec3d * top, vec3d * bot, vec3d * fvec,
                           vec3d * pos, float w) 
{
...
 void trail_render(trail * trailp) 
{
  ...
  do
    ...
    
    {
        ...
        
        {
            ...
            (ubyte) fl2i((trailp->val[n] * a_size + ti->a_start) * 255.0f *
        ...
        
        {
            ...
            {
              vm_vec_sub(&tmp_fvec, &trailp->pos[n],
                          &trailp->pos[sections[i + 1]]);
        ...
        
        {
            ...
            
            {
              ...
              Trail_vlist[nv]->r = Trail_vlist[nv]->g = Trail_vlist[nv]->b =
                l;
  ...
  g3_draw_poly(nv, Trail_vlist,
                TMAP_FLAG_TEXTURED | TMAP_FLAG_ALPHA | TMAP_FLAG_GOURAUD |
                TMAP_FLAG_RGB | TMAP_HTL_3D_UNLIT | TMAP_FLAG_TRISTRIP);
