...
 class weapon_explosions 
{
  ...
   int Load(char *filename = NULL, int specified_lods =
              MAX_WEAPON_EXPL_LOD);
...
 void weapon_hit_do_sound(object * hit_obj, weapon_info * wip,
                            vec3d * hitpos, bool is_armed);
