...
  debug_command::debug_command(char *_name, char *_help,
                                  void (*_func) ()) 
{
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    ("Ignoring the unused command line tail '%s %s'\n",
          ...
          
          {
              ...
              
              {
                  ...
                  
                  {
                      ...
                      {
                        strcpy_s(oldcommand_line[iLoop],
                                  oldcommand_line[iLoop + 1]);
...
 void debug_help() 
{
    ...
    {
      dc_printf(" %s - %s\n", Debug_command[i]->name,
                 Debug_command[i]->help);
