...
  typedef struct 
{
                                  ...
                                  int type, int dur, int per, int ang =
                                  0, int mag = 10000, int att = 0, int fade =
                                  0);
...
 int joy_ff_create_std_periodic(LPDIRECTINPUTEFFECT * eff, int type,
...
}  void joy_ff_play_dir_effect(float x, float y) 
{
    ...
    
    {
        ...
        
        {
          ...
          joy_ff_handle_error(SWFF_SetDirectionGain
                               (pHitEffect1, idegs, imag), "HitEffect1");
        ...
        
        {
                               ...
                               (pHitEffect2, idegs, imag), "HitEffect2");
...
 void joy_ff_play_primary_shoot(int gain) 
{
    ...
    
    {
           ...
           (SWFF_SetGain(pShootEffect, gain),
            "ShootEffect") == DIERR_INPUTLOST)
