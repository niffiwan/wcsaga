...
void debug_cycle_targeted_ship(int delta) 
{
    ...
    
    {
        ...
        sanity++;
                      ...
                      XSTR("Changed player target to %s", 1),
                      Ship_info[si_index].name);
...
extern void g3_set_view_matrix(vec3d * view_pos, matrix * view_matrix,
                                float zoom);
...
 void process_debug_keys(int k) 
{
    ...
    
    {
      ...
      extern int wacky_scheme;
        ...
        
        {
                  ...
                  Countermeasures_enabled ? XSTR("ENABLED",
                                                 7) : XSTR("DISABLED", 8));
    ...
    case KEY_DEBUGGED + KEY_K:
        ...
        
        {
            ...
            
            {
              ...
               ship_apply_local_damage(objp, Player_obj, &objp->pos,
                                         100000.0f, MISS_SHIELDS,
                                         CREATE_SPARKS);
    ...
    case KEY_DEBUGGED + KEY_V:
        ...
        message_send_unique_to_player(Messages[Message_debug_index].name,
                                      Message_waves[Messages
                                                    [Message_debug_index].
                                                    wave_info.index].name,
    ...
    case KEY_DEBUGGED + KEY_ALTED + KEY_SHIFTED + KEY_K:
        ...
        
        {
            ...
            
            {
                                       ...
                                       Ships[objp->instance].
                                       ship_max_hull_strength * 0.1f + 10.0f,
                                       MISS_SHIELDS, CREATE_SPARKS);
    ...
    case KEY_DEBUGGED + KEY_SHIFTED + KEY_K:
        ...
        
        {
            ...
            
            {
                ...
                {
                  mission_log_add_entry(LOG_SHIP_DISABLED, sp->ship_name,
                                         NULL);
                ...
                {
                  mission_log_add_entry(LOG_SHIP_DISARMED, sp->ship_name,
                                         NULL);
      ...
      
      {
        ...
        vm_vec_scale_add(&pos, &Player_obj->pos, &randvec,
                          Player_obj->radius);
        ship_apply_local_damage(Player_obj, Player_obj, &pos, 25.0f,
                                 MISS_SHIELDS, CREATE_SPARKS);
        hud_get_target_strength(Player_obj, &shield, &integrity);
        HUD_sourced_printf(HUD_SOURCE_HIDDEN,
                            XSTR
                            ("You knocked yourself down to %7.3f percent hull.\n",
                             9), 100.0f * integrity);
    ...
    case KEY_DEBUGGED + KEY_I:
                          ...
                          Player_obj->
                          flags & OF_INVULNERABLE ? XSTR("now INVULNERABLE!",
                                                         11) :
        ...
        
        {
                              ...
                              objp->
                              flags & OF_INVULNERABLE ?
                              XSTR("now INVULNERABLE!",
                                   11) : XSTR("no longer invulnerable...",
                                              12));
      ...
      
      {
          ...
          &shipp->weapons.secondary_bank_weapons[shipp->weapons.
                                                 current_secondary_bank];
        *weap = get_next_weapon_looped(*weap, WP_MISSILE);
         HUD_sourced_printf(HUD_SOURCE_HIDDEN,
                              XSTR("Secondary Weapon forced to %s", 18),
                              Weapon_info[*weap].name);
    ...
    case KEY_DEBUGGED + KEY_U:
      ...
      
      {
          ...
          &shipp->weapons.primary_bank_weapons[shipp->weapons.
    ...
    case KEY_DEBUGGED + KEY_S:
      ...
      
      {
        ...
        HUD_sourced_printf(HUD_SOURCE_HIDDEN, "Camera fov raised to %0.2f",
                            cam->get_fov());
      ...
      
      {
        ...
        HUD_sourced_printf(HUD_SOURCE_HIDDEN, "Camera fov lowered to %0.2f",
                            cam->get_fov());
  ...
  int hotkey_set;
    ...
    
    {
        ...
        
        {
                              ...
                              XSTR("%s added to set %d. (F%d)", 27),
                              Ships[Objects[Player_ai->target_objnum].
                                    instance].ship_name, hotkey_set,
                              4 + hotkey_set + 1);
...
void game_do_end_mission_popup() 
{
    ...
    
    {
        ...
        popup(pf_flags, 3, POPUP_NO, XSTR("&Yes, Quit", 28),
              XSTR("Yes, &Restart", 29),
...
void game_process_cheats(int k) 
{
    ...
    jcrypt(&CheatBuffer[CHEAT_BUFFER_LEN - CRYPT_STRING_LENGTH]);
...
 int button_function_critical(int n, net_player * p = NULL) 
{
    ...
    
    {
      ...
       if (NETPLAYER_IS_DEAD(npl)
             || (Ships[Objects[pl->objnum].instance].flags & SF_DYING))
...
int button_function(int n) 
{
    ...
    case TOGGLE_AUTO_TARGETING:
        ...
        
        {
            ...
            {
              hud_target_closest(iff_get_attackee_mask(Player_ship->team),
                                  -1, FALSE, TRUE);
    ...
    case TARGET_CLOSEST_SHIP_ATTACKING_TARGET:
        ...
        
        {
          ...
           hud_target_closest(iff_get_attacker_mask
                                (obj_team
                                 (&Objects[Player_ai->target_objnum])),
    ...
    case TARGET_CLOSEST_SHIP_ATTACKING_SELF:
        ...
        {
          hud_target_closest(iff_get_attacker_mask(Player_ship->team),
    ...
    case END_MISSION:
        ...
        
        {
                      ...
                      ("** WARNING ** Collision danger.  Subspace drive not activated.",
                       39));
        ...
        
        {
                      ...
                      ("Cannot engage subspace drive while gliding.", -1));
    ...
    case MULTI_SELF_DESTRUCT:
        ...
        
        {
               ...
               && (Objects[Net_player->m_player->objnum].instance <
                   MAX_SHIPS))
