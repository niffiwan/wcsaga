...
extern "C"
{
  ...
  HRESULT SWFF_SetDirectionGain(IN LPDIRECTINPUTEFFECT pDIEffect,
                                IN DWORD dwAngle, IN DWORD dwMag);
  ...
  BOOL SWFF_GetJoyData(IN int nJoyID,
                       IN OUT JOYINFOEX * pjix, OUT char *pszErr);
/*
...
DECLARE_INTERFACE_(IVFX, IUnknown)
{
  ...
  // General Methods
  STDMETHOD_(HRESULT, CreateEffectFromFile) (THIS_
                                             LPDIRECTINPUTDEVICE2,
                                             LPDIRECTINPUTEFFECT *,
                                             LPDWORD,
                                             const TCHAR *,
                                             LPVOID,
                                             LPDWORD, DWORD, LPDWORD) PURE;

  STDMETHOD_(HRESULT, CreateEffectFromBuffer) (THIS_
                                               LPDIRECTINPUTDEVICE2,
                                               LPDIRECTINPUTEFFECT *,
                                               LPDWORD,
                                               PVOID,
