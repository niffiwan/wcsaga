                                       ...
                                       IN DWORD dwFlags) 
{
  ...
  if (hWnd == NULL || hInstance == NULL || ppDI == NULL
       || ppDIDevice == NULL)
                                      ...
                                      IN const TCHAR * pszFileName) 
{
    ...
    pIVFX->CreateEffectFromFile(pDIDevice, ppDIEffect, 0, pszFileName, NULL,
                                NULL, dwInFlags, NULL);
                                        ...
                                        IN OUT PDWORD pdwOutFlags) 
{
    ...
    if (pDIDevice == NULL || pszFileName == NULL || pppDIEffect == NULL
        || pdwEffectCount == NULL || ppUDBuffer == NULL
        || pdwOutFlags == NULL)
    ...
    *pppDIEffect = NULL;
    ...
    pIVFX->CreateEffectFromFile(NULL, NULL, &dwEffectCount, pszFileName,
                                NULL, &dwBufferSize, dwInFlags, NULL);
    ...
    pIVFX->CreateEffectFromFile(pDIDevice, ppDIEffect, &dwEffectCount,
                                pszFileName, pUDBuffer, &dwBufferSize,
                                dwInFlags, &dwOutFlags);
                                        ...
                                        IN DWORD dwBufferSize) 
{
    ...
    pIVFX->CreateEffectFromBuffer(pDIDevice, ppDIEffect, 0, pBuffer,
                                  dwBufferSize, NULL, NULL, dwInFlags, NULL);
                                          ...
                                          IN OUT PDWORD pdwOutFlags) 
{
    ...
    *pppDIEffect = NULL;
    ...
    pIVFX->CreateEffectFromBuffer(NULL, NULL, &dwEffectCount, pBuffer,
    ...
    pIVFX->CreateEffectFromBuffer(pDIDevice, ppDIEffect, &dwEffectCount,
                                  pBuffer, dwBufferSize, pUDBuffer,
                                  &dwUDBufferSize, dwInFlags, &dwOutFlags);
                                  ...
                                  IN LONG lCentery, IN LONG lButton) 
{
    ...
    *ppDIEffect = NULL;
    ...
    SWFF_CreateConditionEffect(pDIDevice, ppDIEffect, SPRING, dwDuration,
