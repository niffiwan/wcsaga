...
extern int bm_load_and_parse_eff(char *filename, int dir_type, int *nframes,
                                 int *nfps, int *key, ubyte * type);

// Loads a single EFF frame, given the base EFF file name and frame number
extern int bm_load_eff_frame(char *filename, int frame, int dir_type,
                             ubyte eff_type, int *bitmap_id, int *width,
                             int *height);
...
extern int bm_load_animation(char *filename, int *nframes = NULL, int *fps =
                             NULL, int *keyframe = NULL, int can_drop_frames =
                             0, int dir_type = CF_TYPE_ANY);

//Loads either animation (bm_load_animation) or still image (bm_load)
extern int bm_load_either(char *filename, int *nframes = NULL, int *fps =
                          NULL, int *keyframe = NULL, int can_drop_frames =
                          0, int dir_type = CF_TYPE_ANY);
...
int bm_get_info(int bitmapnum, int *w = NULL, int *h = NULL, ubyte * flags =
                NULL, int *nframes = NULL, int *fps = NULL);
...
void bm_gfx_get_pixel(int bitmap, float u, float v, ubyte * r, ubyte * g,
                      ubyte * b);
...
extern void (*bm_set_components) (ubyte * pixel, ubyte * r, ubyte * g,
                                  ubyte * b, ubyte * a);
extern void (*bm_set_components_32) (ubyte * pixel, ubyte * r, ubyte * g,
                                     ubyte * b, ubyte * a);
void bm_set_components_argb_d3d_16_screen(ubyte * pixel, ubyte * r, ubyte * g,
                                          ubyte * b, ubyte * a);
void bm_set_components_argb_d3d_32_screen(ubyte * pixel, ubyte * r, ubyte * g,
                                          ubyte * b, ubyte * a);
void bm_set_components_argb_d3d_16_tex(ubyte * pixel, ubyte * r, ubyte * g,
                                       ubyte * b, ubyte * a);
void bm_set_components_argb_d3d_32_tex(ubyte * pixel, ubyte * r, ubyte * g,
                                       ubyte * b, ubyte * a);
