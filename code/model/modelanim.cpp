...
void triggered_rotation::start(queued_animation * q) 
{
    ...
    
    {
        ...
        
        {
          ...
          end_angle.a1d[axis] -
          (((q->vel.a1d[axis] * q->vel.a1d[axis]) /
            (2.0f * q->accel.a1d[axis])) * direction.a1d[axis]);
    }
   nprintf(("ModelAnim",
              "Dir=[%f, %f, %f], End=[%f, %f, %f], Vel=[%f, %f, %f], Accel=[%f, %f, %f], Slow=[%f, %f, %f]\n",
              direction.a1d[0], direction.a1d[1], direction.a1d[2],
              end_angle.a1d[0], end_angle.a1d[1], end_angle.a1d[2],
              rot_vel.a1d[0], rot_vel.a1d[1], rot_vel.a1d[2],
...
{
}  void triggered_rotation::add_queue(queued_animation * the_queue,
                                         int dir) 
{
    ...
    
    {
        ...
        
        {
            ...
            memcpy(&queue_tmp[i], &queue_tmp[i + 1],
                    sizeof(queued_animation) * (MAX_TRIGGERED_ANIMATIONS -
                                                (i + 1)));
    ...
    
    {
        ...
        for (i = 0;
             (i < n_queue) && (i < MAX_TRIGGERED_ANIMATIONS)
             && (new_queue.start_time > queue_tmp[i].start_time); i++);
        ...
        
        {
            ...
            
            {
                ...
                if ((trigger->current_vel.a1d[i] *
                    ...
                    (trigger->rot_vel.a1d[i] * trigger->direction.a1d[i])
...
//************************************//
  bool model_anim_start_type(ship_subsys * pss, int animation_type,
                              int subtype, int direction) 
{
...
 bool model_anim_start_type(ship * shipp, int animation_type, int subtype,
                              int direction) 
{
    ...
    
    {
        ...
        model_anim_start_type(pss, animation_type, subtype, direction);
...
int model_anim_instance_get_actual_time(queued_animation * properties) 
{
    ...
    
    {
        ...
        fl2i(((3.0f * properties->vel.a1d[a] * properties->vel.a1d[a]) +
              (2.0f * properties->accel.a1d[a] *
               fabs(properties->angle.a1d[a])))  /(2.0f *
                                                    properties->accel.a1d[a] *
                                                    properties->vel.a1d[a]) *
             1000.0f)  +properties->start;
...
 int model_anim_get_actual_time_type(ship * shipp, int animation_type,
                                       int subtype) 
{
...
  int model_anim_get_actual_time_type(ship_info * sip, int animation_type,
                                         int subtype) 
{
            ...
            
            {
                ...
                
                {
                    ...
                    if (psub->triggers[j].reverse_start == -1)
                      ...
                      ani_time -
                      model_anim_instance_get_actual_time(&psub->triggers[j]);
...
int model_anim_get_time_type(ship_subsys * pss, int animation_type,
                             int subtype) 
{
    ...
    
    {
        ...
        
        {
          ...
           if ((pss->trigger.current_vel.a1d[0] != 0.0f)
                 || (pss->trigger.current_vel.a1d[1] != 0.0f)
            ...
            
            {
              ...
              int a_time = 0;
                ...
                
                {
                    ...
                    if ((pss->trigger.current_ang.a1d[a] * direction) >
                        (pss->trigger.slow_angle.a1d[a] * direction))
                    
                    {
                      a_time =
                        fl2i(((fl_sqrt
                               (2.0f * pss->trigger.rot_accel.a1d[a] *
                                (pss->trigger.end_angle.a1d[a] -
                                 pss->trigger.current_ang.a1d[a]) +
                                pss->trigger.current_vel.a1d[a] *
                                pss->trigger.current_vel.a1d[a]) -
                               pss->trigger.current_vel.a1d[a])  /pss->
                              trigger.rot_accel.a1d[a]) * 1000.0f);
                    ...
                    
                    {
                        ...
                        //if vi is > v
                        if ((pss->trigger.current_vel.a1d[a] * direction) >
                            (pss->trigger.rot_vel.a1d[a] * direction))
                        
                        {
                          a_time =
                            fl2i((pss->trigger.current_vel.a1d[a] *
                                  (pss->trigger.current_vel.a1d[a] +
                                   2))  /(2.0f *
                                           pss->trigger.rot_accel.a1d[a]) *
                                 1000.0f);
                        ...
                        
                        {
                            ...
                            fl2i(((3.0f * pss->trigger.rot_vel.a1d[a]) /
                                  (2.0f *
                                   pss->trigger.rot_accel.a1d[a])  +(pss->
                                                                      trigger.
                                                                      current_vel.
                                                                      ...
                                                                      current_vel.
                                                                      a1d[a])
                                   /(4.0f * pss->trigger.rot_accel.a1d[a] *
                                      pss->trigger.rot_vel.a1d[a])  +(pss->
                                                                       trigger.
                                                                       end_angle.
                                                                       a1d[a]
                                                                       -
                                      ...
                                      direction)  -(pss->trigger.current_vel.
                                                     a1d[a] /
                                                     (pss->trigger.rot_accel.
                                                      a1d[a] *
                                                      direction))) 
                                 *1000.0f);
