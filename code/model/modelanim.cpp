...
void triggered_rotation::start(queued_animation * q)
{
  ...
  nprintf(("ModelAnim",
           ...
           rot_vel.a1d[0], rot_vel.a1d[1], rot_vel.a1d[2], rot_accel.a1d[0],
           rot_accel.a1d[1], rot_accel.a1d[2], slow_angle.a1d[0],
           slow_angle.a1d[1], slow_angle.a1d[2]));
              ...
              (trigger->slow_angle.a1d[i] * trigger->direction.a1d[i])))
        {
          ...
          // we are slowing down...
          else
            {
              ...
              if (((trigger->current_vel.a1d[i] * trigger->direction.a1d[i]) >
                   0) && (trigger->rot_accel.a1d[i] != 0.0f))
                {
                  trigger->current_vel.a1d[i] -=
                    (trigger->rot_accel.a1d[i] * flFrametime);
                }
...
bool model_anim_start_type(ship_subsys * pss, int animation_type, int subtype,
                           int direction)
{
  Assert(pss != NULL);
      ...
      temp =
        fl2i(((3.0f * properties->vel.a1d[a] * properties->vel.a1d[a]) +
              (2.0f * properties->accel.a1d[a] *
               fabs(properties->angle.a1d[a]))) / (2.0f *
                      ...
                      else
                        {
                          a_time =
                            fl2i(((3.0f * pss->trigger.rot_vel.a1d[a]) /
                                  (2.0f * pss->trigger.rot_accel.a1d[a]) +
                                  (pss->trigger.current_vel.a1d[a] *
                                   pss->trigger.current_vel.a1d[a]) / (4.0f *
                                                                       pss->
                                                                       trigger.
                                                                       rot_accel.
                                                                       a1d[a]
