...
void moff_tmappoly(ubyte * p, polymodel * pm, model_octant * oct,
                   int just_count) 
{
...
void moff_flatpoly(ubyte * p, polymodel * pm, model_octant * oct,
                   int just_count) 
{
...
   int model_octant_find_faces_sub(polymodel * pm, model_octant * oct,
                                       void *model_ptr, int just_count) 
{
...
// data.
int model_which_octant_distant_many(vec3d * pnt, int model_num,
