                    ...
                    for (j = 0; j < 3; j++)
                      {
                        ...
                        vm_vec_add2(&pm->shield.
                                    verts[pm->shield.tris[i].verts[j]].normal,
                                    &pm->shield.tris[i].norm);
#ifndef NDEBUG
          ...
          if (strstr(pm->submodel[j].name, live_debris_name))
            {
              ...
              pm->submodel[i].live_debris[pm->submodel[i].num_live_debris++] =
                j;
