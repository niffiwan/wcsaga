...
void model_set_subsys_path_nums(polymodel * pm, int n_subsystems,
        ...
        
        {
            ...
            
            {
                ...
                
                {
                  ...
                   for (nfp = 0; nfp < dest->turret_num_firing_points;
                          nfp++)
...
static void set_subsystem_info(model_subsystem * subsystemp, char *props,
                               char *dname) 
{
    ...
    
    {
      ...
      float turn_time;
        ...
        
        {
            ...
            PI2 / (fraction * (1.0f - fraction) * num_steps * t_trans *
                   t_trans);
...
 void do_new_subsystem(int n_subsystems, model_subsystem * slist,
                         int subobj_num, float rad, vec3d * pnt, char *props,
                         char *subobj_name, int model_num) 
{
    ...
    
    {
        ...
        
        {
                   ...
                   "Subsystem \"%s\" in model \"%s\" is represented as \"%s\" in ships.tbl.  "
...
#endif  /*  */
}  void print_family_tree(polymodel * obj, int modelnum, char *ident,
                             int islast) 
{
                    ...
                    model_subsystem * subsystems, int ferror) 
{
    ...
    
    {
        ...
        *pb = 0;
        ...
        cfopen(ibuffer_info.name, "rb", CFILE_NORMAL, CF_TYPE_CACHE);
        ...
        {
          ibuffer_info.tsb_read =
            cfopen(ibuffer_info.tsb_name, "rb", CFILE_NORMAL, CF_TYPE_CACHE);
           if ((ibuffer_info.tsb_read == NULL)
                 || !cfilelength(ibuffer_info.tsb_read))
        ...
        
        {
          ...
          int ibx = cfread_int(ibuffer_info.read);
            ...
            
            {
                        ...
                        (ibuffer_info.tsb_read != NULL) ? "IBX/TSB" : "IBX",
                        filename));
        ...
        
        {
            ...
            cfopen(ibuffer_info.name, "wb", CFILE_NORMAL, CF_TYPE_CACHE);
            ...
            
            {
                ...
                
                {
                    ...
                    cfopen(ibuffer_info.tsb_name, "wb", CFILE_NORMAL,
                           CF_TYPE_CACHE);
        ...
        
        {
         case ID_OHDR:       //Object header
          {
            ...
            pm->n_models = cfread_int(fp);
              ...
              (bsp_info *) vm_malloc(sizeof(bsp_info) * pm->n_models);
              ...
              
              {
                         ...
                         "Inverted bounding box on model '%s'!  Swapping values to compensate.",
                         pm->filename);
              ...
              
              {
                  ...
                  
                  {
                    ...
                    float area_mass = (float) pow(vol_mass, 0.6667f) * 4.65f;
                      ...
                      vm_vec_scale(&pm->moment_of_inertia.vec.rvec,
                                   mass_ratio);
                    vm_vec_scale(&pm->moment_of_inertia.vec.uvec,
                                  mass_ratio);
                    vm_vec_scale(&pm->moment_of_inertia.vec.fvec,
                                  mass_ratio);
              ...
              
              {
                  ...
                  
                  {
                      ...
                      (cross_section *) vm_malloc(pm->num_xc *
              ...
              
              {
                  ...
                  
                  {
                      ...
                      (bsp_light *) vm_malloc(sizeof(bsp_light) *
                                              pm->num_lights);
        ...
         case ID_SOBJ:       //Subobject header
          {
            ...
            cfread_string_len(props, MAX_PROP_LEN, fp); // and the user properties
              ...
              
              {
                ...
                if (!stricmp(type, "subsystem"))       // if we have a subsystem, put it into the list!
                  {
                                      ...
                                      pm->submodel[n].rad,
                                      &pm->submodel[n].offset, props,
                                      pm->submodel[n].name, pm->id);
                  ...
                  
                  {
                      ...
                      Assert(pm->submodel[n].movement_type !=
                             MOVEMENT_TYPE_ROT);
              ...
              
              {
                         ...
                         "Rotation without rotation axis defined on submodel '%s' of model '%s'!",
                         pm->submodel[n].name, pm->filename);
              ...
              
              {
                  ...
                  
                  {
                    ...
                     vm_vec_crossprod(&orient->vec.rvec, &orient->vec.uvec,
                                        &orient->vec.fvec);
                    vm_vec_crossprod(&orient->vec.fvec, &orient->vec.rvec,
                                      &orient->vec.uvec);
            ...
             
            {
              ...
              
              {
                ...
                cfread(pm->submodel[n].bsp_data, 1,
                        pm->submodel[n].bsp_data_size, fp);
          ...
          
          {
              ...
              
              {
                  ...
                  (shield_vertex *) vm_malloc(pm->shield.nverts *
              ...
              
              {
                  ...
                  (shield_tri *) vm_malloc(pm->shield.ntris *
                                           sizeof(shield_tri));
        ...
         case ID_GLOW:       //start glow point reading -Bobboau
          {
              ...
              
              {
                  ...
                  (glow_point_bank *) vm_malloc(sizeof(glow_point_bank) *
                                                gpb_num);
              ...
              
              {
                    ...
                    (glow_point *) vm_malloc(sizeof(glow_point) *
                                             bank->num_points);
                ...
                int length = strlen(props);
                  ...
                  
                  {
                    ...
                    Assert(strstr((const char *) &props, "$glow_texture=") !=
                            NULL);
                      ...
                      
                      {
                                  ...
                                  "Glow point bank %i nebula texture num is %d for '%s'\n",
            ...
            
            {
                ...
                (thruster_bank *) vm_malloc(sizeof(thruster_bank) *
                                            pm->n_thrusters);
                      ...
                      
                      {
                          ...
                          
                          {
                              ...
                              
                              {
                                         ...
                                         "Model %s has too many turret firing points on subsystem %s",
                                         subsystemp->name);
                              ...
                              
                              {
                                  ...
                                  cfread_vector(&subsystemp->
                                                 turret_firing_point[j], fp);
        ...
         case ID_TXTR:       //Texture filename list
          {
            ...
            
            {
                ...
                
                {
                    ...
                    cfread_string_len(pm->paths[i].parent_name,
                                      MAX_NAME_LEN - 1, fp);
                    ...
                    
                    {
                           ...
                           (pm->submodel[j].name, pm->paths[i].parent_name))
               ...
               int ferror, int duplicate) 
{
      ...
      char live_debris_name[128];
        ...
        
        {
            ...
            
            {
              ...
              pm->submodel[i].live_debris[pm->submodel[i].
                                           num_live_debris++] = j;
  ...
  float rx, ry, rz;
    ...
    fl_abs(pm->submodel[pm->detail[0]].max.xyz.x -
           pm->submodel[pm->detail[0]].min.xyz.x);
  ry =
    fl_abs(pm->submodel[pm->detail[0]].max.xyz.y -
           pm->submodel[pm->detail[0]].min.xyz.y);
  rz =
    fl_abs(pm->submodel[pm->detail[0]].max.xyz.z -
...
void model_set_bay_path_nums(polymodel * pm) 
{
  ...
  pm->ship_bay->depart_flags = 0;       // bitfield, set to 1 when that path number is reserved for a departure
        ...
        
        {
            ...
            
            {
                ...
                
                {
                           ...
                           "Model '%s' bay path '%s' index '%d' has an invalid bay number of %d",
    ...
    {
      Warning(LOCATION, "Model '%s' has too many bay paths - max is %d",
...
int model_find_2d_bound_min(int model_num, matrix * orient, vec3d * pos,
...
int submodel_find_2d_bound_min(int model_num, int submodel, matrix * orient,
                               vec3d * pos, int *x1, int *y1, int *x2,
                               int *y2) 
{
...
// returns 1 for invalid model, 2 for point offscreen.
// note that x1,y1,x2,y2 aren't clipped to 2d screen coordinates!
int model_find_2d_bound(int model_num, matrix * orient, vec3d * pos, int *x1,
...
// note that x1,y1,x2,y2 aren't clipped to 2d screen coordinates!
int subobj_find_2d_bound(float radius, matrix * orient, vec3d * pos, int *x1,
                         int *y1, int *x2, int *y2) 
{
...
void model_find_obj_dir(vec3d * w_vec, vec3d * m_vec, object * ship_obj,
                        int sub_model_num) 
{
...
void model_rot_sub_into_obj(vec3d * outpnt, vec3d * mpnt, polymodel * pm,
                            int sub_model_num) 
{
...
void model_get_rotating_submodel_axis(vec3d * model_axis, vec3d * world_axis,
                                      int modelnum, int submodel_num,
                                      object * obj) 
{
                             ...
                             submodel_instance_info * sii) 
{
  ...
  int cur_step =
    int (((rotation_time - step_offset_time) / step_time) + 0.5f);
  ...
  float coast_start_time =
  ...
  float decel_start_time =
    psub->stepped_rotation->t_transit * (1.0f -
                                         psub->stepped_rotation->fraction);
  float pause_start_time = psub->stepped_rotation->t_transit;
   float start_coast_angle =
    0.5f * psub->stepped_rotation->max_turn_accel * coast_start_time *
    coast_start_time;
    ...
    
    {
      ...
      float accel_time = step_offset_time;
        ...
        0.5f * psub->stepped_rotation->max_turn_accel * accel_time *
        accel_time;
    ...
    
    {
      ...
      float time_to_pause =
        ...
        (step_size -
         0.5f * psub->stepped_rotation->max_turn_accel * time_to_pause *
         time_to_pause);
...
void submodel_rotate(model_subsystem * psub, submodel_instance_info * sii) 
{
  ...
  float diff = sii->desired_turn_rate - sii->cur_turn_rate;
    ...
    (sii->cur_turn_rate + final_turn_rate) * 0.5f * flFrametime;
...
int model_rotate_gun(int model_num, model_subsystem * turret, matrix * orient,
                     angles * base_angles, angles * gun_angles, vec3d * pos,
                     vec3d * dst, int obj_idx, bool reset) 
{
  ...
  vec3d tempv;
    ...
    vm_matrix_x_matrix(&world_to_turret_matrix, orient,
                        &turret->turret_matrix);
  ...
  float step_size = turret->turret_turning_rate * flFrametime;
    ...
    
    {
      ...
      if ((turret_base_to_enemy.xyz.x) != 0
           || (turret_base_to_enemy.xyz.y != 0))
...
void model_find_submodel_offset(vec3d * outpnt, int model_num,
                                int sub_model_num) 
{
...
void model_find_world_point(vec3d * outpnt, vec3d * mpnt, int model_num,
...
void world_find_model_point(vec3d * out, vec3d * world_pt, polymodel * pm,
                            int submodel_num, matrix * orient, vec3d * pos) 
{
    ...
    matrix rotation_matrix = pm->submodel[submodel_num].orientation;
                              ...
                              &pm->submodel[submodel_num].angs);
   matrix inv_orientation;
  vm_copy_transpose_matrix(&inv_orientation,
                            &pm->submodel[submodel_num].orientation);
                                         ...
                                         object * objp) 
{
  ...
  int modelnum = Ship_info[Ships[objp->instance].ship_info_index].model_num;
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                      ...
                      float delta_angle =
                        get_submodel_delta_angle(&subsys->submodel_info_1);
    ...
    
    {
        ...
        rotating_submodel_has_ship_subsys(submodel_list[idx], pship);
        ...
        
        {
          ...
          pm->submodel[submodel_list[idx]].movement_type &=
            ~MOVEMENT_TYPE_ROT;
...
// reference, and given the object's orient and position,
// return the point in 3-space in outpnt.
void model_find_world_dir(vec3d * out_dir, vec3d * in_dir, int model_num,
                          int sub_model_num, matrix * objorient,
                          vec3d * objpos) 
{
...
void model_set_instance(int model_num, int sub_model_num,
                        submodel_instance_info * sii) 
{
                                 ...
                                 int submodel_num) 
{
    ...
    vm_vec_copy_scale((vec3d *) & pm->submodel[submodel_num].angs, &axis,
                      0.0f);
...
void model_add_arc(int model_num, int sub_model_num, vec3d * v1, vec3d * v2,
                   int arc_type) 
{
