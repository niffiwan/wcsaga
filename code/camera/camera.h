  ...
  class camera 
{
  ...
   void set_fov(float in_fov, float in_fov_time =
                  0.0f, float in_fov_acceleration_time =
                  0.0f, float in_deceleration_time = 0.0f);
  ...
   void set_rotation(matrix * in_orientation =
                       NULL, float in_rotation_time =
...
 class subtitle 
{
  ...
  float time_displayed_end;
            ...
            char *in_imageanim = NULL, float in_fade_time =
            0.0f, color * in_text_color = NULL, bool center_x =
            false, bool center_y = false, int in_width =
            200, bool post_shaded = false);
