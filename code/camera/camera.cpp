...
void camera::set_zoom(float in_zoom, float in_zoom_time,
                      float in_zoom_acceleration_time,
                      float in_zoom_deceleration_time)
{
  if (in_zoom_time == 0.0f && in_zoom_acceleration_time == 0.0f
      && in_zoom_deceleration_time == 0.0f)
    {
  ...
  zoom.setAVD(in_zoom, in_zoom_time, in_zoom_acceleration_time,
              in_zoom_deceleration_time, 0.0f);
}
...
void camera::set_position(vec3d * in_position, float in_translation_time,
...
void camera::set_rotation(matrix * in_orientation, float in_rotation_time,
...
void camera::set_rotation_facing(vec3d * in_target, float in_rotation_time,
                                 float in_rotation_acceleration_time,
                                 float in_rotation_deceleration_time)
{
...
subtitle::subtitle(int in_x_pos, int in_y_pos, char *in_text,
                   char *in_imageanim, float in_display_time,
                   float in_fade_time, color * in_text_color, bool center_x,
                   bool center_y, int in_width, int in_height,
                   bool in_post_shaded)
{
