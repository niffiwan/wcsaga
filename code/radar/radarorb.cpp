...
 void radar_init_orb() 
{
    ...
    bm_load_animation(Current_radar_global->Radar_fname[gr_screen.res],
    ...
    
    {
        ...
        
        {
          
          {
              ...
              {
                gr_init_alphacolor(&Radar_colors[i][j],
                                    radar_iff_color[i][j][0],
                                    radar_iff_color[i][j][1],
                                    radar_iff_color[i][j][2],
              ...
              
              {
                                    ...
                                    Radar_color_rgb[i][j].r,
                                    Radar_color_rgb[i][j].g,
...
void radar_stuff_blip_info_orb(object * objp, int is_bright,
                               color ** blip_color, int *blip_type) 
{
    ...
    
    {
      ...
      else if (Ship_info[shipp->ship_info_index].
               flags & (SIF_NAVBUOY | SIF_CARGO))
        ...
        
        {
            ...
            iff_get_color_by_team_and_object(shipp->team, Player_ship->team,
                                             is_bright, objp);
...
void radar_blip_draw_distorted_orb(blip * b) 
{
    ...
    
    {
        ...
        frand_range(MAX(0.75f, 0.75f * scale), MIN(1.25f, 1.25f * scale));
...
void draw_radar_blips_orb(int blip_type, int bright, int distort) 
{
    ...
    
    {
        ...
        
        {
            ...
            Current_radar_global->Radar_blip_radius_target[gr_screen.res];
        ...
        
        {
            ...
            Current_radar_global->Radar_blip_radius_normal[gr_screen.res];
        ...
        
        {
            ...
            {
              radar_orb_draw_image(&b->position, b->rad, b->radar_image_2d,
                                    b->radar_projection_size);
...
 void radar_draw_range_orb() 
{
    ...
    
    {
      ...
      gr_printf(Current_radar_global->
                 Radar_dist_coords[gr_screen.res][RR_SHORT][0],
                 Current_radar_global->Radar_dist_coords[gr_screen.
                                                         res][RR_SHORT][1],
                 XSTR("2k", 467));
      break;
     case RR_LONG:
      gr_printf(Current_radar_global->
                 Radar_dist_coords[gr_screen.res][RR_LONG][0],
                 Current_radar_global->Radar_dist_coords[gr_screen.
                                                         res][RR_LONG][1],
                 XSTR("10k", 468));
                 ...
                 Radar_dist_coords[gr_screen.res][RR_INFINITY][0],
                 Current_radar_global->Radar_dist_coords[gr_screen.
                                                         res][RR_INFINITY][1],
                 buf);
...
 void radar_orb_draw_outlines_htl() 
{
    ...
    {
      gr_init_alphacolor(&Orb_color_orange, 192, 96, 32,
                          radar_orb_calc_alpha(&orb_ring_xy[last]));
      gr_set_color_fast(&Orb_color_orange);
      g3_draw_htl_line(&orb_ring_xy[last], &orb_ring_xy[i]);
       gr_init_alphacolor(&Orb_color_teal, 48, 160, 96,
                            radar_orb_calc_alpha(&orb_ring_xz[last]));
      gr_set_color_fast(&Orb_color_teal);
      g3_draw_htl_line(&orb_ring_xz[last], &orb_ring_xz[i]);
       gr_init_alphacolor(&Orb_color_purple, 112, 16, 192,
                            radar_orb_calc_alpha(&orb_ring_yz[last]));
...
}  void radar_orb_draw_image(vec3d * pnt, int rad, int idx, float mult) 
{
  ...
  float radius =
    (float) Current_radar_global->Radar_blip_radius_normal[gr_screen.res];
    ...
    TMAP_FLAG_TEXTURED | TMAP_FLAG_BW_TEXTURE | TMAP_HTL_3D_UNLIT;
