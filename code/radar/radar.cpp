...
void radar_stuff_blip_info_std(object * objp, int is_bright,
...
 void radar_plot_object_std(object * objp) 
{
  ...
  int ship_is_visible = 0;
    ...
    
    {
        ...
        i2fl(Current_radar_global->Radar_radius[gr_screen.res][0] - 5);
    ...
    fl2i(Current_radar_global->Radar_center[gr_screen.res][0] + new_x_dist);
  ypos =
    fl2i(Current_radar_global->Radar_center[gr_screen.res][1] - new_y_dist);
...
void draw_radar_blips_std(int blip_type, int bright, int distort) 
{
    ...
    
    {
        ...
        
        {
            ...
            radar_draw_image_std(b->x, b->y, b->rad, b->radar_image_2d,
                                  b->radar_image_size);
