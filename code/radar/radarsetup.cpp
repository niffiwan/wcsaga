...
void (*radar_stuff_blip_info) (object * objp, int is_bright,
                               color ** blip_color, int *blip_type) = NULL;
...
void create_radar_global_vars() 
{
    ...
    
    {
      ...
       strcpy_s(Radar_globals[i].Radar_fname[0],
                  radar_default_filenames[0]);
