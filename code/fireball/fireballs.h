...
int fireball_create(vec3d * pos, int fireball_type, int render_type,
                    int parent_obj, float size, int reversed =
                    0, vec3d * velocity = NULL, float warp_lifetime =
                    0.0f, int ship_class = -1, matrix * orient =
                    NULL, int low_res = 0, int extra_flags =
                    0, int warp_open_sound = -1, int warp_close_sound = -1);
...
extern void warpin_render(object * obj, matrix * orient, vec3d * pos,
