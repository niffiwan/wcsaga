...
}  void CMissionNotesDlg::DoDataExchange(CDataExchange * pDX) 
{
  ...
  DDX_Check(pDX, IDC_DISABLE_BUILTIN_COMMAND_MSGS,
...
 void CMissionNotesDlg::OnOK() 
{
  ...
  strcpy_s(The_mission.substitute_event_music_name,
            m_substitute_event_music);
   MODIFY(The_mission.command_persona,
            ((CComboBox *) GetDlgItem(IDC_COMMAND_PERSONA))->
