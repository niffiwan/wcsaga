...
 void CustomWingNames::OnOK() 
{
  ...
   if (!stricmp(m_starting_1, m_starting_2)
         || !stricmp(m_starting_1, m_starting_3)  ||!stricmp(m_starting_2,
                                                              m_starting_3))
  ...
   if (!stricmp(m_squadron_1, m_squadron_2)
         || !stricmp(m_squadron_1, m_squadron_3)
         || !stricmp(m_squadron_1, m_squadron_4)
         || !stricmp(m_squadron_1, m_squadron_5)  ||!stricmp(m_squadron_2,
                                                              m_squadron_3)
         || !stricmp(m_squadron_2, m_squadron_4)
         || !stricmp(m_squadron_2, m_squadron_5)  ||!stricmp(m_squadron_3,
                                                              m_squadron_4)
         || !stricmp(m_squadron_3, m_squadron_5)  ||!stricmp(m_squadron_4,
                                                              m_squadron_5))
...
{
  return strcmp(Starting_wing_names[0], m_starting_1)
    || strcmp(Starting_wing_names[1], m_starting_2)
    || strcmp(Starting_wing_names[2],
              m_starting_3)  ||strcmp(Squadron_wing_names[0], m_squadron_1)
    || strcmp(Squadron_wing_names[1], m_squadron_2)
    || strcmp(Squadron_wing_names[2], m_squadron_3)
    || strcmp(Squadron_wing_names[3], m_squadron_4)
    || strcmp(Squadron_wing_names[4],
              m_squadron_5)  ||strcmp(TVT_wing_names[0], m_tvt_1)
    || strcmp(TVT_wing_names[1], m_tvt_2);
