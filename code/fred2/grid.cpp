...
ON_WM_CLOSE()ON_WM_DESTROY()ON_WM_KILLFOCUS()ON_WM_VSCROLL()
  //}}AFX_MSG_MAP
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
     ...
     void GridOrient(vec3d * forward, vec3d * right)
{
  ...
  The_grid = create_grid(The_grid, forward,
                         right, &center, nrows, ncols, square_size);
...
BOOL CGrid::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName,
