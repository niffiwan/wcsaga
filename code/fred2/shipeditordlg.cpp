...
{
  int i, type, ship_count, player_count, total_count, wing =
    -1, pvalid_count;
                    ...
                    
                    {
                        ...
                        
                        {
                            ...
                            
                            {
                              ...
                               m_arrival_dist.set(Ships[i].
                                                    arrival_distance);
                              m_arrival_delay.set(Ships[i].arrival_delay);
                              m_departure_delay.set(Ships[i].
                                                     departure_delay);
                               if (Ships[i].arrival_anchor !=
                                     m_arrival_target)
...
 int CShipEditorDlg::update_ship(int ship) 
{
  ...
   if ((Ships[ship].ship_info_index != m_ship_class)
         && (m_ship_class != -1))
...
void CShipEditorDlg::OnSelchangeHotkey() 
{
    ...
    
    {
               ...
               "This hotkey set should probably be reserved\nfor wing %s",
