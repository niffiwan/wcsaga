...
ON_BN_CLICKED(IDC_BROWSE_WAVE, OnBrowseWave) ON_BN_CLICKED(IDC_PLAY, OnPlay)
  //}}AFX_MSG_MAP
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
...
void cmd_brief_dlg::update_data(int update)
{
  ...
  if (last_cmd_brief && m_last_stage >= 0
      && m_last_stage < last_cmd_brief->num_stages)
    {
      ...
      string_copy(last_cmd_brief->stage[m_last_stage].ani_filename,
                  m_ani_filename, MAX_FILENAME_LEN);
      string_copy(last_cmd_brief->stage[m_last_stage].wave_filename,
                  m_wave_filename, MAX_FILENAME_LEN);
    }
  ...
  if (Cur_cmd_brief && Cur_cmd_brief->num_stages > 0)
    {
      ...
      m_text =
        convert_multiline_string(Cur_cmd_brief->stage[m_cur_stage].text);
