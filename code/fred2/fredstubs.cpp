...
{
}  void save_restore_vector(vec3d * vec, CFILE * fp, int version,
                              vec3d * deflt)
{
} void save_restore_matrix(matrix * mat, CFILE * fp, int version,
                            matrix * deflt)
{
} void save_restore_float(float *fl, CFILE * fp, int version, float deflt)
{
} void save_restore_angles(angles * ang, CFILE * fp, int version,
                            angles * deflt)
{
...
{
} void save_restore_string(char *str, CFILE * fp, int len, int version,
                            char *deflt)
{
...
 void send_ship_kill_packet(struct object *, struct object *, float,
                              unsigned char)
{
} void send_debris_create_packet(object * objp, ushort net_sig,
                                  int model_num, vec3d pos)
{
...
int game_do_cd_mission_check(char *)
{
  return 1;
}
