     ...
     void create_wing_dlg::OnOK() 
{
    ...
    
    {
      ...
      {
        msg.Format("The name \"%s\" is already being used by another wing",
                    m_name);
    ...
    
    {
        ...
        {
          msg.Format("The name \"%s\" is already being used by a team",
                      m_name);
    ...
    
    {
        ...
        
        {
            ...
            Format
            ("The name \"%s\" is already being used by a target priority group",
             m_name);
