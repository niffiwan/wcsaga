...
// reinforcement_editor_dlg dialog
  reinforcement_editor_dlg::reinforcement_editor_dlg(CWnd *
                                                      pParent /*=NULL*/ ) 
...
 void reinforcement_editor_dlg::update_data() 
{
    ...
    
    {
        ...
        
        {
               ...
               (Ships[objp->instance].ship_name, m_reinforcements[cur].name))
...
}  void reinforcement_editor_dlg::save_data() 
{
    ...
    
    {
        ...
        memset(m_reinforcements[cur].no_messages, 0,
               MAX_REINFORCEMENT_MESSAGES * NAME_LENGTH);
      memset(m_reinforcements[cur].yes_messages, 0,
              MAX_REINFORCEMENT_MESSAGES * NAME_LENGTH);
...
 int reinforcement_editor_dlg::query_modified() 
{
    ...
    
    {
      ...
      if (m_reinforcements[i].arrival_delay !=
        ...
        
        {
               ...
               (m_reinforcements[i].no_messages[j],
                Reinforcements[i].no_messages[j]))
        ...
        
        {
               ...
               (m_reinforcements[i].yes_messages[j],
                Reinforcements[i].yes_messages[j]))
...
 void reinforcement_editor_dlg::OnOK() 
{
    ...
    
    {
        ...
        
        {
                 ...
                 && !stricmp(m_reinforcements[i].name, Ships[j].ship_name))
            ...
            
            {
                     ...
                     && !stricmp(m_reinforcements[i].name, Wings[j].name))
    ...
    
    {
           ...
           ((void *) &Reinforcements[i], (void *) &m_reinforcements[i],
            sizeof(reinforcements)))
...
}  void reinforcement_editor_dlg::OnAdd() 
{
    ...
    
    {
      ...
      memset(m_reinforcements[i].no_messages, 0,
              MAX_REINFORCEMENT_MESSAGES * NAME_LENGTH);
      memset(m_reinforcements[i].yes_messages, 0,
              MAX_REINFORCEMENT_MESSAGES * NAME_LENGTH);
