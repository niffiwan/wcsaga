...
}  BOOL ship_select::OnInitDialog() 
{
    ...
    
    {
        ...
        {
          GetDlgItem(IDC_FILTER_SHIPS_IFF[i])->SetWindowText(Iff_info[i].
                                                              iff_name);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                       ...
                       Waypoint_lists[ptr->instance / 65536].name,
...
}  void ship_select::OnSelchangeWingList() 
{
    ...
    
    {
        ...
        
        {
              ...
              if ((obj_index[k]->type == OBJ_WAYPOINT)
                   && (obj_index[k]->instance == wing_index[i] * 65536 + j))
