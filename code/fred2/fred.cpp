...
BOOL CFREDApp::InitInstance() 
{
  ...
  User_interface =
    ...
    GetProfileInt("Preferences", "Physics rotation", physics_rot);
...
 void CFREDApp::write_window(char *name, window_data * wndd) 
{
  ...
  WriteProfileInt(name, "rcNormalPosition.top",
...
}  int CFREDApp::init_window(window_data * wndd, CWnd * wnd, int adjust,
                                int pre) 
{
