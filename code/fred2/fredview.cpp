...
ON_WM_LBUTTONDOWN()ON_COMMAND(ID_EDITORS_SHIPS, OnEditorsShips)
ON_WM_KEYDOWN()ON_WM_KEYUP()ON_WM_SETFOCUS()ON_WM_KILLFOCUS()ON_WM_SIZE
()ON_WM_MOUSEMOVE()ON_WM_LBUTTONUP()ON_COMMAND(ID_MISCSTUFF_SHOWSHIPSASICONS,
          OnMiscstuffShowshipsasicons)
ON_WM_CONTEXTMENU()ON_COMMAND(ID_EDIT_POPUP_SHOW_SHIP_ICONS, OnEditPopupShowShipIcons) ON_UPDATE_COMMAND_UI(ID_EDIT_POPUP_SHOW_SHIP_ICONS,
OnUpdateEditPopupShowShipIcons) ON_COMMAND(ID_EDIT_POPUP_SHOW_SHIP_MODELS,
                                           OnEditPopupShowShipModels)
ON_UPDATE_COMMAND_UI(ID_EDIT_POPUP_SHOW_SHIP_MODELS, OnUpdateEditPopupShowShipModels) ON_COMMAND(ID_MISC_STATISTICS, OnMiscStatistics) ON_COMMAND(ID_EDIT_POPUP_SHOW_COMPASS,
                                      OnEditPopupShowCompass)
ON_UPDATE_COMMAND_UI(ID_EDIT_POPUP_SHOW_COMPASS, OnUpdateEditPopupShowCompass) ON_UPDATE_COMMAND_UI(ID_CHANGE_VIEWPOINT_EXTERNAL,
OnUpdateChangeViewpointExternal) ON_COMMAND(ID_CHANGE_VIEWPOINT_EXTERNAL,
                                    OnChangeViewpointExternal)
ON_UPDATE_COMMAND_UI(ID_CHANGE_VIEWPOINT_FOLLOW, OnUpdateChangeViewpointFollow) ON_COMMAND(ID_CHANGE_VIEWPOINT_FOLLOW, OnChangeViewpointFollow) ON_COMMAND(ID_EDITORS_GOALS,
                                               OnEditorsGoals)
ON_COMMAND(ID_SPEED1, OnSpeed1) ON_COMMAND(ID_SPEED2, OnSpeed2) ON_COMMAND(ID_SPEED5, OnSpeed5) ON_COMMAND(ID_SPEED10, OnSpeed10) ON_UPDATE_COMMAND_UI(ID_SPEED1,
                                           OnUpdateSpeed1)
ON_COMMAND(ID_SPEED3, OnSpeed3) ON_COMMAND(ID_SPEED8, OnSpeed8) ON_COMMAND(ID_ROT1, OnRot1) ON_COMMAND(ID_ROT2, OnRot2) ON_COMMAND(ID_ROT3, OnRot3) ON_COMMAND(ID_ROT4,
                                                   OnRot4) ON_COMMAND(ID_ROT5,
                                                                      OnRot5)
ON_UPDATE_COMMAND_UI(ID_SPEED2, OnUpdateSpeed2) ON_UPDATE_COMMAND_UI(ID_SPEED3, OnUpdateSpeed3) ON_UPDATE_COMMAND_UI(ID_SPEED5, OnUpdateSpeed5) ON_UPDATE_COMMAND_UI(ID_SPEED8,
                                                         OnUpdateSpeed8)
ON_UPDATE_COMMAND_UI(ID_SPEED10, OnUpdateSpeed10) ON_UPDATE_COMMAND_UI(ID_ROT1, OnUpdateRot1) ON_UPDATE_COMMAND_UI(ID_ROT2, OnUpdateRot2) ON_UPDATE_COMMAND_UI(ID_ROT3,
                                                   OnUpdateRot3)
ON_UPDATE_COMMAND_UI(ID_ROT4, OnUpdateRot4) ON_UPDATE_COMMAND_UI(ID_ROT5, OnUpdateRot5) ON_COMMAND(ID_CONTROL_MODE_CAMERA,
OnControlModeCamera) ON_UPDATE_COMMAND_UI(ID_CONTROL_MODE_CAMERA,
                                 OnUpdateControlModeCamera)
ON_COMMAND(ID_CONTROL_MODE_SHIP, OnControlModeShip) ON_UPDATE_COMMAND_UI(ID_CONTROL_MODE_SHIP, OnUpdateControlModeShip) ON_COMMAND(ID_SHOW_GRID_POSITIONS,
                       OnShowGridPositions)
ON_UPDATE_COMMAND_UI(ID_SHOW_GRID_POSITIONS, OnUpdateShowGridPositions) ON_COMMAND(ID_SHOW_COORDINATES, OnShowCoordinates) ON_UPDATE_COMMAND_UI(ID_SHOW_COORDINATES,
                                    OnUpdateShowCoordinates)
ON_COMMAND(ID_SPEED50, OnSpeed50) ON_UPDATE_COMMAND_UI(ID_SPEED50, OnUpdateSpeed50) ON_COMMAND(ID_SPEED100, OnSpeed100) ON_UPDATE_COMMAND_UI(ID_SPEED100,
                                 OnUpdateSpeed100) ON_COMMAND(ID_SELECT,
                                                              OnSelect)
ON_UPDATE_COMMAND_UI(ID_SELECT, OnUpdateSelect) ON_COMMAND(ID_SELECT_AND_MOVE, OnSelectAndMove) ON_UPDATE_COMMAND_UI(ID_SELECT_AND_MOVE,
         OnUpdateSelectAndMove) ON_COMMAND(ID_SELECT_AND_ROTATE,
                                           OnSelectAndRotate)
ON_UPDATE_COMMAND_UI(ID_SELECT_AND_ROTATE, OnUpdateSelectAndRotate) ON_COMMAND(ID_CONSTRAIN_X, OnConstrainX) ON_UPDATE_COMMAND_UI(ID_CONSTRAIN_X,
                      OnUpdateConstrainX) ON_COMMAND(ID_CONSTRAIN_Y,
                                                     OnConstrainY)
ON_UPDATE_COMMAND_UI(ID_CONSTRAIN_Y, OnUpdateConstrainY) ON_COMMAND(ID_CONSTRAIN_Z, OnConstrainZ) ON_UPDATE_COMMAND_UI(ID_CONSTRAIN_Z, OnUpdateConstrainZ) ON_COMMAND(ID_CONSTRAIN_XZ,
                                                          OnConstrainXz)
ON_UPDATE_COMMAND_UI(ID_CONSTRAIN_XZ, OnUpdateConstrainXz) ON_COMMAND(ID_SELECTION_LOCK, OnSelectionLock) ON_UPDATE_COMMAND_UI(ID_SELECTION_LOCK,
                   OnUpdateSelectionLock)
ON_WM_LBUTTONDBLCLK()ON_COMMAND(ID_DOUBLE_FINE_GRIDLINES, OnDoubleFineGridlines) ON_UPDATE_COMMAND_UI(ID_DOUBLE_FINE_GRIDLINES, OnUpdateDoubleFineGridlines) ON_COMMAND(ID_SHOW_DISTANCES,
                                                            OnShowDistances)
ON_UPDATE_COMMAND_UI(ID_SHOW_DISTANCES, OnUpdateShowDistances) ON_COMMAND(ID_UNIVERSAL_HEADING, OnUniversalHeading) ON_UPDATE_COMMAND_UI(ID_UNIVERSAL_HEADING,
                             OnUpdateUniversalHeading)
ON_COMMAND(ID_FLYING_CONTROLS, OnFlyingControls) ON_UPDATE_COMMAND_UI(ID_FLYING_CONTROLS, OnUpdateFlyingControls) ON_COMMAND(ID_ROTATE_LOCALLY,
                 OnRotateLocally) ON_UPDATE_COMMAND_UI(ID_ROTATE_LOCALLY,
                                                       OnUpdateRotateLocally)
ON_COMMAND(ID_CONSTRAIN_XY, OnConstrainXy) ON_UPDATE_COMMAND_UI(ID_CONSTRAIN_XY, OnUpdateConstrainXy) ON_UPDATE_COMMAND_UI(ID_CONSTRAIN_YZ,
               OnUpdateConstrainYz) ON_COMMAND(ID_CONSTRAIN_YZ,
                                               OnConstrainYz)
ON_COMMAND(ID_SELECT_LIST, OnSelectList) ON_COMMAND(ID_ZOOM_EXTENTS, OnZoomExtents) ON_COMMAND(ID_ZOOM_SELECTED, OnZoomSelected) ON_UPDATE_COMMAND_UI(ID_ZOOM_SELECTED,
                                          OnUpdateZoomSelected)
ON_COMMAND(ID_FORM_WING, OnFormWing) ON_UPDATE_COMMAND_UI(ID_FORM_WING, OnUpdateFormWing) ON_COMMAND(ID_DISBAND_WING, OnDisbandWing) ON_UPDATE_COMMAND_UI(ID_DISBAND_WING,
                                              OnUpdateDisbandWing)
ON_COMMAND(ID_SHOW_HORIZON, OnShowHorizon) ON_UPDATE_COMMAND_UI(ID_SHOW_HORIZON, OnUpdateShowHorizon) ON_COMMAND(ID_EDITORS_WING, OnEditorsWing) ON_COMMAND(ID_EDITORS_PLAYER,
                                                OnEditorsPlayer)
ON_COMMAND(ID_EDITORS_ORIENT, OnEditorsOrient) ON_COMMAND(ID_EDITORS_EVENTS, OnEditorsEvents) ON_UPDATE_COMMAND_UI(ID_EDITORS_ORIENT,
       OnUpdateEditorsOrient) ON_COMMAND(ID_EDITORS_MESSAGE,
                                         OnEditorsMessage)
ON_COMMAND(ID_EDITORS_STARFIELD, OnEditorsStarfield) ON_COMMAND(ID_EDITORS_BG_BITMAPS, OnEditorsBgBitmaps) ON_COMMAND(ID_EDITORS_REINFORCEMENT,
          OnEditorsReinforcement) ON_COMMAND(ID_ERROR_CHECKER,
                                             OnErrorChecker)
ON_COMMAND(ID_EDITORS_WAYPOINT, OnEditorsWaypoint) ON_COMMAND(ID_VIEW_OUTLINES, OnViewOutlines) ON_UPDATE_COMMAND_UI(ID_VIEW_OUTLINES,
         OnUpdateViewOutlines) ON_UPDATE_COMMAND_UI(ID_NEW_SHIP_TYPE,
                                                    OnUpdateNewShipType)
ON_COMMAND(ID_SHOW_STARFIELD, OnShowStarfield) ON_UPDATE_COMMAND_UI(ID_SHOW_STARFIELD, OnUpdateShowStarfield) ON_COMMAND(ID_ASTEROID_EDITOR,
             OnAsteroidEditor) ON_COMMAND(ID_RUN_FREESPACE,
                                          OnRunFreeSpace)
ON_COMMAND(ID_EDITOR_CAMPAIGN, OnEditorCampaign) ON_COMMAND(ID_SHOW_SHIPS, OnShowShips) ON_UPDATE_COMMAND_UI(ID_SHOW_SHIPS, OnUpdateShowShips) ON_COMMAND(ID_SHOW_STARTS,
                                              OnShowStarts)
ON_UPDATE_COMMAND_UI(ID_SHOW_STARTS, OnUpdateShowStarts) ON_COMMAND(ID_SHOW_IFF_0, OnShowIFF0) ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_0, OnUpdateShowIFF0) ON_COMMAND(ID_SHOW_IFF_1,
                                                    OnShowIFF1)
ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_1, OnUpdateShowIFF1) ON_COMMAND(ID_SHOW_IFF_2, OnShowIFF2) ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_2, OnUpdateShowIFF2) ON_COMMAND(ID_SHOW_IFF_3,
                                                 OnShowIFF3)
ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_3, OnUpdateShowIFF3) ON_COMMAND(ID_SHOW_IFF_4, OnShowIFF4) ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_4, OnUpdateShowIFF4) ON_COMMAND(ID_SHOW_IFF_5,
                                                 OnShowIFF5)
ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_5, OnUpdateShowIFF5) ON_COMMAND(ID_SHOW_IFF_6, OnShowIFF6) ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_6, OnUpdateShowIFF6) ON_COMMAND(ID_SHOW_IFF_7,
                                                 OnShowIFF7)
ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_7, OnUpdateShowIFF7) ON_COMMAND(ID_SHOW_IFF_8, OnShowIFF8) ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_8, OnUpdateShowIFF8) ON_COMMAND(ID_SHOW_IFF_9,
                                                 OnShowIFF9)
ON_UPDATE_COMMAND_UI(ID_SHOW_IFF_9, OnUpdateShowIFF9) ON_COMMAND(ID_TOGGLE_VIEWPOINT, OnToggleViewpoint) ON_COMMAND(ID_REVERT, OnRevert) ON_UPDATE_COMMAND_UI(ID_REVERT,
                                                  OnUpdateRevert)
ON_WM_SETCURSOR()ON_COMMAND(ID_HIDE_OBJECTS, OnHideObjects) ON_COMMAND(ID_SHOW_HIDDEN_OBJECTS, OnShowHiddenObjects) ON_COMMAND(ID_EDIT_UNDO,
                   OnEditUndo) ON_UPDATE_COMMAND_UI(ID_EDIT_UNDO,
                                                    OnUpdateEditUndo)
ON_COMMAND(ID_EDITORS_BRIEFING, OnEditorsBriefing) ON_COMMAND(ID_EDITORS_DEBRIEFING, OnEditorsDebriefing) ON_COMMAND(ID_SAVE_CAMERA, OnSaveCamera) ON_COMMAND(ID_RESTORE_CAMERA,
                                                  OnRestoreCamera)
ON_UPDATE_COMMAND_UI(ID_RESTORE_CAMERA, OnUpdateRestoreCamera) ON_COMMAND(ID_SHOW_SEXP_HELP, OnShowSexpHelp) ON_UPDATE_COMMAND_UI(ID_SHOW_SEXP_HELP,
                      OnUpdateShowSexpHelp) ON_COMMAND(ID_LOOKAT_OBJ,
                                                       OnLookatObj)
ON_UPDATE_COMMAND_UI(ID_LOOKAT_OBJ, OnUpdateLookatObj) ON_COMMAND(ID_EDITORS_ADJUST_GRID, OnEditorsAdjustGrid) ON_COMMAND(ID_EDITORS_SHIELD_SYS,
              OnEditorsShieldSys) ON_COMMAND(ID_LEVEL_OBJ,
                                             OnLevelObj)
ON_COMMAND(ID_ALIGN_OBJ, OnAlignObj) ON_COMMAND(ID_CONTROL_OBJ, OnControlObj) ON_COMMAND(ID_NEXT_OBJ, OnNextObj) ON_COMMAND(ID_PREV_OBJ, OnPrevObj) ON_COMMAND(ID_EDIT_DELETE_WING,
                                                   OnEditDeleteWing)
ON_COMMAND(ID_MARK_WING, OnMarkWing) ON_UPDATE_COMMAND_UI(ID_CONTROL_OBJ, OnUpdateControlObj) ON_COMMAND(ID_EDIT_DELETE, OnEditDelete) ON_COMMAND(ID_AA_GRIDLINES,
                                      OnAaGridlines)
ON_UPDATE_COMMAND_UI(ID_AA_GRIDLINES, OnUpdateAaGridlines) ON_COMMAND(ID_EDITORS_CMD_BRIEF, OnCmdBrief) ON_COMMAND(ID_DISABLE_UNDO, OnDisableUndo) ON_UPDATE_COMMAND_UI(ID_DISABLE_UNDO,
                                                            OnUpdateDisableUndo)
ON_UPDATE_COMMAND_UI(ID_EDITORS_CMD_BRIEF, OnUpdateCmdBrief) ON_COMMAND(ID_NEXT_SUBSYS, OnNextSubsys) ON_COMMAND(ID_PREV_SUBSYS, OnPrevSubsys) ON_COMMAND(ID_CANCEL_SUBSYS,
                                              OnCancelSubsys)
ON_COMMAND(ID_DUMP_STATS, OnDumpStats) ON_COMMAND(ID_SHOW_PATHS, OnShowPaths) ON_UPDATE_COMMAND_UI(ID_SHOW_PATHS, OnUpdateShowPaths) ON_COMMAND(ID_SHOW_DOCK_POINTS,
                                    OnShowDockPoints)
ON_UPDATE_COMMAND_UI(ID_SHOW_DOCK_POINTS, OnUpdateShowDockPoints) ON_COMMAND(ID_FORMAT_FS2_OPEN, OnFormatFs2Open) ON_UPDATE_COMMAND_UI(ID_FORMAT_FS2_OPEN,
                           OnUpdateFormatFs2Open)
ON_COMMAND(ID_FORMAT_FS2_OPEN_COMP, OnFormatFs2OpenComp) ON_UPDATE_COMMAND_UI(ID_FORMAT_FS2_OPEN_COMP, OnUpdateFormatFs2OpenComp) ON_COMMAND(ID_FORMAT_FS2_RETAIL,
                                 OnFormatFs2Retail)
ON_UPDATE_COMMAND_UI(ID_FORMAT_FS2_RETAIL, OnUpdateFormatFs2Retail) ON_COMMAND(ID_FORMAT_FS1_RETAIL, OnFormatFs1Retail) ON_UPDATE_COMMAND_UI(ID_FORMAT_FS1_RETAIL,
                                 OnUpdateFormatFs1Retail)
ON_COMMAND(ID_EDITORS_SET_GLOBAL_SHIP_FLAGS, OnEditorsSetGlobalShipFlags) ON_COMMAND(ID_EDITORS_VOICE, OnEditorsVoiceManager) ON_COMMAND(ID_EDITORS_FICTION,
                             OnEditorsFiction)
ON_WM_DESTROY()ON_WM_CREATE()ON_WM_ERASEBKGND()ON_COMMAND(ID_VIEW_LIGHTING, OnViewLighting) ON_UPDATE_COMMAND_UI(ID_VIEW_LIGHTING, OnUpdateViewLighting) ON_COMMAND(ID_VIEW_FULL_DETAIL,
                                                        OnViewFullDetail)
...
ON_COMMAND_RANGE(ID_SET_GROUP1, ID_SET_GROUP9, OnSetGroup) END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
...
void CALLBACK expire_game_proc(HWND wnd, UINT uMsg, UINT idEvent,
                               DWORD dwTime)
{
  KillTimer(wnd, 1);
  if (expire_game == EXPIRE_BAD_CHECKSUM)
    MessageBox(wnd, "Fred can no longer run due to internal overlay error",
               NULL, MB_OK | MB_ICONERROR | MB_TASKMODAL | MB_SETFOREGROUND);
  else
    MessageBox(wnd,
               "Error: cannot enter DOS mode for 80x40 color text mode display.",
               NULL, MB_OK | MB_ICONERROR | MB_TASKMODAL | MB_SETFOREGROUND);
  exit(1);
}
...
#ifdef _DEBUG
void CFREDView::AssertValid() const const
{
  CView::AssertValid();
}

void CFREDView::Dump(CDumpContext & dc) const const
{
  CView::Dump(dc);
}
  ...
  if (Single_axis_constraint)
    {
      ...
      r =
        fvi_ray_plane(&int_pnt, &tmpObject, &tmpAnticonstraint, &view_pos,
                      &cursor_dir, 0.0f);
    ...
    {
      r =
        fvi_ray_plane(&int_pnt, &obj, &Anticonstraint, &view_pos, &cursor_dir,
                      0.0f);
          ...
          if (objp->flags & OF_MARKED)
            {
              ...
              if (objp->type == OBJ_WAYPOINT)
                {
                  Waypoint_lists[objp->instance /
                                 65536].waypoints[objp->instance & 0xffff] =
                    objp->pos;
                }
            }
              ...
              if (objp->flags & OF_MARKED)
                {
                  ...
                  if (!IS_VEC_NULL
                      (&rotation_backup[obj_index].orient.vec.rvec)
                      && !IS_VEC_NULL(&rotation_backup[obj_index].orient.vec.
                                      uvec)
                      && !IS_VEC_NULL(&rotation_backup[obj_index].orient.vec.
                                      fvec))
                    {
...
void CFREDView::OnLButtonDown(UINT nFlags, CPoint point)
{
  ...
  if (nFlags & MK_CONTROL)      // add a new object
  ...
  else if (!Selection_lock)
    {
      ...
      else if ((nFlags & MK_SHIFT) || (on_object == -1)
               || !(Objects[on_object].flags & OF_MARKED))
        {
          if (!(nFlags & MK_SHIFT))
            unmark_all();
  ...
  if (query_valid_object() && (Marked == 1)
      && (Objects[cur_object_index].type == OBJ_POINT))
    {
...
void CFREDView::OnMouseMove(UINT nFlags, CPoint point)
{
  ...
  if (button_down)
    {
      if (abs(marking_box.x1 - marking_box.x2) > 1
          || abs(marking_box.y1 - marking_box.y2) > 1)
        moved = 1;
  ...
  if (button_down)
    {
      ...
      if (Bg_bitmap_dialog)
      ...
      else
        {
          ...
          else if ((!moved && on_object != -1) && !Selection_lock
                   && !(nFlags & MK_SHIFT))
            {
              unmark_all();
              mark_object(on_object);
      ...
      if (Dup_drag == DUP_DRAG_OF_WING)
        {
          ...
          sprintf(msg, "Add cloned ships to wing %s?",
                  Wings[Duped_wing].name);
                  ...
                  if (objp->flags & OF_MARKED)
                    {
                      ...
                      sprintf(Ships[ship].ship_name, "%s %d",
                              Wings[Duped_wing].name,
                              Wings[Duped_wing].wave_count + 1);

                      Wings[Duped_wing].ship_index[Wings[Duped_wing].
                                                   wave_count] = ship;
  ...
  if (GetActiveWindow() != Fred_main_wnd)
    {
      ...
      Fred_main_wnd->SetWindowPos(&wndTop, 0, 0, 0, 0,
                                  SWP_NOMOVE | SWP_NOSIZE);
      nprintf(("Fred routing",
        ...
        if (!(g3_project_vertex(&v) & PF_OVERFLOW))
          {
            ...
            if (x >= marking_box.x1 && x <= marking_box.x2
                && y >= marking_box.y1 && y <= marking_box.y2)
              {
      ...
      if (menu.LoadMenu(IDR_MENU_SHIP_POPUP))
        {
          ...
          ASSERT(pPopup != NULL);
          if (Marked > 1)
            pPopup->ModifyMenu(ID_EDITORS_SHIPS, MF_BYCOMMAND | MF_STRING,
                               ID_EDITORS_SHIPS, "Edit Marked Ships");
          else
            {
              CString str;

              if ((Objects[objnum].type == OBJ_START)
              ...
              else if (Objects[objnum].type == OBJ_WAYPOINT)
                {
                  id = ID_EDITORS_WAYPOINT;
                  str.Format("Edit %s:%d",
                             Waypoint_lists[Objects[objnum].instance /
                                            65536].name,
      ...
      if (menu.LoadMenu(IDR_MENU_EDIT_POPUP))
        {
          ...
          shipPopup.AppendMenu(MF_STRING | MF_ENABLED,
                               SHIP_TYPES + Id_select_type_waypoint,
                               "Waypoint");
          shipPopup.AppendMenu(MF_STRING | MF_ENABLED,
                               SHIP_TYPES + Id_select_type_start,
                               "Player Start");
          shipPopup.AppendMenu(MF_STRING | MF_ENABLED,
                               SHIP_TYPES + Id_select_type_jump_node,
                               "Jump Node");
          for (i = 0; i < (int) Species_info.size(); i++)
            {
              species_submenu[i].CreatePopupMenu();
              shipPopup.AppendMenu(MF_STRING | MF_POPUP | MF_ENABLED,
                                   (UINT) species_submenu[i].m_hMenu,
...
BOOL CFREDView::OnCmdMsg(UINT nID, int nCode, void *pExtra,
      ...
      if ((id >= SHIP_TYPES) && (id < SHIP_TYPES + Num_ship_classes + 3))
        {
          if (nCode == CN_COMMAND)
          ...
          else if (nCode == CN_UPDATE_COMMAND_UI)
            {
              ...
              ((CCmdUI *) pExtra)->SetCheck(cur_model_index + SHIP_TYPES ==
                                            id);
...
{
  pCmdUI->SetRadio(Constraint.xyz.x && !Constraint.xyz.y
                   && !Constraint.xyz.z);
}
          ...
          while (v.codes & CC_OFF)      // is point off screen?
            {
              ...
              vm_vec_scale_add(&view_pos, &center, &view_orient.vec.fvec,
                               -dist);
              g3_set_view_matrix(&view_pos, &view_orient, Viewer_zoom_FRED);
              g3_rotate_vertex(&v, &ptr->pos);
              if (g3_project_vertex(&v) & PF_OVERFLOW)
  ...
  if (query_valid_object())
    {
      if (Marked > 1)
        ...
        vm_vec_scale_add(&view_pos, &Objects[cur_object_index].pos,
                         &view_orient.vec.fvec,
  ...
  while (i--)
    {
      ...
      if ((Objects[obj].type != OBJ_SHIP) && (Objects[obj].type != OBJ_START))
        Error(LOCATION, "Invalid objects detected in wing \"%s\"",
              Wings[cur_wing].name);
...
void CFREDView::OnEditorsEvents()
{
  ...
  Event_editor_dlg->SetWindowPos(&wndTop, 0, 0, 0, 0,
                                 SWP_SHOWWINDOW | SWP_NOMOVE | SWP_NOSIZE);
...
void CFREDView::OnEditorsMessage()
{
  ...
  Message_editor_dlg->SetWindowPos(&wndTop, 0, 0, 0, 0,
                                   SWP_SHOWWINDOW | SWP_NOMOVE | SWP_NOSIZE);
...
int CFREDView::global_error_check()
{
  ...
  while (ptr != END_OF_LIST(&obj_used_list))
    {
      ...
      if ((ptr->type == OBJ_SHIP) || (ptr->type == OBJ_START))
          ...
          if (ptr->type == OBJ_START)
            {
              ...
              if (!count && Ships[i].weapons.num_secondary_banks > 0)
                {
                  if (error
                      ("Player \"%s\" has no secondary weapons.  Should have at least 1",
                       Ships[i].ship_name))
                    {
                      return 1;
                    }
          ...
          if (wing >= 0)        // ship is part of a wing, so check this
            {
              ...
              if (j < 0 || j > MAX_SHIPS_PER_WING)
                {
                  return
                    internal_error("Invalid number of ships in wing \"%s\"",
                                   Wings[z].name);
                }
        ...
        {
          return internal_error("An unknown object type (%d) was detected",
                                ptr->type);
        }
          ...
          if (names[i] && names[obj_count])
            {
              if (!stricmp(names[i], names[obj_count]))
                {
                  return internal_error("Duplicate object names (%s)",
                                        names[i]);
                }
            }
        }
      ...
      if (Ships[i].objnum >= 0) // is ship being used?
        {
          ...
          if (fred_check_sexp
              (Ships[i].arrival_cue, OPR_BOOL, "arrival cue of ship \"%s\"",
               Ships[i].ship_name))
            {
              return -1;
            }
          ...
          if (fred_check_sexp
              (Ships[i].departure_cue, OPR_BOOL,
               "departure cue of ship \"%s\"", Ships[i].ship_name))
            {
              return -1;
            }
          ...
          if (ai < 0 || ai >= MAX_AI_INFO)
            {
              return internal_error("AI index out of range for ship \"%s\"",
                                    Ships[i].ship_name);
            }
          ...
          if ((str =
               error_check_initial_orders(Ai_info[ai].goals, i, -1)) > 0)
            {
              if (*str == '*')
                return
                  internal_error("Initial orders error for ship \"%s\"\n\n%s",
          ...
          for (dock_instance * dock_ptr = Objects[Ships[i].objnum].dock_list;
               dock_ptr != NULL; dock_ptr = dock_ptr->next)
            {
              ...
              if (!ship_docking_valid(i, ship)
                  && !ship_docking_valid(ship, i))
                {
                  return
                    internal_error
              ...
              z =
                get_docking_list(Ship_info[Ships[i].ship_info_index].
                                 model_num);
              ...
              z =
                get_docking_list(Ship_info[Ships[ship].ship_info_index].
                                 model_num);
              point =
                dock_find_dockpoint_used_by_object(dock_ptr->docked_objp,
      ...
      if (j)                    // is wing being used?
        {
          ...
          if (j < 0 || j > MAX_SHIPS_PER_WING)
            {
              return internal_error("Invalid number of ships in wing \"%s\"",
                                    Wings[i].name);
            }
          ...
          while (j--)
            {
              ...
              if ((Objects[obj].type == OBJ_SHIP)
              ...
              else
                {
                  return
                    internal_error
                    ("Wing_objects of \"%s\" references an illegal object type",
                     Wings[i].name);
                }
          ...
          if ((Wings[i].special_ship < 0)
              || (Wings[i].special_ship >= Wings[i].wave_count))
            {
              return internal_error("Special ship out of range for \"%s\"",
                                    Wings[i].name);
            }

          if (Wings[i].num_waves < 0)
            {
              return internal_error("Number of waves for \"%s\" is negative",
                                    Wings[i].name);
            }

          if ((Wings[i].threshold < 0)
              || (Wings[i].threshold >= Wings[i].wave_count))
            {
              return internal_error("Threshold for \"%s\" is invalid",
                                    Wings[i].name);
            }
          ...
          if (Wings[i].threshold + Wings[i].wave_count > MAX_SHIPS_PER_WING)
            {
              ...
              if (error
                  ("Threshold for wing \"%s\" is higher than allowed.  Reset to %d",
                   Wings[i].name, Wings[i].threshold))
                {
                  return 1;
                }
            }
                  ...
                  if (!stricmp(names[j], Wings[i].name))
                    {
                      return
                        internal_error
                        ("Wing name is also used by an object (%s)",
                         names[j]);
                    }
                }
            }
          ...
          if (fred_check_sexp
              (Wings[i].arrival_cue, OPR_BOOL, "arrival cue of wing \"%s\"",
               Wings[i].name))
            {
              return -1;
            }
          ...
          if (fred_check_sexp
              (Wings[i].departure_cue, OPR_BOOL,
               "departure cue of wing \"%s\"", Wings[i].name))
            {
              return -1;
            }
          ...
          if ((str =
               error_check_initial_orders(Wings[i].ai_goals, -1, i)) > 0)
            {
              if (*str == '*')
                return
              ...
              if (!stricmp(names[z], Waypoint_lists[i].name))
                {
                  return
                    internal_error
                    ("Waypoint path name is also used by an object (%s)",
                     names[z]);
                }
            }
        }
      ...
      while (j--)
        {
          ...
          if (z == obj_count)
            {
              return internal_error("Waypoint \"%s\" not linked to an object",
                                    buf);
            }
        }
    }
  ...
  for (i = 0; i < Num_reinforcements; i++)
    {
      ...
      for (ship = 0; ship < MAX_SHIPS; ship++)
        {
          if ((Ships[ship].objnum >= 0)
              && !stricmp(Ships[ship].ship_name, Reinforcements[i].name))
            {
              z = 1;
              break;
            }
      ...
      for (wing = 0; wing < MAX_WINGS; wing++)
        {
          if (Wings[wing].wave_count
              && !stricmp(Wings[wing].name, Reinforcements[i].name))
            {
              z = 1;
              break;
            }
      ...
      if (!z)
        {
          return
            internal_error("Reinforcement name not found in ships or wings");
        }
    }
  ...
  for (i = 0; i < Num_mission_events; i++)
    {
      if (fred_check_sexp
          (Mission_events[i].formula, OPR_NULL, "mission event \"%s\"",
  ...
  for (i = 0; i < Num_goals; i++)
    {
      if (fred_check_sexp
          (Mission_goals[i].formula, OPR_BOOL, "mission goal \"%s\"",
           Mission_goals[i].name))
        {
          return -1;
        }
    }
          ...
          for (i = 0; i < t - 1; i++)
            {
              for (j = i + 1; j < t; j++)
                {
                  if ((sp->icons[i].id > 0)
                      && (sp->icons[i].id == sp->icons[j].id))
                    {
                      if (error
                          ("Duplicate icon IDs %d in briefing stage %d",
                           sp->icons[i].id, s + 1))
                        {
                          return 1;
                        }
  ...
  for (j = 0; j < Num_teams; j++)
    {
      for (i = 0; i < Debriefings[j].num_stages; i++)
        {
          if (fred_check_sexp
              (Debriefings[j].stages[i].formula, OPR_BOOL,
               "debriefing stage %d", i + 1))
            {
              return -1;
            }
        }
  ...
  if (multi && The_mission.game_type & MISSION_TYPE_MULTI_TEAMS)
      ...
      for (i = 0; i < MAX_TVT_WINGS; i++)
        {
          if (TVT_wings[i] >= 0 && Wings[TVT_wings[i]].wave_count > 4)
            {
              if (error
                  ("%s wing has too many ships.  Should only have 4 max.",
                   TVT_wing_names[i]))
                return 1;
            }
        }
  ...
  else
    {
      for (i = 0; i < MAX_STARTING_WINGS; i++)
        {
          if (Starting_wings[i] >= 0
              && Wings[Starting_wings[i]].wave_count > 4)
            {
              if (error
                  ("%s wing has too many ships.  Should only have 4 max.",
                   Starting_wing_names[i]))
      ...
      for (i = 0; i < MAX_TVT_WINGS; i++)
        {
          if (TVT_wings[i] >= 0 && Wings[TVT_wings[i]].arrival_delay > 0)
            {
              if (error
                  ("%s wing shouldn't have a non-zero arrival delay",
                   TVT_wing_names[i]))
                return 1;
            }
        }
      ...
      for (i = 0; i < MAX_TVT_WINGS; i++)
        {
          if (!tvt_wing_count[i])
            {
              if (error
                  ("%s wing doesn't contain any players (which it should)",
                   TVT_wing_names[i]))
                return 1;
            }
        }
...
int CFREDView::internal_error(char *msg, ...)
{
  ...
  if (MessageBox(buf2, "Internal Error", MB_OKCANCEL | MB_ICONEXCLAMATION) ==
      IDCANCEL)
  ...
  if (ship >= 0)
    {
      ...
      for (i = 0; i < MAX_AI_GOALS; i++)
        if (!ai_query_goal_valid(ship, goals[i].ai_mode))
          {
            if (Fred_view_wnd->
                error("Order \"%s\" isn't allowed for ship \"%s\"",
  ...
  else
    {
      ...
      for (j = 0; j < Wings[wing].wave_count; j++)
        for (i = 0; i < MAX_AI_GOALS; i++)
          if (!ai_query_goal_valid
              (Wings[wing].ship_index[j], goals[i].ai_mode))
            {
              if (Fred_view_wnd->
                  error("Order \"%s\" isn't allowed for ship \"%s\"",
  ...
  for (i = 0; i < MAX_AI_GOALS; i++)
    {
      ...
      else if (flag == 3)       // target wing required
        {
          for (j = 0; j < MAX_WINGS; j++)
            if (Wings[j].wave_count
                && !stricmp(Wings[j].name, goals[i].ship_name))
              break;
          ...
          if (ship >= 0)        // check if ship is in target wing
            {
              if (Ships[ship].wingnum == j)
                return
                  "Target wing of ship's goal is same wing said ship is part of";
            }
          ...
          while (ptr != END_OF_LIST(&obj_used_list))
            {
              if (ptr->type == OBJ_SHIP || ptr->type == OBJ_START)
                ...
                {
                  if (!stricmp
                      (goals[i].ship_name, object_name(OBJ_INDEX(ptr))))
                    {
                      found = 1;
                      break;
                    }
      ...
      switch (goals[i].ai_mode)
        ...
        case AI_GOAL_DESTROY_SUBSYSTEM:
          ...
          if (ship_get_subsys_index(&Ships[inst], goals[i].docker.name, 1) <
              0)
        ...
        case AI_GOAL_DOCK:
          {
            ...
            if ((dock1 >= 0) && (dock2 >= 0))
              {
                if (!
                    (model_get_dock_index_type(model1, dock1) &
                     model_get_dock_index_type(model2, dock2)))
...
void CFREDView::OnRunFreeSpace()
{
  ...
  if (fred_index != std::string::npos)
    {
      ...
      r =
        CreateProcess(processed_name.c_str(), cmdline, NULL, NULL, FALSE, 0,
                      NULL, "./", &si, &pi);
      if (r)
        {
          return;
  ...
  r =
    CreateProcess("wcsaga_sse2.exe", cmdline, NULL, NULL, FALSE, 0, NULL,
                  "./", &si, &pi);
  ...
  if (!r)
    {
      ...
      r =
        CreateProcess("wcsaga_sse.exe", cmdline, NULL, NULL, FALSE, 0, NULL,
                      "./", &si, &pi);
    }
  ...
  if (!r)
    {
      ...
      r =
        CreateProcess("wcsaga.exe", cmdline, NULL, NULL, FALSE, 0, NULL, "./",
                      &si, &pi);
    }
...
void CFREDView::OnEditorCampaign()
{
  ...
  if (Campaign_wnd->
      Create(NULL, "Campaign Editor", WS_OVERLAPPEDWINDOW | WS_MAXIMIZE,
  ...
  if (wing != -1)
    {
      ...
      Assert(Wings[wing].special_ship >= 0
             && Wings[wing].special_ship < Wings[wing].wave_count);
...
int get_next_visible_subsys(ship * shipp, ship_subsys ** next_subsys)
{
  ...
  for (*next_subsys = GET_NEXT(*next_subsys);
       *next_subsys != END_OF_LIST(&shipp->subsys_list);
...
int get_prev_visible_subsys(ship * shipp, ship_subsys ** prev_subsys)
{
  ...
  for (*prev_subsys = GET_PREV(*prev_subsys);
       *prev_subsys != END_OF_LIST(&shipp->subsys_list);
      ...
      if (Render_subsys.ship_obj == objp)
        {
          ...
          if (Render_subsys.do_render)
            {
              if (!get_next_visible_subsys
                  (&Ships[objp->instance], &Render_subsys.cur_subsys))
                {
                  OnCancelSubsys();
                }
            }
...
void CFREDView::OnPrevSubsys()
{
  ...
  if (!get_prev_visible_subsys
      (&Ships[Objects[cur_object_index].instance], &Render_subsys.cur_subsys))
    {
      OnCancelSubsys();
    }
