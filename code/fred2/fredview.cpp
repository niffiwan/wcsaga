...
matrix bitmap_matrix_backup, saved_cam_orient =
{
0.0f};
...
ON_UPDATE_COMMAND_UI(ID_EDIT_POPUP_SHOW_SHIP_ICONS,
                     OnUpdateEditPopupShowShipIcons) 
ON_COMMAND(ID_EDIT_POPUP_SHOW_SHIP_MODELS,
           OnEditPopupShowShipModels) 
ON_UPDATE_COMMAND_UI(ID_EDIT_POPUP_SHOW_SHIP_MODELS,
                     OnUpdateEditPopupShowShipModels) 
ON_COMMAND(ID_MISC_STATISTICS,
           OnMiscStatistics)  ON_COMMAND(ID_EDIT_POPUP_SHOW_COMPASS,
                                          OnEditPopupShowCompass) 
ON_UPDATE_COMMAND_UI(ID_EDIT_POPUP_SHOW_COMPASS,
                     OnUpdateEditPopupShowCompass) 
ON_UPDATE_COMMAND_UI(ID_CHANGE_VIEWPOINT_EXTERNAL,
                     OnUpdateChangeViewpointExternal) 
ON_COMMAND(ID_CHANGE_VIEWPOINT_EXTERNAL,
           OnChangeViewpointExternal) 
ON_UPDATE_COMMAND_UI(ID_CHANGE_VIEWPOINT_FOLLOW,
                     OnUpdateChangeViewpointFollow) 
ON_COMMAND(ID_CHANGE_VIEWPOINT_FOLLOW,
           OnChangeViewpointFollow)  ON_COMMAND(ID_EDITORS_GOALS,
                                                 OnEditorsGoals) 
ON_COMMAND(ID_SPEED1, OnSpeed1)  ON_COMMAND(ID_SPEED2,
                                             OnSpeed2)  ON_COMMAND(ID_SPEED5,
                                                                    OnSpeed5)
 ON_COMMAND(ID_SPEED10, OnSpeed10)  ON_UPDATE_COMMAND_UI(ID_SPEED1, OnUpdateSpeed1)  ON_COMMAND(ID_SPEED3,
                                                            OnSpeed3) 
...
 void CFREDView::OnBeginPrinting(CDC * /*pDC */ ,
                                   CPrintInfo * /*pInfo */ ) 
{
  
    // TODO: add extra initialization before printing
}  void CFREDView::OnEndPrinting(CDC * /*pDC */ ,
                                   CPrintInfo * /*pInfo */ ) 
{
        ...
        
        {
            ...
            
            {
                ...
                
                {
                         ...
                         && !IS_VEC_NULL(&rotation_backup[obj_index].orient.
                                          vec.uvec)
                         && !IS_VEC_NULL(&rotation_backup[obj_index].orient.
                                          vec.fvec))
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                      ...
                       wing_objects[Duped_wing][Wings[Duped_wing].
                                                  wave_count] =
                        OBJ_INDEX(objp);
...
void CFREDView::OnContextMenu(CWnd * /*pWnd */ , CPoint point) 
{
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
               pPopup->ModifyMenu(ID_EDITORS_SHIPS,
                                    MF_BYCOMMAND | MF_STRING, id, str);
    ...
    
    {
        ...
        
        {
            ...
            species_submenu[Ship_info[i].species].
              AppendMenu(MF_STRING | MF_ENABLED, SHIP_TYPES + i,
                         Ship_info[i].name);
...
 void CFREDView::OnMiscStatistics() 
{
             ...
             "Number of Ships:   %d\n" 
             "Number of Wings:   %d\n", Num_objects, ship_get_num_ships(),
             Num_wings);
...
 int CFREDView::global_error_check() 
{
    ...
    
    {
      if (Ships[i].objnum >= 0)        // is ship being used?
        {
            ...
            
            {
                 ...
                 (Ships[i].arrival_cue, OPR_BOOL,
                  "arrival cue of ship \"%s\"", Ships[i].ship_name))
          ...
            for (dock_instance * dock_ptr =
                    Objects[Ships[i].objnum].dock_list; dock_ptr != NULL;
    ...
    
    {
      ...
      if (j)                   // is wing being used?
        {
          ...
           if (Wings[i].threshold + Wings[i].wave_count >
                 MAX_SHIPS_PER_WING)
            ...
            
            {
                ...
                
                {
                 ...
                 (Wings[i].arrival_cue, OPR_BOOL,
                  "arrival cue of wing \"%s\"", Wings[i].name))
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                internal_error("Waypoint \"%s\" not linked to an object",
                               buf);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                {
                  if (global_error_check_mixed_player_wing
                       (Starting_wings[i]))
...
}  void CFREDView::OnRunFreeSpace() 
{
    ...
    
    {
        ...
        r =
        CreateProcess(processed_name.c_str(), NULL, NULL, NULL, FALSE, 0,
                      NULL, "./", &si, &pi);
    ...
    CreateProcess("start_fs2.bat", NULL, NULL, NULL, FALSE, 0, NULL, "./",
                  &si, &pi);
   if (!r)
    
    {
      r =
        CreateProcess("fs2_open.exe", NULL, NULL, NULL, FALSE, 0, NULL, "./",
                      &si, &pi);
    ...
    
    {
        ...
        CreateProcess("fs2_open_r.exe", NULL, NULL, NULL, FALSE, 0, NULL,
                      "./", &si, &pi);
...
 void CFREDView::OnPrevSubsys() 
{
    ...
    
    {
         ...
         || (Objects[cur_object_index].type != OBJ_SHIP)
    ...
    
    {
         ...
         (&Ships[Objects[cur_object_index].instance],
          &Render_subsys.cur_subsys))
