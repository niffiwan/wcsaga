...
BEGIN_MESSAGE_MAP(campaign_tree_view, CScrollView)
  ...
  ON_WM_LBUTTONDOWN()ON_WM_MOUSEMOVE()ON_WM_LBUTTONUP()ON_WM_CREATE
  ()ON_WM_CONTEXTMENU()ON_COMMAND(ID_REMOVE_MISSION,
                                  OnRemoveMission) ON_COMMAND(ID_DELETE_ROW,
                                                              OnDeleteRow)
ON_COMMAND(ID_INSERT_ROW, OnInsertRow) ON_COMMAND(ID_ADD_REPEAT,
                                                  OnAddRepeat)
