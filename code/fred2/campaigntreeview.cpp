...
#endif  /*  */
LOCAL int Bx, By, Mission_dragging = -1, Mission_dropping =
  -1, Context_mission;
...
 void campaign_tree_view::OnDraw(CDC * pDC) 
{
    ...
    FillRect(CRect
             (0, 0, total_width * CELL_WIDTH, total_levels * LEVEL_HEIGHT),
             &gray_brush);
    ...
    
    {
      ...
      GetTextExtentPoint32(pDC->m_hDC, str, strlen(str), &size);
        ...
        
        {
          ...
          pDC->Draw3dRect(x - Bx / 2, y - By / 2, Bx, By, RGB(0, 0, 0),
                           RGB(255, 255, 255));
        ...
        
        {
          ...
          pDC->Draw3dRect(x - Bx / 2, y - By / 2, Bx, By, RGB(255, 255, 255),
                           RGB(0, 0, 0));
    ...
    
    {
        ...
        Elements[f].box.left +
        Links[i].from_pos * Bx / (Elements[f].from_links + 1);
      Links[i].p1.y = Elements[f].box.bottom;
      Links[i].p2.x =
        Elements[t].box.left + Links[i].to_pos * Bx / (Elements[t].to_links +
                                                       1);
...
#ifdef _DEBUG
void campaign_tree_view::AssertValid() const const 
{
  CScrollView::AssertValid();
}  void campaign_tree_view::Dump(CDumpContext & dc) const const 
{
...
}  void stuff_link_with_formula(int *link_idx, int formula,
                                   int mission_num) 
{
...
void campaign_tree_view::construct_tree() 
{
  ...
  int link_idx = 0;
    ...
    
    {
        ...
        {
          stuff_link_with_formula(&link_idx,
                                   Campaign.missions[i].mission_loop_formula,
                                   i);
          Links[link_idx - 1].mission_loop_txt =
            Campaign.missions[i].mission_loop_desc;
          Links[link_idx - 1].mission_loop_brief_anim =
            Campaign.missions[i].mission_loop_brief_anim;
          Links[link_idx - 1].mission_loop_brief_sound =
            Campaign.missions[i].mission_loop_brief_sound;
...
 void campaign_tree_view::initialize() 
{
    ...
    
    {
                  ...
                  CSize(total_width * CELL_WIDTH,
                        total_levels * LEVEL_HEIGHT));
    ...
    
    {
        ...
        for (j = 0; j < to_count - 1; j++)
          ...
          
          {
              ...
              Campaign.missions[Links[to_list[j]].from].pos -
        ...
        for (j = 0; j < from_count - 1; j++)
          ...
          
          {
              ...
              Campaign.missions[Links[from_list[j]].to].pos -
              ...
              
              {
                  ...
                  Campaign.missions[Links[from_list[j]].to].level -
    ...
    
    {
        ...
        
        {
          ...
          char buffer[MISSION_DESC_LENGTH];
            ...
            (CEdit *) Campaign_tree_formp->GetDlgItem(IDC_MISSISON_LOOP_DESC);
            ...
            // save mission loop desc
            box =
            (CEdit *) Campaign_tree_formp->GetDlgItem(IDC_LOOP_BRIEF_ANIM);
            ...
            
            {
              ...
              Links[Cur_campaign_link].mission_loop_brief_anim =
                strdup(buffer);
            ...
            // save mission loop desc
            box =
            (CEdit *) Campaign_tree_formp->GetDlgItem(IDC_LOOP_BRIEF_SOUND);
            ...
            
            {
              ...
              Links[Cur_campaign_link].mission_loop_brief_sound =
                strdup(buffer);
          ...
          
          {
              ...
              
              {
                  ...
                  convert_multiline_string(Campaign.
                                           missions[Cur_campaign_mission].
                                           notes);
                box =
                  (CEdit *) Campaign_tree_formp->GetDlgItem(IDC_HELP_BOX);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    if ((Campaign.missions[i].level == level)
                         && (Campaign.missions[i].pos + 1 == pos))
...
 void campaign_tree_view::OnLButtonUp(UINT nFlags, CPoint point) 
{
  ...
  if (Mission_dropping >= 0)   // dropping a new mission into campaign?
    {
        ...
        
        {
          ...
          dc.DrawDragRect(Dragging_rect, CSize(0, 0), Dragging_rect,
                           Last_draw_size);
...
void campaign_tree_view::drop_mission(int m, CPoint point) 
{
    ...
    
    {
      ...
       sprintf(buf, "Filename is too long.  Must be %d or less characters.",
                 MAX_FILENAME_LEN);
    ...
    
    {
        ...
        
        {
          ...
           sprintf(buf, "Mission \"%s\" is not a multiplayer mission",
                     name);
  ...
   Elements[Campaign.num_missions].from_links =
    Elements[Campaign.num_missions].to_links = 0;
...
 void campaign_tree_view::correct_position(int num) 
{
    ...
    if (Campaign.missions[num].level + 2 > total_levels)
      ...
      
      {
             ...
             && (Campaign.missions[num].level >= Campaign.missions[z].level))
...
 void campaign_tree_view::OnDeleteRow() 
{
    ...
    
    {
        ...
        MessageBox("Deleting row will remove all missions on this row",
                   "Notice", MB_ICONEXCLAMATION | MB_OKCANCEL);
