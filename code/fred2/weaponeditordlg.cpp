  ...
  if (pDX->m_bSaveAndValidate)
    {
      ...
      if (save_number((char *) (LPCSTR) str, &m_ammo1))
        {
          m_ammo_max1 =
            (m_missile1 <= 0) ? 0 : get_max_ammo_count_for_bank(m_ship_class,
                                                                0,
                                                                m_missile1 +
      ...
      if (save_number((char *) (LPCSTR) str, &m_ammo2))
        {
          m_ammo_max2 =
            (m_missile2 <= 0) ? 0 : get_max_ammo_count_for_bank(m_ship_class,
                                                                1,
                                                                m_missile2 +
                                                                First_secondary_index
                                                                - 1);
      ...
      if (save_number((char *) (LPCSTR) str, &m_ammo3))
        {
          m_ammo_max3 =
            (m_missile3 <= 0) ? 0 : get_max_ammo_count_for_bank(m_ship_class,
                                                                2,
                                                                m_missile3 +
                                                                First_secondary_index
                                                                - 1);
      ...
      if (save_number((char *) (LPCSTR) str, &m_ammo4))
        {
          m_ammo_max4 =
            (m_missile4 <= 0) ? 0 : get_max_ammo_count_for_bank(m_ship_class,
                                                                3,
                                                                m_missile4 +
                                                                First_secondary_index
                                                                - 1);
      ...
      if (save_number((char *) (LPCSTR) str, &m_ammo5))
        {
          m_ammo_max5 =
            (m_missile5 <= 0) ? 0 : get_max_ammo_count_for_bank(m_ship_class,
                                                                4,
                                                                m_missile5 +
                                                                First_secondary_index
                                                                - 1);
      ...
      if (save_number((char *) (LPCSTR) str, &m_ammo6))
        {
          m_ammo_max6 =
            (m_missile6 <= 0) ? 0 : get_max_ammo_count_for_bank(m_ship_class,
                                                                5,
                                                                m_missile6 +
                                                                First_secondary_index
                                                                - 1);
...
ON_WM_CLOSE()ON_CBN_SELCHANGE(IDC_MISSILE1, OnSelchangeMissile1)
  ...
  for (i = 0; i < end1; i++)
    {
      if ((Weapon_info[i].wi_flags & WIF_CHILD)
          || (!big && (Weapon_info[i].wi_flags & WIF_BIG_ONLY)))
        {
          end1 = i;
        }
    }
...
void WeaponEditorDlg::change_selection()
{
  ...
  if (m_last_item >= 0)
    {
      ...
      cur_weapon->secondary_bank_ammo[0] =
        m_ammo_max1 ? (m_ammo1 * 100 / m_ammo_max1) : 0;
      cur_weapon->secondary_bank_ammo[1] =
        m_ammo_max2 ? (m_ammo2 * 100 / m_ammo_max2) : 0;
      cur_weapon->secondary_bank_ammo[2] =
        m_ammo_max3 ? (m_ammo3 * 100 / m_ammo_max3) : 0;
      cur_weapon->secondary_bank_ammo[3] =
        m_ammo_max4 ? (m_ammo4 * 100 / m_ammo_max4) : 0;
      cur_weapon->secondary_bank_ammo[4] =
        m_ammo_max5 ? (m_ammo5 * 100 / m_ammo_max5) : 0;
      cur_weapon->secondary_bank_ammo[5] =
        m_ammo_max6 ? (m_ammo6 * 100 / m_ammo_max6) : 0;
      if (m_multi_edit)
        {
          if (!strlen(a1))
  ...
  m_gun1 = m_gun2 = m_gun3 = m_missile1 = m_missile2 = m_missile3 =
    m_missile4 = m_missile5 = m_missile6 = -1;
  m_ammo1 = m_ammo2 = m_ammo3 = m_ammo4 = m_ammo5 = m_ammo6 = BLANK_FIELD;
  m_ammo_max1 = m_ammo_max2 = m_ammo_max3 = m_ammo_max4 = m_ammo_max5 =
    m_ammo_max6 = 0;
  if (m_cur_item < 0)
    {
  ...
  cur_weapon =
    (ship_weapon *) ((CListBox *) GetDlgItem(IDC_LIST))->
    GetItemDataPtr(m_cur_item);
  ...
  if (cur_weapon->num_secondary_banks > 0)
    {
      ...
      if (m_missile1 > 0)
        {
          m_ammo_max1 =
            get_max_ammo_count_for_bank(m_ship_class, 0, m_missile1 - 1);
          if (cur_weapon->secondary_bank_ammo[0] != BLANK_FIELD)
            m_ammo1 =
              (int) ((cur_weapon->secondary_bank_ammo[0] * m_ammo_max1 /
                      100.0f) + 0.5f);
          m_missile1 -= First_secondary_index;
        }
  ...
  if (cur_weapon->num_secondary_banks > 1)
    {
      ...
      if (m_missile2 > 0)
        {
          m_ammo_max2 =
            get_max_ammo_count_for_bank(m_ship_class, 1, m_missile2 - 1);
          if (cur_weapon->secondary_bank_ammo[1] != BLANK_FIELD)
            m_ammo2 =
              (int) ((cur_weapon->secondary_bank_ammo[1] * m_ammo_max2 /
                      100.0f) + 0.5f);
          m_missile2 -= First_secondary_index;
        }
  ...
  if (cur_weapon->num_secondary_banks > 2)
    {
      ...
      if (m_missile3 > 0)
        {
          m_ammo_max3 =
            get_max_ammo_count_for_bank(m_ship_class, 2, m_missile3 - 1);
          if (cur_weapon->secondary_bank_ammo[2] != BLANK_FIELD)
            m_ammo3 =
              (int) ((cur_weapon->secondary_bank_ammo[2] * m_ammo_max3 /
                      100.0f) + 0.5f);
          m_missile3 -= First_secondary_index;
        }
  ...
  if (cur_weapon->num_secondary_banks > 3)
    {
      ...
      if (m_missile4 > 0)
        {
          m_ammo_max4 =
            get_max_ammo_count_for_bank(m_ship_class, 3, m_missile4 - 1);
          if (cur_weapon->secondary_bank_ammo[3] != BLANK_FIELD)
            m_ammo4 =
              (int) ((cur_weapon->secondary_bank_ammo[3] * m_ammo_max4 /
                      100.0f) + 0.5f);
          m_missile4 -= First_secondary_index;
        }
  ...
  if (cur_weapon->num_secondary_banks > 4)
    {
      ...
      if (m_missile5 > 0)
        {
          m_ammo_max5 =
            get_max_ammo_count_for_bank(m_ship_class, 4, m_missile5 - 1);
          if (cur_weapon->secondary_bank_ammo[4] != BLANK_FIELD)
            m_ammo5 =
              (int) ((cur_weapon->secondary_bank_ammo[4] * m_ammo_max5 /
                      100.0f) + 0.5f);
          m_missile5 -= First_secondary_index;
        }
  ...
  if (cur_weapon->num_secondary_banks > 5)
    {
      ...
      if (m_missile6 > 0)
        {
          m_ammo_max6 =
            get_max_ammo_count_for_bank(m_ship_class, 5, m_missile6 - 1);
          if (cur_weapon->secondary_bank_ammo[5] != BLANK_FIELD)
            m_ammo6 =
              (int) ((cur_weapon->secondary_bank_ammo[5] * m_ammo_max6 /
                      100.0f) + 0.5f);
          m_missile6 -= First_secondary_index;
        }
              ...
              && (ptr->flags & OF_MARKED))
            {
              ...
              for (i = 0; i < MAX_SHIP_PRIMARY_BANKS; i++)
                if (pilot.primary_bank_weapons[i] != -2)
                  weapon->primary_bank_weapons[i] =
                    pilot.primary_bank_weapons[i];

              for (i = 0; i < MAX_SHIP_SECONDARY_BANKS; i++)
                {
                  if (pilot.secondary_bank_weapons[i] != -2)
                    weapon->secondary_bank_weapons[i] =
                      pilot.secondary_bank_weapons[i];
                  if (pilot.secondary_bank_ammo[i] >= 0)
                    weapon->secondary_bank_ammo[i] =
                      pilot.secondary_bank_ammo[i];
                }
            }
...
void WeaponEditorDlg::OnSelchangeMissile1()
{
  ...
  UpdateData(TRUE);
  m_ammo_max1 =
    get_max_ammo_count_for_bank(m_ship_class, 0,
...
void WeaponEditorDlg::OnSelchangeMissile2()
{
  ...
  UpdateData(TRUE);
  m_ammo_max2 =
    get_max_ammo_count_for_bank(m_ship_class, 1,
...
void WeaponEditorDlg::OnSelchangeMissile3()
{
  ...
  UpdateData(TRUE);
  m_ammo_max3 =
    get_max_ammo_count_for_bank(m_ship_class, 2,
...
void WeaponEditorDlg::OnSelchangeMissile4()
{
  ...
  UpdateData(TRUE);
  m_ammo_max4 =
    get_max_ammo_count_for_bank(m_ship_class, 3,
...
void WeaponEditorDlg::OnSelchangeMissile5()
{
  ...
  UpdateData(TRUE);
  m_ammo_max5 =
    get_max_ammo_count_for_bank(m_ship_class, 4,
...
void WeaponEditorDlg::OnSelchangeMissile6()
{
  ...
  UpdateData(TRUE);
  m_ammo_max6 =
    get_max_ammo_count_for_bank(m_ship_class, 5,
