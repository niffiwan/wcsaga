...
}  BOOL ShipSpecialDamage::OnInitDialog() 
{
    ...
    
    {
              ...
              && (index < MAX_SEXP_VARIABLES - (BLOCK_EXP_SIZE - 1)));
...
 void ShipSpecialDamage::DoGray() 
{
  ...
  GetDlgItem(IDC_SPECIAL_SHOCK_SPEED)->EnableWindow(m_special_exp_enabled
                                                     && m_shock_enabled);
...
 void ShipSpecialDamage::update_ship(int shipnum) 
{
    ...
    
    {
        ...
        
        {
            ...
            start =
            sexp_variable_allocate_block(shipp->ship_name,
                                         SEXP_VARIABLE_BLOCK |
                                         SEXP_VARIABLE_BLOCK_EXP);
    ...
    
    {
        ...
        
        {
            ...
            // free block
            sexp_variable_block_free(shipp->ship_name,
                                     Ships[m_ship_num].special_exp_index,
                                     SEXP_VARIABLE_BLOCK |
                                     SEXP_VARIABLE_BLOCK_EXP);
