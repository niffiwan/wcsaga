...
:CCommonDialog(pWndParent), m_hWnd(NULL)
{
  ...
  SAFE_ZEROMEMORY(m_bi.pszDisplayName, (MAX_PATH * sizeof(TCHAR)));
...
BEGIN_MESSAGE_MAP(CFolderDialog, CCommonDialog) END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
  ...
  if (hResult == S_OK)
    {
      ...
      if (pDeskFolder)
        {
          hResult =
            pDeskFolder->ParseDisplayName(NULL, NULL, T2W(pszRoot), NULL,
                                          &pidlRoot, NULL);
...
VOID CFolderDialog::SetExpanded(IN LPCTSTR pszPath)
{
  ...
  ::SendMessage(m_hWnd, BFFM_SETEXPANDED,
