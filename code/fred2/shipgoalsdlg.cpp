...
// ShipGoalsDlg message handlers
  BOOL ShipGoalsDlg::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName,
...
 BOOL ShipGoalsDlg::OnInitDialog() 
{
  ...
  else if (self_wing >= 0)      // editing orders for just one wing
    {
        ...
        
        {
            ...
            
            {
                   ...
                   (Wings[self_wing].ship_index[i], Ai_goal_list[j].def))
        ...
        
        {
            ...
            
            {
                ...
                
                {
                       ...
                       (ptr->instance, Ai_goal_list[i].def))
    ...
    
    {
        ...
        
        {
          ...
           if ((self_ship > 0) && (self_ship != i)
                 && ship_docking_valid(self_ship, i))
    ...
    ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN1))->SetRange(0,
                                                          MAX_EDITOR_GOAL_PRIORITY);
  ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN2))->SetRange(0,
                                                         MAX_EDITOR_GOAL_PRIORITY);
  ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN3))->SetRange(0,
                                                         MAX_EDITOR_GOAL_PRIORITY);
  ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN4))->SetRange(0,
                                                         MAX_EDITOR_GOAL_PRIORITY);
  ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN5))->SetRange(0,
                                                         MAX_EDITOR_GOAL_PRIORITY);
  ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN6))->SetRange(0,
                                                         MAX_EDITOR_GOAL_PRIORITY);
  ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN7))->SetRange(0,
                                                         MAX_EDITOR_GOAL_PRIORITY);
  ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN8))->SetRange(0,
                                                         MAX_EDITOR_GOAL_PRIORITY);
  ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN9))->SetRange(0,
                                                         MAX_EDITOR_GOAL_PRIORITY);
  ((CSpinButtonCtrl *) GetDlgItem(IDC_SPIN10))->SetRange(0,
                                                          MAX_EDITOR_GOAL_PRIORITY);
...
void ShipGoalsDlg::initialize(ai_goal * goals, int ship) 
{
    ...
    
    {
      ...
       if (m_priority[item] < 0
             || m_priority[item] > MAX_EDITOR_GOAL_PRIORITY)
        ...
        
        {
          ...
          break;
              ...
              ship_get_subsys_index(&Ships[num], goalp[item].docker.name, 1);
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                           ...
                           (goalp[item].ship_name, Ships[inst].ship_name))
        ...
        
        {
            ...
            
            {
                ...
                get_docking_list(Ship_info
                                 [Ships[m_data[item] & DATA_MASK].
                                  ship_info_index].model_num);
...
 void ShipGoalsDlg::set_item(int item, int init) 
{
  ...
  if ((mode == AI_GOAL_CHASE_ANY) || (mode == AI_GOAL_UNDOCK)
       || (mode == AI_GOAL_KEEP_SAFE_DISTANCE) || (mode == AI_GOAL_PLAY_DEAD)
       || (mode == AI_GOAL_WARP))
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              m_object_box[item]->SetItemData(z,
                                               OBJ_INDEX(ptr) |
                                               TYPE_WAYPOINT);
    ...
    
    {
        ...
        get_docking_list(Ship_info[Ships[cur_ship].ship_info_index].
                         model_num);
...
 int ShipGoalsDlg::verify_orders(int ship) 
{
          ...
          error_check_initial_orders(goalp, self_ship, self_wing)) != NULL)
    
    {
      ...
       if (MessageBox(buf, "Error", MB_OKCANCEL | MB_ICONEXCLAMATION) !=
             IDOK)
...
 void ShipGoalsDlg::update_item(int item, int multi) 
{
    ...
    
    {
        ...
        
        {
                   ...
                   "Order #%d doesn't have valid subsystem name.  Order will be removed",
                   item + 1);
        ...
        
        {
                   ...
                   "Order #%d doesn't have valid docking points.  Order will be removed",
                   item + 1);
    ...
    
    {
      ...
      goalp[item].ship_name =
        ai_get_goal_ship_name(Ships[m_data[item] & DATA_MASK].ship_name,
                              &not_used);
      break;
     case TYPE_WING:
      goalp[item].ship_name =
        ai_get_goal_ship_name(Wings[m_data[item] & DATA_MASK].name,
                              &not_used);
      break;
     case TYPE_PATH:
      goalp[item].ship_name =
        ai_get_goal_ship_name(Waypoint_lists[m_data[item] & DATA_MASK].name,
                              &not_used);
      break;
     case TYPE_WAYPOINT:
      goalp[item].ship_name =
        ai_get_goal_ship_name(object_name(m_data[item] & DATA_MASK),
                              &not_used);
                 ...
                 "Order #%d doesn't have a valid target.  Order will be removed",
                 item + 1);
...
 void ShipGoalsDlg::OnOK() 
{
    ...
    
    {
      ...
      if ((mode != AI_GOAL_NONE) && (mode != AI_GOAL_CHASE_ANY)
           && (mode != AI_GOAL_UNDOCK) && (mode != AI_GOAL_KEEP_SAFE_DISTANCE)
...
}  void ShipGoalsDlg::set_object(int item) 
{
    ...
    
    {
        ...
        {
          if (((m_data[item] & TYPE_MASK) == TYPE_SHIP)
               || ((m_data[item] & TYPE_MASK) == TYPE_PLAYER))
            ...
            {
              m_subsys_box[item]->AddString(subsys->system_info->
                                             subobj_name);
              m_subsys_box[item]->SetItemDataPtr(z,
                                                  subsys->system_info->
                                                  subobj_name);
