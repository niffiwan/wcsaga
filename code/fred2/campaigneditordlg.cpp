...
void campaign_editor::OnUpdate(CView * pSender, LPARAM lHint,
                                CObject * pHint) 
{
...
 void campaign_editor::OnChangeBriefingCutscene() 
{
    ...
    
    {
        ...
        {
          bc_dialog->GetWindowText(Campaign.missions[Cur_campaign_mission].
...
 void campaign_editor::OnChangeDebriefingPersona() 
{
    ...
    
    {
      ...
       Campaign.missions[Cur_campaign_mission].debrief_persona_index =
        persona;
