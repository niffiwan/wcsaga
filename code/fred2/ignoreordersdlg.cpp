...
ON_BN_CLICKED(IDC_CHECK9, OnCheck9) ON_BN_CLICKED(IDC_CHECK10, OnCheck10)
  //}}AFX_MSG_MAP
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
      ...
      if (default_orders & Comm_orders[i].item)
        {
          ...
          check_boxes[m_num_checks_active].button->
            SetWindowText(Comm_orders[i].name);
              ...
              for (i = 0; i < m_num_checks_active; i++)
                {
                  ...
                  if (box_value == 1)
                    Ships[objp->instance].orders_accepted |=
                      check_boxes[i].id;
                  else
                    Ships[objp->instance].orders_accepted &=
                      ~(check_boxes[i].id);
