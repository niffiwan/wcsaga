...
}  void ShipSpecialHitpoints::OnOk() 
{
    ...
    
    {
        ...
        
        {
            ...
            start =
            sexp_variable_allocate_block(Ships[m_ship_num].ship_name,
                                         SEXP_VARIABLE_BLOCK |
            ...
            
            {
                ...
                ("Unable to allocate storage, try deleting Sexp variables");
        ...
        // set em
        sprintf(Sexp_variables[start + SHIELD_STRENGTH].text, "%d",
                m_shields);
    ...
    
    {
        ...
        
        {
            ...
            // free block
            sexp_variable_block_free(Ships[m_ship_num].ship_name,
                                     Ships[m_ship_num].special_hitpoint_index,
                                     SEXP_VARIABLE_BLOCK |
                                     SEXP_VARIABLE_BLOCK_HIT);
    ...
    
    {
        ...
        (float)
        atoi(Sexp_variables
             [Ships[m_ship_num].special_hitpoint_index + HULL_STRENGTH].text);
    ...
    
    {
        ...
        Ship_info[Ships[m_ship_num].ship_info_index].max_hull_strength;
    }
   Ai_info[Ships[m_ship_num].ai_index].kamikaze_damage =
