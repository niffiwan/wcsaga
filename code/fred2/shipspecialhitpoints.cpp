...
ON_BN_CLICKED(ID_OK, OnOk) ON_BN_CLICKED(ID_CANCEL, OnCancel)
  //}}AFX_MSG_MAP
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
      ...
      if (Ships[m_selected_ships[i]].special_hitpoints)
        {
          temp_max_hull_strength =
            (float) Ships[m_selected_ships[i]].special_hitpoints;
        }
      else
        {
          temp_max_hull_strength =
            Ship_info[Ships[m_selected_ships[i]].ship_info_index].
            max_hull_strength;
        }

      Ai_info[Ships[m_selected_ships[i]].ai_index].kamikaze_damage =
