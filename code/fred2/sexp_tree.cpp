                                   ...
                                   const char *sexp_var_name) 
{
             ...
             Sexp_variables[sexp_var_index].variable_name,
             Sexp_variables[sexp_var_index].text);
...
int sexp_tree::load_branch(int index, int parent) 
{
    ...
    
    {
        ...
        
        {
          ...
           set_node(cur, (SEXPT_OPERATOR | SEXPT_VALID),
        ...
        
        {
            ...
            {
              get_combined_variable_name(combined_var_name,
                                          Sexp_nodes[index].text);
              set_node(cur, (SEXPT_VARIABLE | SEXPT_NUMBER | SEXPT_VALID),
                        combined_var_name);
            ...
            {
              set_node(cur, (SEXPT_NUMBER | SEXPT_VALID),
                        Sexp_nodes[index].text);
        ...
        
        {
            ...
            
            {
                                          ...
                                          Sexp_nodes[index].text);
              set_node(cur, (SEXPT_VARIABLE | SEXPT_STRING | SEXPT_VALID),
                        combined_var_name);
            ...
            {
              set_node(cur, (SEXPT_STRING | SEXPT_VALID),
                        Sexp_nodes[index].text);
...
int sexp_tree::save_branch(int cur, int at_root) 
{
    ...
    
    {
        ...
        
        {
            ...
            alloc_sexp(tree_nodes[cur].text, SEXP_ATOM, SEXP_ATOM_OPERATOR,
                       -1, save_branch(tree_nodes[cur].child));
        ...
        
        {
            ...
            {
              var_name_from_sexp_tree_text(var_name_text,
                                            tree_nodes[cur].text);
              node =
                alloc_sexp(var_name_text, (SEXP_ATOM | SEXP_FLAG_VARIABLE),
            ...
            
            {
                ...
                alloc_sexp(tree_nodes[cur].text, SEXP_ATOM, SEXP_ATOM_NUMBER,
                           -1, -1);
        ...
        
        {
            ...
            
            {
                ...
                alloc_sexp(tree_nodes[cur].text, SEXP_ATOM, SEXP_ATOM_STRING,
                           -1, -1);
...
void sexp_tree::add_sub_tree(int node, HTREEITEM root) 
{
  ...
   root = tree_nodes[node].handle =
    insert(tree_nodes[node].text, bitmap, bitmap, root);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                insert(tree_nodes[node].text, BITMAP_VARIABLE,
                       BITMAP_VARIABLE, root);
            ...
            
            {
                ...
                insert(tree_nodes[node].text, bmap, bmap, root);
...
void sexp_tree::right_clicked(int mode) 
{
  ...
  CMenu menu, *mptr, *popup_menu, *add_data_menu = NULL, *replace_data_menu =
    NULL;
    ...
    
    {
        ...
        
        {
          ...
           add_op_menu->AppendMenu(MF_POPUP,
                                     (UINT) add_op_submenu[i].m_hMenu,
                                     op_menu[i].name);
          replace_op_menu->AppendMenu(MF_POPUP,
                                       (UINT) replace_op_submenu[i].m_hMenu,
                                       op_menu[i].name);
          insert_op_menu->AppendMenu(MF_POPUP,
         ...
         */ 
      {
                  ...
                  
                  {
                      ...
                      
                      {
                          ...
                          
                          {
                            ...
                             replace_variable_menu->AppendMenu(flag,
                                                                 (ID_VARIABLE_MENU
                                                                  + idx),
                                                                 buf);
        ...
        
        {
            ...
            
            {
                ...
                {
                  add_op_submenu[j].AppendMenu(MF_POPUP,
                                                (UINT)
                                                add_op_subcategory_menu[i].
                                                m_hMenu, op_submenu[i].name);
                  replace_op_submenu[j].AppendMenu(MF_POPUP,
                                                    (UINT)
                                                    replace_op_subcategory_menu
                                                    [i].m_hMenu,
                                                    op_submenu[i].name);
                  insert_op_submenu[j].AppendMenu(MF_POPUP,
                                                   (UINT)
                                                   insert_op_subcategory_menu
                                                   [i].m_hMenu,
                                                   op_submenu[i].name);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                       ...
                       (Operators[i].value & OP_CATEGORY_MASK))
                    
                    {
                        ...
                        {
                          add_op_submenu[j].AppendMenu(MF_STRING | MF_GRAYED,
                                                        Operators[i].value,
                                                        Operators[i].text);
                          replace_op_submenu[j].
                            AppendMenu(MF_STRING | MF_GRAYED,
                                       Operators[i].value | OP_REPLACE_FLAG,
                                       Operators[i].text);
                          insert_op_submenu[j].AppendMenu(MF_STRING,
                                                           Operators[i].
                                                           value |
                                                           OP_INSERT_FLAG,
                                                           Operators[i].text);
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        {
                          add_op_subcategory_menu[j].
                            AppendMenu(MF_STRING | MF_GRAYED,
                                       Operators[i].value, Operators[i].text);
                          replace_op_subcategory_menu[j].
                            AppendMenu(MF_STRING | MF_GRAYED,
                                       Operators[i].value | OP_REPLACE_FLAG,
                                       Operators[i].text);
                          insert_op_subcategory_menu[j].AppendMenu(MF_STRING,
                                                                    Operators
                                                                    [i].
                                                                    value |
                                                                    OP_INSERT_FLAG,
        ...
        
        {
            ...
            {
              menu.EnableMenuItem(Operators[j].value | OP_INSERT_FLAG,
                                   MF_GRAYED);
            }
           gray_menu_tree(popup_menu);
          popup_menu->TrackPopupMenu(TPM_LEFTALIGN | TPM_RIGHTBUTTON,
      ...
      if (!(tree_nodes[item_index].flags & EDITABLE))
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        menu.EnableMenuItem(Operators[ptr->op].value,
                                            MF_ENABLED);
                    ...
                    
                    {
                        ...
                        {
                          add_data_menu->AppendMenu(MF_STRING | MF_ENABLED,
                                                     ID_ADD_MENU + data_idx,
                                                     ptr->text);
                        ...
                        
                        {
                            ...
                            AppendMenu(MF_MENUBARBREAK | MF_STRING |
                                       MF_ENABLED, ID_ADD_MENU + data_idx,
                                       ptr->text);
        ...
        
        {
            ...
            {
              if (query_operator_argument_type(op, i - 1) !=
                   query_operator_argument_type(op, i))
            ...
            
            {
                ...
                
                {
                    ...
                    {
                      menu.EnableMenuItem(Operators[ptr->op].
                                           value | OP_REPLACE_FLAG,
                                           MF_ENABLED);
                    ...
                    
                    {
                        ...
                        replace_data_menu->AppendMenu(MF_STRING | MF_ENABLED,
                                                       ID_REPLACE_MENU +
                                                       data_idx, ptr->text);
                      
                      else
                        replace_data_menu->
                          AppendMenu(MF_MENUBARBREAK | MF_STRING | MF_ENABLED,
            ...
            if (Operators[op].value == OP_MODIFY_VARIABLE
                || Operators[op].value == OP_SET_VARIABLE_BY_INDEX)
      ...
      else                      // top node, so should be a Boolean type.
        {
          if (m_mode == MODE_EVENTS)   // return type should be null
            {
                  ...
                  menu.EnableMenuItem(Operators[j].value | OP_REPLACE_FLAG,
                                       MF_ENABLED);
        ...
        
        {
            ...
            
            {
             ...
             && (Sexp_nodes[Sexp_clipboard].type != SEXP_NOT_USED))
        
        {
            ...
            {
              if ((replace_type == OPR_POSITIVE)
                   && (atoi(CTEXT(Sexp_clipboard)) > -1))
                menu.EnableMenuItem(ID_EDIT_PASTE, MF_ENABLED);
               
              else if (replace_type == OPR_NUMBER)
                menu.EnableMenuItem(ID_EDIT_PASTE, MF_ENABLED);
               if ((add_type == OPR_POSITIVE)
                     && (atoi(CTEXT(Sexp_clipboard)) > -1))
      ...
      popup_menu->TrackPopupMenu(TPM_LEFTALIGN | TPM_RIGHTBUTTON, mouse.x,
                                  mouse.y, this);
...
 int sexp_tree::end_label_edit(TVITEMA & item) 
{
    ...
    
    {
        ...
        return 0;               // Goober5000 - avoids crashing
    ...
    
    {
        ...
        
        {
            ...
            {
              MessageBox("Can not enter a negative value", "Invalid Number",
                          MB_ICONEXCLAMATION);
...
char *sexp_tree::match_closest_operator(char *str, int node) 
{
  ...
  opr = query_operator_return_type(op);
    ...
    
    {
        ...
        {
          if ((stricmp(str, Operators[i].text) <= 0)
               && (!best || (stricmp(str, best) < 0)))
  ...
  BOOL sexp_tree::OnCommand(WPARAM wParam, LPARAM lParam) 
{
    ...
    
    {
        ...
        
        {
          ...
          int sexp_var_index =
            get_index_sexp_variable_name(dlg.m_cur_variable_name);
        ...
        
        {
          ...
          int sexp_var_index =
            get_index_sexp_variable_name(dlg.m_old_var_name);
          ...
          int type;
            ...
            sexp_fred_modify_variable(dlg.m_default_value,
                                      dlg.m_cur_variable_name, sexp_var_index,
                                      type);
    ...
    
    {
        ...
        get_operator_index(tree_nodes[tree_nodes[item_index].parent].text);
      Assert(op >= 0);
       type = query_operator_argument_type(op, Replace_count);        // check argument type at this position
      list =
        get_listing_opf(type, tree_nodes[item_index].parent, Replace_count);
    ...
    
    {
        ...
        
        {
            ...
            insert(Operators[op].text, BITMAP_OPERATOR, BITMAP_OPERATOR, h,
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                get_index_sexp_variable_name(Sexp_nodes[Sexp_clipboard].text);
              Assert(var_idx > -1);
              replace_variable_data(var_idx,
                                     (SEXPT_VARIABLE | SEXPT_NUMBER |
                                      SEXPT_VALID));
            ...
            
            {
              ...
              replace_data(CTEXT(Sexp_clipboard),
      ...
      
      {
          ...
          
          {
              ...
              
              {
                  ...
                  Event_editor_dlg->handler(ROOT_DELETED, item_index);
              ...
              
              {
                  ...
                  Campaign_tree_formp->handler(ROOT_DELETED, item_index);
    ...
    
    {
      if (tree_nodes[item_index].flags & OPERAND)      // are both operators?
        {
          ...
          if ((i >= Operators[op].min) && (i <= Operators[op].max))    // are old num args valid?
            {
                ...
                {
                  set_node(item_index, (SEXPT_OPERATOR | SEXPT_VALID),
                            Operators[op].text);
                  SetItemText(tree_nodes[item_index].handle,
                               Operators[op].text);
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              else if (Sexp_variables[sexp_var_index].
                       type & SEXP_VARIABLE_NUMBER)
              ...
              sprintf(node_text, "%s(%s)", item.text,
                       Sexp_variables[sexp_var_index].text);
            ...
            
            {
              ...
              char buf2[256];
                ...
                get_index_sexp_variable_name(temp_item.text);
...
 int sexp_tree::get_default_value(sexp_list_item * item, int op, int i) 
{
    ...
    
    {
        ...
        if ((query_operator_return_type(op) == OPR_AI_GOAL)
            && (i == (Operators[op].min - 1)))
        ...
        if (((Operators[op].value == OP_HAS_DOCKED_DELAY)
             || (Operators[op].value == OP_HAS_UNDOCKED_DELAY)) && (i == 2))
...
 int sexp_tree::query_default_argument_available(int op, int i) 
{
    ...
    
    {
      ...
      
      {
          ...
          else if ((value == OP_PREVIOUS_GOAL_TRUE)
                   || (value == OP_PREVIOUS_GOAL_FALSE)
      ...
      
      {
          ...
          // need to be sure that previous-event functions are available.  (i.e. we are providing a default argument for them)
                   ...
                   || (value == OP_PREVIOUS_EVENT_FALSE)
                   || (value == OP_PREVIOUS_EVENT_INCOMPLETE)
                   || Num_mission_events)
...
void sexp_tree::expand_operator(int node) 
{
    ...
    
    {
      ...
      Assert((tree_nodes[node].flags & OPERAND)
              && (tree_nodes[node].flags & EDITABLE));
  ...
   if ((tree_nodes[node].flags & OPERAND) && (tree_nodes[node].flags & EDITABLE))     // expandable?
    {
      ...
      Assert(data != -1 && tree_nodes[data].next == -1
              && tree_nodes[data].child == -1);
...
int sexp_tree::add_data(char *data, int type) 
{
    ...
    insert(data, bmap, bmap, tree_nodes[item_index].handle);
...
int sexp_tree::add_variable_data(char *data, int type) 
{
    ...
    insert(data, BITMAP_VARIABLE, BITMAP_VARIABLE,
           tree_nodes[item_index].handle);
...
void sexp_tree::add_operator(char *op, HTREEITEM h) 
{
    ...
    
    {
        ...
        insert(op, BITMAP_OPERATOR, BITMAP_OPERATOR, h);
    ...
    
    {
        ...
        insert(op, BITMAP_OPERATOR, BITMAP_OPERATOR,
               tree_nodes[item_index].handle);
...
}  int sexp_tree::get_modify_variable_type(int parent) 
{
    ...
    
    {
        ...
        get_tree_name_to_sexp_variable_index(tree_nodes
                                             [tree_nodes[parent].child].text);
    ...
    
    {
         ...
         || Sexp_variables[sexp_var_index].type & SEXP_VARIABLE_BLOCK
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              char *text_ptr;
                ...
                
                {
                    ...
                    if ((arg_num == 0
                         && Operators[op].value == OP_MODIFY_VARIABLE)
                        || (arg_num == 8
                             && Operators[op].value ==
                    ...
                    
                    {
                        ...
                        get_variable_name_from_sexp_tree_node_text(tree_nodes
                                                                   [item_index].
                                                                   text,
                    ...
                    
                    {
                        ...
                        get_index_sexp_variable_name(default_variable_text);
                        ...
                        
                        {
                          ...
                          if (Sexp_variables[sexp_var_index].
                               type & SEXP_VARIABLE_NUMBER)
                        ...
                        
                        {
                            ...
                            get_variable_default_text_from_variable_text
            ...
            
            {
                ...
                {
                  if (SEXPT_TYPE(tree_nodes[item_index].type) ==
                       SEXPT_OPERATOR)
...
void sexp_tree::replace_variable_data(int var_idx, int type) 
{
    ...
    // Assemble name
    sprintf(buf, "%s(%s)", Sexp_variables[var_idx].variable_name,
            Sexp_variables[var_idx].text);
...
 HTREEITEM sexp_tree::move_branch(HTREEITEM source, HTREEITEM parent,
                                    HTREEITEM after) 
{
...
 void sexp_tree::copy_branch(HTREEITEM source, HTREEITEM parent,
                               HTREEITEM after) 
{
...
//#define BITMAP_BLACK_DOT 8
   HTREEITEM sexp_tree::insert(LPCTSTR lpszItem, int image, int sel_image,
...
  void sexp_tree::update_help(HTREEITEM h) 
{
    ...
    
    {
        ...
        {
          Warning(LOCATION, "Sexp data \"%s\" has no parent!",
                   tree_nodes[i].text);
        ...
        if ((SEXPT_TYPE(tree_nodes[i].type) == SEXPT_NUMBER)
            || (SEXPT_TYPE(tree_nodes[i].type) == SEXPT_STRING)
            && sibling_place > 0)
...
// would have nothing to select from.
  sexp_list_item * sexp_tree::get_listing_opf(int opf, int parent_node,
                                              int arg_index) 
{
    ...
    find_ancestral_argument_number(OP_EVERY_TIME_ARGUMENT, parent_node);
  if (w_arg < 1
       && e_arg < 1 /* && the same for any future _ARGUMENT sexps */ )
...
 int sexp_tree::get_sibling_place(int node) 
{
       ...
       || tree_nodes[node].parent > (int) tree_nodes.size())
...
 sexp_list_item * sexp_tree::get_listing_opf_bool(int parent_node) 
{
    ...
    
    {
      ...
      if ((op == OP_PREVIOUS_GOAL_TRUE) || (op == OP_PREVIOUS_GOAL_FALSE)
           || (op == OP_PREVIOUS_EVENT_TRUE)
    ...
    
    {
        ...
        
        {
               ...
               || (only_basic
                   && ((Operators[i].value == OP_TRUE)
                       || (Operators[i].value == OP_FALSE))))
...
 sexp_list_item * sexp_tree::get_listing_opf_ship(int parent_node) 
{
    ...
    
    {
        ...
        
        {
          ...
          Assert(!stricmp(tree_nodes[z].text, "add-ship-goal")
                  || !stricmp(tree_nodes[z].text, "add-wing-goal")
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                if ((dock_ship != ptr->instance)
                    && ship_docking_valid(dock_ship, ptr->instance))
    ...
    
    {
        ...
        
        {
            ...
            case OPS_CAP_CARGO:
              ...
              if (valid_cap_subsys_cargo_list
...
 sexp_list_item * sexp_tree::get_listing_opf_arrival_anchor_all() 
{
  ...
   for (restrict_to_players = 0; restrict_to_players < 2;
          restrict_to_players++)
...
 sexp_list_item * sexp_tree::get_listing_opf_who_from() 
{
    ...
    
    {
             ...
             (Ship_info[Ships[get_ship_from_obj(ptr)].ship_info_index].
...
 sexp_list_item * sexp_tree::get_listing_opf_mission_name() 
{
    ...
    
    {
             ...
             || (Campaign.missions[i].level <
                 Campaign.missions[Cur_campaign_mission].level))
...
 sexp_list_item * sexp_tree::get_listing_opf_ship_or_none() 
{
  ...
  sexp_tree::get_listing_opf_subsystem_or_none(int parent_node,
                                               int arg_index) 
{
  ...
  sexp_tree::get_listing_opf_subsys_or_generic(int parent_node,
                                               int arg_index) 
{
...
 sexp_list_item * sexp_tree::get_listing_opf_jump_nodes() 
{
  ...
   for (jump_node * jnp = (jump_node *) Jump_nodes.get_first();
          !Jump_nodes.is_end(jnp); jnp = (jump_node *) jnp->get_next())
...
 sexp_list_item * sexp_tree::get_listing_opf_post_effect() 
{
  ...
  SCP_vector < opengl::post_effect > &ppe_names =
    opengl::post_shader::get_effects();
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                Assert((tree_nodes[idx].type & SEXPT_NUMBER)
                       || (tree_nodes[idx].type & SEXPT_STRING));
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                replace_variable_data(sexp_var_index,
                                      (type | SEXPT_VARIABLE));
...
int sexp_tree::get_item_index_to_var_index() 
{
    ...
    {
       return get_tree_name_to_sexp_variable_index(tree_nodes[item_index].
                                                     text);
...
get_tree_name_to_sexp_variable_index(const char *tree_name) 
{
