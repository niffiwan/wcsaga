...
 void CFred_mission_save::convert_special_tags_to_retail(char *text,
                                                           int max_len) 
{
...
void CFred_mission_save::convert_special_tags_to_retail() 
{
    ...
    
    {
        ...
        {
          convert_special_tags_to_retail(Briefings[team].stages[stage].
                                          new_text, MAX_BRIEF_LEN);
        ...
        {
          convert_special_tags_to_retail(Debriefings[team].stages[stage].
                                          new_text, MAX_DEBRIEF_LEN);
...
 int CFred_mission_save::save_mission_info() 
{
    ...
    // squadron info
    if (!(The_mission.game_type & MISSION_TYPE_MULTI)
        && (strlen(The_mission.squad_name) > 0))
    ...
    
    {
        ...
        // starting wings
        if (strcmp(Starting_wing_names[0], "Alpha")
            || strcmp(Starting_wing_names[1], "Beta")
        ...
        // squadron wings
        if (strcmp(Squadron_wing_names[0], "Alpha")
            || strcmp(Squadron_wing_names[1], "Beta")
            || strcmp(Squadron_wing_names[2], "Gamma")
            || strcmp(Squadron_wing_names[3], "Delta")
        ...
        // tvt wings
        if (strcmp(TVT_wing_names[0], "Alpha")
            || strcmp(TVT_wing_names[1], "Zeta"))
  ...
  int profile_index = (The_mission.ai_profile - Ai_profiles);
    ...
    
    {
                    ...
                    The_mission.ai_profile->profile_name);
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                                    ...
                                    The_mission.cutscenes[i].cutscene_name);
                    }
                   required_string_fred("+formula:");
                  parse_comments();
                  convert_sexp_to_string(The_mission.cutscenes[i].formula,
                                          out, SEXP_SAVE_MODE, 4096);
...
 int CFred_mission_save::save_debriefing() 
{
    ...
    
    {
        ...
        
        {
          ...
          convert_sexp_to_string(Debriefing->stages[i].formula, out,
                                  SEXP_SAVE_MODE, 4096);
            ...
            required_string_fred("$Recommendation text:");
                    ...
                    Debriefing->stages[i].new_recommendation_text);
  ...
  int num_variables = sexp_variable_count();
    ...
    
    {
        ...
        
        {
            ...
            fout("\n\t\t%d\t\t\"%s\"\t\t\"%s\"\t\t\"%s\"", i,
                 Sexp_variables[i].variable_name, Sexp_variables[i].text,
                 type);
      ...
       for (i = MAX_SEXP_VARIABLES - num_block_vars; i < MAX_SEXP_VARIABLES;
              i++)
    ...
    
    {
        ...
        
        {
            ...
            
            {
                      ...
                      Sexp_variables[Team_data[i].ship_list_variables[j]].
                      variable_name);
            ...
            
            {
                      ...
                      Sexp_variables[Team_data[i].ship_count_variables[j]].
                      variable_name);
        ...
        
        {
            ...
            
            {
                      ...
                      Sexp_variables[Team_data[i].weaponry_pool_variable[j]].
                      variable_name);
            ...
            
            {
                      ...
                      Sexp_variables[Team_data[i].
                                     weaponry_amount_variable[j]].
                      variable_name);
            ...
            
            {
                ...
                
                {
                        ...
                        Team_data[i].weaponry_count[j] +
                        used_pool[Team_data[i].weaponry_pool[j]]);
...
// Goober5000
void CFred_mission_save::save_single_dock_instance(ship * shipp,
                                                   dock_instance * dock_ptr) 
{
  Assert(shipp && dock_ptr);
  Assert(dock_ptr->docked_objp->type == OBJ_SHIP
          || dock_ptr->docked_objp->type == OBJ_START);
    ...
    required_string_fred("$Docker Point:", "$Name:");
        ...
        model_get_dock_name(Ship_info[other_shipp->ship_info_index].model_num,
                            dock_find_dockpoint_used_by_object(other_objp,
                                                               objp)));
    ...
    required_string_fred("$Dockee Point:", "$Name:");
        ...
        model_get_dock_name(Ship_info[shipp->ship_info_index].model_num,
                            dock_find_dockpoint_used_by_object(objp,
                                                               other_objp)));
...
 int CFred_mission_save::save_objects() 
{
    ...
    
    {
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                                    ...
                                    Sexp_variables[Ships[i].s_alt_classes[k].
                                                   variable_index].
                                    variable_name);
                    ...
                    
                    {
                        ...
                        ("\n;;FSO 3.6.10;; $Alt Ship Class: \"%s\"",
                         Ship_info[Ships[i].s_alt_classes[k].ship_class].
                         name);
      ...
       if (Ships[i].weapons.ai_class !=
             Ship_info[Ships[i].ship_info_index].ai_class)
        ...
        {
          if ((Ships[i].arrival_location == ARRIVE_FROM_DOCK_BAY)
               && (Ships[i].arrival_path_mask > 0))
            
            {
                ...
                model_get(Ship_info[Ships[anchor_shipnum].ship_info_index].
                          model_num);
                ...
                
                {
                    ...
                    
                    {
                            ...
                            pm->paths[pm->ship_bay->path_indexes[j]].name);
        ...
        
        {
            ...
            if (Format_fs2_open == FSO_FORMAT_RETAIL
                && !dock_check_docked_one_on_one(&Objects[Ships[i].objnum]))
            ...
            
            {
                ...
                {
                  save_single_dock_instance(&Ships[i],
        ...
        if (Ships[i].orders_accepted !=
            ship_get_default_orders_accepted(&Ship_info
                                             [Ships[i].ship_info_index]))
        
        {
          ...
           fout(" %d\t\t;! note that this is a bitfield!!!",
                  Ships[i].orders_accepted);
        ...
        
        {
            ...
            
            {
                   ...
                   (Ships[i].ship_name,
                    Fred_texture_replacements[k].ship_name))
                
                {
                    ...
                    
                    {
                                    ...
                                    Fred_texture_replacements[k].old_texture);
                    ...
                    
                    {
                                    ...
                                    Fred_texture_replacements[k].new_texture);
...
 int CFred_mission_save::save_common_object_data(object * objp,
                                                   ship * shipp) 
{
    ...
    {
      if (optional_string_fred
           ("+Initial Velocity:", "$Name:", "+Subsystem:"))
    ...
    {
      temp_max_hull_strength =
        (float)
        atoi(Sexp_variables[shipp->special_hitpoint_index + HULL_STRENGTH].
             text);
...
 int CFred_mission_save::save_wings() 
{
    ...
    
    {
        ...
        {
          if ((Wings[i].arrival_location == ARRIVE_FROM_DOCK_BAY)
               && (Wings[i].arrival_path_mask > 0))
...
 int CFred_mission_save::save_waypoints() 
{
    ...
    
    {
        ...
        
        {
          ...
          fout(" %u %u %u %u", jn_color.red, jn_color.green, jn_color.blue,
                jn_color.alpha);
        }
       int hidden_is_there =
        optional_string_fred("+Hidden:", "$Jump Node:");
...
 int CFred_mission_save::save_waypoint_list(waypoint_list & w) 
{
    ...
    fout("\t( %f, %f, %f )\n", w.waypoints[i].xyz.x, w.waypoints[i].xyz.y,
          w.waypoints[i].xyz.z);
...
 int CFred_mission_save::save_messages() 
{
    ...
    
    {
              ...
              Personas[The_mission.command_persona].name);
...
{
  fout("\n\t%f, %f, %f,\n", m.vec.rvec.xyz.x, m.vec.rvec.xyz.y,
        m.vec.rvec.xyz.z);
  fout("\t%f, %f, %f,\n", m.vec.uvec.xyz.x, m.vec.uvec.xyz.y,
        m.vec.uvec.xyz.z);
...
void CFred_mission_save::parse_comments(int newlines) 
{
  ...
   if (fred_parse_flag || !Token_found_flag || !token_found
         || (token_found && (*Mission_text_raw == EOF_CHAR)))
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                if ((raw_ptr[1] == ';') && (raw_ptr[2] == 'F')
                    && (raw_ptr[3] == 'S') && (raw_ptr[4] == 'O'))
                
                {
                  int major, minor, build, revis;
                  int s_num =
                    scan_fso_version_string(raw_ptr, &major, &minor, &build,
                                            &revis);
                  ...
                   if ((s_num == 3) && (major <= FS_VERSION_MAJOR)
                  ...
                  else if ((s_num == 4) && (major <= FS_VERSION_MAJOR)
                           && (minor <= FS_VERSION_MINOR)
                           && (build <= FS_VERSION_BUILD)
                           && (revis <= FS_VERSION_REVIS))
...
 int CFred_mission_save::fout_version(char *format, ...) 
{
    ...
    if ((Format_fs2_open == FSO_FORMAT_COMPATIBILITY_MODE) && (*format != ' ')
        && !fso_ver_comment.empty())
    ...
    if ((Format_fs2_open == FSO_FORMAT_COMPATIBILITY_MODE)
        && !fso_ver_comment.empty())
    ...
    
    {
        ...
        
        {
            ...
            
            {
                       ...
                       "Ai goal has no target where one is required");
            ...
            
            {
                ...
                
                {
                    ...
                    {
                      sprintf(buf, "\"%s\" \"%s\"", goalp[i].ship_name,
                               goalp[i].docker.name);
                    ...
                    
                    {
                               ...
                               "Wings aren't allowed to have a docking goal\n");
                     }
                  
                  else if (goalp[i].docker.index == -1
                           || !goalp[i].docker.index)
                  ...
                  else if (goalp[i].dockee.index == -1
                           || !goalp[i].dockee.index)
...
 int CFred_mission_save::save_events() 
{
    ...
    
    {
        ...
        
        {
             ...
             && Mission_events[i].trigger_count != 1)
...
 int CFred_mission_save::save_reinforcements() 
{
    ...
    
    {
             ...
             && !stricmp(Ships[j].ship_name, Reinforcements[i].name))
...
 int CFred_mission_save::save_music() 
{
    ...
    
    {
        ...
        
        {
          ...
          fout_version("\n$Substitute Event Music: %s",
                        The_mission.substitute_event_music_name);
    ...
    
    {
        ...
        
        {
          ...
          fout_version("\n$Substitute Briefing Music: %s",
                        The_mission.substitute_briefing_music_name);
    ...
    // old stuff
    if (Mission_music[SCORE_DEBRIEF_SUCCESS] !=
        event_music_get_spooled_music_index("Success"))
    
    {
        ...
        
        {
            ...
            Mission_music[SCORE_DEBRIEF_SUCCESS] <
            0 ? "None" : Spooled_music[Mission_music[SCORE_DEBRIEF_SUCCESS]].
            name);
    }
  if (Mission_music[SCORE_DEBRIEF_AVERAGE] !=
       event_music_get_spooled_music_index("Average"))
    
    {
        ...
        
        {
            ...
            Mission_music[SCORE_DEBRIEF_AVERAGE] <
            0 ? "None" : Spooled_music[Mission_music[SCORE_DEBRIEF_AVERAGE]].
            name);
    }
  if (Mission_music[SCORE_DEBRIEF_FAIL] !=
       event_music_get_spooled_music_index("Failure"))
    ...
    
    {
        ...
        
        {
          ...
          fout_version("\n$Fiction Viewer Music: %s",
                        Spooled_music[Mission_music[SCORE_FICTION_VIEWER]].
                        name);
...
 void CFred_mission_save::save_turret_info(ship_subsys * ptr, int ship) 
{
    ...
    if (wp->secondary_bank_weapons[i] !=
         ptr->system_info->secondary_banks[i])
  ...
  Campaign_tree_viewp->sort_elements();
    ...
    
    {
        ...
        
        {
            ...
            fout(" %d",
                 Campaign.missions[m].
                 flags | ((Campaign.missions[m].main_hall > 0) ?
                          CMISSION_FLAG_BASTION : 0));
        }
       if ((Campaign.missions[m].debrief_persona_index >= 0)
             && (Campaign.missions[m].debrief_persona_index <= 0xff))
        
        {
            ...
            
            {
              ...
              fout_version("\n+Debriefing Persona Index: %d",
                            Campaign.missions[m].debrief_persona_index);
            ...
            
            {
                ...
                
                {
                    ...
                    if ((num_mission_loop == 1)
                        && Links[j].mission_loop_brief_anim)
                    ...
                    // maybe write out mission loop descript
                    if ((num_mission_loop == 1)
                        && Links[j].mission_loop_brief_sound)
...
 void CFred_mission_save::fso_comment_push(char *ver) 
{
    ...
    scan_fso_version_string(fso_ver_comment.back().c_str(), &major, &minor,
                            &build, &revis);
  elem2 =
    scan_fso_version_string(ver, &in_major, &in_minor, &in_build, &in_revis);
    ...
    
    {
         ...
         && ((major > in_major) || (minor > in_minor) || (build > in_build)))
