...
 void palman_load_pixels() 
{
    ...
    
    {
        ...
        {
          stuff_ubyte(&Palman_non_darkening_default
                       [Palman_num_nondarkening_default][0]);
          stuff_ubyte(&Palman_non_darkening_default
                       [Palman_num_nondarkening_default][1]);
          stuff_ubyte(&Palman_non_darkening_default
                       [Palman_num_nondarkening_default++][2]);
...
 void palette_load_table(char *filename) 
{
    ...
    pcx_read_header(palette_base_filename, NULL, &w, &h, NULL, palette_org);
...
 ubyte * palette_get_fade_table() 
{
    ...
    
    {
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        (float) pow(i2fl(l) / 23.0f, 1.0f / Gr_gamma);
                  ...
                  gr_fade_table[((l + 1) * 256) + i] =
                    (unsigned char) palette_find(ur, ug, ub);
             } } gr_fade_table[(0 * 256) + i] =
            gr_fade_table[(1 * 256) + i];
        ...
        
        {
            ...
            {
              gr_fade_table[((67 - i) * 256) + l] =
                gr_fade_table[(i * 256) + l];
