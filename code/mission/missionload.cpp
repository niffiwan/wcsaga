...
int mission_load(char *filename_ext) 
{
    ...
    strncpy(Game_current_mission_filename, filename_ext,
             MAX_FILENAME_LEN - 1);
...
 void mission_load_menu_init() 
{
    ...
    cf_get_file_list(MLM_MAX_MISSIONS, mlm_missions, CF_TYPE_MISSIONS,
...
 void mission_load_menu_do() 
{
    ...
    
    {
        ...
        {
          mission_campaign_get_filenames(Campaign_file_names
                                          [Campaign_filter_index - 2],
                                          Campaign_missions,
