...
 struct hotkey_buttons 
{
   ...
    hotkey_buttons(char *name, int x1, int y1, int h):filename(name), x(x1),
    y(y1), hotspot(h)
  {
} };
...
 int hotkey_build_team_listing(int enemy_team_mask, int y,
                                 bool list_enemies) 
{
    ...
    
    {
        ...
        if (Ship_info[Ships[shipnum].ship_info_index].class_type < 0
            ||
            !(Ship_types
              [Ship_info[Ships[shipnum].ship_info_index].class_type].
              hud_bools & STI_HUD_HOTKEY_ON_LIST))
        continue;
       
        // don't process ships invisible to sensors, dying or departing
        if (Ships[shipnum].
            flags & (SF_HIDDEN_FROM_SENSORS | SF_DYING | SF_DEPARTING))
    ...
    
    {
           ...
           &&
           iff_matches_mask(Ships[Wings[i].ship_index[Wings[i].special_ship]].
                            team, team_mask))
        
        {
            ...
            hotkey_line_add_sorted(Wings[i].name, HOTKEY_LINE_WING, i, start);
            ...
            
            {
                ...
                
                {
                    ...
                    hotkey_line_insert(z + 1, Ships[s].ship_name,
...
void mission_hotkey_init() 
{
  ...
  Ui_window.create(0, 0, gr_screen.max_w_unscaled, gr_screen.max_h_unscaled,
    ...
    
    {
      ...
       b->button.create(&Ui_window, "", b->x, b->y, 60, 30, i < 2 ? 1 : 0,
                          1);
...
void mission_hotkey_do_frame(float frametime) 
{
  ...
  color circle_color;
    ...
    
    {
        ...
        
        {
          ...
          if ((z >= Hotkey_wing_icon_x[gr_screen.res])
              && (z <
                  (Hotkey_wing_icon_x[gr_screen.res]) +
    ...
    
    {
        ...
        Hotkey_list_coords[gr_screen.res][1] + Hotkey_lines[line].y -
        ...
        
        {
                        ...
                        Scroll_offset].
            update_dimensions(Hotkey_list_coords[gr_screen.res][0], y,
                              Hotkey_list_coords[gr_screen.res][0] +
