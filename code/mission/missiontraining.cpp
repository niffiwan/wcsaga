...
void training_obj_display() 
{
    ...
    emp_hud_printf(Directive_coords[gr_screen.res][DIRECTIVE_COORDS_TITLE][0]
                   + fl2i(HUD_offset_x),
                   Directive_coords[gr_screen.
                                    res][DIRECTIVE_COORDS_TITLE][1] +
                   fl2i(HUD_offset_y), EG_OBJ_TITLE, XSTR("directives", 422));
    ...
    Directive_coords[gr_screen.res][DIRECTIVE_COORDS_MIDDLE][1] +
    fl2i(HUD_offset_y);
    ...
    
    {
        ...
        Training_obj_window_coords[gr_screen.res][1] + fl2i(HUD_offset_y) +
        ...
        
        {
            ...
            Training_obj_window_coords[gr_screen.res][1] +
...
void training_mission_init() 
{
    ...
    
    {
        ...
        {
          Directive_gauge[i].first_frame =
            bm_load_animation(Directive_fnames[i],
...
void sort_training_objectives() 
{
    ...
    insertion_sort(Training_obj_lines, Training_obj_num_lines, sizeof(int),
              ...
              if (ptr)          // was key translated properly?
                {
                    ...
                    
                    {
                        ...
                        
                        {
                            ...
                            popup(PF_TITLE_BIG | PF_TITLE_RED, 2,
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    audiostream_open(Message_waves[index].name, ASF_VOICE);
...
void message_training_setup(int m, int length, char *special_message) 
{
    ...
    split_str(Training_buf, TRAINING_LINE_WIDTH, Training_line_sizes,
...
void message_training_queue_check() 
{
    ...
    
    {
        ...
        {
          message_training_setup(Training_message_queue[i].num,
...
void message_training_display() 
{
  ...
  gr_shade(Training_message_window_coords[gr_screen.res][0],
            Training_message_window_coords[gr_screen.res][1],
            TRAINING_MESSAGE_WINDOW_WIDTH,
  ...
  for (i = 0; i < Training_num_lines; i++)     // loop through all lines of message
    {
        ...
        Training_message_window_coords[gr_screen.res][0] +
        (TRAINING_MESSAGE_WINDOW_WIDTH - TRAINING_LINE_WIDTH) / 2;
      y =
        Training_message_window_coords[gr_screen.res][1] + i * height +
        height / 2 + 1;
