  ...
  int subhead_selected = FALSE;
    ...
    
    {
        ...
        
        {
          ...
          else if (Personas[persona_index].
                   flags & (PERSONA_FLAG_COMMAND | PERSONA_FLAG_LARGE))
...
void message_queue_process() 
{
  ...
  int found = -1;
    ...
    
    {
           ...
           ((Ship_info[Ships[Message_shipnum].ship_info_index].
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                snd_set_volume(Playing_messages[i].wave,
                                Master_sound_volume);
...
// Add and remove messages - used by autopilot code now, but useful elswhere
  bool add_message(char *name, char *message, int persona_index,
                    int multi_team) 
{
