...
 struct goal_buttons 
{
   ...
    goal_buttons(char *name, int x1, int y1, int h):filename(name), x(x1),
    y(y1), hotspot(h)
  {
} };
      ...
      switch (list[i]->satisfied)
        ...
        
        {
            ...
            - ys / 2;           // center of icon offest
               ...
               && (y + ys <=
                   Goal_screen_text_y + Goal_screen_text_h + ys / 2))
...
void mission_show_goals_init() 
{
  ...
  Goals_screen_ui_window.create(0, 0, gr_screen.max_w_unscaled,
    ...
    
    {
      ...
       b->button.create(&Goals_screen_ui_window, "", b->x, b->y, 60, 30,
                          (i < 2), 1);
...
 void ML_render_objectives_key() 
{
    ...
    
    {
      ...
       gr_string(Objective_key_text_coords_gr[gr_screen.res][0][0],
                   Objective_key_text_coords_gr[gr_screen.res][0][1],
                   XSTR("Complete", 1437));
      gr_string(Objective_key_text_coords_gr[gr_screen.res][1][0],
                 Objective_key_text_coords_gr[gr_screen.res][1][1],
                 XSTR("Incomplete", 1438));
      gr_string(Objective_key_text_coords_gr[gr_screen.res][2][0],
...
void mission_goal_status_change(int goal_num, int new_status) 
{
    ...
    
    {
      ...
      mission_log_add_entry(LOG_GOAL_FAILED, Mission_goals[goal_num].name,
                             NULL, goal_num);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                                 ...
                                 Mission_goals[goal_num].name, NULL,
                                 goal_num);
        }
       if (Game_mode & GM_MULTIPLAYER)
        
        {
          multi_team_maybe_add_score(Mission_goals[goal_num].score,
                                      Mission_goals[goal_num].team);
          multi_player_maybe_add_score(Mission_goals[goal_num].score,
                                        Mission_goals[goal_num].team);
        ...
        
        {
            ...
            (int) (Mission_goals[goal_num].score *
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                multi_team_maybe_add_score(Mission_events[event].score,
                                           Mission_events[event].team);
              multi_player_maybe_add_score(Mission_events[event].score,
                                            Mission_events[event].team);
            ...
            
            {
                ...
                Player->stats.m_score +=
                (int) (Mission_events[event].score *
                       scoring_get_scale_factor());
