...
void mission_log_add_entry(int type, char *pname, char *sname,
                           int info_index) 
{
...
  void message_log_add_seg(int n, int x, int color, char *text, int flags =
                              0) 
{
...
void message_log_init_scrollback(int pw) 
{
    ...
    
    {
        ...
        
        {
          ...
          message_log_add_segs(XSTR("Self Destructed", 1476),
                                LOG_COLOR_NORMAL);
          ...
          
          {
            ...
             message_log_add_segs(XSTR("Subsystem ", 410),
                                    LOG_COLOR_NORMAL);
          ...
          message_log_add_segs(XSTR(" aborted rearm", 416),
                                LOG_COLOR_NORMAL);
          ...
          
          {
            ...
             sprintf(text, XSTR("%s objective ", 419),
                       Goal_type_text(type));
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              gr_line(list_x + TIME_X - 6, i - 4, list_x + TIME_X - 6,
                       i - 2);
              gr_line(list_x + TIME_X - 4, i, list_x + TIME_X - 2, i);
              gr_line(list_x + TIME_X - 6, i + 2, list_x + TIME_X - 6,
                       i + 4);
