  ...
  Flag exe_params[] = 
{
  ...
  {
  "-cache_bitmaps", "Cache bitmaps between missions", true, 0,
      EASY_DEFAULT_MEM, "Game Speed",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-cache_bitmaps",},
     
  {
  "-dualscanlines", "Another pair of scanning lines", true, 0, EASY_DEFAULT,
      "HUD",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-dualscanlines",},
    
  {
  "-targetinfo", "Enable info next to target", true, 0, EASY_DEFAULT, "HUD",
  ...
  {
  "-rearm_timer", "Enable Rearm/Repair Completion Timer", true, 0,
      EASY_DEFAULT, "HUD",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-rearm_timer",},
    
  {
  "-ballistic_gauge", "Enable the analog ballistic ammo gauge", true, 0,
      EASY_DEFAULT, "HUD",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-ballistic_gauge",},
     
  {
  "-ship_choice_3d", "Use models for ship selection", true, 0, EASY_DEFAULT,
      "Gameplay",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-ship_choice_3d",},
    
  {
  "-weapon_choice_3d", "Use models for weapon selection", true, 0,
      EASY_DEFAULT, "Gameplay",
  ...
  {
  "-warp_flash", "Enable flash upon warp", true, 0, EASY_DEFAULT,
      "Gameplay",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-warp_flash",},
    
  {
  "-no_ap_interrupt", "Disable interrupting autopilot", true, 0,
      EASY_DEFAULT, "Gameplay",
  ...
  {
  "-wcsaga", "Toggle features for Wing Commander Saga", true, 0,
      EASY_DEFAULT, "Gameplay",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-wcsaga",},
     
  {
  "-snd_preload", "Preload mission game sounds", true, EASY_MEM_ALL_ON,
      EASY_DEFAULT_MEM, "Audio",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-snd_preload",},
    
  {
  "-nosound", "Disable sound and music", false, 0, EASY_DEFAULT, "Audio",
  ...
  {
  "-query_speech", "Does this build have speech?", true, 0, EASY_DEFAULT,
      "Troubleshoot",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-query_speech",},
    
  {
  "-d3d_bad_tsys", "Enable inefficient textures", true, 0, EASY_DEFAULT,
      "Troubleshoot",
  ...
  {
  "-noibx", "Don't use cached index buffers (IBX)", true, 0, EASY_DEFAULT,
      "Troubleshoot",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-noibx",},
    
  {
  "-loadallweps", "Load all weapons, even those not used", true, 0,
      EASY_DEFAULT, "Troubleshoot",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-loadallweps",},
    
  {
  "-disable_fbo", "Disable OpenGL RenderTargets", true, 0, EASY_DEFAULT,
      "Troubleshoot", "",}, 
  {
  "-no_glsl", "Disable GLSL (shader) support", true, 0, EASY_DEFAULT,
      "Troubleshoot", "",}, 
  {
  "-ati_swap", "Fix Color issues on some ATI cards", true, 0, EASY_DEFAULT,
      "Troubleshoot", "http://scp.indiegames.us/mantis/view.php?id=1669",},
     
  {
  "-ingame_join", "Allows ingame joining", true, 0, EASY_DEFAULT,
      "Experimental",
  ...
  {
  "-fps", "Show frames per second on HUD", false, 0, EASY_DEFAULT,
      "Dev Tool",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-fps",},
    
  {
  "-pos", "Show position of camera", false, 0, EASY_DEFAULT, "Dev Tool",
  ...
  "-fullscreen_window", "Run in fullscreen window", false, 0, 0, "Dev Tool",
      "",}, 
  {
  "-res", "Run at specified resolution", true, 0, EASY_DEFAULT, "Dev Tool",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-res",},
  ...
  {
  "-dis_collisions", "Disable collisions", true, 0, EASY_DEFAULT,
      "Dev Tool",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-dis_collisions",},
    
  {
  "-dis_weapons", "Disable weapon rendering", true, 0, EASY_DEFAULT,
      "Dev Tool",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-dis_weapons",},
    
  {
  "-output_sexps", "Outputs SEXPs to sexps.html", true, 0, EASY_DEFAULT,
      "Dev Tool",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-output_sexps",},
    
  {
  "-output_scripting", "Outputs scripting to scripting.html", true, 0,
      EASY_DEFAULT, "Dev Tool",
      "http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-output_scripting",},
    
  {
  "-save_render_target", "Save render targets to file", true, 0,
      EASY_DEFAULT, "Dev Tool", "",}, 
  {
  "-debug_window", "Display debug window", true, 0, EASY_DEFAULT,
      "Dev Tool", "",}, 
  {
  "-verify_vps", "Spew VP crcs to vp_crcs.txt", true, 0, EASY_DEFAULT,
      "Dev Tool", "",}, 
#ifdef SCP_UNIX
  {
  "-nograb", "Don't grab mouse/keyboard in a window", true, 0, EASY_DEFAULT,
      "Dev Tool",
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                get_new_offset =
                (strlen(cmdline) - strlen(cmdline_offset) +
                 strlen(parmp->name));
               if ((*(cmdline_offset + strlen(parmp->name)))
                     &&
                     !is_extra_space(*(cmdline_offset + strlen(parmp->name))))
        ...
        
        {
            ...
            
            {
              ...
              char buffer[128];
                       ...
                       "Unrecogzined command line parameter %s, continue?",
                       token);
                ...
                CFStringRef message;
                          ...
                          "Unrecognized command line parameter, \"%s\", continue?",
                          token);
              message =
                CFStringCreateWithCString(NULL, buffer,
                                          kCFStringEncodingASCII);
               if (CFUserNotificationDisplayAlert
                     (0, kCFUserNotificationPlainAlertLevel, NULL, NULL, NULL,
                      CFSTR("Unknown Command"), message, NULL, CFSTR("Quit"),
                      NULL, &result))
...
void os_init_cmdline(char *cmdline) 
{
  ...
  char cmdname[MAX_PATH];
   snprintf(cmdname, MAX_PATH, "%s/%s/data/cmdline_fso.cfg", detect_home(),
              Osreg_user_dir);
    ...
    
    {
        ...
        snprintf(cmdname, MAX_PATH, "%s/%s/data/cmdline.cfg", detect_home(),
                 Osreg_user_dir);
...
// Sets externed variables used for communication cmdline information
{
    ...
    
    {
        ...
        {
          MessageBox(NULL, "Error creating flag list for launcher", "Error",
                      MB_OK);
...
#ifdef WIN32
        MessageBox(NULL,
                   "Decals have been disabled in builds after May 4, 2006.  Please remove the \"-decals\" command line from the launcher to prevent this message from appearing the the future.",
