...
{
SND_ENV_BATHROOM, 0.2F, 0.2F, 1.0F};
...
void game_loading_callback(int count) 
{
    ...
    ((Game_loading_ani.num_frames * count) / COUNT_ESTIMATE) + 1;
    ...
    //if ( keyd_pressed[KEY_LSHIFT] )
  {
      ...
      
      {
          ...
          
          {
            ...
             model_find_world_point(eye_pos,
                                      &turret->turret_firing_point[0],
                                      turret->model_num,
                                      turret->turret_gun_sobj, &tobj->orient,
                                      &tobj->pos);
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              Script_system.RunCondition(CHA_HUDDRAW, '\0', NULL,
                                          Viewer_obj);
...
void get_version_string(char *str, int max_size) 
{
    ...
    {
      sprintf(str, "FreeSpace 2 Open v%i.%i", FS_VERSION_MAJOR,
               FS_VERSION_MINOR);
    ...
    {
      sprintf(str, "FreeSpace 2 Open v%i.%i.%i", FS_VERSION_MAJOR,
               FS_VERSION_MINOR, FS_VERSION_BUILD);
    ...
    {
      sprintf(str, "FreeSpace 2 Open v%i.%i.%i.%i", FS_VERSION_MAJOR,
               FS_VERSION_MINOR, FS_VERSION_BUILD, FS_VERSION_REVIS);
...
 void oem_upsell_show_screens() 
{
  ...
  Oem_normal_cursor = gr_get_cursor_bitmap();
    ...
    
    {
        ...
        {
          if (Oem_upsell_bitmaps[gr_screen.res][Oem_upsell_screen_number] <
               0)
