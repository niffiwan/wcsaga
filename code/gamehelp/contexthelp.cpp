  ...
  for (idx = 0; idx < rbracketcount; idx++)
    {
      ...
      gr_bitmap(help_overlaylist[overlay_id].rbracketlist[gr_screen.res][idx].
                x_coord,
                help_overlaylist[overlay_id].rbracketlist[gr_screen.res][idx].
                y_coord);
    }
  ...
  for (idx = 0; idx < lbracketcount; idx++)
    {
      ...
      gr_bitmap(help_overlaylist[overlay_id].lbracketlist[gr_screen.res][idx].
                x_coord,
                help_overlaylist[overlay_id].lbracketlist[gr_screen.res][idx].
                y_coord);
    }
