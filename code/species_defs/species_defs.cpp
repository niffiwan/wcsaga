...
void parse_thrust_anims(species_info * species, bool no_create) 
{
    ...
    
    {
      ...
      generic_bitmap_init(&species->thruster_secondary_glow_info.normal,
                           NULL);
      generic_bitmap_init(&species->thruster_secondary_glow_info.afterburn,
                           NULL);
      generic_bitmap_init(&species->thruster_tertiary_glow_info.normal,
                           NULL);
      generic_bitmap_init(&species->thruster_tertiary_glow_info.afterburn,
                           NULL);
    ...
    
    {
        ...
        stuff_string(species->thruster_info.flames.normal.filename, F_NAME,
                      MAX_FILENAME_LEN);
    ...
    
    {
        ...
        stuff_string(species->thruster_info.flames.afterburn.filename,
                      F_NAME, MAX_FILENAME_LEN);
    ...
    stuff_string(species->thruster_secondary_glow_info.normal.filename,
                  F_NAME, MAX_FILENAME_LEN);
   
    // etc.
    if (optional_string("+Sec_Afterburn:"))
    stuff_string(species->thruster_secondary_glow_info.afterburn.filename,
                  F_NAME, MAX_FILENAME_LEN);
   
    // etc.
    if (optional_string("+Ter_Normal:"))
    stuff_string(species->thruster_tertiary_glow_info.normal.filename,
                  F_NAME, MAX_FILENAME_LEN);
   
    // etc.
    if (optional_string("+Ter_Afterburn:"))
    stuff_string(species->thruster_tertiary_glow_info.afterburn.filename,
                  F_NAME, MAX_FILENAME_LEN);
...
 void parse_thrust_glows(species_info * species, bool no_create) 
{
    ...
    
    {
        ...
        stuff_string(species->thruster_info.glow.normal.filename, F_NAME,
                      MAX_FILENAME_LEN);
    ...
    
    {
        ...
        stuff_string(species->thruster_info.glow.afterburn.filename, F_NAME,
                      MAX_FILENAME_LEN);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                       ...
                       "Species %s default IFF %s not found in iff_defs.tbl!  Defaulting to %s.\n",
        ...
        
        {
            ...
            // let them know
            Warning(LOCATION,
                    "$Default IFF not specified for species %s in species_defs.tbl!  Defaulting to %s.\n",
        ...
        
        {
          ...
          else if (!stricmp(species->species_name, "Ancients")
        ...
        
        {
          ...
          stuff_string(species->debris_texture.filename, F_NAME,
                        MAX_FILENAME_LEN);
        }
        
        // Shield Hit Animation
        if ((!no_create && required_string("+Shield_Hit_ani:"))
            || optional_string("+Shield_Hit_ani:"))
        
        {
          generic_anim_init(&species->shield_anim, NULL);
          stuff_string(species->shield_anim.filename, F_NAME,
                        MAX_FILENAME_LEN);
