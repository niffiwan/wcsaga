...
void encrypt(char *text, int text_len, char *scrambled_text,
             int *scrambled_len, int use_8bit, bool new_encrypt) 
{
                 ...
                 int *scrambled_len) 
{
    ...
    
    {
        ...
        {
          memcpy(lvl1_block, text + *scrambled_len,
                  text_len - *scrambled_len);
                   ...
                   int *text_len) 
{
    ...
    *text_len = 0;
    ...
    
    {
        ...
        // the running checksum
        block_checksum =
        chksum_add_short(block_checksum, (char *) lvl1_block_copy,
                         block_size);
