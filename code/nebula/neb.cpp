        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    // it's just black
                    Neb2_fog_color_r = Neb2_fog_color_g = Neb2_fog_color_b =
                    0;
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                h_inch + (hs * (float) idx1) + frand_range(-Nd->hj, Nd->hj);
              v->xyz.z =
                h_incd + (ds * (float) idx2) + frand_range(-Nd->dj, Nd->dj);
        ...
        
        {
            ...
            
            {
                ...
                h_incw + (ws * (float) idx1) + frand_range(-Nd->wj, Nd->wj);
        ...
        
        {
            ...
            
            {
                ...
                h_inch + (hs * (float) idx2) + frand_range(-Nd->hj, Nd->hj);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                alpha =
                neb2_get_alpha_2shell(Nd->cube_inner, Nd->cube_outer,
                                      Nd->prad / 4.0f,
                ...
                
                {
                    ...
                    neb2_get_alpha_offscreen(ptemp.sx, ptemp.sy, alpha);
                ...
                gr_set_lighting(false, false);
                                      ...
                                      fl_radian(Neb2_cubes[idx1][idx2][idx3].
                                                rot), Nd->prad,
                                      TMAP_FLAG_TEXTURED);
...
void neb2_get_pixel(int x, int y, int *r, int *g, int *b) 
{
  ...
  bm_get_components(&tpixels[PIXEL_INDEX_SMALL(xs, ys)], &rv, &gv, &bv,
                     NULL);
