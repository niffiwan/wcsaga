                  ...
                  if (b->strikes_left == bi->num_strikes)
                    {
                      ...
                      if (frand_range(0.0f, 1.0f) < 0.5f)
                      ...
                      else
                        {
                          if (frand_range(0.0f, 1.0f) < 0.5f)
                            {
                              snd_play(&Snds[SND_LIGHTNING_4], 0.0f, bang,
                                       SND_PRIORITY_DOUBLE_INSTANCE);
                            }
                          else
                            {
                              snd_play(&Snds[SND_LIGHTNING_3], 0.0f, bang,
                                       SND_PRIORITY_DOUBLE_INSTANCE);
                            }
                        }
  ...
  for (idx = 0; idx < 3; idx++)
    {
      ...
      if ((proj_vertex.sx >= 0) && (proj_vertex.sx < gr_screen.max_w)
          && (proj_vertex.sy >= 0) && (proj_vertex.sy < gr_screen.max_h))
        {
