...
int nebl_gen(vec3d * left, vec3d * right, float depth, float max_depth,
             int child, l_node ** l_left, l_node ** l_right);
...
void nebl_calc_facing_pts_smart(vec3d * top, vec3d * bot, vec3d * fvec,
...
// generate a section
void nebl_generate_section(bolt_type * bi, float width, l_node * a,
                           l_node * b, l_section * c, l_section * cap,
                           int pinch_a, int pinch_b);
...
void nebl_process() 
{
    ...
    
    {
        ...
        timestamp((int) frand_range((float) Storm->min, (float) Storm->max));
    ...
    
    {
        ...
        num_bolts =
        (int) frand_range((float) Storm->min_count, (float) Storm->max_count);
        ...
        
        {
          ...
          do
            ...
            
            {
              ...
              vm_vec_interp_constant(&the_mixture, &your_basic_hot_sauce,
                                      &wing_sauce,
            ...
            (int) frand_range(0.0f, (float) (Storm->num_bolt_types - 1));
...
void nebl_bolt(int type, vec3d * start, vec3d * strike) 
{
    ...
    if (!nebl_gen
        (&Nebl_bolt_start, &Nebl_bolt_strike, 0, 4, 0, &bolt->head, &tail))
  ...
  &v[0], &v[1], &v[2], &v[3]};
    ...
    
    {
      ...
      v[3].v = 1.0f;
        ...
        // draw
        gr_set_bitmap(bi->texture, GR_ALPHABLEND_FILTER,
                      GR_BITBLT_MODE_NORMAL, Nebl_alpha);
                 ...
                 l_section * prev) 
{
    ...
    
    {
        ...
        // generate section
        nebl_generate_section(bi, width * 0.5f, whee, whee->links[LINK_CHILD],
                              &child_start, &end, 0,
                              whee->links[LINK_CHILD]->links[LINK_RIGHT] ==
                              NULL ? 1 : 0);
    ...
    
    {
        ...
        nebl_generate_section(bi, width, whee->links[LINK_RIGHT],
                              whee->links[LINK_RIGHT]->links[LINK_RIGHT],
                              &end, NULL, 0, 0);
