...
 void parse_stringstbl(char *filename) 
{
    ...
    
    {
        ...
        
        {
            ...
            Warning(LOCATION, "Strings table index %d used more than once",
                     index);
...
int lcl_add_dir_to_path_with_filename(char *current_path, uint path_max) 
{
  ...
  char *last_slash = strrchr(current_path, DIR_SEPARATOR_CHAR);
    ...
    strcat_s(current_path, path_max,
             Lcl_languages[Lcl_current_lang].lang_ext);
        ...
        case TS_ID_STRING:
            ...
            
            {
                ...
                
                {
                  ...
                   return found_new_string_id ? (1 << 1) | (1 << 31) : (1 <<
                                                                          1);
...
void lcl_ext_setup_pointers() 
{
    ...
    
    {
                     ...
                     "Could not find specified langauge in tstrings.tbl!\n");
    ...
    
    {
        ...
        case 3:
            ...
            Lcl_pointers[Lcl_pointer_count++] =
            cftell(Lcl_ext_file) - strlen(line) - 1;
