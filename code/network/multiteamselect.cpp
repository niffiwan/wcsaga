            ...
            
            {
                   ...
                   (Objects
                    [Multi_ts_team[pl->p_info.team].
                     multi_ts_objnum[slot_num]].flags & OF_PLAYER_SHIP)
...
 void multi_ts_assign_players_all() 
{
    ...
    {
      sprintf(name_lookup, "%s 1",
               TVT_wing_names[Netgame.host->p_info.team]);
    ...
    
    {
        ...
        
        {
            ...
            if ((Multi_ts_team[idx].multi_ts_player[s_idx] != NULL)
                &&
                !MULTI_CONNECTED((*Multi_ts_team[idx].
                                  multi_ts_player[s_idx])))
...
void multi_ts_init_graphics() 
{
    ...
    Multi_ts_window.add_XSTR("Briefing", 765,
                             Multi_ts_buttons[gr_screen.
                                              res][MULTI_TS_BRIEFING].xt,
                             Multi_ts_buttons[gr_screen.
                                              res][MULTI_TS_BRIEFING].yt,
                             &Multi_ts_buttons[gr_screen.
    ...
    
    {
        ...
        
        {
            ...
            if ((Netgame.type_flags & NG_TYPE_TEAM)
                ...
                && (Multi_ts_team[Net_player->p_info.team].
                    multi_ts_player[idx]->flags & NETINFO_FLAG_TEAM_CAPTAIN))
...
void multi_ts_blit_ship_info() 
{
  ...
  gr_string(Multi_ts_ship_info_coords[gr_screen.res][MULTI_TS_X_COORD] + 150,
             y_start, str);
    ...
    
    {
        ...
        
        {
            ...
            if (!strnicmp
                ...
                && multi_ts_validate_ship(ship_name,
                                          Starting_wing_names[idx]))
...
 void multi_ts_apply(int from_type, int from_index, int to_type,
                       int to_index, int ship_class, int player_index) 
{
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                send_pslot_update_packet(pl->p_info.team,
                                         TS_CODE_PLAYER_UPDATE, -1);
                   ...
                   int ship_class, int player_index) 
{
    ...
    
    {
        ...
        {
          multi_ts_apply(from_type, from_index, to_type, to_index,
                          ship_class, player_index);
    ...
    
    {
        ...
        strcpy_s(callsign,
                 ...
                 callsign);
                           ...
                           [Multi_ts_carried_from_index][gr_screen.
                                                         res]
                           [MULTI_TS_W_COORD]);
