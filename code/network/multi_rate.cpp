    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                {
                  memmove(m->records_second, m->records_second + 1,
                ...
                R_AVG(m->records_second_count, m->records_second,
                      m->avg_second);
            ...
            {
              memmove(m->records_frame, m->records_frame + 1,
                       sizeof(int) * (NUM_UPDATE_RECORDS - 1));
...
void multi_rate_display(int np_index, int x, int y) 
{
    ...
    
    {
      ...
      gr_printf(x, y, "%s %d (%d/s) (%f/f)", m->type, m->total_bytes,
