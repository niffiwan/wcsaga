...
 extern void stuff_netplayer_info(net_player * nplayer, net_addr * addr,
...
extern int multi_create_player(int player_num, player * pl, char *name,
...
extern void fill_net_addr(net_addr * addr, ubyte * address, ubyte * net_id,
                           ushort port);
...
 void multi_assign_player_ship(int net_player, object * objp,
                                 int ship_class);
...
 void server_verify_filesig(short player_id, ushort sum_sig,
                              int length_sig);
...
 void multi_maybe_send_repair_info(object * dest_obj, object * source_objp,
                                     int code);
