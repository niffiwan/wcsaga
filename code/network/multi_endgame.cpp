...
void multi_endgame_process() 
{
    ...
    
    {
        ...
        
        {
            ...
            {
              popup_till_condition(multi_endgame_server_ok_to_leave,
                                    XSTR("&Cancel", 645),
                                    XSTR("Waiting for clients to disconnect",
                                         646));
...
int multi_quit_game(int prompt, int notify_code, int err_code,
                    int wsa_error) 
{
    ...
    
    {
      ...
      physics_read_flying_controls(&Player_obj->orient,
                                    &Player_obj->phys_info, &(Player->ci),
                                    flFrametime);
    ...
    
    {
        ...
        
        {
            ...
            popup(p_flags, 2, POPUP_CANCEL, POPUP_OK,
                  XSTR
        ...
        
        {
            ...
            popup(PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON |
        ...
        {
          send_netgame_end_error_packet(MULTI_END_NOTIFY_SERVER_LEFT,
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                multi_display_chat_msg(XSTR("<Team captains have left>", 649),
                                       0, 0);
...
void multi_endgame_cleanup() 
{
    ...
    
    {
        ...
        {
          multi_endgame_popup(Multi_endgame_notify_code,
                               Multi_endgame_error_code,
    ...
    
    {
        ...
        
        {
            ...
            
            {
                        ...
                        XSTR("You have waited too long to select a ship",
                             655));
        ...
        
        {
            ...
            
            {
                        ...
                        XSTR("Contact with server has been lost", 656));
              break;
            case MULTI_END_ERROR_CONNECT_FAIL:
              strcat_s(err_msg,
                        XSTR("Failed to connect to server on reliable socket",
                             657));
                        ...
                        XSTR("Unable to create ingame join player ship",
                             659));
                        ...
                        XSTR("Server transfer failed (obsolete)", 661));
                        ...
                        XSTR("There was an error receiving the mission file!",
                             665));
            ...
            case MULTI_END_ERROR_TEAM0_EMPTY:
                        ...
                        XSTR("All players from team 1 have left the game",
                             664));
              break;
            case MULTI_END_ERROR_TEAM1_EMPTY:
              strcat_s(err_msg,
                        XSTR("All players from team 2 have left the game",
                             664));
