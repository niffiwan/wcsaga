...
void multi_voice_player_send_stream()
{
  ...
  // get the data
  rtvoice_get_data((unsigned char **) &Multi_voice_record_buffer, &sound_size,
                   &uncompressed_size, &d_gain, NULL, NULL);
  gain = (float) d_gain;
...
void multi_voice_test_process_next_chunk()
{
  ...
  options_multi_set_voice_data(outbuf_raw, raw_size, outbuf, compressed_size,
                               uncompressed_size, gain);
}
