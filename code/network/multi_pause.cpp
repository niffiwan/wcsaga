...
void multi_pause_init() 
{
    ...
    
    {
        ...
        // create ui window
        Multi_paused_window.create(0, 0, gr_screen.max_w_unscaled,
        ...
        
        {
            ...
            // create the button
            Multi_paused_buttons[gr_screen.res][i].button.
            create(&Multi_paused_window, "",
            ...
            // set the ani
            Multi_paused_buttons[gr_screen.res][i].button.
            set_bmaps(Multi_paused_buttons[gr_screen.res][i].filename);
           
            // set the hotspot
            Multi_paused_buttons[gr_screen.res][i].button.
            link_hotspot(Multi_paused_buttons[gr_screen.res][i].hotspot);
...
void multi_pause_render_callsign() 
{
    ...
    
    {
      ...
      gr_string(Mp_callsign_coords[gr_screen.res][0],
                 Mp_callsign_coords[gr_screen.res][1], pause_str);
