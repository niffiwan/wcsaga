...
#define MULTI_PXO_GAMES                     14
  ...
  Multi_pxo_buttons[GR_NUM_RESOLUTIONS][MULTI_PXO_NUM_BUTTONS] = 
{
...
void multi_pxo_init(int use_last_channel) 
{
    ...
    
    {
        ...
        Multi_pxo_buttons[gr_screen.res][idx].button.
        set_highlight_action(common_play_highlight_sound);
       
        // set the ani for the button
        Multi_pxo_buttons[gr_screen.res][idx].button.
        set_bmaps(Multi_pxo_buttons[gr_screen.res][idx].filename);
       
        // set the hotspot
        Multi_pxo_buttons[gr_screen.res][idx].button.
        link_hotspot(Multi_pxo_buttons[gr_screen.res][idx].hotspot);
  ...
  Multi_pxo_buttons[gr_screen.res][MULTI_PXO_PLIST_DOWN].button.
    repeatable(1);
    ...
    {
      Multi_pxo_buttons[gr_screen.res][MULTI_PXO_RANKINGS].button.
        set_custom_cursor_bmap(Web_cursor_bitmap);
    }
   
    // create the channel list select button and hide it
    Multi_pxo_channel_button.create(&Multi_pxo_window, "",
                                    Multi_pxo_chan_coords[gr_screen.res][0],
                                    Multi_pxo_chan_coords[gr_screen.res][1],
                                    Multi_pxo_chan_coords[gr_screen.res][2],
                                    Multi_pxo_chan_coords[gr_screen.res][3],
                                    0, 1);
  Multi_pxo_channel_button.hide();
   
    // create the player list select button and hide it
    Multi_pxo_player_button.create(&Multi_pxo_window, "",
                                   Multi_pxo_player_coords[gr_screen.res][0],
                                   Multi_pxo_player_coords[gr_screen.res][1],
                                   Multi_pxo_player_coords[gr_screen.res][2],
                                   Multi_pxo_player_coords[gr_screen.res][3],
                                   0, 1);
  Multi_pxo_player_button.hide();
   
    // create the chat input box
    Multi_pxo_chat_input.create(&Multi_pxo_window,
                                Multi_pxo_input_coords[gr_screen.res][0],
                                Multi_pxo_input_coords[gr_screen.res][1],
                                Multi_pxo_input_coords[gr_screen.res][2],
                                MAX_CHAT_LINE_LEN + 1, "",
    ...
    Multi_pxo_ban_button.create(&Multi_pxo_window, "",
                                Pxo_ban_coords[gr_screen.res][0],
                                Pxo_ban_coords[gr_screen.res][1],
                                Pxo_ban_coords[gr_screen.res][2],
    ...
    Multi_pxo_chat_slider.create(&Multi_pxo_window,
...
void multi_pxo_do_normal() 
{
    ...
    
    {
        ...
        
        {
            ...
            // set our status
            multi_pxo_set_status_text(XSTR
                                      ("Retrieving Public Channels", 939));
...
void multi_pxo_blit_all() 
{
  ...
  do
    ...
    generic_anim_render(&Multi_pxo_anim, flFrametime, MULTI_PXO_ANIM_X,
                         MULTI_PXO_ANIM_Y);
...
void multi_pxo_handle_disconnect() 
{
    ...
    {
      popup_change_text(XSTR
                         ("You have been disconnected from the server", 942));
...
void multi_pxo_button_pressed(int n) 
{
    ...
    
    {
        ...
        {
          multi_pxo_notify_add(XSTR
                                ("Already trying to join a channel!", 945));
        ...
        
        {
            ...
            
            {
                       ...
                       ("Could not get stats for %s\n(May not be a registered pilot)",
                        946), Multi_pxo_player_select->name);
...
int multi_pxo_connect() 
{
    ...
    
    {
        ...
        
        {
          ...
           strcpy_s(join_fail_str,
                      XSTR("Unable to join last channel", 983));
        ...
        rval =
        popup_till_condition(multi_pxo_autojoin_do, XSTR("&Cancel", 779),
                             join_str);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                multi_pxo_find_channel(Multi_pxo_channel_current.name,
                                       Multi_pxo_channels);
...
int multi_pxo_is_autojoin(char *name) 
{
    ...
    return !strnicmp(name, MULTI_PXO_AUTOJOIN_PREFIX,
                     strlen(MULTI_PXO_AUTOJOIN_PREFIX));
...
void multi_pxo_channel_count_update(char *name, int count) 
{
    ...
    
    {
        ...
        ("PXO : unable to locate channel when trying to update count for %s",
         name);
...
void multi_pxo_set_status_text(char *txt) 
{
    ...
    gr_force_fit_string(Multi_pxo_status_text, 254,
...
void multi_pxo_blit_status_text() 
{
    ...
    
    {
      ...
      gr_string(Multi_pxo_status_coords[gr_screen.res][0] +
                 ((Multi_pxo_status_coords[gr_screen.res][2] - w) / 2),
                 Multi_pxo_status_coords[gr_screen.res][1],
                 Multi_pxo_status_text);
...
void multi_pxo_process_channels() 
{
    ...
    
    {
        ...
        // refresh channels
        multi_pxo_set_status_text(XSTR
                                  ("Refreshing Public Channel List", 952));
...
void multi_pxo_blit_channels() 
{
  ...
  do
    
    {
      ...
      gr_force_fit_string(chan_name, 254,
                           Multi_pxo_chan_coords[gr_screen.res][2] -
                           Multi_pxo_chan_column_offsets[gr_screen.
                                                         res]
                           [CHAN_PLAYERS_COLUMN]);
       
        // blit the strings
        gr_string(Multi_pxo_chan_coords[gr_screen.res][0], y_start,
                  chan_name + 1);
      gr_string(Multi_pxo_chan_coords[gr_screen.res][0] +
                 Multi_pxo_chan_coords[gr_screen.res][2] -
                 Multi_pxo_chan_column_offsets[gr_screen.
                                               res][CHAN_PLAYERS_COLUMN],
                 y_start, chan_users);
      gr_set_color_fast(&Color_bright);
      gr_string(Multi_pxo_chan_coords[gr_screen.res][0] +
                 Multi_pxo_chan_coords[gr_screen.res][2] -
                 Multi_pxo_chan_column_offsets[gr_screen.
                                               res][CHAN_GAMES_COLUMN],
                 y_start, chan_servers);
...
void multi_pxo_join_channel(pxo_channel * chan) 
{
    ...
    
    {
        ...
        {
          sprintf(switch_msg, "[Switching to channel %s]",
      ...
       multi_pxo_chat_process_incoming(switch_msg,
                                         CHAT_MODE_CHANNEL_SWITCH);
...
void multi_pxo_handle_channel_change() 
{
    ...
    case 1:
        ...
        // copy the current channel info, and unset the switching status
        memcpy(&Multi_pxo_channel_current, &Multi_pxo_channel_switch,
               sizeof(pxo_channel));
...
void multi_pxo_blit_players() 
{
  ...
  do
    
    {
      ...
      gr_force_fit_string(player_name, 254,
                           Multi_pxo_player_coords[gr_screen.res][2]);
       
        // blit the string
        gr_string(Multi_pxo_player_coords[gr_screen.res][0], y_start,
                  player_name);
...
void multi_pxo_chat_process_incoming(char *txt, int mode) 
{
  ...
  char *priv_ptr;
    ...
    n_lines =
    split_str(msg_total, Multi_pxo_chat_coords[gr_screen.res][2] - 5, n_chars,
              p_str, 3);
...
void multi_pxo_chat_blit() 
{
    ...
    
    {
        ...
        case CHAT_MODE_SERVER:
          ...
          gr_string(Multi_pxo_chat_coords[gr_screen.res][0], y_start,
                     moveup->text);
...
void multi_pxo_chat_process() 
{
  ...
  else if ((Multi_pxo_chat_input.pressed() && (strlen(msg) > 0))
...
int multi_pxo_is_server_text(char *txt) 
{
    ...
    if ((strlen(txt) >= strlen(MULTI_PXO_SERVER_PREFIX))
        && !strncmp(txt, MULTI_PXO_SERVER_PREFIX,
...
int multi_pxo_is_motd_text(char *txt) 
{
    ...
    if ((strlen(txt) >= strlen(PXO_CHAT_MOTD_PREFIX))
        && !strncmp(txt, PXO_CHAT_MOTD_PREFIX, strlen(PXO_CHAT_MOTD_PREFIX)))
...
int multi_pxo_is_end_of_motd_text(char *txt) 
{
    ...
    // if we're not on a channel, and this is not a channel switching message assume its coming from a server
    if ((strlen(txt) >= strlen(PXO_CHAT_END_OF_MOTD_PREFIX))
        && !strncmp(txt, PXO_CHAT_END_OF_MOTD_PREFIX,
...
int multi_pxo_chat_is_left_message(char *txt) 
{
    ...
    memset(last_portion, 0, 100);
       ...
       && !strcmp(&txt[strlen(txt) - strlen(MULTI_PXO_HAS_LEFT)],
                  MULTI_PXO_HAS_LEFT))
...
void multi_pxo_motd_maybe_blit() 
{
    ...
    
    {
        ...
        {
          Multi_pxo_buttons[gr_screen.res][MULTI_PXO_MOTD].button.
            draw_forced(2);
...
void multi_pxo_com_init(int input_len) 
{
    ...
    set_mask_bmap(Multi_pxo_com_mask_fname[gr_screen.res]);
    ...
    
    {
        ...
        // create the object
        Multi_pxo_com_buttons[gr_screen.res][idx].button.
        create(&Multi_pxo_com_window, "",
        ...
        // set the ani for the button
        Multi_pxo_com_buttons[gr_screen.res][idx].button.
        set_bmaps(Multi_pxo_com_buttons[gr_screen.res][idx].filename);
       
        // set the hotspot
        Multi_pxo_com_buttons[gr_screen.res][idx].button.
        link_hotspot(Multi_pxo_com_buttons[gr_screen.res][idx].hotspot);
    ...
    Multi_pxo_com_input.create(&Multi_pxo_com_window,
                               Multi_pxo_com_input_coords[gr_screen.res][0],
...
void multi_pxo_com_blit_text() 
{
    ...
    
    {
      ...
      gr_string(Multi_pxo_com_top_text_coords[gr_screen.res][0],
...
void multi_pxo_com_set_top_text(char *txt) 
{
    ...
    
    {
      ...
      gr_force_fit_string(Multi_pxo_com_top_text, 254,
                           Multi_pxo_com_input_coords[gr_screen.res][2]);
...
void multi_pxo_com_set_middle_text(char *txt) 
{
    ...
    
    {
      ...
      gr_force_fit_string(Multi_pxo_com_middle_text, 254,
                           Multi_pxo_com_input_coords[gr_screen.res][2]);
...
void multi_pxo_com_set_bottom_text(char *txt) 
{
    ...
    
    {
      ...
      gr_force_fit_string(Multi_pxo_com_bottom_text, 254,
                           Multi_pxo_com_input_coords[gr_screen.res][2]);
...
void multi_pxo_priv_init() 
{
    ...
    // set some text
    multi_pxo_com_set_middle_text(XSTR
...
int multi_pxo_priv_popup() 
{
  ...
  gr_bitmap(Multi_pxo_com_coords[gr_screen.res][0],
             Multi_pxo_com_coords[gr_screen.res][1]);
...
int multi_pxo_find_popup() 
{
    ...
    case 1:
        ...
        
        {
            ...
            multi_pxo_find_channel(Multi_pxo_find_channel,
                                   Multi_pxo_channels);
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              sprintf(search_text, XSTR("Searching for %s", 963),
                       name_lookup);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    {
                      Multi_pxo_find_channel[strlen(Multi_pxo_find_channel) -
                                              1] = '\0';
                ...
                {
                  sprintf(p_text, XSTR("Found %s on a private channel", 967),
                           name_lookup);
...
void multi_pxo_pinfo_build_vals() 
{
  ...
  multi_sg_rank_build_name(Ranks[fs->stats.rank].name,
  ...
  sprintf(Multi_pxo_pinfo_vals[4], "%d",
  ...
  game_format_time(fl2f((float) fs->stats.flight_time),
                    Multi_pxo_pinfo_vals[6]);
    ...
    {
      sprintf(Multi_pxo_pinfo_vals[10], "%d%%",
               (int) ((float) fs->stats.p_shots_hit /
                      (float) fs->stats.p_shots_fired * 100.0f));
    ...
    {
      sprintf(Multi_pxo_pinfo_vals[13], "%d%%",
               (int) ((float) fs->stats.s_shots_hit /
                      (float) fs->stats.s_shots_fired * 100.0f));
    ...
    
    {
               ...
               (int) ((float) 100.0f *
                      ((float) fs->stats.p_bonehead_hits /
                       (float) fs->stats.p_shots_fired)));
    ...
    
    {
               ...
               (int) ((float) 100.0f *
                      ((float) fs->stats.s_bonehead_hits /
                       (float) fs->stats.s_shots_fired)));
...
void multi_pxo_pinfo_init() 
{
    ...
    set_mask_bmap(Multi_pxo_pinfo_mask_fname[gr_screen.res]);
    ...
    
    {
        ...
        // create the object
        Multi_pxo_pinfo_buttons[gr_screen.res][idx].button.
        create(&Multi_pxo_pinfo_window, "",
        ...
        // set the ani for the button
        Multi_pxo_pinfo_buttons[gr_screen.res][idx].button.
        set_bmaps(Multi_pxo_pinfo_buttons[gr_screen.res][idx].filename);
       
        // set the hotspot
        Multi_pxo_pinfo_buttons[gr_screen.res][idx].button.
        link_hotspot(Multi_pxo_pinfo_buttons[gr_screen.res][idx].hotspot);
    ...
    
    {
        ...
        add_XSTR(&Multi_pxo_pinfo_text[gr_screen.res][idx]);
...
int multi_pxo_pinfo_do() 
{
    ...
    if (Multi_pxo_pinfo_buttons[gr_screen.res][MULTI_PXO_PINFO_OK].button.
        pressed())
    ...
    if (Multi_pxo_pinfo_buttons[gr_screen.res][MULTI_PXO_PINFO_MEDALS].button.
        pressed())
...
void multi_pxo_pinfo_blit() 
{
    ...
    
    {
        ...
        // blit the label
        gr_set_color_fast(&Color_bright);
      gr_string(Multi_pxo_pinfo_coords[gr_screen.res][0], y_start,
                 Multi_pxo_pinfo_stats_labels[idx]);
       
        // blit the label's value
        gr_set_color_fast(&Color_normal);
      gr_string(Multi_pxo_pinfo_val_x[gr_screen.res], y_start,
                 Multi_pxo_pinfo_vals[idx]);
...
void multi_pxo_notify_blit() 
{
  ...
  gr_string((gr_screen.max_w - w) / 2, MULTI_PXO_NOTIFY_Y,
             Multi_pxo_notify_text);
...
void multi_pxo_help_init() 
{
    ...
    set_mask_bmap(Multi_pxo_help_mask_fname[gr_screen.res]);
    ...
    
    {
        ...
        // create the object
        Multi_pxo_help_buttons[gr_screen.res][idx].button.
        create(&Multi_pxo_help_window, "",
        ...
        // set the ani for the button
        Multi_pxo_help_buttons[gr_screen.res][idx].button.
        set_bmaps(Multi_pxo_help_buttons[gr_screen.res][idx].filename);
       
        // set the hotspot
        Multi_pxo_help_buttons[gr_screen.res][idx].button.
        link_hotspot(Multi_pxo_help_buttons[gr_screen.res][idx].hotspot);
    ...
    
    {
        ...
        add_XSTR(&Multi_pxo_help_text[gr_screen.res][idx]);
...
void multi_pxo_help_load() 
{
    ...
    
    {
        ...
        cfgets(cp->text[cp->num_lines++],
               Multi_pxo_chars_per_line[gr_screen.res], in);
...
void multi_pxo_help_blit_page() 
{
    ...
    
    {
        ...
        // blit the line
        gr_string(Multi_pxo_help_coords[gr_screen.res][0], y_start,
                  cp->text[idx] + start_pos);
...
void multi_pxo_ban_process() 
{
    ...
    case PXO_BAN_MODE_LIST_STARTUP:
        ...
        // remote file
        sprintf(url_string, /*"%s/%s" */ "http://www.pxo.net/files/%s",
                /*Multi_options_g.pxo_banner_url, */ PXO_BANNERS_CONFIG_FILE);
       
        // local file
        cf_create_default_path_string(local_file, sizeof(local_file) - 1,
                                      CF_TYPE_MULTI_CACHE,
...
void multi_pxo_ban_parse_banner_file(int choose_existing) 
{
    ...
    cfopen(PXO_BANNERS_CONFIG_FILE, "rt", CFILE_NORMAL, CF_TYPE_MULTI_CACHE);
    ...
    
    {
      ...
      int select = (int) frand_range(0.0f, (float) exist_count);
        ...
        
        {
            ...
            // base filename
            strncpy(Multi_pxo_banner.ban_file, banners[idx],
                    MAX_FILENAME_LEN);
           
            // get the full file url
            strncpy(Multi_pxo_banner.ban_file_url, file_url,
                    MULTI_OPTIONS_STRING_LEN);
          strncat(Multi_pxo_banner.ban_file_url, banners[idx],
                   MULTI_OPTIONS_STRING_LEN);
           
            // url of where to go to when clicked
            strncpy(Multi_pxo_banner.ban_url, urls[idx],
                    MULTI_OPTIONS_STRING_LEN);
...
void multi_pxo_ban_clicked() 
{
    ...
    if ((Multi_pxo_banner.ban_bitmap >= 0)
        && (strlen(Multi_pxo_banner.ban_url) > 0))
