...
void multi_pxo_init(int use_last_channel)
{
  ...
  Multi_pxo_channel_button.create(&Multi_pxo_window, "",
                                  ...
                                  Multi_pxo_chan_coords[gr_screen.res][3], 0,
                                  1);
  ...
  Multi_pxo_player_button.create(&Multi_pxo_window, "",
                                 ...
                                 Multi_pxo_player_coords[gr_screen.res][3], 0,
                                 1);
  ...
  Multi_pxo_chat_slider.create(&Multi_pxo_window,
                               Multi_pxo_chat_slider_coords[gr_screen.res][0],
                               Multi_pxo_chat_slider_coords[gr_screen.res][1],
                               Multi_pxo_chat_slider_coords[gr_screen.res][2],
                               Multi_pxo_chat_slider_coords[gr_screen.res][3],
                               0, Multi_pxo_chat_slider_name[gr_screen.res],
...
void multi_pxo_process_channels()
{
  ...
  // last refresh time
  if ((Multi_pxo_channel_server_refresh > 0.0f)
      && ((f2fl(timer_get_fixed_seconds()) - Multi_pxo_channel_server_refresh)
          > CHANNEL_SERVER_REFRESH_TIME))
    {
...
void multi_pxo_scroll_channels_down()
{
  ...
  if ((Multi_pxo_channel_start_index +
       Multi_pxo_max_chan_display[gr_screen.res]) >= Multi_pxo_channel_count)
    {
      gamesnd_play_iface(SND_GENERAL_FAIL);
      return;
    }
...
void multi_pxo_handle_channel_change()
{
  ...
  switch (SetNewChatChannel(NULL))
    ...
    case -1:
      ...
      // notify of error
      multi_pxo_set_status_text(XSTR
                                ("No channel (error while switching)", 954));
      break;
  ...
  if (fs->stats.p_shots_fired > 0)
    {
      sprintf(Multi_pxo_pinfo_vals[10], "%d%%",
              (int) ((float) fs->stats.p_shots_hit * 100.0f /
  ...
  if (fs->stats.s_shots_fired > 0)
    {
      sprintf(Multi_pxo_pinfo_vals[13], "%d%%",
              (int) ((float) fs->stats.s_shots_hit * 100.0f /
