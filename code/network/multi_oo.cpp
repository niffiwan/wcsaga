    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                //adjust for lag
                physics_sim_vel(&objp->pos, &objp->phys_info, lag,
                                &objp->orient);
            ...
            {
              physics_sim_vel(&objp->pos, &objp->phys_info, flFrametime,
                               &objp->orient);
...
void multi_oo_handle_new_data(ship * shipp, object * obj_data, ubyte oo_flags,
                              net_player * pl) 
{
    ...
    
    {
        ...
        
        {
            ...
            // copy in desired velocity
            shipp->int_cur.desired_rotvel =
            obj_data->phys_info.desired_rotvel;
...
int multi_oo_pack_client_data(ubyte * data) 
{
    ...
    ret =
    (ubyte) multi_pack_unpack_position(1, data + packet_size,
                                       &Net_player->s_info.eye_pos);
  Assert(ret == OO_POS_RET_SIZE);
  packet_size += ret;
   ret =
    (ubyte) multi_pack_unpack_orient(1, data + packet_size,
    ...
    
    {
        ...
        
        {
            ...
            (char) ship_get_index_from_subsys(Player_ai->targeted_subsys,
        ...
        
        {
            ...
            (char) ship_get_index_from_subsys(Player->locking_subsys,
...
int multi_oo_pack_data(net_player * pl, object * objp, ubyte oo_flags,
                       ubyte * data_out) 
{
    ...
    
    {
        ...
        (ubyte) multi_pack_unpack_orient(1, data + packet_size + header_bytes,
                                         &objp->orient);
        ...
        (ubyte) multi_pack_unpack_rotvel(1, data + packet_size + header_bytes,
        ...
        
        {
            ...
            (ubyte) multi_pack_unpack_desired_rotvel(1,
                                                     data + packet_size +
                                                     header_bytes,
                                                     &objp->orient,
                                                     &objp->pos,
    ...
    
    {
        ...
        (ubyte) multi_pack_unpack_position(1,
                                           data + packet_size + header_bytes,
                                           &objp->pos);
        ...
        (ubyte) multi_pack_unpack_vel(1, data + packet_size + header_bytes,
                                      &objp->orient, &objp->pos,
                                      &objp->phys_info);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                (float) subsysp->current_hits /
                (float) subsysp->system_info->max_hits;
...
int multi_oo_unpack_client_data(net_player * pl, ubyte * data) 
{
    ...
    
    {
        ...
        if ((pl->player->objnum != -1)
            && (Objects[pl->player->objnum].type == OBJ_SHIP)
    ...
    
    {
        ...
        {
          Ai_info[Ships[Objects[pl->player->objnum].instance].ai_index].
...
int multi_oo_unpack_data(net_player * pl, ubyte * data,
                         ushort packet_sequence_num,
                         ushort packet_sequence_ref, int time_born) 
{
    ...
    if ((pobjp == NULL) || (pobjp->type != OBJ_SHIP) || (pobjp->instance < 0)
        ...
        || (packet_sequence_num < packet_sequence_ref))
    ...
    
    {
        ...
        multi_pack_unpack_rotvel(0, data + offset, &objp->orient, &objp->pos,
                                 &objp->phys_info);
        ...
        
        {
            ...
            multi_pack_unpack_desired_rotvel(0, data + offset, &objp->orient,
    ...
    
    {
        ...
        multi_pack_unpack_vel(0, data + offset, &objp->orient, &objp->pos,
                              &objp->phys_info);
    ...
    
    {
        ...
        // TEST code
#ifndef NDEBUG
        if (OO_debug_info && (Player_ai != NULL) && (pobjp != NULL)
            && (pobjp->instance >= 0)
    ...
    
    {
        ...
        
        {
                    ...
                    pobjp->shield_quadrant[0], pobjp->shield_quadrant[1],
                    pobjp->shield_quadrant[2], pobjp->shield_quadrant[3],
                    Ships[pobjp->instance].ship_name));
    ...
    
    {
        ...
        
        {
            ...
            subsystem_percent[subsys_count] * subsysp->system_info->max_hits;
                              ...
                              int in_cone) 
{
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                Multi_oo_front_far_update_times[pl->p_info.options.
                                                obj_update_level];
        ...
        
        {
            ...
            
            {
                ...
                Multi_oo_rear_near_update_times[pl->p_info.options.
                                                obj_update_level];
                ...
                Multi_oo_rear_far_update_times[pl->p_info.options.
                                               obj_update_level];
    ...
    {
      Ships[objp->instance].pos_update_stamp[player_index] =
        timestamp(stamp);
...
{
  Ships[objp->instance].status_update_stamp[player_index] =
...
{
  Ships[objp->instance].subsys_update_stamp[player_index] =
    timestamp(OO_SUBSYS_TIME);
}  

// determine what needs to get sent for this player regarding the passed object, and when
int multi_oo_maybe_update(net_player * pl, object * pobj, object * obj,
                          ubyte * data) 
{
    ...
    
    {
        ...
        if ((Ships[obj->instance].status_update_stamp[player_index] == -1)
            || timestamp_elapsed(Ships[obj->instance].
                                 status_update_stamp[player_index]))
        ...
        if ((Ships[obj->instance].subsys_update_stamp[player_index] == -1)
            || timestamp_elapsed(Ships[obj->instance].
                                 subsys_update_stamp[player_index]))
        ...
        
        {
            ...
            (OO_POS_NEW | OO_ORIENT_NEW | OO_HULL_NEW | OO_SHIELD_NEW);
        ...
        if (Ship_info[Ships[obj->instance].ship_info_index].
            flags & (SIF_CRUISER | SIF_CAPITAL))
...
void multi_oo_process_update(ubyte * data, header * hinfo) 
{
    ...
    
    {
        ...
        
        {
            ...
            // wrap around
            if (((packet_seq - Net_players[player_index].client_cinfo_seq) <
                 0)
    ...
    
    {
        ...
        // process the data
        offset +=
        multi_oo_unpack_data(pl, data + offset, packet_seq, sequence_ref,
                             time_born);
...
void multi_oo_display() 
{
    ...
    // display info
    gr_string(gr_screen.max_w - 150, sy,
              Net_players[OO_update_index].player->callsign);
  sy += 10;
  gr_printf(gr_screen.max_w - 150, sy, "pos : %d (%d/s)", r->pos_bytes,
             (int) r->pos_avg);
  sy += 10;
  gr_printf(gr_screen.max_w - 150, sy, "ori : %d (%d/s)", r->orient_bytes,
             (int) r->orient_avg);
  sy += 10;
  gr_printf(gr_screen.max_w - 150, sy, "hul : %d (%d/s)", r->hull_bytes,
             (int) r->hull_avg);
  sy += 10;
  gr_printf(gr_screen.max_w - 150, sy, "shi : %d (%d/s)", r->shield_bytes,
             (int) r->shield_avg);
  sy += 10;
  gr_printf(gr_screen.max_w - 150, sy, "aim : %d (%d/s)", r->ai_mode_bytes,
             (int) r->ai_mode_avg);
  sy += 10;
  gr_printf(gr_screen.max_w - 150, sy, "ext : %d (%d/s)",
             r->extra_physics_bytes, (int) r->extra_physics_avg);
  sy += 10;
  gr_printf(gr_screen.max_w - 150, sy, "fth : %d (%d/s)", r->fthrust_bytes,
             (int) r->fthrust_avg);
  sy += 10;
  gr_printf(gr_screen.max_w - 150, sy, "sub : %d (%d/s)", r->subsys_bytes,
             (int) r->subsys_avg);
...
void multi_oo_server_process() 
{
    ...
    
    {
        ...
        
        {
            ...
            if ((Net_players[idx].s_info.rate_stamp == -1)
                || timestamp_elapsed(Net_players[idx].s_info.rate_stamp))
    ...
    if ((OO_server_rate_stamp == -1)
        || timestamp_elapsed(OO_server_rate_stamp))
