...
void send_game_chat_packet(net_player * from, char *msg, int msg_mode,
                           net_player * to = NULL, char *expr =
                           NULL, int server_msg = 0);
...
void send_leave_game_packet(short player_id = -1, int kicked_reason =
                            -1, net_player * target = NULL);
...
void send_ship_kill_packet(object * ship_obj, object * other_objp,
...
 void send_debris_create_packet(object * objp, ushort net_signature,
                                  int model_num, vec3d exp_center);
...
void send_wss_request_packet(short player_id, int from_slot, int from_index,
                             ...
                             int ship_class, int mode, net_player * p = NULL);
...
// turret fired packet
void send_turret_fired_packet(int objnum, int subsys_index,
                              int weapon_objnum);
