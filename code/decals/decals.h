...
inline int decal_create(object * obj, decal_point * point, int subobject,
                        int texture, int backfaced_texture =
                        -1, int glow_texture = -1, int burn_texture =
                        -1, int burn_time = 1000)
{
  return 0;
}
