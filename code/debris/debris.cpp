...
static void debris_start_death_roll(object * debris_obj, debris * debris_p) 
{
    ...
    
    {
        ...
        fireball_ship_explosion_type(&Ship_info[debris_p->ship_info_index]);
      ...
      fireball_create(&debris_obj->pos, fireball_type,
                       FIREBALL_LARGE_EXPLOSION, OBJ_INDEX(debris_obj),
...
void debris_page_in() 
{
    ...
    
    {
        ...
        
        {
                   ...
                   "Couldn't load species %s debris\ntexture, '%s'\n",
     ...
     void debris_render(object * obj) 
{
    ...
    
    {
        ...
        
        {
          ...
          tbase->SetTexture(Species_info[db->species].debris_texture.
                             bitmap_id);
    ...
    
    {
        ...
        
        {
            ...
            {
              model_add_arc(db->model_num, db->submodel_num,
                             &db->arc_pts[i][0], &db->arc_pts[i][1],
                             MARC_TYPE_NORMAL);
    ...
    
    {
      ...
      submodel_render(db->model_num, db->submodel_num, &obj->orient,
                       &obj->pos);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                {
                  if (vm_vec_dist_quick(&objp->pos, &Objects[db->objnum].pos)
                       < MAX_DEBRIS_DIST)
     ...
     void debris_process_post(object * obj, float frame_time) 
{
    ...
    
    {
        ...
        
        {
          ...
          submodel_get_two_random_points(db->model_num, db->submodel_num,
                                          &v1, &v2);
...
void calc_debris_physics_properties(physics_info * pi, vec3d * min,
                                    vec3d * max);
...
//                  1.0f assigns velocity like before.  2.0f assigns twice as much to non-inherited part of velocity
  object * debris_create(object * source_obj, int model_num, int submodel_num,
                         vec3d * pos, vec3d * exp_center, int hull_flag,
                         float exp_force) 
{
    ...
    
    {
        ...
        ((sip->debris_max_lifetime - sip->debris_min_lifetime) * frand()) +
    ...
    
    {
        ...
        
        {
            ...
            db->lifeleft =
              2.0f * ((float) myrand() / (float) RAND_MAX) + 0.5f;
    ...
    
    {
        ...
        
        {
            ...
            ((sip->debris_max_lifetime -
              sip->debris_min_lifetime) * frand()) + sip->debris_min_lifetime;
  ...
  db->time_started = Missiontime;
    ...
    obj_create(OBJ_DEBRIS, parent_objnum, n, &source_obj->orient, pos, radius,
               flags);
    ...
    
    {
        ...
        
        {
            ...
            ((sip->debris_max_hitpoints -
              sip->debris_min_hitpoints) * frand()) +
    ...
    
    {
      ...
      db->sound_delay = timestamp(DEBRIS_SOUND_DELAY);
        ...
        t =
        1000 * Objects[db->source_objnum].radius / 3 +
...
//
void debris_hit(object * debris_obj, object * other_obj, vec3d * hitpos,
                float damage) 
{
...
//
int debris_check_collision(object * pdebris, object * other_obj,
                           vec3d * hitpos,
                ...
                
                {
                    ...
                    
                    {
                        ...
                        
                        {
                            ...
                            {
                              model_find_obj_dir(&debris_hit_info->
                                                  collision_normal,
                            ...
                            vec3d int_light_pos, diff;
                                            ...
                                            mc.hit_dist);
                          model_find_world_point(&debris_hit_info->
...
void calc_debris_physics_properties(physics_info * pi, vec3d * mins,
                                    vec3d * maxs) 
{
