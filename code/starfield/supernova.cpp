...
} void supernova_do_particles() 
{
    ...
    
    {
        ...
        {
          submodel_get_two_random_points(Ship_info
...
}  void supernova_process() 
{
    ...
    
    {
        ...
        
        {
          ...
          snd_play(&Snds[SND_SUPERNOVA_1], 0.0f, 1.0f,
        ...
        
        {
          ...
          snd_play(&Snds[SND_SUPERNOVA_2], 0.0f, 1.0f,
                    SND_PRIORITY_MUST_PLAY);
...
void supernova_get_eye(vec3d * eye_pos, matrix * eye_orient) 
{
  ...
  vm_vec_scale_add(&Supernova_camera_pos, &Player_obj->pos, &whee.vec.rvec,
                    sn_cam_distance);
    ...
    *eye_pos = Supernova_camera_pos;
    ...
    
    {
      ...
      float pct =
        ((SUPERNOVA_CUT_TIME - Supernova_time) / SUPERNOVA_CAMERA_MOVE_TIME);
