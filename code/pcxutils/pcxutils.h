...
extern int pcx_read_header(char *filename, CFILE * img_cfp = NULL, int *w =
                           0, int *h = 0, int *bpp = 0, ubyte * pal = NULL);
...
extern int pcx_read_bitmap(char *filename, ubyte * org_data, ubyte * pal,
                           int byte_size, int aabitmap = 0, int nondark =
