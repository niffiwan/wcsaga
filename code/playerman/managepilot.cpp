...
int verify_pilot_file(char *filename, int single, int *rank) 
{
    ...
    *p = 0;
    ...
    
    {
                ...
                "WARNING => Player file ('%s') is outdated and not compatible...\n",
                pname));
    ...
    
    {
                ...
                "WARNING => Player file ('%s') is too new and not compatible...\n",
                pname));
...
 void pilot_write_techroom_data(CFILE * file, int multi) 
{
    ...
    
    {
        ...
        (Ship_info[idx].flags & SIF_IN_TECH_DATABASE) ? (ubyte) 1 : (ubyte) 0;
    ...
    
    {
        ...
        (Intel_info[idx].
         flags & IIF_IN_TECH_DATABASE) ? (ubyte) 1 : (ubyte) 0;
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              Player_loadout.ship_pool[ship_info_lookup(sw_name)] =
                pool_count;
        ...
        
        {
            ...
            
            {
              ...
              Player_loadout.weapon_pool[weapon_info_lookup(sw_name)] =
                pool_count;
...
int read_pilot_file(char *callsign, int single, player * p) 
{
  ...
  strcpy_s(filename, callsign);
    ...
    
    {
        ...
        
        {
            ...
            cfopen(filename, "rb", CFILE_NORMAL, CF_TYPE_SINGLE_PLAYERS);
  ...
  char fname[MAX_FILENAME_LEN];
    ...
    
    {
        ...
        memcpy(&HUD_config.clr[NUM_HUD_GAUGES - 2],
               &HUD_config.clr[HUD_RADAR], sizeof(color));
  ...
  int protocol_temp = cfread_int(file);
    ...
    
    {
        ...
        
        {
          ...
          cfread_string_len(Player->player_variables[i].text, TOKEN_LENGTH,
                             file);
          cfread_string_len(Player->player_variables[i].variable_name,
                             TOKEN_LENGTH, file);
...
 void read_stats_block(CFILE * file, int pfile_version,
                         scoring_struct * stats) 
{
    ...
    
    {
        ...
        
        {
                   ...
                   "Some ship kill information will be lost due to MAX_SHIP_CLASSES decrease");
  ...
  do
    
    {
        ...
        
        {
            ...
            popup(PF_TITLE_RED | PF_TITLE_BIG, 3, XSTR("&Retry", 41),
...
int pilot_verify_overwrite() 
{
                ...
                | PF_TITLE_BIG, 2, XSTR("&No", 47), XSTR("&Yes", 48),
...
void pilot_load_pic_list() 
{
    ...
    Num_pilot_images =
    cf_get_file_list_preallocated(MAX_PILOT_IMAGES, Pilot_images_arr,
                                  Pilot_image_names, CF_TYPE_PLAYER_IMAGES,
                                  NOX("*.pcx"));
...
void pilot_load_squad_pic_list() 
{
    ...
    cf_get_file_list_preallocated(MAX_PILOT_IMAGES, Pilot_squad_images_arr,
                                  Pilot_squad_image_names,
