...
}  void fs2netd_options_config_init() 
{
    ...
    
    {
        ...
        ("NOTICE: Address for game tracker not specified, using default instead (%s).",
         FS2NETD_DEFAULT_SERVER);
      strncpy(Multi_options_g.game_tracker_ip, FS2NETD_DEFAULT_SERVER,
    ...
    
    {
        ...
        ("NOTICE: Incompatible game tracker IP detected (gt.pxo.net), using default instead (%s)!",
         FS2NETD_DEFAULT_SERVER);
    ...
    
    {
        ...
        ("NOTICE: Address for user tracker not specified, using default instead (%s).",
         FS2NETD_DEFAULT_SERVER);
      strncpy(Multi_options_g.user_tracker_ip, FS2NETD_DEFAULT_SERVER,
               MULTI_OPTIONS_STRING_LEN);
    ...
    
    {
        ...
        ("NOTICE: Incompatible user tracker IP detected (ut.pxo.net), using default instead (%s)!",
         FS2NETD_DEFAULT_SERVER);
    ...
    
    {
        ...
        ("NOTICE: Port for game/user trackers not specified, using default instead (%s).",
         FS2NETD_DEFAULT_PORT);
      strncpy(Multi_options_g.tracker_port, FS2NETD_DEFAULT_PORT,
               STD_NAME_LEN);
    ...
    
    {
        ...
        
        {
            ...
            ("NOTICE: Port for game/user trackers is invalid, using default instead (%s).",
             FS2NETD_DEFAULT_PORT);
    ...
    
    {
        ...
        ("NOTICE: Address for chat server not specified, using default instead (%s).",
         FS2NETD_DEFAULT_CHAT_SERVER);
      strncpy(Multi_options_g.pxo_ip, FS2NETD_DEFAULT_CHAT_SERVER,
               MULTI_OPTIONS_STRING_LEN);
    ...
    
    {
        ...
        ("NOTICE: Incompatible chat server IP detected (chat.pxo.net), using default instead (%s)!",
         FS2NETD_DEFAULT_CHAT_SERVER);
    ...
    
    {
        ...
        ("NOTICE: URL for banners not specified, using default instead (%s).",
         FS2NETD_DEFAULT_BANNER_URL);
      strncpy(Multi_options_g.pxo_banner_url, FS2NETD_DEFAULT_BANNER_URL,
               MULTI_OPTIONS_STRING_LEN);
    }
  
  else
    if (!strcmp
        ("http://www.pxo.net/files/banners", Multi_options_g.pxo_banner_url))
    
    {
      ml_printf
        ("NOTICE: Incompatible banner URL detected (chat.pxo.net), using default instead (%s)!",
         FS2NETD_DEFAULT_BANNER_URL);
...
 static int fs2netd_connect_do() 
{
    ...
    FS2NetD_ConnectToServer(Multi_options_g.game_tracker_ip,
                            Multi_options_g.tracker_port);
...
 void fs2netd_connect() 
{
    ...
    {
      popup_till_condition(fs2netd_connect_do, XSTR("&Cancel", 779),
                            XSTR("Connecting into FS2NetD", -1));
...
 int fs2netd_login_do() 
{
    ...
    
    {
        ...
        {
          ml_printf("FS2NetD MSG: Login '%s' is valid, session ID is %d!",
                     user, Multi_tracker_id);
    ...
    
    {
        ...
        FS2NetD_GetPlayerData(Players[Player_num].callsign,
                              &Players[Player_num], true, do_full_packet);
...
 bool fs2netd_login() 
{
    ...
    
    {
        ...
        
        {
                 ...
                 XSTR("Failed to connect to FS2NetD server!", -1));
    ...
    
    {
        ...
        popup_till_condition(fs2netd_login_do, XSTR("&Cancel", 779),
                             XSTR("Logging into FS2NetD", -1));
    ...
    case 6:
                ...
                "Unkown return case from GetPlayerData(). Contact the FS2NetD Administrator!");
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              popup(PF_USE_AFFIRMATIVE_ICON | PF_TITLE_BIG | PF_TITLE_RED, 1,
                     POPUP_OK,
            ...
            ("FS2NetD MSG: Will attempt an automatic reconnect to server in 30 minutes...");
        ...
        
        {
            ...
            
            {
                ...
                
                {
                  ...
                  popup(PF_USE_AFFIRMATIVE_ICON | PF_TITLE_BIG |
                         PF_TITLE_RED, 1, POPUP_OK,
                         "ERROR:\nLost connection to the FS2NetD server!");
...
 static void fs2netd_handle_messages() 
{
    ...
    
    {
        ...
        FS2NetD_GetData(buffer + bytes_read, sizeof(buffer) - bytes_read);
    ...
    
    {
        ...
        
        {
          ...
          
          {
            ...
             ml_printf("FS2NetD PONG: %d ms",
                         timer_get_milliseconds() - itemp);
          ...
          
          {
              ...
              
              {
                  ...
                  {
                    ml_printf("FS2NetD SLIST: Invalid ip string (%s)!",
                               svr_ip);
...
 void fs2netd_gameserver_start() 
{
    ...
    {
      strcpy_s(Multi_tracker_game_data.chat_channel,
                Multi_fs_tracker_channel);
...
 int fs2netd_check_mission_do() 
{
    ...
    FS2NetD_CheckSingleMission(Chk_mission_name, Chk_mission_crc,
                               do_full_packet);
...
 bool fs2netd_check_mission(char *mission_name) 
{
    ...
    
    {
        ...
        popup_till_condition(fs2netd_check_mission_do, XSTR("&Cancel", 779),
                             popup_string);
    ...
    case 4:
        ...
        
        {
                 ...
                 XSTR("Server request timed out!", -1));
...
 static int fs2netd_send_player_do() 
{
    ...
    FS2NetD_SendPlayerData(Players[Player_num].callsign, &Players[Player_num],
                           do_full_packet);
...
 static int fs2netd_send_player() 
{
    ...
    
    {
        ...
        popup_till_condition(fs2netd_send_player_do, XSTR("&Cancel", 779),
...
 static void fs2netd_store_stats_results() 
{
  ...
   multi_display_chat_msg(XSTR("<PXO stats store process complete>", 1001),
                            0, 0);
  ml_string(XSTR("<PXO stats store process complete>", 1001));
   if (Multi_debrief_stats_accept_code != 1)
    
    {
      sprintf(str, XSTR("<PXO stats store failed for player %s>", 1002),
...
 void fs2netd_store_stats() 
{
    ...
    
    {
      ...
      multi_display_chat_msg(XSTR
                              ("<Duplicate login detected - stats have been tossed>",
                               -1), 0, 0);
      ml_string(XSTR
                 ("<Duplicate login detected - stats have been tossed>", -1));
    ...
    
    {
                              ...
                              ("<Hacked tables detected - stats have been tossed>",
                               -1), 0, 0);
      popup(PF_USE_AFFIRMATIVE_ICON, 1, POPUP_OK,
             XSTR
             ("You are playing with a hacked tables, your stats will not be saved",
              -1));
  ...
   switch (spd_ret)           // 0 = pilot updated, 1  = invalid pilot, 2 = invalid (expired?) sid
    {
      ...
      multi_display_chat_msg(XSTR("Unknown Stats Store Request Reply", -1),
                              0, 0);
...
 void fs2netd_update_ban_list() 
{
    ...
    
    {
        ...
        popup_till_condition(fs2netd_update_ban_list_do, XSTR("&Cancel", 779),
                             XSTR("Requesting IP ban list", -1));
    ...
    
    {
        ...
        
        {
            ...
            {
              cfputs(const_cast < char *>(FS2NetD_ban_list[i].c_str()),
                      banlist_cfg);
...
 int fs2netd_get_valid_missions_do() 
{
    ...
    
    {
        ...
        
        {
            ...
            cf_get_file_list(1024, file_names, CF_TYPE_MISSIONS, wild_card);
      ...
      strncpy(full_name, cf_add_ext(file_names[idx], FS_MISSION_FILE_EXT),
               sizeof(full_name) - 1);
        ...
        
        {
            ...
            {
              ml_printf("FS2NetD Mission Validation: %s  =>  Valid!",
                         full_name);
...
 bool fs2netd_get_valid_missions() 
{
    ...
    
    {
        ...
        popup_till_condition(fs2netd_get_valid_missions_do,
                             XSTR("&Cancel", 779),
    ...
    case 1:
        ...
        
        {
                 ...
                 XSTR("Mission validation timed out!", -1));
    ...
    case 2:
        ...
        
        {
                 ...
                 XSTR
                 ("No missions are available from the server for validation!",
                  -1));
    ...
    case 3:
        ...
        
        {
                 ...
                 XSTR("Memory error during mission validation!", -1));
...
 int fs2netd_update_valid_tables() 
{
    ...
    
    {
        ...
        popup_till_condition(fs2netd_update_valid_tables_do,
                             XSTR("&Cancel", 779),
    ...
    case 1:
      
      {
          ...
          
          {
                   ...
                   XSTR("Table validation timed out!", -1));
    ...
    
    {
        ...
        {
          ml_printf("FS2NetD Table Check: '%s' -- Valid!",
                     Table_valid_status[i].name);
        }
      
      else
        
        {
          ml_printf("FS2NetD Table Check: '%s' -- INVALID (0x%x)!",
                     Table_valid_status[i].name, Table_valid_status[i].crc32);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                 ...
                 Table_valid_status[idx].crc32, description);
