...
UI_BUTTON Popupdead_button_regions[POPUPDEAD_NUM_CHOICES_MAX];  // fake buttons used for mouse detection over text
  ...
  Popupdead_button_coords[GR_NUM_RESOLUTIONS][POPUPDEAD_NUM_CHOICES_MAX][2] =
  ...
  *Popupdead_button_filenames[GR_NUM_RESOLUTIONS][POPUPDEAD_NUM_CHOICES_MAX] =
...
void popupdead_start() 
{
    ...
    Popupdead_window.create(Popupdead_background_coords[gr_screen.res][0],
                            Popupdead_background_coords[gr_screen.res][1], 1,
                            1, 0);
  Popupdead_window.
    set_foreground_bmap(Popupdead_background_filename[gr_screen.res]);
