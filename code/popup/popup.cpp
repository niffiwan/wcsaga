...
void popup_split_lines(popup_info * pi, int flags) 
{
    ...
    split_str(pi->raw_text, Popup_text_coords[gr_screen.res][2], n_chars,
...
char *popup_get_button_filename(popup_info * pi, int i, int flags) 
{
    ...
    
    {
        ...
        
        {
            ...
            Popup_button_filenames[gr_screen.
                                   res][is_tiny][BUTTON_GENERIC_FIRST];
        ...
        
        {
            ...
            Popup_button_filenames[gr_screen.
                                   res][is_tiny][BUTTON_GENERIC_SECOND];
        ...
        
        {
            ...
            Popup_button_filenames[gr_screen.
                                   res][is_tiny][BUTTON_GENERIC_THIRD];
...
int popup_init(popup_info * pi, int flags) 
{
    ...
    
    {
        ...
        {
          b->create(&Popup_window, "",
                     Button_coords[gr_screen.res][i + 1][0],
      ...
      int lx, w, h;
        ...
        
        {
                     ...
                     Button_regions[gr_screen.res][i + 1][1], 0, 1);
        ...
        
        {
                     ...
                     Button_regions[gr_screen.res][i][1], 0, 1);
    ...
    
    {
                          ...
                          pbg->coords[1] +
                          Popup_input_y_offset[gr_screen.res],
                          Popup_text_coords[gr_screen.res][2],
    ...
    Popup_slider.create(&Popup_window, Popup_slider_coords[gr_screen.res][0],
                        ...
                        Popup_max_display[gr_screen.res] : 0,
...
int popup_calc_starting_y(popup_info * pi, int flags) 
{
    ...
    pi->nlines >
    Popup_max_display[gr_screen.res] ? Popup_max_display[gr_screen.res] : pi->
    nlines;
    ...
    fl2i((Popup_text_coords[gr_screen.res][1] +
          Popup_text_coords[gr_screen.res][3] / 2.0f) - total_h / 2.0f +
         0.5f);
...
void popup_draw_msg_text(popup_info * pi, int flags) 
{
    ...
    
    {
                 ...
                 sy + (Popup_max_display[gr_screen.res]) * h, XSTR("More",
                                                                   459));
...
 int popup_do_with_condition(popup_info * pi, int flags,
                               int (*condition) ()) 
{
