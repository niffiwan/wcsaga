...
 static void dispatchDecoder16(ushort ** pFrame, unsigned char codeType,
                                 unsigned char **pData,
                                 unsigned char **pOffData, int *pDataRemain,
                                 int *curXb, int *curYb);
static void genLoopkupTable();
 void decodeFrame16(unsigned char *pFrame, unsigned char *pMap,
                      int mapRemain, unsigned char *pData, int dataRemain) 
{
    ...
    
    {
        ...
        
        {
          ...
          dispatchDecoder16((ushort **) & pFrame, op, &pData, &pOffData,
                             &dataRemain, &i, &j);
...
 static void patternRow4Pixels(ushort * pFrame, unsigned char pat0,
                                 unsigned char pat1, ushort * p) 
{
...
 static void patternRow4Pixels2(ushort * pFrame, unsigned char pat0,
                                  ushort * p) 
{
...
 static void patternRow4Pixels2x1(ushort * pFrame, unsigned char pat,
                                    ushort * p) 
{
...
 static void patternQuadrant4Pixels(ushort * pFrame, unsigned char pat0,
                                      unsigned char pat1, unsigned char pat2,
...
 static void patternRow2Pixels(ushort * pFrame, unsigned char pat,
                                 ushort * p) 
{
...
 static void patternRow2Pixels2(ushort * pFrame, unsigned char pat,
                                  ushort * p) 
{
...
 static void patternQuadrant2Pixels(ushort * pFrame, unsigned char pat0,
                                      unsigned char pat1, ushort * p) 
{
                                 ...
                                 int *curXb, int *curYb) 
{
    ...
    
    {
        ...
        /* relClose(*(*pOffData)++, &x, &y); */ 
                   ...
                   *pFrame + (backBuf2 - backBuf1) + x + y * g_width);
        ...
        
        {
            ...
            
            {
              ...
               patternQuadrant4Pixels(*pFrame, pat[0], pat[1], pat[2],
                                        pat[3], p);
