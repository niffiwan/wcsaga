...
 class UI_INPUTBOX:public UI_GADGET 
{
  ...
  int cursor_first_frame;
    ...
    //      int first_time;
               ...
               char *text, int _flags = 0, int pixel_lim = -1, color * clr =
               NULL);
...
 public:void create(UI_WINDOW * wnd, char *_text, int _x, int _y, int _w,
               int _h);
...
 class UI_SLIDER2:public UI_GADGET 
{
  ...
  { S2M_DEFAULT = 2 };
    ...
    // create the slider
  void create(UI_WINDOW * wnd, int _x, int _y, int _w, int _h,
...
 class UI_DOT_SLIDER_NEW:public UI_GADGET 
{
               ...
               int slider_mask, char *bm_left = NULL, int left_mask =
               -1, int left_x = -1, int left_y = -1, char *bm_right =
               NULL, int right_mask = -1, int right_x = -1, int right_y =
               -1, int dot_width = 19);
...
 class UI_LISTBOX:public UI_GADGET 
{
  ...
  { LBOX_DISABLED = 1 };
               ...
               char **_list, char *_check_list = NULL, int _max_items =
               -1);
...
typedef struct ui_button_info 
{
   ...
    ui_button_info(char *name, int x1, int y1, int xt1, int yt1,
