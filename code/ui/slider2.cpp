...
void UI_SLIDER2::create(UI_WINDOW * wnd, int _x, int _y, int _w, int _h,
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                fl2i((((float) currentItem / (float) numberItems) *
            ...
            
            {
                ...
                fl2i(((((float) ui_mouse.y - (float) y -
                        (float) slider_half_h) / (float) numberPositions) *
