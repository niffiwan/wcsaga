...
 void UI_INPUTBOX::create(UI_WINDOW * wnd, int _x, int _y, int _w,
                            int _text_len, char *_text, int _flags,
                            int pixel_lim, color * clr) 
{
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        {
                          passwd_text[position] =
                            (char) INPUTBOX_PASSWD_CHAR;
             ...
             || (key_used && (flags & UI_INPUTBOX_FLAG_EAT_USED)))
