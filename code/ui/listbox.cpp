...
//                   0 ==> success
//
int UI_LISTBOX::set_bmaps(char *lbox_fname, char *b_up_fname,
                          char *b_down_fname, char *sb_fname)
{
  if (has_scrollbar)
    {
...
void UI_LISTBOX::create(UI_WINDOW * wnd, int _x, int _y, int _w, int _h,
                        int _numitems, char **_list, char *_check_list,
                        int _max_items)
{
