...
void png_scp_read_data(png_structp png_ptr, png_bytep data,
                       png_size_t length) 
{
...
//
int png_read_header(char *real_filename, CFILE * img_cfp, int *w, int *h,
...
//
int png_read_bitmap(char *real_filename, ubyte * image_data, ubyte * bpp,
                    int dest_size, int cf_type) 
{
  ...
   png_read_png(png_ptr, info_ptr, PNG_TRANSFORM_BGR | PNG_TRANSFORM_EXPAND,
                  png_voidp_NULL);
