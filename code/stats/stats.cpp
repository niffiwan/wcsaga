...
}  void show_stats_numbers(int stage, int sx, int sy, int dy,
                              int add_mission) 
{
    ...
    
    {
        ...
        sprintf(text, "%d", Active_player->stats.mp_shots_fired);
          ...
          (float) 100.0 *((float) Active_player->stats.mp_shots_hit /
      ...
      strcat_s(text, " %%");
        ...
        sprintf(text, "%d", Active_player->stats.ms_shots_fired);
          ...
          (float) 100.0 *((float) Active_player->stats.ms_shots_hit /
      ...
      strcat_s(text, " %%");
        ...
        sprintf(text, "%d",
               ...
               Active_player->stats.p_shots_hit + add.p_shots_hit);
      ...
      strcat_s(text, " %%");
          ...
          (float) 100.0
          *((float)
            (Active_player->stats.p_bonehead_hits +
             add.p_bonehead_hits) /
            (float) (Active_player->stats.p_shots_fired + add.p_shots_fired));
      ...
      strcat_s(text, " %%");
        ...
        sprintf(text, "%d",
               ...
               Active_player->stats.s_shots_hit + add.s_shots_hit);
      ...
      strcat_s(text, " %%");
          ...
          (float) 100.0
          *((float)
            (Active_player->stats.s_bonehead_hits +
             add.s_bonehead_hits) /
            (float) (Active_player->stats.s_shots_fired + add.s_shots_fired));
