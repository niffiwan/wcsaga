                  ...
                  if (net_plr != NULL)
                    {
                      ...
                      if (!(Netgame.type_flags & NG_TYPE_DOGFIGHT)
                          && (Ship_info[dead_ship->ship_info_index].flags &
                              ...
                              if (MULTI_CONNECTED(Net_players[idx])
                                  ...
                                  && (&Net_players[idx] != net_plr))
                                {
                                  assist_score =
                                    (int) (dead_ship->score *
                                           The_mission.
                                           ai_profile->assist_award_percentage_scale
                                           [Game_skill_level]);
              ...
              if (Netgame.type_flags & NG_TYPE_DOGFIGHT)
                {
                  ...
                  // update stats
                  send_player_stats_block_packet(&Net_players[net_player_num],
