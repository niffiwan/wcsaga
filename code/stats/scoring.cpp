...
 void parse_rank_tbl() 
{
    ...
    
    {
      ...
      stuff_string(Ranks[idx].promotion_voice_base, F_NAME,
                    MAX_FILENAME_LEN);
  ...
  int kill_score, assist_score;
    ...
    
    {
        ...
        
        {
                    ...
                    Net_players[net_player_num].m_player->stats.
                    m_player_deaths));
    ...
    
    {
        ...
        if (The_mission.ai_profile->
            flags & AIPF_KILL_SCORING_SCALES_WITH_DAMAGE)
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    {
                      multi_team_maybe_add_score(-(dead_ship->score),
                                                  net_plr->p_info.team);
            ...
            
            {
                ...
                if ((Game_mode & GM_MULTIPLAYER)
                    && (Netgame.type_flags & NG_TYPE_DOGFIGHT)
                    && (multi_find_player_by_object(ship_obj) < 0))
                  ...
                  char kill_score_text[1024] = "";
                    ...
                    
                    {
                        ...
                        
                        {
                          ...
                           sprintf(dead_text, "%s gets the kill for %s",
                                     net_plr->m_player->callsign,
                                     dead_plr->m_player->callsign);
                          send_game_chat_packet(Net_player, dead_text,
                                                 MULTI_MSG_ALL, NULL, NULL,
                                                 2);
            ...
            
            {
                ...
                
                {
                    ...
                    multi_df_eval_kill(&Net_players[net_player_num],
                                       ship_obj);
                   
                    // update stats
                    send_player_stats_block_packet(&Net_players
                                                   [net_player_num],
                                                   STATS_DOGFIGHT_KILLS);
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              sprintf(buf, "%s: %f", plr->callsign,
                       dead_ship->damage_ship[i]);
  ...
  int assist_score;
    ...
    
    {
        ...
        if (((sp->damage_ship[idx] / sp->total_damage_received) >=
             Assist_percentage)
            || (The_mission.ai_profile->
                flags & AIPF_ASSIST_SCORING_SCALES_WITH_DAMAGE))
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    (int) (sp->score * scoring_scale_factor *
                           scoring_scale_by_damage);
                ...
                
                {
                    ...
                    (int) (sp->score * sp->assist_score_pct *
                           scoring_scale_factor);
              ...
              char score_text[1024] = "";
                ...
                {
                  send_game_chat_packet(Net_player, score_text,
                                         MULTI_MSG_ALL);
...
void scoring_eval_hit(object * hit_obj, object * other_obj, int from_blast) 
{
    ...
    
    {
         ...
         && !(Weapons[other_obj->instance].
              weapon_flags & WF_ALREADY_APPLIED_STATS))
    
    {
        ...
        
        {
            ...
            Ships[Objects[other_obj->parent].instance].team ? 1 : 0;
                ...
                
                {
                    ...
                    
                    {
                        ...
                        
                        {
                            ...
                            if (Weapons[other_obj->instance].
                                weapon_flags & WIF_BOMB)
