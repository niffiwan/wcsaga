            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        for (int k = next_point;
                             k < next_point + missles_left; k++)
                        
                        {
                          float &s_pct =
                            shipp->secondary_point_reload_pct[i][k % points];
...
void obj_set_flags(object * obj, uint new_flags) 
{
    ...
    if (MULTIPLAYER_MASTER && !(obj->flags & OF_COULD_BE_PLAYER)
        && (new_flags & OF_COULD_BE_PLAYER))
    ...
    
    {
      ...
      
      {
          ...
          
          {
              ...
              // Weapons cast light
                   ...
                   && (Obj_weapon_group_id_used[group_id] == 0))
              ...
              
              {
                  ...
                  {
                    light_add_point(&objp->pos, 10.0f, 20.0f, 1.0f, 1.0f,
                                     1.0f, 1.0f, objp->parent);
              ...
              
              {
                  ...
                  
                  {
                      ...
                      
                      {
                        ...
                         light_add_point(&tmp1, 10.0f, 20.0f, frand(), 1.0f,
                                           1.0f, 1.0f, -1);
                        light_add_point(&tmp2, 10.0f, 20.0f, frand(), 1.0f,
                                         1.0f, 1.0f, -1);
      ...
      
      {
          ...
          
          {
            ...
             fireball_get_color(Fireballs[objp->instance].
                                  fireball_info_index, &r, &g, &b);
            ...
            float p = fireball_lifeleft_percent(objp);
              ...
              
              {
                ...
                 light_add_point(&objp->pos, rad * 2.0f, rad * 5.0f, 1.0f,
                                   r, g, b, -1);
                  ...
                  
                  {
                      ...
                      
                      {
                          ...
                          
                          {
                              ...
                              // Move arc endpoints into world coordinates
                              vec3d tmp1, tmp2;
                            vm_vec_unrotate(&tmp1, &db->arc_pts[i][0],
                                             &objp->orient);
                            vm_vec_add2(&tmp1, &objp->pos);
                             vm_vec_unrotate(&tmp2, &db->arc_pts[i][1],
                                               &objp->orient);
                            vm_vec_add2(&tmp2, &objp->pos);
                             light_add_point(&tmp1, 10.0f, 20.0f, frand(),
                                               1.0f, 1.0f, 1.0f, -1);
                            light_add_point(&tmp2, 10.0f, 20.0f, frand(),
                                             1.0f, 1.0f, 1.0f, -1);
...
int obj_team(object * objp) 
{
    ...
    case OBJ_WEAPON:
                ...
                "Warning => Asking for a team for object type %s\n",
...
int object_get_model(object * objp) 
{
    ...
    
    {
      ...
      
      {
        ...
        return Asteroid_info[asp->asteroid_type].model_num[asp->
                                                            asteroid_subtype];
