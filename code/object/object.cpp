                ...
                if (wi->render_type == WRT_LASER)
                  {
                    ...
                    light_add_point(&objp->pos, 10.0f, 20.0f, 1.0f, r, g, b,
                                    objp->parent);
        ...
        if (Detail.lighting > 3)
          {
            ...
            fireball_get_color(Fireballs[objp->instance].fireball_info_index,
                               &r, &g, &b);
            ...
            if (p > 0.0f)
              {
                ...
                light_add_point(&objp->pos, rad * 2.0f, rad * 5.0f, 1.0f, r,
                                g, b, -1);
              }
          }
...
DCF_BOOL(collisions, Collisions_enabled) MONITOR(NumObjects)
//--------------------------------------------------------------------
