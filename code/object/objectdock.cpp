...
// helper prototypes
void dock_evaluate_tree(object * objp, dock_function_info * infop,
...
dock_calc_max_semilatus_rectum_squared_parallel_to_directrix_helper(object *
                                                                    objp,
                                                                    dock_function_info
                                                                    * infop);
...
 bool dock_check_docked_one_on_one(object * objp) 
{
    ...
    Assert(objp ==
           dock_get_first_docked_object(objp)->dock_list->docked_objp);
...
 int dock_count_total_docked_objects(object * objp) 
{
                                      ...
                                      dock_count_total_docked_objects_helper);
...
 bool dock_check_find_docked_object(object * objp, object * other_objp) 
{
                                      ...
                                      dock_check_find_docked_object_helper);
...
 void dock_calc_docked_center(vec3d * dest, object * objp) 
{
                                      ...
                                      dock_calc_docked_center_helper);
...
}  void dock_calc_docked_center_of_mass(vec3d * dest, object * objp) 
{
                                      ...
                                      dock_calc_docked_center_of_mass_helper);
...
}  float dock_calc_total_docked_mass(object * objp) 
{
                                      ...
                                      dock_calc_total_docked_mass_helper);
   return dfi.maintained_variables.float_value;
}

 float dock_calc_max_cross_sectional_radius_perpendicular_to_axis(object *
                                                                    objp,
                                                                    axis_type
                                                                    axis) 
{
  ...
  
{
    ...
    
    {
        ...
        bool * visited_bitstring =
        (bool *) malloc(Num_objects * sizeof(bool));
                           ...
                           bool * visited_bitstring) 
{
    ...
    
    {
        ...
        dock_evaluate_tree(ptr->docked_objp, infop, function,
                           visited_bitstring);
                                                  ...
                                                  infop) 
{
    ...
    vm_vec_scale_add2(infop->maintained_variables.vecp_value, &objp->pos,
                      objp->phys_info.mass);
...
(object * objp, dock_function_info * infop) 
{
  ...
  local_point[5].xyz.z = pm->mins.xyz.z;        // rear point (min z)
    ...
    
    {
        ...
        vm_vec_dist_squared_to_line(&world_point, line_start, line_end,
                                    &nearest, &dist_squared);
...
void dock_dock_objects(object * objp1, int dockpoint1, object * objp2,
                       int dockpoint2) 
{
