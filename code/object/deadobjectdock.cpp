...
void dead_dock_add_instance(object * objp, int dockpoint,
                             object * other_objp);
...
void dock_dead_dock_objects(object * objp1, int dockpoint1, object * objp2,
                            int dockpoint2) 
{
...
 dock_instance * dead_dock_find_instance(object * objp,
                                           object * other_objp) 
{
