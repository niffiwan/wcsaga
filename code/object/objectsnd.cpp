        ...
        
        {
            ...
            
            {
                ...
                
                {
                           ...
                           Ships[Objects[osp->objnum].instance].ship_name);
...
//
int obj_snd_get_freq(int source_freq, object * source, object * observor,
                     vec3d * source_pos) 
{
                          ...
                          object * listener_objp) 
{
    ...
    
    {
      ...
      vm_vec_sub(&diff, &listener_objp->phys_info.vel,
...
void obj_snd_do_frame() 
{
    ...
    
    {
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        snd_play_3d(gs, &source_pos, &View_position,
                                    add_distance, &objp->phys_info.vel, 1,
                                    1.0f, SND_PRIORITY_TRIPLE_INSTANCE);
                    ...
                    
                    {
                        ...
                        snd_play_looping(gs, osp->pan, 0, 0,
                                         (osp->vol * speed_vol_multiplier *
                                          rot_vol_mult) / gs->default_volume,
        ...
        
        {
          ...
           ds3d_update_buffer(channel, i2fl(gs->min), i2fl(gs->max),
                                &source_pos, vel);
        ...
        
        {
            ...
            
            {
                              ...
                              osp->vol * speed_vol_multiplier * rot_vol_mult);
                ...
                
                {
                    ...
                    
                    {
                        ...
                        // calc doppler effect
                        new_freq =
                        obj_snd_get_freq(osp->freq, objp, observer_obj,
                                         &source_pos);
...
//
int obj_snd_assign(int objnum, int sndnum, vec3d * pos, int main, int flags,
