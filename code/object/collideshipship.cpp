...
void calculate_ship_ship_collision_physics(collision_info_struct *
                                           ship_ship_hit_info);
 int ship_hit_shield(object * obj, mc_info * mc,
                                 ...
                                 vec3d * hitpos) 
{
  ...
  mc.radius =
    model_get_core_radius(Ship_info[light_shipp->ship_info_index].model_num);
  ...
  vec3d copy_p0, copy_p1;
    ...
    
    {
        ...
        
        {
            ...
            model_get(Ship_info[heavy_shipp->ship_info_index].model_num);
    ...
    
    {
        ...
        
        {
            ...
            if ((Ship_info[heavy_shipp->ship_info_index].
            ...
            
            {
                ...
                
                {
                  ...
                   vm_vec_sub(&h_to_l_vec, &heavy_obj->pos,
                                &light_obj->pos);
...
void mcp_1(object * player_objp, object * planet_objp) 
{
                              ...
                              (float)
                              pow((planet_radius * PLANET_DAMAGE_RANGE) /
                                  dist, 3.0f));
    ...
    
    {
      ...
      snd_play_3d(&Snds[SND_ABURN_ENGAGE], &player_objp->pos,
                   &View_position);
                                ...
                                int player_involved) 
{
  ...
   vm_vec_sub(&rel_vel, &A->phys_info.desired_vel,
                &B->phys_info.desired_vel);
            ...
            
            {
              ...
              if (damage > 5.0f)
                ...
                
                {
                    ...
                    vm_vec_dist_quick(&A->pos,
                                      &B->pos) / (A->radius + B->radius);
                ...
                
                {
                    ...
                    
                    {
                      ...
                       vm_vec_scale_add2(&A->phys_info.vel,
                                           &right_angle_vec, +2.0f);
                ...
                
                {
                                         ...
                                         &world_hit_pos,
                                         100.0f * damage /
                                         HeavyOne->phys_info.mass,
                                         quadrant_num, CREATE_SPARKS,
                                         ship_ship_hit_info.submodel_num,
                                         &ship_ship_hit_info.
                                         collision_normal);
              hud_shield_quadrant_hit(ship_ship_hit_info.heavy,
                                       quadrant_num);
                ...
                ship_apply_local_damage(ship_ship_hit_info.light,
                                        ...
                                        NO_SPARKS, -1,
                                        &ship_ship_hit_info.collision_normal);
              hud_shield_quadrant_hit(ship_ship_hit_info.light,
                                       quadrant_num);
                                       ...
                                       ship_ship_hit_info) 
{
  ...
  float dot = vm_vec_dotprod(r_light, &ship_ship_hit_info->collision_normal);
    ...
    nprintf(("Physics",
             ...
             heavy->last_pos.y, heavy->last_pos.z, heavy_collide_cm_pos.x,
             heavy_collide_cm_pos.y, heavy_collide_cm_pos.z,
             heavy->phys_info.vel.x, heavy->phys_info.vel.y,
             heavy->phys_info.vel.z));
   nprintf(("Physics",
              "Frame: %i %s info: last_pos: [%4.1f, %4.1f, %4.1f], collide_pos: [%4.1f, %4.1f, %4.1f] vel: [%4.1f, %4.1f, %4.1f]\n",
              Framecount, Ships[light->instance].ship_name,
              light->last_pos.x, light->last_pos.y, light->last_pos.z,
              light_collide_cm_pos.x, light_collide_cm_pos.y,
              light_collide_cm_pos.z, light->phys_info.vel.x,
