...
int collide_debris_ship(obj_pair * pair) 
{
    ...
    if ((pdebris->parent == OBJ_INDEX(pship))
        && (Ships[pship->instance].flags & SF_DYING))
    ...
    
    {
        ...
        
        {
          ...
           Script_system.SetHookObjects(2, "Self", pship, "Object",
                                          pdebris);
          bool ship_override =
            Script_system.IsConditionOverride(CHA_COLLIDEDEBRIS, pship);
           Script_system.SetHookObjects(2, "Self", pdebris, "Object",
                                          pship);
            ...
            
            {
              ...
              int quadrant_num, apply_ship_damage;
                ...
                apply_ship_damage =
                !(pship->signature == pdebris->parent_sig);
          ...
           Script_system.RemHookVars(4, "Ship", "Debris", "Self",
                                       "ObjectB");
  ...
  else                          //  Bounding spheres don't intersect, set timestamp for next collision check.
    {
        ...
        
        {
            ...
            MAX(ship_get_max_speed(shipp), ship_get_warpout_speed(pship));
...
int collide_asteroid_ship(obj_pair * pair) 
{
    ...
    
    {
        ...
        asteroid_check_collision(pasteroid, pship, &hitpos,
                                 &asteroid_hit_info);
        ...
        
        {
            ...
            Script_system.SetHookObjects(4, "Ship", pship, "Asteroid",
                                         pasteroid, "Self", pship, "Object",
                                         pasteroid);
          bool ship_override =
            Script_system.IsConditionOverride(CHA_COLLIDEASTEROID, pship);
           Script_system.SetHookObjects(2, "Self", pasteroid, "Object",
                                          pship);
            ...
            
            {
              ...
              asteroid_damage =
                (asteroid_damage >
                 ship_damage) ? asteroid_damage : ship_damage;
            ...
            Script_system.RunCondition(CHA_COLLIDEASTEROID, '\0', NULL,
                                        pship);
           Script_system.SetHookObjects(2, "Self", pasteroid, "Object",
                                          pship);
          if ((asteroid_override && !ship_override)
               || (!asteroid_override && !ship_override))
            Script_system.RunCondition(CHA_COLLIDESHIP, '\0', NULL,
                                        pasteroid);
           Script_system.RemHookVars(4, "Ship", "Asteroid", "Self",
                                       "ObjectB");
