...
void dock_add_instance(p_object * objp, char *dockpoint,
                        p_object * other_objp);
                                                        ...
                                                        *)) 
{
    ...
    
    {
        ...
        bool * visited_bitstring =
        (bool *) malloc(Parse_objects.size() * sizeof(bool));
...
void dock_dock_objects(p_object * objp1, char *dockpoint1, p_object * objp2,
                       char *dockpoint2) 
{
