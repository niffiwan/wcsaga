...
void obj_add_pair(object * A, object * B, int check_time =
                   -1, int add_to_end = 0);
...
int weapon_will_never_hit(object * weapon, object * other,
...
 void collide_ship_ship_do_sound(vec3d * world_hit_pos, object * A,
                                   object * B, int player_involved);
