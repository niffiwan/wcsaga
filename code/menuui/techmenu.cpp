...
struct techroom_buttons 
{
 ...
  techroom_buttons(char *name, int x1, int y1, int xt1, int yt1, int h, int t, int f = 0):filename(name), x(x1), y(y1), xt(xt1), yt(yt1), hotspot(h), tab(t),
    flags
    (f)
  {
} };
...
void techroom_init_desc(char *src, int w) 
{
    ...
    split_str(src, w, Text_line_size, Text_lines, MAX_TEXT_LINES);
    ...
    
    {
        ...
        
        {
                 ...
                 Tech_list_coords[gr_screen.res][SHIP_Y_COORD] + y, buf);
                      ...
                      List_offset].
        update_dimensions(Tech_list_coords[gr_screen.res][SHIP_X_COORD],
...
 void techroom_init() 
{
  ...
   Tech_background_bitmap =
    bm_load(Tech_background_filename[gr_screen.res]);
    ...
    Ui_window.add_XSTR("Ships", 293,
                       Buttons[gr_screen.res][SHIPS_DATA_TAB].xt,
