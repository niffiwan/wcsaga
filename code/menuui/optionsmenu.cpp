...
struct options_buttons 
{
 ...
  options_buttons(char *name, int x1, int y1, int h, int t, int f = 0):filename(name), x(x1), y(y1), hotspot(h), tab(t),
    flags
    (f)
  {
} };
  ...
  op_sliders Options_sliders[GR_NUM_RESOLUTIONS][NUM_OPTIONS_SLIDERS] = 
{
  ...
  op_sliders("OMB_21", 440, 75, -1, -1, 21, 36, 5, NULL, -1, -1, -1, NULL,
                 -1, -1, -1) }, 
  {
...
op_sliders("2_OMB_21", 704, 120, -1, -1, 21, 60, 5, NULL, -1, -1, -1,
                 NULL, -1, -1, -1) } };
...
 void options_menu_init() 
{
  ...
  Ui_window.create(0, 0, gr_screen.max_w_unscaled, gr_screen.max_h_unscaled,
    ...
    {
      Options_sliders[gr_screen.res][i].slider.create(&Ui_window,
                                                       Options_sliders
                                                       [gr_screen.res][i].x,
                                                       Options_sliders
                                                       [gr_screen.res][i].y,
    ...
    Sound_volume_int =
    Options_sliders[gr_screen.res][OPT_SOUND_VOLUME_SLIDER].slider.pos =
    (int) (Master_sound_volume * 9.0f + 0.5f);
  Music_volume_int =
    Options_sliders[gr_screen.res][OPT_MUSIC_VOLUME_SLIDER].slider.pos =
    (int) (Master_event_music_volume * 9.0f + 0.5f);
  Voice_volume_int =
    Options_sliders[gr_screen.res][OPT_VOICE_VOLUME_SLIDER].slider.pos =
    (int) (Master_voice_volume * 9.0f + 0.5f);
...
  void draw_gamma_box() 
{
  ...
   
  {
    ...
    int Gamma_bitmap =
      bm_create(16, Options_gamma_coords[gr_screen.res][OPTIONS_W_COORD],
                Options_gamma_coords[gr_screen.res][OPTIONS_H_COORD],
                Gamma_data, 0);
    ...
    
    {
        ...
        
        {
                 ...
                 (Options_skills_text_coords[gr_screen.res][OPTIONS_W_COORD] /
                  2) - (w / 2), y, Skill_level_names(Game_skill_level));
...
}  void options_detail_init() 
{
    ...
    {
      Detail_sliders[gr_screen.res][i].slider.create(&Ui_window,
                                                      Detail_sliders
                                                      [gr_screen.res][i].x,
                                                      Detail_sliders
                                                      [gr_screen.res][i].y,
                                                      Detail_sliders
                                                      [gr_screen.res][i].dots,
                                                      Detail_sliders
                                                      [gr_screen.res][i].
                                                      filename,
