...
void main_hall_init(int main_hall_num) 
{
    ...
    XSTR("Barracks - Manage your FreeSpace 2 pilots", 354);
  Main_hall->region_descript[2] =
    XSTR("Ready room - Start or continue a campaign", 355);
  Main_hall->region_descript[3] =
    XSTR("Tech room - View specifications of FreeSpace 2 ships and weaponry",
         356);
  Main_hall->region_descript[4] =
    XSTR("Options - Change your FreeSpace 2 options", 357);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    if (Main_hall->misc_anim_modes[idx] ==
...
void main_hall_read_table() 
{
    ...
    
    {
        ...
        // set head anim. hehe
        strcpy_s(Main_hall_defines[GR_640][hall].
                 door_anim_name[OPTIONS_REGION], "vhallheads");
