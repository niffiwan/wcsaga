...
 void mht_init() 
{
    ...
    Mht_window.create(0, 0, gr_screen.max_w_unscaled,
    ...
    
    {
        ...
        // create the object
        Mht_buttons[gr_screen.res][idx].button.create(&Mht_window, "",
                                                      Mht_buttons[gr_screen.
                                                                  res][idx].x,
                                                      Mht_buttons[gr_screen.
                                                                  res][idx].y,
                                                      1, 1, 0, 1);
        ...
        Mht_buttons[gr_screen.res][idx].button.
        set_highlight_action(common_play_highlight_sound);
       
        // set the ani for the button
        Mht_buttons[gr_screen.res][idx].button.
        set_bmaps(Mht_buttons[gr_screen.res][idx].filename);
       
        // set the hotspot
        Mht_buttons[gr_screen.res][idx].button.
        link_hotspot(Mht_buttons[gr_screen.res][idx].hotspot);
