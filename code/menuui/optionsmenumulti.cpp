  ...
  UI_XSTR Om_pro_text[GR_NUM_RESOLUTIONS][OM_PRO_NUM_TEXT] = 
{
  
  {
    ...
    {
    "Broadcast Locally", 1397, 42, 260, UI_XSTR_COLOR_GREEN, -1,
        ...
        &Om_pro_buttons[0][OM_PRO_GEN_TAB].button}, }, 
  {
    ...
    {
    "Broadcast Locally", 1397, 68, 417, UI_XSTR_COLOR_GREEN, -1,
...
void options_multi_load_protocol_controls() 
{
    ...
    
    {
        ...
        // create the object
        Om_pro_buttons[gr_screen.res][idx].button.create(Om_window, "",
                                                         Om_pro_buttons
                                                         [gr_screen.res][idx].
                                                         x,
                                                         Om_pro_buttons
        ...
        Om_pro_buttons[gr_screen.res][idx].button.
        set_highlight_action(common_play_highlight_sound);
       
        // set the ani for the button
        Om_pro_buttons[gr_screen.res][idx].button.
        set_bmaps(Om_pro_buttons[gr_screen.res][idx].filename);
       
        // set the hotspot
        Om_pro_buttons[gr_screen.res][idx].button.
        link_hotspot(Om_pro_buttons[gr_screen.res][idx].hotspot);
    ...
    Om_tracker_login.create(Om_window,
                            Om_tracker_login_coords[gr_screen.res][0],
                            Om_tracker_login_coords[gr_screen.res][1],
                            Om_tracker_login_coords[gr_screen.res][2],
                            LOGIN_LEN - 1, Multi_tracker_login,
                            UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR
                            | UI_INPUTBOX_FLAG_KEYTHRU |
                            UI_INPUTBOX_FLAG_NO_BACK);
  Om_tracker_passwd.create(Om_window,
                            Om_tracker_passwd_coords[gr_screen.res][0],
                            Om_tracker_passwd_coords[gr_screen.res][1],
                            Om_tracker_passwd_coords[gr_screen.res][2],
                            LOGIN_LEN - 1, Multi_tracker_passwd,
                            UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR
                            | UI_INPUTBOX_FLAG_PASSWD |
                            UI_INPUTBOX_FLAG_KEYTHRU |
                            UI_INPUTBOX_FLAG_NO_BACK);
  Om_tracker_squad_name.create(Om_window,
                                Om_tracker_squad_name_coords[gr_screen.
                                                             res][0],
                                Om_tracker_squad_name_coords[gr_screen.
                                                             res][1],
                                Om_tracker_squad_name_coords[gr_screen.
                                                             res][2],
                                LOGIN_LEN - 1, Multi_tracker_squad_name,
    ...
    Om_ip_button.create(Om_window, "", Ip_list_coords[gr_screen.res][0],
                        Ip_list_coords[gr_screen.res][1],
                        Ip_list_coords[gr_screen.res][2],
                        Ip_list_coords[gr_screen.res][3], 0, 1);
  Om_ip_button.hide();
   
    // create the new ip address input box
    Om_ip_input.create(Om_window, Ip_input_coords[gr_screen.res][0],
                       Ip_input_coords[gr_screen.res][1],
                       Ip_input_coords[gr_screen.res][2], IP_STRING_LEN,
                       IP_EMPTY_STRING,
                       UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR |
                       UI_INPUTBOX_FLAG_KEYTHRU);
...
void options_multi_protocol_do(int key) 
{
    ...
    {
      Om_pro_buttons[gr_screen.res][OM_PRO_LOCAL_BROADCAST].button.
        draw_forced(2);
...
void options_multi_protocol_button_pressed(int n) 
{
    ...
    case OM_PRO_GEN_TAB:
        ...
        
        {
            ...
            Assert(Om_mask_0 >= 0);
          Om_window->set_mask_bmap(Om_mask_0,
                                    Om_background_0_mask_fname[gr_screen.
                                                               res]);
    ...
    case OM_PRO_VOX_TAB:
        ...
        
        {
            ...
            Assert(Om_mask_1 >= 0);
          Om_window->set_mask_bmap(Om_mask_1,
...
void options_multi_protocol_display_ips() 
{
    ...
    
    {
      ...
       gr_printf(Ip_list_coords[gr_screen.res][0], y_start,
                   Om_ip_addrs[idx]);
...
void options_multi_protocol_add_current_ip() 
{
    ...
    
    {
        ...
        
        {
                                    ...
                                    ("Max # of IP addresses reached!", 389));
...
void options_multi_load_gen_controls() 
{
    ...
    
    {
        ...
        // create the object
        Om_gen_buttons[gr_screen.res][idx].button.create(Om_window, "",
                                                         Om_gen_buttons
                                                         [gr_screen.res][idx].
                                                         x,
                                                         Om_gen_buttons
        ...
        // set the sound to play when highlighted
        Om_gen_buttons[gr_screen.res][idx].button.
        set_highlight_action(common_play_highlight_sound);
       
        // set the ani for the button
        Om_gen_buttons[gr_screen.res][idx].button.
        set_bmaps(Om_gen_buttons[gr_screen.res][idx].filename);
       
        // set the hotspot
        Om_gen_buttons[gr_screen.res][idx].button.
        link_hotspot(Om_gen_buttons[gr_screen.res][idx].hotspot);
...
void options_multi_gen_do() 
{
    ...
    {
      Om_gen_buttons[gr_screen.res][OM_GEN_XFER_MULTIDATA_YES].button.
        draw_forced(2);
    ...
    {
      Om_gen_buttons[gr_screen.res][OM_GEN_XFER_MULTIDATA_NO].button.
        draw_forced(2);
...
void options_multi_load_vox_controls() 
{
    ...
    
    {
        ...
        // create the object
        Om_vox_buttons[gr_screen.res][idx].button.create(Om_window, "",
                                                         Om_vox_buttons
                                                         [gr_screen.res][idx].
                                                         x,
                                                         Om_vox_buttons
        ...
        // set the sound to play when highlighted
        Om_vox_buttons[gr_screen.res][idx].button.
        set_highlight_action(common_play_highlight_sound);
       
        // set the ani for the button
        Om_vox_buttons[gr_screen.res][idx].button.
        set_bmaps(Om_vox_buttons[gr_screen.res][idx].filename);
       
        // set the hotspot
        Om_vox_buttons[gr_screen.res][idx].button.
        link_hotspot(Om_vox_buttons[gr_screen.res][idx].hotspot);
    ...
    {
      Om_vox_sliders[gr_screen.res][idx].slider.create(Om_window,
                                                        Om_vox_sliders
                                                        [gr_screen.res][idx].
                                                        x,
                                                        Om_vox_sliders
    ...
    Om_vox_plist_button.create(Om_window, "",
                               Om_vox_plist_coords[gr_screen.res][0],
...
void options_multi_vox_do() 
{
    ...
    
    {
        ...
        Om_vox_buttons[gr_screen.res][OM_VOX_VOICE_TEST].button.
        draw_forced(2);
        ...
        
        {
            ...
            
            {
                ...
                {
                  Om_vox_playback_handle =
                    rtvoice_play_uncompressed(handle, Om_vox_comp_buffer,
    ...
    case OM_VOX_VOICE_TEST:
        ...
        
        {
            ...
            
            {
                ...
                rtvoice_set_qos(Om_vox_sliders[gr_screen.res]
                                [OM_VOX_QOS_SLIDER].slider.pos + 1);
...
void options_multi_vox_process_waveform() 
{
    ...
    
    {
        ...
        
        {
          ...
          gr_string(OM_VOX_DROP_ICON_X, OM_VOX_DROP_ICON_Y,
                     XSTR("Packet Overflow", 393));
...
void options_multi_vox_process_player_list() 
{
    ...
    
    {
        ...
        
        {
          ...
          gr_force_fit_string(str, CALLSIGN_LEN + 1,
                               Om_vox_plist_coords[gr_screen.res][2]);
                                  ...
                                  int uncomp_size, double gain) 
{
    ...
    
    {
        ...
        // uncompress the data
        rtvoice_uncompress(comp_buf, comp_size, gain,
                           Om_vox_comp_buffer + Om_vox_voice_comp_size,
                           uncomp_size);
