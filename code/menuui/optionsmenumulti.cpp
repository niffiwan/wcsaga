...
void options_multi_load_protocol_controls()
{
  ...
  Om_tracker_squad_name.create(Om_window,
                               Om_tracker_squad_name_coords[gr_screen.res][0],
                               Om_tracker_squad_name_coords[gr_screen.res][1],
                               Om_tracker_squad_name_coords[gr_screen.res][2],
...
void options_multi_vox_do()
{
  ...
  if ((Om_vox_player_select != NULL)
      &&
      !Om_vox_player_flags[options_multi_vox_plist_get(Om_vox_player_select)])
    {
