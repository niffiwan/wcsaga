...
struct sim_room_buttons 
{
   ...
    sim_room_buttons(char *name, int x1, int y1, int xt1, int yt1,
...
int sim_room_line_add(int type, char *name, char *filename, int x, int y,
                      int flags) 
{
...
int sim_room_campaign_mission_filter(char *filename) 
{
    ...
    mission_campaign_get_mission_list(filename,
                                      &Campaign_missions
    ...
    
    {
        ...
        
        {
          ...
          int flags = 0;
            ...
            game_find_builtin_mission(Campaign.
                                      missions
                                      [Num_campaign_missions_with_info].name);
            ...
            
            {
                               ...
                               Campaign_mission_names
                               [Num_campaign_missions_with_info],
                               Campaign.
                               missions[Num_campaign_missions_with_info].name,
...
void sim_room_build_listing() 
{
        ...
        
        {
          if (!Standalone_mission_names_inited)        // Is this the first time through
            {
                ...
                popup_till_condition(build_standalone_mission_list_do_frame,
                                     POPUP_CANCEL, XSTR("Loading missions",
                                                        991));
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                      ...
                      strcpy_s(full_filename,
                                cf_add_ext(Mission_filenames[i],
                                           FS_MISSION_FILE_EXT));
            ...
            
            {
                ...
                
                {
                  ...
                  int flags = 0;
                            ...
                            cf_add_ext(Campaign.missions[i].name,
                                       FS_MISSION_FILE_EXT));
    ...
    set_numberItems((Num_lines >
                     max_num_entries_viewable) ? (Num_lines -
...
 int readyroom_continue_campaign() 
{
    ...
    
    {
      ...
      int reset_campaign = 0;
        ...
        popup(PF_BODY_BIG, 2, POPUP_NO, POPUP_YES,
              XSTR
...
 void sim_room_commit() 
{
    ...
    
    {
             ...
             sim_room_lines[Selected_line].filename, MAX_FILENAME_LEN);
...
 int sim_room_button_pressed(int n) 
{
    ...
    
    {
        ...
        
        {
                 ...
                 XSTR
                 ("The currently active campaign cannot be found, unable to switch to campaign mode!",
                  -1));
...
void sim_room_init() 
{
  ...
  Ui_window.create(0, 0, gr_screen.max_w_unscaled, gr_screen.max_h_unscaled,
    ...
    Ui_window.add_XSTR("Single Missions", 1060,
                      ...
                      UI_XSTR_COLOR_GREEN);
  Ui_window.add_XSTR("Commit", 1062,
                      Buttons[gr_screen.res][COMMIT_BUTTON].xt,
                      Buttons[gr_screen.res][COMMIT_BUTTON].yt,
                      &Buttons[gr_screen.res][COMMIT_BUTTON].button,
                      UI_XSTR_COLOR_PINK);
  Ui_window.add_XSTR("Options", 1036,
                      Buttons[gr_screen.res][OPTIONS_BUTTON].xt,
    ...
    Ui_window.add_XSTR("Technical Database", 1055,
                      ...
                      UI_XSTR_COLOR_GREEN);
  Ui_window.add_XSTR("Credits", 1058,
                      Buttons[gr_screen.res][CREDITS_BUTTON].xt,
    ...
    Ui_window.add_XSTR("Mission", 1063,
                       Sim_misc_text_coords[gr_screen.
                                            res][SIM_MISC_TEXT_MISSION][0],
                       Sim_misc_text_coords[gr_screen.
                                            res][SIM_MISC_TEXT_MISSION][1],
                       NULL, UI_XSTR_COLOR_GREEN);
  Ui_window.add_XSTR("Filename", 1064,
                      Sim_misc_text_coords[gr_screen.
                                           res][SIM_MISC_TEXT_FILENAME][0],
                      Sim_misc_text_coords[gr_screen.
                                           res][SIM_MISC_TEXT_FILENAME][1],
                      NULL, UI_XSTR_COLOR_GREEN);
    ...
    cf_get_file_list(MAX_MISSIONS, Mission_filenames, CF_TYPE_MISSIONS,
                     wild_card, CF_SORT_NAME);
   
    // set up slider with 0 items to start
    Sim_room_slider.create(&Ui_window,
                           Sim_room_slider_coords[gr_screen.res][X_COORD],
                           ...
                           Sim_room_slider_filename[gr_screen.res],
                           &sim_room_scroll_screen_up,
                           &sim_room_scroll_screen_down,
...
void sim_room_do_frame(float frametime) 
{
    ...
    
    {
        ...
        {
          List_buttons[line - Scroll_offset].update_dimensions(list_x1, y,
                                                                list_x2 +
                                                                list_w2 -
                                                                list_x1,
                                                                font_height);
                           ...
                           list_x1 + list_w1 - sim_room_lines[line].x);
    ...
    help_overlay_maybe_blit(SIM_ROOM_OVERLAY);
                            ...
                            fs_builtin_mission * fb, int is_md) 
{
    ...
    
    {
        ...
        (sim_room_lines[line_index].
         flags & READYROOM_FLAG_FROM_VOLITION) ? 1 : 0;
...
 void campaign_room_build_listing() 
{
    ...
    
    {
        ...
        
        {
          ...
           sim_room_line_add(READYROOM_LINE_CAMPAIGN, Campaign_names[i],
                               Campaign_file_names[i],
...
 void set_new_campaign_line(int n) 
{
    ...
    
    {
        ...
        split_str(str, Cr_info_coords[gr_screen.res][2], Info_text_line_size,
...
int campaign_room_reset_campaign(int n) 
{
    ...
    z =
    popup(PF_TITLE_BIG | PF_TITLE_RED, 2, POPUP_CANCEL, POPUP_OK,
          XSTR
...
 void campaign_room_init() 
{
    ...
    // set up sim_rooms for buttons so we draw the correct animation frame when a key is pressed
    Cr_buttons[gr_screen.res][CR_SCROLL_UP_BUTTON].button.
    set_hotkey(KEY_PAGEUP);
  Cr_buttons[gr_screen.res][CR_SCROLL_DOWN_BUTTON].button.
    set_hotkey(KEY_PAGEDOWN);
  Cr_buttons[gr_screen.res][CR_RESET_BUTTON].button.set_hotkey(KEY_DELETE);
  Cr_buttons[gr_screen.res][CR_COMMIT_BUTTON].button.
    set_hotkey(KEY_CTRLED | KEY_ENTER);
...
 void campaign_room_close() 
{
    ...
    
    {
        ...
        Campaign.missions[Campaign.current_mission].main_hall;
       
        // we might need to switch the music
        if (main_hall_get_music_index(Player->main_hall) !=
            main_hall_get_music_index(Old_main_hall))
...
 void campaign_room_do_frame(float frametime) 
{
    ...
    
    {
        ...
        Cr_list_coords[gr_screen.res][1] + sim_room_lines[line].y -
        sim_room_lines[Scroll_offset].y;
       List_buttons[line -
                      Scroll_offset].
        update_dimensions(Cr_list_coords[gr_screen.res][0], y,
    ...
    
    {
             ...
             XSTR("No campaigns are available!", -1));
