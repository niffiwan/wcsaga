      ...
      if (!Campaign_mission_names_inited)
        {
          ...
          popup_till_condition(build_campaign_mission_list_do_frame,
                               POPUP_CANCEL, XSTR("Loading campaign missions",
                                                  992));
        }
      else
        {
...
void sim_room_blit_icons(int line_index, int y_start, fs_builtin_mission * fb,
                         int is_md)
{
  ...
  while (sim_room_line_query_visible(line))
    {
      ...
      List_buttons[line -
                   Scroll_offset].update_dimensions(Cr_list_coords[gr_screen.
                                                                   res][0], y,
                                                    Cr_list_coords[gr_screen.
                                                                   res][2],
                                                    font_height);
      List_buttons[line - Scroll_offset].enable();
