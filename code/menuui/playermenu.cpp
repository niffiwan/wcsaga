...
struct barracks_buttons 
{
   ...
    barracks_buttons(char *name, int x1, int y1, int xt1, int yt1,
...
void player_select_init() 
{
    ...
    Player_select_window.create(0, 0, gr_screen.max_w_unscaled,
                                gr_screen.max_h_unscaled, 0);
  Player_select_window.
    set_mask_bmap(Player_select_background_mask_bitmap[gr_screen.res]);
    ...
    Player_select_list_region.create(&Player_select_window, "",
                                     ...
                                     Choose_list_coords[gr_screen.res][3], 0,
                                     1);
  Player_select_list_region.hide();
   
    // create the pilot callsign input box
    Player_select_input_box.create(&Player_select_window,
                                   Choose_list_coords[gr_screen.res][0],
                                   Choose_list_coords[gr_screen.res][1],
                                   Choose_list_coords[gr_screen.res][2],
                                   CALLSIGN_LEN - 1, "",
    ...
    Player_select_buttons[gr_screen.res][SCROLL_LIST_UP_BUTTON].button.
    set_hotkey(KEY_UP);
  Player_select_buttons[gr_screen.res][SCROLL_LIST_DOWN_BUTTON].button.
    set_hotkey(KEY_DOWN);
...
 void player_select_close() 
{
    ...
    if (read_pilot_file
        (Pilots[Player_select_pilot], !Player_select_mode, Player) != 0)
...
 void player_select_set_input_mode(int n) 
{
    ...
    set_hotkey(n ? -1 : KEY_ENTER);
  Player_select_buttons[gr_screen.res][CREATE_PILOT_BUTTON].button.
    set_hotkey(n ? -1 : KEY_C);
...
 void player_select_button_pressed(int n) 
{
    ...
    
    {
        ...
        {
          player_select_set_bottom_text(XSTR
        ...
        
        {
            ...
            if (read_pilot_file
                (Pilots[Player_select_pilot], !Player_select_mode,
                 Player) != 0)
        ...
        // display some text on the bottom of the dialog
        player_select_set_bottom_text(XSTR
                                      ("Type Callsign and Press Enter", 381));
...
 int player_select_create_new_pilot() 
{
  ...
  Player_select_input_box.
    update_dimensions(Choose_list_coords[gr_screen.res][0],
                      Choose_list_coords[gr_screen.res][1],
                      Choose_list_coords[gr_screen.res][2],
                      gr_get_font_height());
...
 int player_select_get_last_pilot() 
{
    ...
    
    {
        ...
        
        {
            ...
            cf_get_file_list_preallocated(MAX_PILOTS, old_pilots_arr,
                                          old_pilots, CF_TYPE_SINGLE_PLAYERS,
                                          NOX("*.plr"), CF_SORT_TIME);
           new_pilot_num =
            MIN((Player_select_num_pilots + old_pilot_num), MAX_PILOTS);
        ...
        
        {
          ...
          read_pilot_file(Pilots_arr[idx], !Player_select_last_is_multi,
                           Player);
...
 void player_select_init_player_stuff(int mode) 
{
    ...
    
    {
      ...
      player_select_set_middle_text(XSTR
                                     ("Type Callsign and Press Enter", 381));
...
 void player_select_process_noninput(int k) 
{
    ...
    case KEY_DELETE:
        ...
        
        {
            ...
            // display a popup requesting confirmation
            ret =
            popup(PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON, 2, POPUP_NO,
                  POPUP_YES,
...
void player_select_display_copyright() 
{
    ...
    
    {
               ...
               XSTR("Copyright %c 1999, Volition, Inc.  All rights reserved.",
                    385), '\xA8');
...
 void player_select_eval_very_first_pilot() 
{
    ...
    
    {
        ...
        
        {
          ...
          strcpy_s(Player_select_very_first_pilot_callsign,
                    Pilots[Player_select_pilot]);
       ...
       "Sets the player to be on the bastion (or any other main hall)") 
{
    ...
    
    {
        ...
        ("This command can only be run in the initial player select screen.\n");
    ...
    
    {
        ...
        ("There is no current main hall, as the player has not been selected yet!\n");
...
void player_tips_init() 
{
    ...
    
    {
        ...
        stuff_and_malloc_string(F_NAME, NULL, 1024);
...
 void player_tips_popup() 
{
  ...
  do
    
    {
        ...
        popup(PF_NO_SPECIAL_BUTTONS | PF_TITLE | PF_TITLE_WHITE, 3,
