...
 struct credits_screen_buttons 
{
   ...
    credits_screen_buttons(char *name, int x1, int y1, int xt1, int yt1,
                            int h):filename(name), x(x1), y(y1), xt(xt1),
    yt(yt1), hotspot(h)
  {
} };
...
 void credits_init() 
{
    ...
    event_music_get_spooled_music_index("Cinema");
    ...
    
    {
        ...
        (char *) vm_malloc(size + 200 + strlen(fs2_open_credit_text) +
                           strlen(unmodified_credits));
        ...
        
        {
          ...
          do
            
            {
                ...
                split_str_once(linep1, Credits_text_coords[gr_screen.res][2]);
    ...
    Ui_window.add_XSTR("Technical Database", 1055,
                      ...
                      Buttons[CREDITS_BUTTON][gr_screen.res].xt,
...
 void credits_do_frame(float frametime) 
{
    ...
    (int) (100.0f -
           (CREDITS_ARTWORK_DISPLAY_TIME -
            Credits_counter) * 100.0f / CREDITS_ARTWORK_FADE_TIME);
    ...
    
    {
      ...
       gr_cross_fade(bm1, bm2, bx1, by1, bx2, by2,
