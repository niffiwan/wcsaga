...
float Energy_levels[NUM_ENERGY_LEVELS] =
  { 0.0f, 0.0833f, 0.167f, 0.25f, 0.333f, 0.417f, 0.5f, 0.583f, 0.667f, 0.75f,
0.833f, 0.9167f, 1.0f };
  ...
  float y = Energy_levels[ship_p->engine_recharge_index];
    ...
    
    {
        ...
        
        {
            ...
            sinfo_p->max_speed + (y -
                                  Energy_levels[INTIAL_ENGINE_RECHARGE_INDEX])
            * (sinfo_p->max_overclocked_speed - sinfo_p->max_speed) / (1.0f -
                                                                       Energy_levels
...
void hud_show_ets() 
{
    ...
    
    {
        ...
        
        {
          ...
           GR_AABITMAP_EX(Ets_gauge.first_frame, x, y_start, w,
                            y_end - y_start, 0,
