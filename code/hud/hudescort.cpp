...
void hud_setup_escort_list(int level) 
{
    ...
    insertion_sort(complete_escorts, num_complete_escorts,
                   sizeof(escort_info), escort_compare_func);
...
void hud_display_escort() 
{
    ...
    GR_AABITMAP(Escort_gauges[0].first_frame, current_hud->Escort_coords[0],
