...
{
-1, 0, 150, 1000, 30.0f, 1500.0f, 1.729412f};
...
 void hud_make_shader(shader * sh, int r, int g, int b, float dimmer =
                        1000.0f) 
{
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        // and test again
                        if (Weapon_gauges[hud_index][gauge_index].
                            first_frame < 0)
        ...
        ship_obj * startShip, *so;
             ...
             &&((Ship_info
                 [Ships[Objects[aip->target_objnum].instance].
                  ship_info_index].flags & SIF_BOMBER)  ||(Objects[aip->
                                                                    target_objnum].
                                                            flags &
        ...
        
        {
            ...
            if (!
                (Ship_info[Ships[A->instance].ship_info_index].
                 flags & SIF_BOMBER) && !(A->flags & OF_TARGETABLE_AS_BOMB))
  ...
  int last_subsys_turret = FALSE;
    ...
    
    {
        ...
        
        {
               ...
               || Player_ai->targeted_subsys->weapons.num_secondary_banks >=
               0)
...
void hud_target_auto_target_next() 
{
    ...
    {
      hud_target_closest(valid_team_mask, OBJ_INDEX(Player_obj), FALSE,
                          TRUE);
...
 int hud_target_closest(int team_mask, int attacked_objnum,
                          int play_fail_snd, int filter,
...
void hud_target_targets_target() 
{
    ...
    {
      hud_maybe_set_sorted_turret_subsys(&Ships
                                          [Objects[tt_objnum].instance]);
...
}  void hud_tri(float x1, float y1, float x2, float y2, float x3,
                   float y3) 
{
...
  void hud_tri_empty(float x1, float y1, float x2, float y2, float x3,
                        float y3) 
{
                         ...
                         int show_interior, int split_tri) 
{
    ...
    
    {
        ...
        hud_render_tail_missile_triangle(ang, xpos, ypos, cur_dist,
                                         aspect_flag, draw_inside);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                snd_play(&Snds[SND_PROXIMITY_ASPECT_WARNING]);
            ...
            
            {
                ...
                snd_play(&Snds[SND_PROXIMITY_WARNING]);
...
 void hud_update_target_in_reticle(vertex * projected_v) 
{
    ...
    (sx - Hud_reticle_center[gr_screen.res][0]) * (sx -
                                                   Hud_reticle_center
                                                   [gr_screen.res][0]) +
    (sy - Hud_reticle_center[gr_screen.res][1]) * (sy -
                                                    Hud_reticle_center
                                                    [gr_screen.res][1]);
...
void hud_show_lead_indicator(vec3d * target_world_pos) 
{
  ...
   g3_rotate_vertex(&lead_target_vertex,
...
void hud_show_lead_indicator_quick(vec3d * target_world_pos,
                                   object * targetp) 
{
                                  ...
                                  vec3d * world_pos) 
{
  ...
   vm_vec_unrotate(world_pos, &subsys->system_info->pnt,
                     &parent_obj->orient);
...
void hud_show_afterburner_gauge() 
{
    ...
    {
      GR_AABITMAP_EX(Aburn_bar_gauge.first_frame,
    ...
    {
      GR_AABITMAP_EX(Aburn_bar_gauge.first_frame + 1,
                      current_hud->Aburn_coords[0] + nose_offset_x,
    ...
    
    {
        ...
        
        {
            ...
            gr_string(current_hud->Wenergy_text_coords[0] + nose_offset_x,
                      current_hud->Wenergy_text_coords[1] + nose_offset_y,
                      buf);
        ...
        {
          GR_AABITMAP_EX(Wenergy_bar_gauge.first_frame + 2,
        ...
        {
          GR_AABITMAP_EX(Wenergy_bar_gauge.first_frame + 3,
                          current_hud->Wenergy_coords[0] + nose_offset_x,
...
void hud_show_weapons() 
{
  ...
  char name[NAME_LENGTH];
    ...
    GR_AABITMAP(Weapon_gauges[ballistic_hud_index][0].first_frame,
                Weapon_gauge_primary_coords[ballistic_hud_index][gr_screen.
                                                                 res][0][0],
                Weapon_gauge_primary_coords[ballistic_hud_index][gr_screen.
                                                                 res][0][1]);
   emp_hud_string(Weapon_title_coords[ballistic_hud_index][gr_screen.res]
                    [0],
                    Weapon_title_coords[ballistic_hud_index][gr_screen.
                                                             res][1],
    ...
    
    {
        ...
        {
          GR_AABITMAP(Weapon_gauges[ballistic_hud_index][1].first_frame,
        ...
        
        {
            ...
            GR_AABITMAP(New_weapon.first_frame,
                         Weapon_gauge_primary_coords[ballistic_hud_index]
                         [gr_screen.res][1][0], y);
        ...
        {
          GR_AABITMAP(Weapon_info[sw->primary_bank_weapons[i]].
                       hud_image_index,
  ...
   GR_AABITMAP(Weapon_gauges[ballistic_hud_index][2].first_frame,
                 Weapon_gauge_primary_coords[ballistic_hud_index][gr_screen.
                                                                  res][1][0],
                 y);
    ...
    
    {
        ...
        GR_AABITMAP(Weapon_gauges[ballistic_hud_index][3].first_frame,
        ...
        
        {
            ...
            {
              emp_hud_printf(Weapon_slinked_x[gr_screen.res], name_y,
                              EG_NULL, "%c", Lcl_special_chars + 2);
            }
           if (wip->hud_image_index != -1)
            
            {
              GR_AABITMAP(wip->hud_image_index,
  ...
  GR_AABITMAP(Weapon_gauges[ballistic_hud_index][4].first_frame,
...
void hud_stuff_ship_class(char *ship_class_text, ship * shipp) 
{
    ...
    
    {
              ...
              (Ship_info[shipp->ship_info_index].
               alt_name[0]) ? Ship_info[shipp->ship_info_index].
