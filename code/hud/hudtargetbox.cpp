...
void hud_get_target_strength(object * objp, float *shields,
                             float *integrity) 
{
    ...
    
    {
        ...
        if (((Player_ship->team == target_shipp->team)
             || ((Iff_info[target_shipp->team].flags & IFFF_ORDERS_SHOWN)
                 && !(Iff_info[target_shipp->team].
                      flags & IFFF_ORDERS_HIDDEN)))
        ...
        
        {
            ...
            
            {
              ...
               emp_hud_string(Targetbox_coords[gr_screen.res]
                                [TBOX_EXTRA_TIME][0],
                                Targetbox_coords[gr_screen.
...
void hud_render_target_jump_node(object * target_objp) 
{
    ...
    hud_set_gauge_color(HUD_TARGET_MONITOR);
                    ...
                    Targetbox_coords[gr_screen.res][TBOX_NAME][1],
...
void hud_render_target_asteroid(object * target_objp) 
{
  ...
  char hud_name[64];
    ...
    
    {
      ...
      sprintf(hud_name, NOX("%s debris"),
               Species_info[(asteroidp->asteroid_type / NUM_DEBRIS_SIZES) -
                            1].species_name);
...
void hud_render_target_ship_info(object * target_objp) 
{
  ...
  Assert(target_objp->type == OBJ_SHIP);
    ...
    
    {
                    ...
                    Targetbox_coords[gr_screen.res][TBOX_HULL][1],
    ...
    
    {
      ...
      char linebreak[2] = "|";
        ...
        
        {
                     ...
                     Target_window_coords[gr_screen.res][1] +
                     Target_window_coords[gr_screen.res][3] - h, "%s",
                     outstr);
    ...
    
    {
        ...
        
        {
                 ...
                 Target_window_coords[gr_screen.res][1] +
                 Target_window_coords[gr_screen.res][3] - 2 * h, "%s",
                 outstr);
            ...
            
            {
              ...
              sprintf(outstr2, " / %s",
                ...
                sprintf(outstr2, " / Wpnum: %i", aip->wp_index);
                       ...
                       (int) (100.0f *
                              vm_vec_mag(&target_objp->phys_info.vel) /
                    ...
                    
                    {
                        ...
                        vm_vec_dist_quick(&Enemy_attacker->pos,
                                          &Player_obj->pos);
                                             ...
                                             &Objects[eaip->target_objnum].
                                             pos, &Enemy_attacker->pos);
                       dot =
                        vm_vec_dot(&v2t, &Enemy_attacker->orient.vec.fvec);
                       gr_printf(sx, sy, "#%i: %s",
                                   Enemy_attacker - Objects,
...
int hud_targetbox_static_maybe_blit(float frametime) 
{
    ...
    ship_get_subsystem_strength(Player_ship, SUBSYSTEM_SENSORS);
