...
void hud_config_set_gauge_flags(int gauge_index, int on_flag,
                                int popup_flag) 
{
...
void hud_set_default_hud_config(player * p) 
{
    ...
    {
      gr_init_alphacolor(&HUD_config.clr[idx], HUD_color_red,
                          HUD_color_green, HUD_color_blue,
                          (HUD_color_alpha + 1) * 16);
