...
 int hud_shield_maybe_flash(int gauge, int target_index,
                              int shield_offset) 
{
...
}  void hud_show_mini_ship_integrity(object * objp, int x_force,
                                        int y_force) 
{
                          ...
                          int x_hull_offset, int y_hull_offset) 
{
    ...
    
    {
      ...
       GR_AABITMAP(Shield_mini_gauge.first_frame + frame_offset,
