...
void hud_init_reticle() 
{
    ...
    
    {
        ...
        Reticle_frame_names[Hud_reticle_style][gr_screen.res][i];
...
void hud_render_throttle_background(int y_end) 
{
    ...
    {
      GR_AABITMAP_EX(Reticle_gauges[RETICLE_LEFT_ARC].first_frame + 1,
...
void hud_render_throttle_foreground(int y_end) 
{
    ...
    {
      GR_AABITMAP_EX(Reticle_gauges[RETICLE_LEFT_ARC].first_frame + 2,
...
void hud_show_throttle() 
{
    ...
    hud_render_throttle_foreground(y_end);
             ...
             Zero_speed_coords[gr_screen.res][1] + HUD_nose_y, XSTR("0",
                                                                    292));
...
void hud_show_reticle_weapons() 
{
    ...
    {
      GR_AABITMAP(Reticle_gauges[gauge_index].first_frame + frame_offset,
                   Reticle_frame_coords[Hud_reticle_style][gr_screen.
                                                           res][gauge_index]
                   [0] + HUD_nose_x,
                   Reticle_frame_coords[Hud_reticle_style][gr_screen.
...
void hud_show_lock_threat() 
{
    ...
    
    {
                 ...
                 Reticle_frame_coords[Hud_reticle_style][gr_screen.
                                                         res]
                 [RETICLE_LOCK_WARN][0] + HUD_nose_x,
                 Reticle_frame_coords[Hud_reticle_style][gr_screen.
                                                         res]
                 [RETICLE_LOCK_WARN][1] + HUD_nose_y);
...
void hud_show_dumbfire_threat() 
{
  ...
   GR_AABITMAP(Reticle_gauges[RETICLE_LASER_WARN].first_frame +
                 frame_offset,
                 Reticle_frame_coords[Hud_reticle_style][gr_screen.
                                                         res]
...
void hud_show_right_arc() 
{
    ...
    
    {
        ...
        
        {
            ...
            GR_AABITMAP(Reticle_gauges[RETICLE_RIGHT_ARC].first_frame,
                        Reticle_frame_coords[Hud_reticle_style][gr_screen.
                                                                res]
                        [RETICLE_RIGHT_ARC][0] + HUD_nose_x,
                        Reticle_frame_coords[Hud_reticle_style][gr_screen.
