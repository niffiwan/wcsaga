...
static int HUD_wingman_update_timer;
  ...
  HUD_wingman_flash_duration[MAX_SQUADRON_WINGS][MAX_SHIPS_PER_WING];
...
int HUD_wingman_left_coords[GR_NUM_RESOLUTIONS][5][2] = { {
  ...
  HUD_wingman_status_name_coords[GR_NUM_RESOLUTIONS][MAX_SQUADRON_WINGS][2] =
                                     ...
                                     int num_wings_to_draw) 
{
    ...
    
    {
        ...
        
        {
            ...
            Wingman_status_frames[WINGMAN_STATUS_DOTS].first_frame + 1;
