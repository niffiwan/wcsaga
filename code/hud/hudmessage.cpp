...
struct scrollback_buttons 
{
   ...
    scrollback_buttons(char *name, int x1, int y1, int x2, int y2,
                        int h):filename(name), x(x1), y(y1), xt(x2), yt(y2),
    hotspot(h)
  {
} };
...
void hud_show_msg_window() 
{
    ...
    
    {
      ...
      HUD_active_msgs_list[Active_index].total_life =
        timestamp(HUD_MESSAGE_TOTAL_LIFE);
       for (i = Active_index + 1; i < Active_index + ACTIVE_BUFFER_LINES;
              i++)
        ...
        
        {
            ...
            (ACTIVE_BUFFER_LINES - 1) * MSG_WINDOW_FONT_HEIGHT;
        ...
        
        {
            ...
            (ACTIVE_BUFFER_LINES - 2) * MSG_WINDOW_FONT_HEIGHT;
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    gr_printf(MSG_WINDOW_X_START +
                              HUD_active_msgs_list[i].msg.x - 2,
...
 void hud_show_fixed_text() 
{
    ...
    
    {
        ...
        gr_printf(0x8000, MSG_WINDOW_Y_START + MSG_WINDOW_HEIGHT + 8,
                  hp->text);
...
int hud_get_scroll_max_pos() 
{
    ...
    
    {
        ...
        (Scroll_max -
         Hud_mission_log_list_coords[gr_screen.res][3]) / font_height;
...
 void hud_scrollback_init() 
{
  ...
  Ui_window.create(0, 0, gr_screen.max_w_unscaled, gr_screen.max_h_unscaled,
    ...
    // add all strings
    Ui_window.add_XSTR("Continue", 1069,
                       Buttons[gr_screen.res][ACCEPT_BUTTON].xt,
    ...
    message_log_init_scrollback(Hud_mission_log_list_coords[gr_screen.res]
                                 [2]);
    ...
    ML_objectives_init(Hud_mission_log_list_coords[gr_screen.res][0],
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    gr_print_timestamp(Hud_mission_log_list_coords
                                        [gr_screen.res][0],
                                        Hud_mission_log_list_coords[gr_screen.
                                                                    res][1] +
                                        y, node_ptr->time);
                    ...
                    
                    {
                        ...
                        font_height / 2 - 1;
                      gr_circle(Hud_mission_log_list2_coords[gr_screen.res]
                                 [0] - 6, i, 5);
                       gr_set_color_fast(&Color_bright);
                      gr_line(Hud_mission_log_list2_coords[gr_screen.res][0]
                               - 10, i,
                               Hud_mission_log_list2_coords[gr_screen.
                                                            res][0] - 8, i);
