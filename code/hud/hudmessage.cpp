...
void hud_sourced_print(int source, char *msg)
{
  ...
  float old_aspect =
    (float) gr_screen.max_w_unscaled / gr_screen.max_h_unscaled;
  ...
  while ((ptr = split_str_once(str, split_width - x - 7)) != NULL)
    {
      // the 7 is a fudge hack
