    ...
    
    {
      if (Player->stats.m_medal_earned == 13)  // special hack for the wings..
        {
            ...
            
            {
                   ...
                   Debrief_award_filename[gr_screen.res][DB_AWARD_WINGS],
                   ver);
      ...
      else if (Player->stats.m_medal_earned == 17)      // special hack for the soc crest
        {
            ...
            bm_load(Debrief_award_filename[gr_screen.res][DB_AWARD_SOC]);
...
void debrief_replay_pressed() 
{
    ...
    
    {
        ...
        popup(0, 2, POPUP_CANCEL, XSTR("&Replay", 451),
              XSTR
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    {
                      scoring_backout_accept(&Net_players[i].m_player->
                                              stats);
...
void debrief_do_frame(float frametime) 
{
    ...
    
    {
                 ...
                 Debrief_text_wnd_coords[gr_screen.res][1] +
                 Debrief_text_wnd_coords[gr_screen.res][3], XSTR("More",
                                                                 459));
    ...
    
    {
        ...
        popup(0, 3, XSTR("Do Not Skip This Mission", 1473),
