...
ui_button_info
  Fiction_viewer_buttons[NUM_FVW_SETTINGS][GR_NUM_RESOLUTIONS]
  [NUM_FVW_BUTTONS] = {
  // standard FS2-style interface
  {
   {
...
void fiction_viewer_init()
{
  ...
  for (Fiction_viewer_ui = NUM_FVW_SETTINGS - 1; Fiction_viewer_ui >= 0;
       Fiction_viewer_ui--)
    {
  ...
  Fiction_viewer_window.
    set_mask_bmap(Fiction_viewer_screen_mask[Fiction_viewer_ui]
                  [gr_screen.res]);
  ...
  for (int i = 0; i < NUM_FVW_BUTTONS; i++)
    {
      ...
      b->button.create(&Fiction_viewer_window, "", b->x, b->y, b->xt, b->yt,
                       repeat, 1);
  ...
  Fiction_viewer_buttons[Fiction_viewer_ui][gr_screen.
                                            res][FVW_BUTTON_SCROLL_UP].button.
    set_hotkey(KEY_UP);
  Fiction_viewer_buttons[Fiction_viewer_ui][gr_screen.
                                            res][FVW_BUTTON_SCROLL_DOWN].
  ...
  if (Num_brief_text_lines[0] > Fiction_viewer_text_max_lines)
    {
      Fiction_viewer_slider.create(&Fiction_viewer_window,
                                   ...
                                   [Fiction_viewer_ui][gr_screen.res][0],
                                   Fiction_viewer_slider_coordinates
                                   [Fiction_viewer_ui][gr_screen.res][1],
                                   Fiction_viewer_slider_coordinates
                                   [Fiction_viewer_ui][gr_screen.res][2],
                                   Fiction_viewer_slider_coordinates
                                   [Fiction_viewer_ui][gr_screen.res][3],
                                   Num_brief_text_lines[0] -
                                   Fiction_viewer_text_max_lines,
                                   Fiction_viewer_slider_filename
                                   [Fiction_viewer_ui][gr_screen.res],
                                   &fiction_viewer_scroll_up,
                                   &fiction_viewer_scroll_down,
...
void fiction_viewer_do_frame(float frametime)
{
  ...
  for (i = 0; i < NUM_FVW_BUTTONS; i++)
    if (Fiction_viewer_buttons[Fiction_viewer_ui][gr_screen.res][i].button.
        pressed())
