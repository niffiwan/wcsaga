...
struct brief_buttons
{
  ...
  brief_buttons(char *name, int x1, int y1, int xt1, int yt1, int h, int r = 0):filename(name),
    x(x1),
    y(y1), xt(xt1), yt(yt1), hotspot(h), repeat(r)
  {
  }
};
...
void brief_render(float frametime)
{
  ...
  gr_printf(Brief_bmap_coords[gr_screen.res][0] + title_x_offset,
      ...
      if (Current_brief_stage != Last_brief_stage)
        {
          ...
          brief_set_new_stage(&Briefing->stages[Current_brief_stage].
                              ...
                              camera_orient, time, Current_brief_stage);
