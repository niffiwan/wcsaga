...
struct ss_buttons 
{
   ...
    ss_buttons(char *name, int x1, int y1, int xt1, int yt1, int h,
                int s):filename(name), x(x1), y(y1), xt(xt1), yt(yt1),
    hotspot(h), scrollable(s)
  {
} };
...
void ss_set_carried_icon(int from_slot, int ship_class) 
{
    ...
    Ship_select_buttons[gr_screen.res][SS_BUTTON_DUMMY].button.
    capture_mouse();
...
void ship_select_init() 
{
    ...
    Num_mask_regions = 0;
  ...
  snazzy_menu_add_region(&Region[Num_mask_regions++], "", COMMON_SS_REGION,
                          0);
                          ...
                          0);
   snazzy_menu_add_region(&Region[Num_mask_regions++], "", WING_0_SHIP_0,
                            0);
  ...
  // restoring a game from the Options screen invoked from ship select
    ...
    Ship_select_ui_window.create(0, 0, gr_screen.max_w_unscaled,
                                 gr_screen.max_h_unscaled, 0);
  Ship_select_ui_window.
    set_mask_bmap(Ship_select_background_mask_fname[gr_screen.res]);
    ...
    Ship_select_background_bitmap =
    bm_load(Ship_select_background_fname[gr_screen.res]);
...
void ss_maybe_flash_button() 
{
    ...
    
    {
        ...
        if (Common_buttons[Current_screen - 1][gr_screen.res][2].button.
            button_hilighted())
        ...
        
        {
                          ...
                          1][gr_screen.res][2].button.draw_forced(1);
...
void ship_select_blit_ship_info() 
{
    ...
    {
      gr_string(Ship_info_coords[gr_screen.res][SHIP_SELECT_X_COORD],
    ...
    
    {
                 ...
                 y_start, Species_info[sip->species].species_name);
...
 void ship_select_do(float frametime) 
{
    ...
    snazzy_menu_do(ShipSelectMaskData, Shipselect_mask_w, Shipselect_mask_h,
    ...
    
    {
        ...
        {
          generic_anim_render(&Ss_icons[Selected_ss_class].ss_anim,
                               (help_overlay_active(SS_OVERLAY)) ? 0 :
    ...
    
    {
        ...
        
        {
            ...
            {
              draw_model_icon(Ss_icons[Carried_ss_icon.ship_class].
                               model_index,
                               MR_LOCK_DETAIL | MR_AUTOCENTER | MR_NO_FOGGING
                               | MR_NO_LIGHTING, sip->closeup_zoom / 1.25f,
                               sx, sy, w, h, sip);
    ...
    //////////////////////////////////
    if (Cmdline_ship_choice_3d
        || ((Ss_icons != NULL) && (Selected_ss_class >= 0)
            && (Ss_icons[Selected_ss_class].ss_anim.num_frames > 0)))
    ...
    
    {
        ...
        
        {
                           ...
                           32, 28, sip);
                            ...
                            Ship_list_coords[gr_screen.res][screen_offset][1],
                            Ship_list_coords[gr_screen.
                                             res][screen_offset][0] + 32,
                            Ship_list_coords[gr_screen.
                                             res][screen_offset][1] + 28);
...
void pick_from_wing(int wb_num, int ws_num) 
{
    ...
    
    {
      ...
      
      {
          ...
          Wing_icon_coords[gr_screen.res][slot_index][0] - mouse_x;
        Ss_delta_y =
          Wing_icon_coords[gr_screen.res][slot_index][1] - mouse_y;
                     ...
                     int class_select) 
{
    ...
    Wing_icon_coords[gr_screen.res][wb_num * MAX_WING_SLOTS][0] + 16 - w / 2;
  sy =
    Wing_icon_coords[gr_screen.res][wb_num * MAX_WING_SLOTS + 3][1] + 32 + h;
    ...
    
    {
        ...
        
        {
            ...
            draw_model_icon(icon->model_index,
                            ...
                            Wing_icon_coords[gr_screen.res][slot_index][1],
                            32, 28, sip);
          draw_brackets_square(Wing_icon_coords[gr_screen.res][slot_index]
                                [0],
                                Wing_icon_coords[gr_screen.
                                                 res][slot_index][1],
                                Wing_icon_coords[gr_screen.
                                                 res][slot_index][0] + 32,
                                Wing_icon_coords[gr_screen.
                        ...
                        
                        {
                            ...
                            
                            {
                                ...
                                
                                {
                                  ...
                                  wl_update_parse_object_weapons(p_objp,
                                                                  &Wss_slots[i
                                                                             *
                                                                             MAX_WING_SLOTS
                                                                             +
        ...
        
        {
            ...
            
            {
                ...
                
                {
                  ...
                  hud_set_wingman_status_none(Ships[shipnum].
...
int ss_disabled_slot(int slot_num) 
{
  ...
   return (Ss_wings[slot_num / MAX_WING_SLOTS].
             ss_slots[slot_num % MAX_WING_SLOTS].status & WING_SLOT_IGNORE);
...
int ss_valid_slot(int slot_num) 
{
    ...
    Ss_wings[slot_num / MAX_WING_SLOTS].ss_slots[slot_num %
                                                 MAX_WING_SLOTS].status;
...
 void ss_apply(int mode, int from_slot, int from_list, int to_slot,
                 int to_list, int player_index) 
{
...
 void ss_drop(int from_slot, int from_list, int to_slot, int to_list,
                int player_index) 
{
