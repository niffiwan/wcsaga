...
 void common_buttons_maybe_reload(UI_WINDOW * ui_window) 
{
    ...
    
    {
      ...
      b->set_bmaps(Common_buttons[Current_screen - 1][gr_screen.res][i].
                    filename);
...
 void common_buttons_init(UI_WINDOW * ui_window) 
{
    ...
    
    {
                 ...
                 Common_buttons[Current_screen - 1][gr_screen.res][i].y, 60,
                 30, 0, 1);
        ...
        b->set_highlight_action(common_play_highlight_sound);
                    ...
                    filename);
      b->link_hotspot(Common_buttons[Current_screen - 1][gr_screen.res][i].
                       hotspot);
    }
   
    // add some text
    ui_window->add_XSTR("Briefing", 1504,
                        Common_buttons[Current_screen -
                                       1][gr_screen.
                                          res][COMMON_BRIEFING_BUTTON].xt,
                        Common_buttons[Current_screen -
                                       1][gr_screen.
                                          res][COMMON_BRIEFING_BUTTON].yt,
                        &Common_buttons[Current_screen -
                                        1][gr_screen.
                                           res][COMMON_BRIEFING_BUTTON].
                        button, UI_XSTR_COLOR_GREEN);
  ui_window->add_XSTR("Ship Selection", 1067,
                       Common_buttons[Current_screen -
                                      1][gr_screen.res][COMMON_SS_BUTTON].xt,
                       Common_buttons[Current_screen -
                                      1][gr_screen.res][COMMON_SS_BUTTON].yt,
                       &Common_buttons[Current_screen -
                                       1][gr_screen.res][COMMON_SS_BUTTON].
                       button, UI_XSTR_COLOR_GREEN);
  ui_window->add_XSTR("Weapon Loadout", 1068,
                       Common_buttons[Current_screen -
                                      1][gr_screen.res][COMMON_WEAPON_BUTTON].
                       xt,
                       Common_buttons[Current_screen -
                                      1][gr_screen.res][COMMON_WEAPON_BUTTON].
                       yt,
                       &Common_buttons[Current_screen -
                                       1][gr_screen.
                                          res][COMMON_WEAPON_BUTTON].button,
                       UI_XSTR_COLOR_GREEN);
  ui_window->add_XSTR("Commit", 1062,
                       Common_buttons[Current_screen -
                                      1][gr_screen.res][COMMON_COMMIT_BUTTON].
                       xt,
                       Common_buttons[Current_screen -
                                      1][gr_screen.res][COMMON_COMMIT_BUTTON].
                       yt,
                       &Common_buttons[Current_screen -
                                       1][gr_screen.
                                          res][COMMON_COMMIT_BUTTON].button,
                       UI_XSTR_COLOR_PINK);
  ui_window->add_XSTR("Help", 928,
                       Common_buttons[Current_screen -
                                      1][gr_screen.res][COMMON_HELP_BUTTON].
                       xt,
                       Common_buttons[Current_screen -
                                      1][gr_screen.res][COMMON_HELP_BUTTON].
                       yt,
                       ...
                       Common_buttons[Current_screen -
                                      1][gr_screen.
                                         res][COMMON_OPTIONS_BUTTON].xt,
                       Common_buttons[Current_screen -
                                      1][gr_screen.
                                         res][COMMON_OPTIONS_BUTTON].yt,
                       &Common_buttons[Current_screen -
                                       1][gr_screen.
                                          res][COMMON_OPTIONS_BUTTON].button,
                       UI_XSTR_COLOR_GREEN);
   common_reset_buttons();
   Common_buttons[Current_screen -
                    1][gr_screen.res][COMMON_COMMIT_BUTTON].button.
    set_hotkey(KEY_CTRLED + KEY_ENTER);
  Common_buttons[Current_screen -
                  1][gr_screen.res][COMMON_HELP_BUTTON].button.
    set_hotkey(KEY_F1);
  Common_buttons[Current_screen -
                  1][gr_screen.res][COMMON_OPTIONS_BUTTON].button.
    set_hotkey(KEY_F2);
    ...
    
    {
                      ...
                      1][gr_screen.res][COMMON_SS_REGION].button.disable();
      Common_buttons[Current_screen -
                      1][gr_screen.res][COMMON_WEAPON_REGION].button.
        disable();
    ...
    Common_buttons[Current_screen -
                  ...
                  1][gr_screen.res][COMMON_WEAPON_REGION].button.disable();
...
void common_select_init() 
{
  ...
  gr_init_alphacolor(&Icon_colors[ICON_FRAME_DISABLED_HIGH], 100, 100, 100,
                      255);
  ...
  gr_create_shader(&Icon_shaders[ICON_FRAME_DISABLED_HIGH], 100, 100, 100,
                    255);
...
 void common_reset_buttons() 
{
    ...
    
    {
                      ...
                      1][gr_screen.res][COMMON_BRIEFING_REGION].button.
        skip_first_highlight_callback();
      break;
    case ON_SHIP_SELECT:
      Common_buttons[Current_screen -
                      1][gr_screen.res][COMMON_SS_REGION].button.
        skip_first_highlight_callback();
...
int common_select_do(float frametime) 
{
    ...
    {
      Common_buttons[0][gr_screen.res][COMMON_HELP_BUTTON].button.
        reset_status();
      Common_buttons[1][gr_screen.res][COMMON_HELP_BUTTON].button.
        reset_status();
      Common_buttons[2][gr_screen.res][COMMON_HELP_BUTTON].button.
        reset_status();
...
{
  Common_buttons[Next_screen - 1][gr_screen.res][Next_screen -
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                      ...
                      hud_set_wingman_status_none(shipp->
                                                   wing_status_wing_index,
                                                   shipp->
                                                   wing_status_wing_pos);
...
 void draw_model_icon(int model_id, int flags, float closeup_zoom, int x,
                        int y, int w, int h, ship_info * sip, bool resize) 
{
  ...
  0.0f, 0.0f, 0.0f};
    ...
    
    {
        ...
        {
          gr_set_proj_matrix(0.5f * Proj_fov, gr_screen.clip_aspect,
    ...
    
    {
      ...
      for (int i = 0; i < pm->n_models; i++)
        ...
        {
          gr_set_proj_matrix(0.5f * Proj_fov, gr_screen.clip_aspect, 0.05f,
                              1000.0f);
...
 void draw_model_rotating(int model_id, int x1, int y1, int x2, int y2,
                            float *rotation_buffer, vec3d * closeup_pos,
                            float closeup_zoom, float rev_rate, int flags,
                            bool resize) 
{
