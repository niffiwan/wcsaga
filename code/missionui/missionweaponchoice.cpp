...
struct wl_buttons 
{
   ...
    wl_buttons(char *name, int x1, int y1, int xt1, int yt1,
                int h):filename(name), x(x1), y(y1), xt(xt1), yt(yt1),
    hotspot(h)
  {
} };
  ...
  { 
{"weaponloadoutmulti-m", "2_weaponloadoutmulti-m" },  {"weaponloadoutmulti-mb", "2_weaponloadoutmulti-mb" } 
  ...
  *Weapon_select_multi_background_fname[NUM_WEAPON_SETTINGS]
  [GR_NUM_RESOLUTIONS] =
...
void wl_render_overhead_view(float frametime) 
{
  ...
  static float WeapSelectScreenShipRot = 0.0f;
    ...
    
    {
               ...
               "ivalid ship class (%d) passed for render_overhead_view",
               ship_class);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    bm_load_animation(sip->overhead_filename);
            ...
            
            {
                       ...
                       "Unable to load overhead image for ship '%s', generating one instead",
                       sip->name);
    ...
    
    {
        ...
        
        {
          ...
           gr_set_clip(Wl_overhead_coords[gr_screen.res][0],
                         Wl_overhead_coords[gr_screen.res][1],
          ...
          model_render(wl_ship->model_num, &object_orient, &vmd_zero_vector,
                        MR_LOCK_DETAIL | MR_AUTOCENTER | MR_NO_FOGGING, -1,
                        -1);
            ...
            
            {
                    ...
                    && Hot_weapon_bank < 0) || x == Hot_weapon_bank)
                
                {
                  Assert(num_found < NUM_ICON_FRAMES);
                  gr_set_color_fast(&Icon_colors
                                     [ICON_FRAME_NORMAL + num_found]);
                  gr_circle(Wl_bank_coords[gr_screen.res][x][0] + 106,
                    ...
                    
                    {
                        ...
                        //Stuff
                        vm_vec_unrotate(&subobj_pos, &pm->gun_banks[x].pnt[y],
                                        &object_orient);
                        ...
                        fl2i(draw_point.sy +
                             Wl_overhead_coords[gr_screen.res][1]);
                       gr_line(Wl_bank_coords[gr_screen.res][x][0] + 106,
                                ...
                                Wl_bank_coords[gr_screen.res][x][1] + 12, 5,
                                1);
                      gr_line(xc, Wl_bank_coords[gr_screen.res][x][1] + 17,
                               xc, yc);
            ...
            
            {
                    ...
                    wep[x + MAX_SHIP_PRIMARY_BANKS] == Selected_wl_class
                    && Hot_weapon_bank < 0)
                ...
                
                {
                                     ...
                                     [ICON_FRAME_NORMAL + num_found]);
                  gr_circle(Wl_bank_coords[gr_screen.res]
                             [x + MAX_SHIP_PRIMARY_BANKS][0] - 50,
                             Wl_bank_coords[gr_screen.res][x +
                                                           MAX_SHIP_PRIMARY_BANKS]
                             [1] + 12, 5);
                  for (y = 0; y < pm->missile_banks[x].num_slots; y++)
                    
                    {
                      vm_vec_unrotate(&subobj_pos,
                                       &pm->missile_banks[x].pnt[y],
                                       &object_orient);
                        ...
                        fl2i(draw_point.sy +
                             Wl_overhead_coords[gr_screen.res][1]);
                       gr_line(Wl_bank_coords[gr_screen.res]
                                 [x + MAX_SHIP_PRIMARY_BANKS][0] - 50,
                                 Wl_bank_coords[gr_screen.res][x +
                                                               MAX_SHIP_PRIMARY_BANKS]
                                 [1] + 12, xc + 4,
  ...
   ss_return_name(Selected_wl_slot / MAX_WING_SLOTS,
                    Selected_wl_slot % MAX_WING_SLOTS, name);
...
void wl_load_icons(int weapon_class) 
{
    ...
    
    {
        ...
        bm_load_animation(Weapon_info[weapon_class].icon_filename,
                          &num_frames);
...
void wl_get_ship_class_weapons(int ship_class, int *wep, int *wep_count) 
{
    ...
    
    {
      ...
      wep_count[i + MAX_SHIP_PRIMARY_BANKS] =
        wl_calc_missile_fit(sip->secondary_bank_weapons[i],
...
void wl_get_parseobj_weapons(int sa_index, int ship_class, int *wep,
                             int *wep_count) 
{
    ...
    
    {
        ...
        
        {
            ...
            wl_calc_missile_fit(wep[i + MAX_SHIP_PRIMARY_BANKS],
...
void wl_cull_illegal_weapons(int ship_class, int *wep, int *wep_count) 
{
    ...
    
    {
        ...
        
        {
            ...
            Ship_info[ship_class].allowed_bank_restricted_weapons[i][wep[i]];
    ...
    
    {
      ...
      sa_index = ss_return_saindex(slot_num);
        ...
        
        {
          ...
          ss_return_ship(slot_num / MAX_WING_SLOTS,
                          slot_num % MAX_WING_SLOTS, &ship_index, &pobjp);
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                      ...
                      int wep_pool_index, wep_precedence_index, new_wi_index =
                        -1;
                    ...
                    
                    {
                        ...
                        wl_calc_missile_fit(wi_index,
                                            Ship_info[ship_class].
                                            secondary_bank_ammo_capacity
...
void weapon_select_init() 
{
  ...
  Weapon_select_background_bitmap =
    bm_load((Game_mode & GM_MULTIPLAYER) ?
            Weapon_select_multi_background_fname[Uses_apply_all_button]
            [gr_screen.
             res] :
            Weapon_select_background_fname[Uses_apply_all_button][gr_screen.
                                                                  res]);
    ...
    Num_weapon_select_regions = 0;
   snazzy_menu_add_region(&Weapon_select_region
                            [Num_weapon_select_regions++], "",
                          ...
                          "", COMMON_OPTIONS_REGION, 0);
                            ...
                            [Num_weapon_select_regions++], "", WING_0_SHIP_0,
                            0);
                          ...
                          "", WING_2_SHIP_3, 0);
                            ...
                            [Num_weapon_select_regions++], "", ICON_PRIMARY_0,
                            0);
    ...
    // init common UI
    Weapon_ui_window.create(0, 0, gr_screen.max_w_unscaled,
                            gr_screen.max_h_unscaled, 0);
   if (Game_mode & GM_MULTIPLAYER)
    
    {
      Weapon_ui_window.
        set_mask_bmap(Wl_mask_multi[Uses_apply_all_button][gr_screen.res]);
    ...
    
    {
        ...
        set_mask_bmap(Wl_mask_single[Uses_apply_all_button][gr_screen.res]);
...
int drop_icon_on_slot(int bank_num) 
{
  ...
   wl_drop(Carried_wl_icon.from_bank, Carried_wl_icon.weapon_class,
             bank_num, -1, Selected_wl_slot);
...
void wl_maybe_flash_button() 
{
    ...
    
    {
        ...
        // commit button
        if (Common_buttons[Current_screen - 1][gr_screen.res][3].button.
            button_hilighted())
        ...
        
        {
                          ...
                          1][gr_screen.res][3].button.draw_forced(1);
  ...
  if (!Weapon_desc_wipe_done)
    
    {
      ...
      int bright_char_index =
        (int) (Weapon_desc_wipe_time_elapsed * WEAPON_DESC_MAX_LENGTH /
...
void wl_weapon_desc_start_wipe() 
{
  ...
  gr_get_string_size(&w, &h, Weapon_info[Selected_wl_class].title,
                      title_len);
...
void weapon_select_do(float frametime) 
{
    ...
    snazzy_menu_do(WeaponSelectMaskData, Weaponselect_mask_w,
    ...
    
    {
                           ...
                           MR_IS_MISSILE | MR_LOCK_DETAIL | MR_AUTOCENTER |
                           MR_NO_FOGGING);
    }
   
  else if (Weapon_anim_class != -1
           && (Selected_wl_class == Weapon_anim_class))
    
    {
      ...
       generic_anim_render(&Cur_Anim,
                             (help_overlay_active(WL_OVERLAY)) ? 0 :
                             frametime, weapon_ani_coords[0],
                             weapon_ani_coords[1]);
    ...
    
    {
            ...
            
            {
                ...
                
                {
                    ...
                    draw_model_icon(icon->model_index,
                                    MR_LOCK_DETAIL | MR_NO_FOGGING |
                                    MR_NO_LIGHTING, 0.4f, sx, sy, w, h, NULL);
                ...
                
                {
                  ...
                  int half_x, half_y;
                    ...
                    (Weapon_info[Carried_wl_icon.weapon_class].
                     alt_name[0]) ? Weapon_info[Carried_wl_icon.weapon_class].
                    alt_name : Weapon_info[Carried_wl_icon.weapon_class].name;
        ...
        
        {
            ...
            
            {
                ...
                Wss_slots[Carried_wl_icon.from_slot].
                ...
                 wl_render_icon_count(num_missiles,
                                        Wl_bank_coords[gr_screen.
                                                       res][Carried_wl_icon.
                                                            from_bank][0],
                                        Wl_bank_coords[gr_screen.
                                                       res][Carried_wl_icon.
        ...
        
        {
            ...
            
            {
                ...
                
                {
                           ...
                           (Weapon_info[Carried_wl_icon.weapon_class].
                            alt_name[0]) ? Weapon_info[Carried_wl_icon.
                                                       weapon_class].
                           alt_name : Weapon_info[Carried_wl_icon.
                                                  weapon_class].name,
                           NAME_LENGTH);
                         ...
                         (Ship_info[ship_class].
                          name[0]) ? Ship_info[ship_class].
                         alt_name : Ship_info[ship_class].name, display_name);
                ...
                
                {
                         ...
                         (Ship_info[ship_class].
                          name[0]) ? Ship_info[ship_class].
                         alt_name : Ship_info[ship_class].name,
...
//
void wl_render_icon(int index, int x, int y, int num, int draw_num_flag,
                    int hot_mask, int hot_bank_mask, int select_mask) 
{
    ...
    
    {
        ...
        
        {
            ...
            //Draw the model
            draw_model_icon(icon->model_index,
                            MR_LOCK_DETAIL | MR_NO_FOGGING | MR_NO_LIGHTING,
                            .5f / 1.25f, x, y, 56, 24, NULL);
        ...
        
        {
          ...
          int half_x, half_y;
            ...
            (Weapon_info[index].alt_name[0]) ? Weapon_info[index].
            alt_name : Weapon_info[index].name;
...
void wl_draw_ship_weapons(int index) 
{
    ...
    
    {
             ...
             || (i >= MAX_SHIP_PRIMARY_BANKS
                 && ((i - MAX_SHIP_PRIMARY_BANKS) <
                     Ship_info[Wss_slots[index].ship_class].
                     num_secondary_banks)))
        
        {
            ...
            
            {
              ...
              gr_bitmap(Wl_bank_coords[gr_screen.res][i][0] - 2,
                         Wl_bank_coords[gr_screen.res][i][1] - 2);
            ...
            
            {
              ...
              draw_brackets_square(Wl_bank_coords[gr_screen.res][i][0],
        ...
        
        {
          ...
          wl_render_icon(wep[i],
                          Wl_bank_coords[gr_screen.res][i][0] + x_offset,
...
void wl_update_parse_object_weapons(p_object * pobjp, wss_unit * slot) 
{
    ...
    
    {
        ...
        
        {
            ...
            max_count =
            wl_calc_missile_fit(slot->wep[sidx],
                                Ship_info[slot->ship_class].
                                secondary_bank_ammo_capacity[j]);
          ss->secondary_ammo[j] =
            fl2i(i2fl(slot->wep_count[sidx]) / max_count * 100.0f + 0.5f);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                swp->primary_bank_ammo[j] =
                wl_calc_ballistic_fit(swp->primary_bank_weapons[j],
                                      Ship_info[slot->ship_class].
                                      primary_bank_ammo_capacity[i]);
...
void wl_saturate_bank(int ship_slot, int bank) 
{
    ...
    wl_calc_missile_fit(slot->wep[bank],
                        Ship_info[slot->ship_class].
                        secondary_bank_ammo_capacity[bank - 3]);
                      ...
                      net_player * pl) 
{
    ...
    class_mismatch_flag = (IS_BANK_PRIMARY(from_bank)
                           && IS_BANK_SECONDARY(to_bank))
    ...
    
    {
        ...
        
        {
               ...
               (sip->
                allowed_bank_restricted_weapons[to_bank][slot->
                                                         wep[from_bank]]))
            
            {
                         ...
                         (Weapon_info[slot->wep[from_bank]].
                          alt_name[0]) ? Weapon_info[slot->wep[from_bank]].
                         alt_name : Weapon_info[slot->wep[from_bank]].name,
                         NAME_LENGTH);
                ...
                
                {
                         ...
                         NOX("This bank is unable to carry '%s' weaponry"),
                         display_name);
                ...
                {
                  send_game_chat_packet(Netgame.host, txt, MULTI_MSG_TARGET,
                                         pl, NULL, 1);
        ...
        
        {
               ...
               (sip->
                allowed_bank_restricted_weapons[from_bank][slot->
                                                           wep[to_bank]]))
    ...
    
    {
        ...
        
        {
            ...
            wl_calc_missile_fit(slot->wep[to_bank],
                                Ship_info[slot->ship_class].
                      ...
                      net_player * pl) 
{
    ...
    
    {
        ...
        
        {
          ...
           sprintf(txt, NOX("This bank is unable to carry '%s' weaponry"),
                     display_name);
            ...
            {
              send_game_chat_packet(Netgame.host, txt, MULTI_MSG_TARGET, pl,
                                     NULL, 1);
    ...
    
    {
        ...
        wl_calc_missile_fit(from_list,
                            Ship_info[slot->ship_class].
                            secondary_bank_ammo_capacity[to_bank -
                                                         MAX_SHIP_PRIMARY_BANKS]);
                      ...
                      net_player * pl) 
{
    ...
    
    {
        ...
        
        {
                     ...
                     (Weapon_info[from_list].
                      alt_name[0]) ? Weapon_info[from_list].
                     alt_name : Weapon_info[from_list].name, NAME_LENGTH);
...
{
}  int wl_apply(int mode, int from_bank, int from_list, int to_bank,
                   int to_list, int ship_slot, int player_index,
               ...
               int ship_slot, int player_index, bool dont_play_sound) 
{
    ...
    {
      send_wss_request_packet(Net_player->player_id, from_bank, from_list,
                               to_bank, to_list, ship_slot, -1,
                               WSS_WEAPON_SELECT);
...
void wl_apply_current_loadout_to_all_ships_in_current_wing() 
{
  ...
  char error_messages[MAX_WING_SLOTS * MAX_SHIP_WEAPONS][50 +
                                                          NAME_LENGTH * 2];
    ...
    
    {
        ...
        
        {
            ...
            wl_drop(cur_bank, -1, -1, Wss_slots[cur_wss_slot].wep[cur_bank],
                    cur_wss_slot, -1, true);
            ...
            
            {
                       ...
                       (Weapon_info[weapon_type_to_add].
                        alt_name[0]) ? Weapon_info[weapon_type_to_add].
            ...
            if (!eval_weapon_flag_for_game_type
                (sip->
                 allowed_weapons[weapon_type_to_add])  ||((wip->
                                                            wi_flags2 &
                                                            WIF2_BALLISTIC)
                                                           && !(sip->
                                                                flags &
            ...
            
            {
                       ...
                       [cur_wing_slot * MAX_SHIP_WEAPONS + cur_bank],
                       NOX("%s is unable to carry %s weaponry"), ship_name,
                       wep_display_name);
            ...
            
            {
                   ...
                   (sip->
                    allowed_bank_restricted_weapons[cur_bank]
                    [weapon_type_to_add]))
                
                {
                             ...
                             [cur_wing_slot * MAX_SHIP_WEAPONS + cur_bank],
                             NOX
                             ("%s is unable to carry %s weaponry in primary bank %d"),
                             ...
                             [cur_wing_slot * MAX_SHIP_WEAPONS + cur_bank],
                             NOX
                             ("%s is unable to carry %s weaponry in secondary bank %d"),
            ...
            
            {
                       ...
                       [cur_wing_slot * MAX_SHIP_WEAPONS + cur_bank],
                       NOX("Insufficient %s available to arm %s"),
                       (Weapon_info[weapon_type_to_add].
                        alt_name[0]) ? Weapon_info[weapon_type_to_add].
                       alt_name : Weapon_info[weapon_type_to_add].name,
                       ship_name);
    ...
    
    {
      ...
      char error_msg[MAX_WING_SLOTS * MAX_SHIP_WEAPONS *
                      (50 + NAME_LENGTH * 2) + 40];
