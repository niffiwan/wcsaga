  ...
  else
    {
      ...
      if (sa_index >= 0)
      ...
      else
        {
          ...
          int ship_index = -1;
          p_object *pobjp;
          ss_return_ship(slot_num / MAX_WING_SLOTS, slot_num % MAX_WING_SLOTS,
                         &ship_index, &pobjp);
          Assert(ship_index != -1);
...
void weapon_select_init()
{
  ...
  snazzy_menu_add_region(&Weapon_select_region[Num_weapon_select_regions++],
                         "", ICON_SHIP_SECONDARY_4, 0);
  snazzy_menu_add_region(&Weapon_select_region[Num_weapon_select_regions++],
                         "", ICON_SHIP_SECONDARY_5, 0);
...
int drop_icon_on_slot(int bank_num)
{
  ...
  wl_drop(Carried_wl_icon.from_bank, Carried_wl_icon.weapon_class, bank_num,
          -1, Selected_wl_slot);
  return 1;
}
  ...
  if (Wl_icons[Selected_wl_class].model_index != -1)
           ...
           && (Selected_wl_class == Weapon_anim_class))
    {
      ...
      generic_anim_render(&Cur_Anim,
                          (help_overlay_active(WL_OVERLAY)) ? 0 : frametime,
                          weapon_ani_coords[0], weapon_ani_coords[1]);
    }
              ...
              if (Lcl_gr)
                {
                  ...
                  popup(PF_USE_AFFIRMATIVE_ICON, 1, POPUP_OK,
                        ...
                        (Ship_info[ship_class].
                         alt_name[0]) ? Ship_info[ship_class].
      ...
      for (cur_bank = 0; cur_bank < MAX_SHIP_WEAPONS; cur_bank++)
        {
          ...
          if (Lcl_gr)
          ...
          else
            {
              wep_display_name =
                (Weapon_info[weapon_type_to_add].
                 alt_name[0]) ? Weapon_info[weapon_type_to_add].alt_name :
