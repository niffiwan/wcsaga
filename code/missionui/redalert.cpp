...
void red_alert_blit_title() 
{
    ...
    
    {
                          ...
                          (int) (255.0f * (Ra_flash_time / RA_FLASH_CYCLE)),
                          0, 0, 255);
    ...
    
    {
                          ...
                          (int) (255.0f *
                                 (1.0f - (Ra_flash_time / RA_FLASH_CYCLE))),
                          0, 0, 255);
...
void red_alert_init() 
{
    ...
    Buttons[gr_screen.res][RA_CONTINUE].button.
    ...
    
    {
                             ...
                             Ra_brief_text_wnd_coords[gr_screen.
                                                      res][RA_W_COORD], 0);
...
 void red_alert_bash_subsys_status(red_alert_ship_status * ras,
                                     ship * shipp) 
{
    ...
    
    {
      ...
       shipp->subsys_info[i].current_hits =
        ras->subsys_aggregate_current_hits[i];
} }   void red_alert_store_subsys_status(red_alert_ship_status * ras,
                                              ship * shipp) 
{
    ...
    
    {
        ...
        
        {
            ...
            if ((Ships_exited[idx].flags & SEF_DESTROYED)
                || (Ships_exited[idx].flags & SEF_PLAYER_DELETED))
...
void red_alert_read_wingman_status_campaign(CFILE * fp,
                                            char ships[][NAME_LENGTH],
                                            char weapons[][NAME_LENGTH]) 
{
