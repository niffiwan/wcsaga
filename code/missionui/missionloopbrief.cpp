...
void loop_brief_init() 
{
    ...
    // window
    Loop_brief_window.create(0, 0, gr_screen.max_w_unscaled,
    ...
    
    {
        ...
        anim_load(Campaign.missions[Campaign.current_mission].
    ...
    
    {
      ...
       anim_play_init(&aps, Loop_anim,
                        Loop_brief_anim_coords[gr_screen.res][0],
    ...
    {
      brief_color_text_init(Campaign.missions[Campaign.current_mission].
                             mission_loop_desc,
    ...
    if (Campaign.missions[Campaign.current_mission].
        mission_loop_brief_sound != NULL)
    
    {
      Loop_sound =
        audiostream_open(Campaign.missions[Campaign.current_mission].
                         mission_loop_brief_sound, ASF_VOICE);
...
void loop_brief_do() 
{
    ...
    
    {
        ...
        do_loop =
        popup(PF_USE_NEGATIVE_ICON | PF_USE_AFFIRMATIVE_ICON | PF_IGNORE_ESC |
              PF_BODY_BIG, 2, XSTR("Decline", 1467), XSTR("Accept", 1035),
              XSTR
              ("You must either Accept or Decline before returning to the Main Hall",
               -1));
