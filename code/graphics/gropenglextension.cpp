  ...
  ogl_extension GL_Extensions[NUM_OGL_EXTENSIONS] = 
{
    ...
    // (NOTE: this was included in OpenGL 1.2.1 standard, but we still need to check for it or require > 1.2 OGL)
  {
    ...
    {
  "glMultiTexCoord2fARB", "glActiveTextureARB",
        "glClientActiveTextureARB" } },  
    // "ADD" function for texture environment
  {
    true, false, 2,
    {
    "GL_ARB_texture_env_add", "GL_EXT_texture_env_add"}, 0,
    {
  NULL}},  
    ...
    // "COMBINE" function for texture environment, these two are basically the same
  {
    false, false, 2,
    {
    "GL_ARB_texture_env_combine", "GL_EXT_texture_env_combine"}, 0,
    {
  NULL}},  
    ...
    // allows pixel data to use buffer objects
  {
    ...
    {
    "GL_ARB_pixel_buffer_object", "GL_EXT_pixel_buffer_object"}, 7,
    {
  "glBindBufferARB", "glDeleteBuffersARB", "glGenBuffersARB",
        "glBufferDataARB", "glBufferSubDataARB", "glMapBufferARB",
        "glUnmapBufferARB" } },  
    ...
    // framebuffer object gives us render-to-texture support, among other things
  {
    ...
    {
    "GL_EXT_framebuffer_object"}, 15,
    {
  "glIsRenderbufferEXT", "glBindRenderbufferEXT",
    ...
    // cube map support (for environment maps, normal maps, bump maps, etc.)
  {
    false, false, 2,
    {
    "GL_ARB_texture_cube_map", "GL_EXT_texture_cube_map"}, 0,
    {
  NULL}},  
    ...
    // point sprites (for particles)
  {
    false, false, 2,
    {
    "GL_ARB_point_sprite", "NV_point_sprite"}, 0,
    {
  NULL}},  
    ...
    // shader objects and program object management
  {
    ...
    {
    "GL_ARB_shader_objects"}, 17,
    {
  "glDeleteObjectARB", "glCreateShaderObjectARB", "glShaderSourceARB",
        "glCompileShaderARB", "glGetObjectParameterivARB",
        "glGetInfoLogARB", "glCreateProgramObjectARB",
        "glAttachObjectARB", "glLinkProgramARB", "glUseProgramObjectARB",
        "glValidateProgramARB", "glGetUniformLocationARB",
        "glGetUniformivARB", "glUniform1fARB", "glUniform3fARB",
        "glUniform1iARB", "glUniformMatrix4fvARB" } },  
    ...
    // shader version 3.0 detection extensions (if any of these extensions exist then we should have a SM3.0 compatible card, hopefully)
  {
    false, false, 3,
    {
    "GL_ARB_shader_texture_lod", "GL_NV_vertex_program3",
        "GL_ATI_shader_texture_lod"}, 0,
    {
NULL}} };
        ...
        
        {
            ...
            
            {
                ...
                
                {
                      ...
                      (ptr_u) GET_PROC_ADDRESS(func->function_name);
...
 void opengl_extensions_init() 
{
    ...
    Is_Extension_Enabled(OGL_EXT_TEXTURE_COMPRESSION_S3TC);
  Texture_compression_available =
    Is_Extension_Enabled(OGL_ARB_TEXTURE_COMPRESSION);
   
    //allow VBOs to be used
    if (!Cmdline_nohtl && !Cmdline_novbo
        && Is_Extension_Enabled(OGL_ARB_VERTEX_BUFFER_OBJECT))
    ...
    if (!
        (Is_Extension_Enabled(OGL_ARB_TEXTURE_CUBE_MAP)
         && Is_Extension_Enabled(OGL_ARB_TEXTURE_ENV_COMBINE)))
