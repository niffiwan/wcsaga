    ...
    static int *get_switch_int(feature fconf)
    {
      switch (fconf)
        ...
        case bloom_int:
          ...
          case env_map:return &Cmdline_env;
          case no_fbo:return &Cmdline_no_fbo;
          case glow:return &Cmdline_glow;
          case glsl:return &Use_GLSL;
          case height_map:return &Cmdline_height;
          case normal_map:return &Cmdline_normal;
          case post_process:return &Cmdline_postprocess;
          case specular:return &Cmdline_spec;
          default:mprintf(("ERROR: Unknown feature: 0x%x!\n", fconf));
          Int3();
 ...
 */
  ...
  protected:
	 ...
	 */
    GLhandleARB compile_object(const GLcharARB * shader_source,
                               GLenum shader_type);
	 ...
	 */
    GLhandleARB link_objects(GLhandleARB vertex_object,
 ...
 */
  ...
  public:
    ...
    enum uniform
    {
      ...
      main_shader(resources::text_file * v,
                  resources::text_file * f):shader(v, f)
    {
    }
    virtual ~ main_shader()
    {
...
*/
  ...
  public:
    ...
    enum uniform_classes
    {
      ...
      post_shader(resources::text_file * v,
                  resources::text_file * f):shader(v, f)
    {
    }
    virtual ~ post_shader()
	 ...
	 * @param tex texture instance
	 */
    void set_texture(unsigned int cls, unsigned int uni,
                     const opengl::texture * tex)
    {
      Assert(cls < unif_classes.size());
 ...
 */
  ...
  public:
      special_shader(int id, resources::text_file * v,
                     resources::text_file * f):shader(v, f), flags_id(id)
    {
    }
