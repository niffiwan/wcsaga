...
static opengl_shader_file_t GL_shader_file[] = {
...

  {
   ...
   "lbgse-f.sdr",
   (SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP |
    SDR_FLAG_SPEC_MAP | SDR_FLAG_ENV_MAP),
   7,
   {
    "sBasemap",
    "sGlowmap",
...

  {
   ...
   "lbgsnh-f.sdr",
   (SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP |
    SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
   6,
   {
    "sBasemap",
    "sGlowmap",
...

  {
   ...
   "lbgsne-f.sdr",
   (SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP |
    SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_ENV_MAP),
   8,
   {
    "sBasemap",
    "sGlowmap",
  ...
  if (itr == special_shaders.end())
    {
      ...
      bool r_vert =
        vert.open(special_shader::get_vert_name(flags).c_str(),
                  resources::text_file::shader_source);
      bool r_frag =
        frag.open(special_shader::get_frag_name(flags).c_str(),
                  resources::text_file::shader_source);
