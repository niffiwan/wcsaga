...
(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP),
                                                      ...
                                                      SDR_FLAG_SPEC_MAP), 3,
                                    {"sBasemap", "sSpecmap", "n_lights"} },
 {"le-v.sdr", "lbgse-f.sdr",
(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_ENV_MAP), 7, {"sBasemap", "sGlowmap",
                                                     "sSpecmap", "sEnvmap",
                                                     "envMatrix", "alpha_spec",
                                                     "n_lights"} },
 {"le-v.sdr", "lbse-f.sdr", (SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_ENV_MAP), 6,
{"sBasemap", "sSpecmap", "sEnvmap", "envMatrix", "alpha_spec", "n_lights"} },  {"ln-v.sdr", "lbgn-f.sdr",
                               (SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP |
                            SDR_FLAG_GLOW_MAP | SDR_FLAG_NORMAL_MAP), 4,
{"sBasemap", "sGlowmap", "sNormalmap", "n_lights"} },  {"ln-v.sdr", "lbgsn-f.sdr",
                                          (SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP |
                                       SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP |
                                       SDR_FLAG_NORMAL_MAP), 5, {"sBasemap",
                                                              "sGlowmap",
                                                              "sSpecmap",
                                                              "sNormalmap",
...
{"sBasemap", "sNormalmap", "n_lights"} },  {"ln-v.sdr", "lbsn-f.sdr",
(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP), 4,
{"sBasemap", "sSpecmap", "sNormalmap", "n_lights"} },  {"ln-v.sdr", "lbgnh-f.sdr",
                                                  (SDR_FLAG_LIGHT |
                                               SDR_FLAG_DIFFUSE_MAP |
                                               SDR_FLAG_GLOW_MAP |
                                               SDR_FLAG_NORMAL_MAP |
                                               SDR_FLAG_HEIGHT_MAP), 5,
                             {"sBasemap", "sGlowmap", "sNormalmap", "sHeightmap",
                          "n_lights"} },  {"ln-v.sdr", "lbgsnh-f.sdr",
                                          (SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP |
                                       SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP |
...
{"sBasemap", "sNormalmap", "sHeightmap", "n_lights"} },  {"ln-v.sdr", "lbsnh-f.sdr",
     (SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP |
SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP), 5, {"sBasemap", "sSpecmap",
                                           "sNormalmap", "sHeightmap",
                                           "n_lights"} },  {"lne-v.sdr",
                                                         "lbgsne-f.sdr",
                                                         (SDR_FLAG_LIGHT |
                                                    SDR_FLAG_DIFFUSE_MAP |
                                                    ...
                                                    SDR_FLAG_NORMAL_MAP |
                                                    SDR_FLAG_ENV_MAP), 8,
                                  {"sBasemap", "sGlowmap", "sSpecmap", "sNormalmap",
                             "sEnvmap", "envMatrix", "alpha_spec", "n_lights"} },
                                                       ...
                                                       SDR_FLAG_HEIGHT_MAP |
                                                       SDR_FLAG_ENV_MAP), 9,
                                     {"sBasemap", "sGlowmap", "sSpecmap",
                                "sNormalmap", "sHeightmap", "sEnvmap", "envMatrix",
                                "alpha_spec", "n_lights"} },  {"lne-v.sdr",
                                                            "lbsnhe-f.sdr",
                                                            (SDR_FLAG_LIGHT |
                                                       SDR_FLAG_DIFFUSE_MAP |
...
{"sBasemap", "sGlowmap", "sSpecmap", "n_lights"} },  {"lf-v.sdr", "lfbs-f.sdr",
                          ...
                          | SDR_FLAG_SPEC_MAP), 3, {"sBasemap", "sSpecmap",
                                               "n_lights"} },  {"lfe-v.sdr",
                                                        ...
                                                        SDR_FLAG_ENV_MAP), 7,
                                      {"sBasemap", "sGlowmap", "sSpecmap",
                                 "sEnvmap", "envMatrix", "alpha_spec",
                                 "n_lights"} },  {"lfe-v.sdr", "lfbse-f.sdr",
                                               (SDR_FLAG_LIGHT | SDR_FLAG_FOG |
                                          SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP |
                                          SDR_FLAG_ENV_MAP), 6, {"sBasemap",
                                                            "sSpecmap", "sEnvmap",
                                                            "envMatrix",
                                                            "alpha_spec",
                                                            "n_lights"} },
 {"lfn-v.sdr", "lfbgn-f.sdr", (SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_NORMAL_MAP), 4, {"sBasemap", "sGlowmap", "sNormalmap", "n_lights"} },  {"lfn-v.sdr", "lfbgsn-f.sdr",
                  (SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP |
             SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP), 5,
{"sBasemap", "sGlowmap", "sSpecmap", "sNormalmap", "n_lights"} },  {"lfn-v.sdr", "lfbn-f.sdr",
                      (SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP |
                 SDR_FLAG_NORMAL_MAP), 3, {"sBasemap", "sNormalmap",
                                      "n_lights"} },  {"lfn-v.sdr",
                                                    "lfbsn-f.sdr",
                                                    (SDR_FLAG_LIGHT | SDR_FLAG_FOG |
                                               SDR_FLAG_DIFFUSE_MAP |
              ...
              {"sBasemap", "sSpecmap", "sNormalmap", "n_lights"} },
                           ...
                           "sHeightmap", "n_lights"} },  {"lfn-v.sdr",
                                                  ...
                                                  SDR_FLAG_NORMAL_MAP |
                                                  SDR_FLAG_HEIGHT_MAP), 4,
                                {"sBasemap", "sNormalmap", "sHeightmap",
                           "n_lights"} },  {"lfn-v.sdr", "lfbsnh-f.sdr",
                                         (SDR_FLAG_LIGHT | SDR_FLAG_FOG |
                                    SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP |
                                    SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP), 5,
   {"sBasemap", "sSpecmap", "sNormalmap", "sHeightmap", "n_lights"} },
...
{"sGlowmap", "n_lights"} },  {"l-v.sdr", "lgs-f.sdr",
                     ...
                     {"sGlowmap", "sSpecmap", "n_lights"} },  {"l-v.sdr",
                                     ...
                                     {"sSpecmap", "n_lights"} },  {"le-v.sdr",
                                                           ...
                                                           SDR_FLAG_SPEC_MAP |
                                                           SDR_FLAG_ENV_MAP), 6,
                                         {"sGlowmap", "sSpecmap", "sEnvmap",
                                    "envMatrix", "alpha_spec", "n_lights"} },
...
{"sGlowmap", "sSpecmap", "sNormalmap", "sHeightmap", "sEnvmap", "envMatrix", "alpha_spec", "n_lights"} },  {"lne-v.sdr", "lsnhe-f.sdr",
(SDR_FLAG_LIGHT | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP | SDR_FLAG_ENV_MAP), 7, {"sSpecmap", "sNormalmap",
                                                  "sHeightmap", "sEnvmap",
                                                  "envMatrix", "alpha_spec",
                                                  "n_lights"} } 
};

 static const int Num_shader_files =
  sizeof(GL_shader_file) / sizeof(opengl_shader_file_t);
...
 text_file::text_file(const char *filename, txt_file_type ftype) 
{
    ...
    // open file
  CFILE * fp =
    cfopen(const_cast < char *>(filename), "rt", CFILE_NORMAL,
           get_cfile_type(ftype));
  ...
  int len = cfilelength(fp);
    ...
    // clean
    vm_free(bytes);
}  const SCP_string & text_file::read() const const 
{
...
{
  return cf_exists_full(const_cast < char *>(filename),
                         get_cfile_type(ftype)) !=0;
...
 opengl::shader::shader(resources::text_file * vert, resources::text_file * frag):last_texture(0),
shader_program(0)
...
 bool opengl::shader::compile_link() 
{
    ...
    
    {
        ...
        compile_object((const GLcharARB *) vert_src, GL_VERTEX_SHADER_ARB);
        ...
        compile_object((const GLcharARB *) frag_src, GL_FRAGMENT_SHADER_ARB);
    ...
    SCP_vector < SCP_string > uniform_names = get_uniform_names();
      ...
      push_back(vglGetUniformLocationARB
                (shader_program, uniform_names[i].c_str()));
   return true;
}

 GLhandleARB opengl::shader::compile_object(const GLcharARB * shader_source,
                                              GLenum shader_type) 
{
    ...
    vglGetObjectParameterivARB(shader_object, GL_OBJECT_COMPILE_STATUS_ARB,
                               &status);
    ...
    
    {
        ...
        mprintf(("%s shader failed to compile:\n%s\n",
                 (shader_type ==
                  GL_VERTEX_SHADER_ARB) ? "Vertex" : "Fragment",
                 info_log.c_str()));
    ...
    
    {
                ...
                (shader_type == GL_VERTEX_SHADER_ARB) ? "Vertex" : "Fragment",
                info_log.c_str()));
    }
   return shader_object;
}

 GLhandleARB opengl::shader::link_objects(GLhandleARB vertex_object,
                                            GLhandleARB fragment_object) 
{
    ...
    vglGetObjectParameterivARB(shader_object, GL_OBJECT_LINK_STATUS_ARB,
                               &status);
...
 SCP_string opengl::shader::check_info_log(GLhandleARB shader_object) 
{
  ...
  vglGetObjectParameterivARB(shader_object, GL_OBJECT_INFO_LOG_LENGTH_ARB,
                              &length);
...
 void opengl::shader::apply() 
{
    ...
    
    {
      ...
      vglGetObjectParameterivARB(shader_program,
                                  GL_OBJECT_VALIDATE_STATUS_ARB, &obj_status);
...
 void opengl::shader::set_uniformMatrix4f(unsigned int name,
                                            matrix4x4 matrix) 
{
...
{
  for (unsigned int i = 0; i < sizeof(uniform_names) / sizeof(const char *);
        i++)
...
{
  SCP_map < int, SCP_vector < SCP_string > >::iterator itr =
    uniforms.find(flags_id);
...
 void shader_manager::apply_main_shader(int flags) 
{
  ...
   SCP_map < int, main_shader * >::iterator itr =
    main_shaders_cache.find(flags);
...
 opengl::special_shader * shader_manager::apply_special_shader(int flags) 
{
  ...
   SCP_map < int, special_shader * >::iterator itr =
    special_shaders.find(flags);
    ...
    
    {
        ...
        new resources::text_file(special_shader::get_vert_name(flags).c_str(),
                                 resources::text_file::shader_source);
      resources::text_file * frag =
        new resources::text_file(special_shader::get_frag_name(flags).c_str(),
                                 resources::text_file::shader_source);
...
 void shader_manager::load_main_shaders() 
{
    ...
    bool main_vert =
    resources::text_file::file_exist("main-v.sdr",
                                     resources::text_file::shader_source) !=
    0;
  bool main_frag =
    resources::text_file::file_exist("main-f.sdr",
                                     resources::text_file::shader_source) !=
    0;
    ...
    
    {
        ...
        if (!config::is_enabled(config::glow)
            && (shader_file->flags & main_shader::flag_glow_map))
        continue;
       if (!config::is_enabled(config::specular)
             && (shader_file->flags & main_shader::flag_specular_map))
        continue;
       if (!config::is_enabled(config::env_map)
             && (shader_file->flags & main_shader::flag_env_map))
        continue;
       if (!config::is_enabled(config::normal_map)
             && (shader_file->flags & main_shader::flag_normal_map))
        continue;
       if (!config::is_enabled(config::height_map)
             && (shader_file->flags & main_shader::flag_height_map))
      ...
      char *vert_name;
        ...
        resources::text_file * vert =
        new resources::text_file(vert_name,
                                 resources::text_file::shader_source);
      resources::text_file * frag =
        new resources::text_file(frag_name,
                                 resources::text_file::shader_source);
...
 opengl::post_shader * shader_manager::load_post_shader(int flags) 
{
    ...
    // create new shader program
    resources::text_file * vert =
    new resources::text_file(vert_name, resources::text_file::shader_source);
  resources::text_file * frag =
    new resources::text_file(frag_name, resources::text_file::shader_source);
