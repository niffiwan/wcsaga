...
 int gr_stub_tcache_set(int bitmap_id, int bitmap_type, float *u_scale,
                          float *v_scale, int tex_unit = 0) 
{
...
{
}  void gr_stub_cross_fade(int bmap1, int bmap2, int x1, int y1, int x2,
                              int y2, float pct) 
{
...
{
}  void gr_stub_dump_frame_start(int first_frame,
...
{
}  void gr_stub_fog_set(int fog_mode, int r, int g, int b, float fog_near,
                           float fog_far) 
{
...
{
}  void gr_stub_render_buffer(int start, int n_prim, ushort * sbuffer,
...
{
}  void gr_stub_set_projection_matrix(float fov, float aspect,
...
{
}  void gr_stub_stuff_secondary_color(vertex * v, ubyte fr, ubyte fg,
                                         ubyte fb) 
{
...
// bitmap functions
int gr_stub_bm_load(ubyte type, int n, char *filename, CFILE * img_cfp,
...
 int gr_stub_bm_lock(char *filename, int handle, int bitmapnum, ubyte bpp,
                       ubyte flags) 
{
...
int gr_stub_bm_make_render_target(int n, int *width, int *height,
