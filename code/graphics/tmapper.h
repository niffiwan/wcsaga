...
{
bitmap_2d_list(int X = 0, int Y = 0, int W = -1, int H = -1):x(X), y(Y), w(W),
    h(H)
  {
  } int x;
...
{
texture_rect_list(float X = 0, float Y = 0, float W = 1.0f, float H = 1.0f):x(X), y(Y), w(W),
    h
    (H)
  {
  } float x;
...
 struct bitmap_rect_list 
{
                                                                     ...
                                                                     H)
  {
} bitmap_rect_list(int X = 0, int Y = 0, int W = -1, int H = -1, float TX = 0.0f, float TY = 0.0f, float TW = 1.0f, float TH = 1.0f):screen_rect(X, Y, W, H), texture_rect(TX, TY, TW,
                                        TH)
  {
