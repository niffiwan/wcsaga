...
/*************************************************************/ 
   ...
   WINGDIAPI void APIENTRY glColor3us(GLushort red, GLushort green,
                                       GLushort blue);
                                      ...
                                      GLshort blue, GLshort alpha);
   ...
    WINGDIAPI void APIENTRY glEvalMesh2(GLenum mode, GLint i1, GLint i2,
                                         GLint j1, GLint j2);
                                       ...
                                       GLdouble zNear, GLdouble zFar);
                                          ...
                                          GLint * params);
    WINGDIAPI void APIENTRY glGetMapdv(GLenum target, GLenum query,
                                        GLdouble * v);
    WINGDIAPI void APIENTRY glGetMapfv(GLenum target, GLenum query,
                                        GLfloat * v);
    WINGDIAPI void APIENTRY glGetMapiv(GLenum target, GLenum query,
                                        GLint * v);
                                    ...
                                    GLdouble zNear, GLdouble zFar);
                                     ...
                                     GLdouble y2);
                                      ...
                                      const GLdouble * v2);
   WINGDIAPI void APIENTRY glRectf(GLfloat x1, GLfloat y1, GLfloat x2,
                                    GLfloat y2);
   ...
   WINGDIAPI void APIENTRY glRects(GLshort x1, GLshort y1, GLshort x2,
                                    GLshort y2);
   ...
   WINGDIAPI void APIENTRY glVertex4f(GLfloat x, GLfloat y, GLfloat z,
                                       GLfloat w);
    WINGDIAPI void APIENTRY glVertex4fv(const GLfloat * v);
   WINGDIAPI void APIENTRY glVertex4i(GLint x, GLint y, GLint z, GLint w);
    WINGDIAPI void APIENTRY glVertex4iv(const GLint * v);
   WINGDIAPI void APIENTRY glVertex4s(GLshort x, GLshort y, GLshort z,
                                       GLshort w);
...
/* WIN_draw_range_elements */ 
  typedef void (APIENTRY * PFNGLDRAWRANGEELEMENTSWINPROC) (GLenum mode,
                                                           GLuint start,
                                                           GLuint end,
                                                           GLsizei count,
                                                           GLenum type,
