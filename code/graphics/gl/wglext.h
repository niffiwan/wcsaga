...
#define WGL_ARB_pbuffer 1
  ...
  typedef HPBUFFERARB(WINAPI * PFNWGLCREATEPBUFFERARBPROC) (HDC hDC,
                  ...
                  PFNWGLRELEASEPBUFFERDCARBPROC) (HPBUFFERARB hPbuffer,
                                                  HDC hDC);
...
#define WGL_ARB_render_texture 1
  ...
  typedef BOOL(WINAPI * PFNWGLBINDTEXIMAGEARBPROC) (HPBUFFERARB hPbuffer,
                 ...
                 PFNWGLSETPBUFFERATTRIBARBPROC) (HPBUFFERARB hPbuffer,
...
#define WGL_EXT_display_color_table 1
  ...
  typedef GLboolean(WINAPI *
                    PFNWGLCREATEDISPLAYCOLORTABLEEXTPROC) (GLushort id);
                       ...
                       PFNWGLLOADDISPLAYCOLORTABLEEXTPROC) (const GLushort *
                                                            table,
                                                            GLuint length);
...
#define WGL_EXT_pbuffer 1
  ...
  typedef HPBUFFEREXT(WINAPI * PFNWGLCREATEPBUFFEREXTPROC) (HDC hDC,
                  ...
                  PFNWGLRELEASEPBUFFERDCEXTPROC) (HPBUFFEREXT hPbuffer,
                                                  HDC hDC);
...
#define WGL_EXT_pixel_format 1
  ...
  extern BOOL WINAPI wglGetPixelFormatAttribivEXT(HDC, int, int, UINT, int *,
                                                  int *);
   extern BOOL WINAPI wglGetPixelFormatAttribfvEXT(HDC, int, int, UINT,
                                                    int *, FLOAT *);
...
#define WGL_OML_sync_control 1
  ...
  extern BOOL WINAPI wglGetSyncValuesOML(HDC, INT64 *, INT64 *, INT64 *);
                                        ...
                                        INT64 *, INT64 *);
    extern BOOL WINAPI wglWaitForSbcOML(HDC, INT64, INT64 *, INT64 *,
                                         INT64 *);
...
#define WGL_I3D_swap_frame_usage 1
  ...
  typedef BOOL(WINAPI * PFNWGLGETFRAMEUSAGEI3DPROC) (float *pUsage);
   ...
   typedef BOOL(WINAPI * PFNWGLQUERYFRAMETRACKINGI3DPROC) (DWORD *
                                                            pFrameCount,
                                                            DWORD *
                                                            pMissedFrames,
                                                            float
