...
}  void create_low_detail_poly(int global_index, vec3d * tcp,
                                  vec3d * rightv, vec3d * upv) 
{
  ...
   vm_vec_scale_add(&trip->verts[1].pos, &trip->verts[0].pos, rightv,
                      scale);
   vm_vec_scale_add(&trip->verts[2].pos, &trip->verts[1].pos, upv, -scale);
   vm_vec_scale_add(&trip->verts[3].pos, &trip->verts[2].pos, rightv,
                      -scale);
...
void create_shield_explosion_all(object * objp) 
{
    ...
    
    {
        ...
        
        {
                                   ...
                                   model_num, &objp->orient, &objp->pos,
...
void ship_draw_shield(object * objp) 
{
    ...
    
    {
        ...
        
        {
            ...
            (int) (Ships[objp->instance].shield_integrity[i] * 255);
