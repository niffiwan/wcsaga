...
 int num_ai_tgt_obj_flags =
  sizeof(ai_tgt_obj_flags) / sizeof(flag_def_list);
...
 int num_ai_tgt_ship_flags =
  sizeof(ai_tgt_ship_flags) / sizeof(flag_def_list);
...
 int num_ai_tgt_weapon_flags =
  sizeof(ai_tgt_weapon_flags) / sizeof(flag_def_list);
...
void parse_engine_wash(bool replace) 
{
    ...
    
    {
        ...
        
        {
                    ...
                    "More than one version of engine wash %s exists; using newer version.",
                    ewt.name));
        ...
        
        {
                 ...
                 "Error:  Engine wash %s already exists.  All engine wash names must be unique.",
                 ewt.name);
  ...
  int ship_id;
    ...
    
    {
        ...
        
        {
                   ...
                   "Error:  Ship name %s already exists in %s.  All ship class names must be unique.",
                   sip->name, filename);
    ...
    
    {
        ...
        
        {
                   ...
                   "Ships %s is a copy, but does not use the ship copy name extension.");
...
int parse_ship_template() 
{
  ...
  int template_id;
    ...
    
    {
               ...
               "Error:  Ship template %s already exists. All ship template names must be unique.",
               sip->name);
    ...
    
    {
               ...
               "Ship Template '%s' already exists, discarding duplicate...",
               sip->name);
...
int parse_ship_values(ship_info * sip, bool isTemplate, bool first_time,
                      bool replace) 
{
  ...
  find_and_stuff_optional("$Species:", &sip->species, F_NAME, tspecies_names,
                           Species_info.size(), "species names");
  ...
  int PLACEHOLDER_num_texture_replacements = 0;
    ...
    
    {
      ...
       while ((PLACEHOLDER_num_texture_replacements <
                 MAX_REPLACEMENT_TEXTURES) && (optional_string("+old:")))
    ...
    {
      sip->num_detail_levels =
        stuff_int_list(sip->detail_distance, MAX_SHIP_DETAIL_LEVELS,
                       RAW_INTEGER_TYPE);
    ...
    
    {
        ...
        
        {
                     ...
                     "Debris min lifetime on %s '%s' is below 0 and will be ignored",
        ...
        
        {
                     ...
                     "Debris max lifetime on %s '%s' is below 0 and will be ignored",
                     info_type_name, sip->name);
        ...
        
        {
                     ...
                     "Debris min speed on %s '%s' is below 0 and will be ignored",
                     info_type_name, sip->name);
        ...
        
        {
                     ...
                     "Debris max speed on %s '%s' is below 0 and will be ignored",
                     info_type_name, sip->name);
        ...
        
        {
                     ...
                     "Debris min hitpoints on %s '%s' is below 0 and will be ignored",
                     info_type_name, sip->name);
        ...
        
        {
                     ...
                     "Debris max hitpoints on %s '%s' is below 0 and will be ignored",
                     info_type_name, sip->name);
        ...
        
        {
                     ...
                     "Debris damage multiplier on %s '%s' is below 0 and will be ignored",
                     info_type_name, sip->name);
    ...
    
    {
        ...
        // div/0 safety check.
        if ((sip->rotation_time.xyz.x == 0) || (sip->rotation_time.xyz.y == 0)
            || (sip->rotation_time.xyz.z == 0))
    ...
    
    {
        ...
        
        {
                   ...
                   "Invalid warpin type '%s' specified for ship '%s'", buf,
                   sip->name);
    ...
    
    {
        ...
        
        {
                   ...
                   "Warp-in time specified as 0 or less on ship '%s'; value ignored",
                   sip->name);
    ...
    
    {
        ...
        
        {
                   ...
                   "Warp-in radius specified as 0 or less on ship '%s'; value ignored",
                   sip->name);
    ...
    
    {
        ...
        
        {
                   ...
                   "Invalid warpout type '%s' specified for ship '%s'", buf,
                   sip->name);
    ...
    
    {
        ...
        
        {
                   ...
                   "Warp-out time specified as 0 or less on ship '%s'; value ignored",
                   sip->name);
    ...
    
    {
        ...
        
        {
                   ...
                   "Warp-out radius specified as 0 or less on ship '%s'; value ignored",
                   sip->name);
    ...
    
    {
        ...
        
        {
                   ...
                   "$Vaporize Percent Chance should be between 0 and 100.0 (read %f). Setting to 0.",
                   sip->vaporize_chance);
    ...
    
    {
      ...
      sip->explosion_bitmap_anims.insert(sip->explosion_bitmap_anims.begin(),
                                          temp, temp + parsed_ints);
  ...
  int bank;
    ...
    
    {
        ...
        
        {
            ...
            stuff_int_list(allowed_weapons, MAX_WEAPON_TYPES,
                           WEAPON_LIST_TYPE);
            ...
            
            {
              if (allowed_weapons[i] >= 0)     // MK, Bug fix, 9/6/99.  Used to be "allowed_weapons" not "allowed_weapons[i]".
                {
                    ...
                    allowed_bank_restricted_weapons[bank][allowed_weapons[i]]
                    |= REGULAR_WEAPON;
    ...
    
    {
      ...
      sip->num_primary_banks =
        stuff_int_list(sip->primary_bank_weapons, MAX_SHIP_PRIMARY_BANKS,
                       WEAPON_LIST_TYPE);
        ...
        {
          Assertion((sip->primary_bank_weapons[i] >= 0),
                     "%s. No $Default PBanks supplied for bank %d",
                     parse_error_text, i);
    ...
    
    {
      ...
      pbank_capacity_count =
        stuff_int_list(sip->primary_bank_ammo_capacity,
                       MAX_SHIP_PRIMARY_BANKS, RAW_INTEGER_TYPE);
    ...
    
    {
        ...
        
        {
            ...
            
            {
              if (allowed_weapons[i] >= 0)     // MK, Bug fix, 9/6/99.  Used to be "allowed_weapons" not "allowed_weapons[i]".
                {
                    ...
                    allowed_bank_restricted_weapons[MAX_SHIP_PRIMARY_BANKS +
                                                    bank][allowed_weapons[i]]
                    |= REGULAR_WEAPON;
        ...
        if (bank > 0)           // meaning there was a restricted bank table entry
        {
            ...
            {
              sip->restricted_loadout_flag[MAX_SHIP_PRIMARY_BANKS + i] |=
                REGULAR_WEAPON;
    ...
    
    {
        ...
        stuff_int_list(sip->secondary_bank_weapons, MAX_SHIP_SECONDARY_BANKS,
                       WEAPON_LIST_TYPE);
        ...
        
        {
            ...
            
            {
                       ...
                       "%s has no secondary weapons, this cannot be!",
                       sip->name);
      ...
      sbank_capacity_count =
        stuff_int_list(sip->secondary_bank_ammo_capacity,
                       MAX_SHIP_SECONDARY_BANKS, RAW_INTEGER_TYPE);
    ...
    
    {
        ...
        
        {
                   ...
                   "Max hull strength on ship %s cannot be less than 0.  Defaulting to 100.\n",
    ...
    
    {
                 ...
                 "Invalid armor name %s specified for hull in ship class %s",
                 buf, sip->name);
    ...
    
    {
                 ...
                 "Invalid armor name %s specified for shield in ship class %s",
                 buf, sip->name);
          ...
          char *ship_type = ship_strings[i];
            ...
            
            {
                ...
                
                {
                             ...
                             "Use of '%s' flag for ship '%s' - this flag is no longer needed.",
    ...
    
    {
             ...
             "Ship Class %s has too many primary banks (%d).  Maximum for ships is currently %d.\n",
    ...
    
    {
        ...
        
        {
               ...
               && (Weapon_info[j].wi_flags2 & WIF2_BALLISTIC))
  ...
   find_and_stuff_optional("$AI Class:", &sip->ai_class, F_NAME,
                             Ai_class_names, Num_ai_classes,
                             "AI class names");
  ...
  int has_afterburner = 0;
    ...
    
    {
        ...
        
        {
          ...
          stuff_string(sip->afterburner_trail.filename, F_NAME,
                        MAX_FILENAME_LEN);
        ...
        
        {
                 ...
                 "Ship %s entry has $Trails field specified, but no properties given.",
                 sip->name);
    ...
    
    {
        ...
        
        {
                   ...
                   "Could not find weapon type '%s' to use as countermeasure on ship class '%s'",
                   sip->name);
        ...
        
        {
                   ...
                   "Attempt made to set a beam weapon as a countermeasure on ship class '%s'",
                   sip->name);
    ...
    
    {
               ...
               "formatting error in the thruster's particle section for ship %s\n",
               sip->name);
    ...
    
    {
        ...
        {
          Warning(LOCATION, "%s has more contrails than the max of %d",
                   sip->name, MAX_SHIP_CONTRAILS);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                       ...
                       "Too many maneuvering thrusters on ship '%s'; maximum is %d",
                       sip->name, MAX_MAN_THRUSTERS);
        ...
        
        {
                   ...
                   "Invalid index (%d) specified for maneuvering thruster on ship %s",
                   idx, sip->name);
        ...
        
        {
            ...
            bm_load_animation(name_tmp, &tex_nframes, &tex_fps, NULL, 1);
    ...
    
    {
        ...
        iff_init_color(iff_color_data[0], iff_color_data[1],
                       iff_color_data[2]);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                   ...
                   (target_group_strings[j].c_str(), Ai_tp_list[i].name))
          ...
          
          {
              ...
              
              {
                  ...
                  
                  {
                             ...
                             sip->name, sip->n_subsystems, n_subsystems,
                ...
                memset(sp->alt_dmg_sub_name, 0,
                        sizeof(sp->alt_dmg_sub_name));
              ...
              
              {
                ...
                stuff_int_list(sp->primary_banks, MAX_SHIP_PRIMARY_BANKS,
                                WEAPON_LIST_TYPE);
              ...
              
              {
                ...
                stuff_int_list(sp->primary_bank_capacity,
                                MAX_SHIP_PRIMARY_BANKS, RAW_INTEGER_TYPE);
              ...
              
              {
                ...
                stuff_int_list(sp->secondary_banks, MAX_SHIP_SECONDARY_BANKS,
                                WEAPON_LIST_TYPE);
              ...
              
              {
                ...
                stuff_int_list(sp->secondary_bank_capacity,
                                MAX_SHIP_SECONDARY_BANKS, RAW_INTEGER_TYPE);
            ...
            parse_sound("$Turret Base RotationSnd:",
                         &sp->turret_base_rotation_snd, sp->subobj_name);
            parse_sound("$Turret Gun RotationSnd:",
                         &sp->turret_gun_rotation_snd, sp->subobj_name);
              ...
              
              {
                  ...
                  
                  {
                      ...
                      
                      {
                             ...
                             (Ai_tp_list[j].name, tgt_priorities[i].c_str()))
              ...
              {
                parse_string_flag_list((int *) &sp->flags, Subsystem_flags,
                                        Num_subsystem_flags);
            ...
             if ((sp->flags & MSS_FLAG_TURRET_FIXED_FP)
                   && !(sp->flags & MSS_FLAG_USE_MULTIPLE_GUNS))
              ...
              
              {
                  ...
                  
                  {
                      ...
                      (queued_animation *) vm_realloc(sp->triggers,
                      ...
                      
                      {
                          ...
                          
                          {
                              ...
                              fl_radian(current_trigger->angle.xyz.x);
                            current_trigger->angle.xyz.y =
                              fl_radian(current_trigger->angle.xyz.y);
                            current_trigger->angle.xyz.y =
                              fl_radian(current_trigger->angle.xyz.z);
                          ...
                          
                          {
                              ...
                              fl_radian(current_trigger->vel.xyz.x);
                            current_trigger->vel.xyz.y =
                              fl_radian(current_trigger->vel.xyz.y);
                            current_trigger->vel.xyz.z =
                              fl_radian(current_trigger->vel.xyz.z);
                          ...
                          
                          {
                              ...
                              fl_radian(current_trigger->accel.xyz.x);
                            current_trigger->accel.xyz.y =
                              fl_radian(current_trigger->accel.xyz.y);
                            current_trigger->accel.xyz.z =
                              fl_radian(current_trigger->accel.xyz.z);
  ...
  int orig_n_subsystems = sip->n_subsystems;
    ...
    
    {
        ...
        
        {
            ...
            (model_subsystem *) vm_malloc(sizeof(model_subsystem) *
                                          sip->n_subsystems);
        ...
        
        {
            ...
            (model_subsystem *) vm_realloc(sip->subsystems,
                                           sizeof(model_subsystem) *
                                           sip->n_subsystems);
...
 void parse_ship_type() 
{
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    //find the index number of the current ship info type
                    Ai_tp_list[i].ship_type.
                    push_back(ship_type_name_lookup(name_buf));
    ...
    
    {
        ...
        {
          parse_string_flag_list(&stp->ai_valid_goals, Ai_goal_names,
                                  Num_ai_goals);
        ...
        {
          parse_string_flag_list(&stp->ai_player_orders, Player_orders,
                                  Num_player_orders);
        ...
        {
          parse_string_flag_list(&stp->ai_active_dock, Dock_type_names,
                                  Num_dock_type_names);
        }
       if (optional_string("+Passive docks:"))
        
        {
          parse_string_flag_list(&stp->ai_passive_dock, Dock_type_names,
                                  Num_dock_type_names);
    ...
    
    {
      ...
      stp->explosion_bitmap_anims.insert(stp->explosion_bitmap_anims.begin(),
                                          temp, temp + parsed_ints);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                ship_type_name_lookup((char *) stp->
                                      ai_actively_pursues_temp[j].c_str());
        ...
        //ships.tbl
      {
          ...
          tspecies_names =
          (char **) vm_malloc(Species_info.size() * sizeof(char *));
...
 static int ship_allocate_subsystems(int num_so, bool page_in = false) 
{
  ...
   mprintf(("Allocating space for at least %i new ship subsystems ... ",
              num_so));
    ...
    
    {
        ...
        (ship_subsys *) vm_malloc(sizeof(ship_subsys) *
                                  NUM_SHIP_SUBSYSTEMS_PER_SET);
      memset(Ship_subsystems[idx], 0,
              sizeof(ship_subsys) * NUM_SHIP_SUBSYSTEMS_PER_SET);
...
  void physics_ship_init(object * objp) 
{
    ...
    
    {
      ...
      Warning(LOCATION, "%s (%s) has no mass! setting to %f", sinfo->name,
    ...
    
    {
                ...
                pm->filename));
      Warning(LOCATION, "%s (%s) has a null moment of inertia!", sinfo->name,
               sinfo->pof_file);
    ...
    pi->glide_cap = sinfo->glide_cap;
      ...
      MAX(MAX(pi->max_vel.xyz.z, sinfo->max_overclocked_speed),
    ...
    ((The_mission.ai_profile->flags & AIPF_USE_NEWTONIAN_DAMPENING) != 0);
  ...
  shipp->current_max_speed = Ship_info[ship_type].max_speed;
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                fl2i(sip->primary_bank_ammo_capacity[i] / weapon_size + 0.5f);
    ...
    
    {
        ...
        
        {
            ...
            fl2i(sip->secondary_bank_ammo_capacity[i] / weapon_size + 0.5f);
    ...
    
    {
               ...
               "Unable to allocate ship subsystems. Maximum is %d. No subsystems have been assigned to %s.",
    ...
    
    {
        ...
        
        {
            ...
            1.0f / Weapon_info[swp->secondary_bank_weapons[i]].fire_wait;
...
void ship_recalc_subsys_strength(ship * shipp) 
{
    ...
    
    {
        ...
        
        {
            ...
            {
              obj_snd_delete_type(shipp->objnum,
                                   ship_system->system_info->dead_snd,
                                   ship_system);
            ...
            {
              obj_snd_assign(shipp->objnum,
                              ship_system->system_info->alive_snd,
            ...
            
            {
                ...
                
                {
                                  ...
                                  ship_system->system_info->
                                  turret_gun_rotation_snd,
                                  &ship_system->system_info->pnt, 0,
                                  OS_TURRET_GUN_ROTATION, ship_system);
                  ship_system->subsys_snd_flags |= SSSF_TURRET_ROTATION;
                }
            }
          if ((ship_system->system_info->flags & MSS_FLAG_ROTATES)
               && (ship_system->system_info->rotation_snd != -1)
               && !(ship_system->subsys_snd_flags & SSSF_ROTATE))
            
            {
              obj_snd_assign(shipp->objnum,
                              ship_system->system_info->rotation_snd,
                              &ship_system->system_info->pnt, 0,
        ...
        
        {
            ...
            
            {
                                   ...
                                   ship_system->system_info->
                                   turret_base_rotation_snd, ship_system);
              obj_snd_delete_type(shipp->objnum,
                                   ship_system->system_info->
                                   turret_gun_rotation_snd, ship_system);
    ...
    
    {
      ...
      ship_reset_disabled_physics(&Objects[shipp->objnum],
...
int subsys_set(int objnum, int ignore_subsys_info) 
{
    ...
    
    {
      ...
      list_append(&shipp->subsys_list, ship_system);    // link the element into the ship
        ...
        {
          strcpy_s(ship_system->sub_name,
                    ship_system->system_info->alt_sub_name);
      ...
      ship_system->turret_last_fire_direction = model_system->turret_norm;
        ...
         if ((ship_system->system_info->flags & MSS_FLAG_TURRET_SALVO)
               && (ship_system->system_info->
                   flags & MSS_FLAG_TURRET_FIXED_FP))
      ...
       if ((ship_system->system_info->flags & MSS_FLAG_TURRET_FIXED_FP)
             && (model_system->turret_num_firing_points < 2))
        
        {
             ...
             && (ship_system->system_info->
                 flags & MSS_FLAG_USE_MULTIPLE_GUNS))
        ...
        
        {
            ...
            (Fred_running ? 100 : ship_system->weapons.
      ...
      ship_system->system_info->model_decal_system.max_decals =
        shipp->ship_decal_system.max_decals / 10;
       
        // turn_rate, turn_accel
        // model_set_instance_info
      float turn_accel = 0.5f;
      model_set_instance_info(&ship_system->submodel_info_1,
                               model_system->turn_rate, turn_accel);
...
void batch_render_man_thrusters() 
{
    ...
    
    {
      ...
      gr_set_bitmap(mtr->bmap_id, GR_ALPHABLEND_FILTER,
                     GR_BITBLT_MODE_NORMAL, 1.0f);
       mtr->man_batcher.
        render(TMAP_FLAG_GOURAUD | TMAP_FLAG_RGB | TMAP_FLAG_TEXTURED |
...
void ship_render(object * obj) 
{
    ...
    vec3d temp, target;
       ...
       &&
       (Ship_info
        [Ships[Objects[aip->target_objnum].instance].ship_info_index].
        flags & (SIF_SUPERCAP | SIF_CAPITAL | SIF_CRUISER)))
    
    {
      vm_vec_unrotate(&temp, &aip->big_attack_point,
                       &Objects[aip->target_objnum].orient);
    ...
    
    {
        ...
        
        {
          ...
           vm_vec_scale_add(&v, &obj->phys_info.vel, &obj->orient.vec.fvec,
                              3.0f);
        ...
        
        {
          ...
           gr_set_proj_matrix(Proj_fov, gr_screen.clip_aspect, 0.05f,
                                Max_draw_distance);
    ...
    dock_evaluate_all_docked_objects(obj, &dfi,
                                     ship_find_warping_ship_helper);
    ...
    
    {
        ...
        ((warp_shipp->flags & SF_ARRIVING_STAGE_1) > 0);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    model_add_arc(sip->model_num, -1, &shipp->arc_pts[i][0],
        ...
        
        {
            ...
            
            {
              ...
              else if (pi->desired_rotvel.xyz.x > 0
                       && (mtp->use_flags & MT_PITCH_DOWN))
              ...
              else if (pi->desired_rotvel.xyz.y < 0
                       && (mtp->use_flags & MT_ROLL_RIGHT))
              ...
              else if (pi->desired_rotvel.xyz.z < 0
                       && (mtp->use_flags & MT_BANK_RIGHT))
              ...
               if (pi->flags & PF_GLIDING)    //Backslash - show thrusters according to thrust amount, not speed
                {
                       ...
                       && (mtp->use_flags & MT_SLIDE_RIGHT))
                    
                    {
                      render_amount = pi->side_thrust;
                    }
                  
                  else if (pi->side_thrust < 0
                           && (mtp->use_flags & MT_SLIDE_LEFT))
                    
                    {
                      render_amount = -pi->side_thrust;
                    }
                  
                  else if (pi->vert_thrust > 0
                           && (mtp->use_flags & MT_SLIDE_UP))
                    
                    {
                           ...
                           && (mtp->use_flags & MT_SLIDE_DOWN))
                    
                    {
                      render_amount = -pi->vert_thrust;
                    }
                  
                  else if (pi->forward_thrust > 0
                           && (mtp->use_flags & MT_FORWARD))
              ...
              else              // because it looks more realistic, but I don't think the AI uses side_thrust or vert_thrust
                {
                    ...
                    
                    {
                        ...
                        fl_abs(des_vel.xyz.x) / pi->max_vel.xyz.x;
                    }
                  
                  else if (des_vel.xyz.x < 0
                           && (mtp->use_flags & MT_SLIDE_LEFT))
                  ...
                  else if (des_vel.xyz.y > 0
                           && (mtp->use_flags & MT_SLIDE_UP))
                    
                    {
                      render_amount =
                        fl_abs(des_vel.xyz.y) / pi->max_vel.xyz.y;
                    ...
                    
                    {
                        ...
                        fl_abs(des_vel.xyz.z) / pi->max_vel.xyz.z;
                ...
                
                {
                    ...
                    
                    {
                        ...
                        snd_play_3d(&Snds[mtp->start_snd], &mtp->pos,
                                     &Eye_position, 0.0f,
                                     &obj->phys_info.vel);
                    ...
                    if (mtp->loop_snd >= 0 
                        ...
                        &&(mtp->start_snd < 0
                           || (snd_get_duration(mtp->start_snd) <
                               timestamp() - shipp->thrusters_start[i])) )
                    
                    {
                      shipp->thrusters_sounds[i] =
                        obj_snd_assign(OBJ_INDEX(obj), mtp->loop_snd,
                                       &mtp->pos, 1);
                    ...
                    
                    {
                        ...
                        //End
                        vm_vec_scale_add(&tmpend, &mtp->pos, &mtp->norm,
                                         len * render_amount);
                        ...
                        fx_batcher.draw_beam(&start, &end, rad, 1.0f);
                          ...
                          (int) (((float)
                                  (timestamp() -
                                   shipp->thrusters_start[i]) / 1000.0f) *
                                 (float) mtp->tex_fps) % mtp->tex_nframes;
                ...
                
                {
                    ...
                    
                    {
                      ...
                       snd_play_3d(&Snds[mtp->stop_snd], &mtp->pos,
                                     &Eye_position, 0.0f,
                                     &obj->phys_info.vel);
            ...
            
            {
              ...
              mst.secondary_glow_bitmap =
                shipp->thruster_secondary_glow_bitmap;
              mst.tertiary_glow_bitmap =
                shipp->thruster_tertiary_glow_bitmap;
              ...
              mst.secondary_glow_rad_factor =
                sip->thruster02_glow_rad_factor;
          ...
          int clip_started = 0;
            ...
            
            {
              ...
              int np_index = multi_find_player_by_object(obj);
                ...
                {
                  model_set_insignia_bitmap(Net_players[np_index].m_player->
                                             insignia_texture);
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        {
                          model_set_insignia_bitmap(Wings[shipp->wingnum].
                                                     wing_insignia_texture);
                ...
                
                {
                    ...
                    
                    {
                        ...
                        model_get(Weapon_info[swp->primary_bank_weapons[i]].
                                  external_model_num);
                      pm->gun_submodel_rotation =
                        shipp->primary_rotate_ang[i];
                      model_render(Weapon_info[swp->primary_bank_weapons[i]].
                                    external_model_num, &vmd_identity_matrix,
                                    &bank->pnt[k], render_flags);
              ...
              int num_secondaries_rendered = 0;
                ...
                
                {
                    ...
                    
                    {
                             ...
                             shipp->weapons.secondary_bank_ammo[i])
                      ...
                       vm_vec_scale_add2(&secondary_weapon_pos,
                                           &vmd_z_vector,
                                           -(1.0f -
                                             shipp->
                                             secondary_point_reload_pct[i][k])
                                           *
                                           model_get(Weapon_info
                                                     [swp->
                                      ...
                                      [swp->secondary_bank_weapons[i]].
                                      external_model_num,
                                      &vmd_identity_matrix,
                                      &secondary_weapon_pos, render_flags);
            ...
            
            {
              ...
              float fog_val = neb2_get_fog_intensity(obj);
                ...
                
                {
                  ...
                  model_render(sip->model_num, &obj->orient, &obj->pos,
                                render_flags | MR_LOCK_DETAIL, OBJ_INDEX(obj),
                                -1, shipp->ship_replacement_textures);
        ...
        
        {
          ...
           gr_set_proj_matrix(Proj_fov, gr_screen.clip_aspect,
...
 void ship_render_cockpit(object * objp) 
{
    ...
    
    {
        ...
        //gr_end_proj_matrix();
        //gr_end_view_matrix();
        gr_set_proj_matrix(Proj_fov, gr_screen.clip_aspect, 0.02f,
                            10.0f * pm->rad);
  ...
  int saved_zbuffer_mode = gr_zbuffer_get();
    ...
    model_render(sip->cockpit_model_num, &eye_ori, &pos,
                 MR_LOCK_DETAIL | MR_NO_FOGGING /*| MR_NO_LIGHTING */ , -1,
                 -1);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                mission_log_add_entry(LOG_WING_DESTROYED, wingp->name, NULL,
                                      team);
            ...
            
            {
                ...
                mission_log_add_entry(LOG_WING_DEPARTED, wingp->name, NULL,
                                      team);
...
void ship_actually_depart_helper(object * objp, dock_function_info * infop) 
{
    ...
    ship_cleanup(objp->instance,
                  infop->parameter_variables.
                  bool_value ? SHIP_VANISHED : SHIP_DEPARTED);
...
void ship_actually_depart(int shipnum, int method) 
{
  ...
  dock_evaluate_all_docked_objects(&Objects[Ships[shipnum].objnum], &dfi,
                                    ship_actually_depart_helper);
...
void ship_cleanup(int shipnum, int cleanup_mode) 
{
  ...
  Assert(cleanup_mode == SHIP_DESTROYED || cleanup_mode == SHIP_DEPARTED
    ...
    
    {
        ...
        mission_log_add_entry(LOG_SHIP_DEPARTED, shipp->ship_name,
                               jnp->get_name_ptr(), shipp->wingnum);
      
      else
        mission_log_add_entry(LOG_SHIP_DEPARTED, shipp->ship_name, NULL,
                               shipp->wingnum);
    ...
    
    {
        ...
        {
          hud_set_wingman_status_departed(shipp->wing_status_wing_index,
                                           shipp->wing_status_wing_pos);
...
//
int ship_explode_area_calc_damage(vec3d * pos1, vec3d * pos2, float inner_rad,
                                  float outer_rad, float max_damage,
                                  float max_blast, float *damage,
                                  float *blast) 
{
...
void ship_blow_up_area_apply_blast(object * exp_objp) 
{
    ...
    
    {
           ...
           && (Ai_info[Ships[exp_objp->instance].ai_index].
               ai_flags & AIF_KAMIKAZE) && (shipp->special_exp_index < 0))
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                (float) atoi(Sexp_variables[start + SHOCK_SPEED].text);
    ...
    
    {
        ...
        
        {
            ...
            
            {
              ...
              ship_apply_global_damage(objp, exp_objp, &exp_objp->pos,
                                        damage);
...
void do_dying_undock_physics(object * dying_objp, ship * dying_shipp) 
{
    ...
    
    {
      ...
      float docked_mass =
        ...
        ship_apply_global_damage(docked_objp, dying_objp, &dying_objp->pos,
                                 damage);
        ...
        impulse_mag =
        50.f * docked_objp->phys_info.mass * dying_objp->phys_info.mass /
        docked_mass;
        ...
        physics_apply_whack(&impulse_vec, &pos, &docked_objp->phys_info,
                            &docked_objp->orient,
      ...
      physics_apply_whack(&impulse_vec, &pos, &dying_objp->phys_info,
                           &dying_objp->orient, dying_objp->phys_info.mass);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                submodel_get_two_random_points(pm->id, pm->detail[0], &pnt1,
                                               &pnt2);
               
                //  vm_vec_avg( &tmp, &pnt1, &pnt2 ); [KNOSSOS get random in plane 1/1.414 in rad
                model_find_world_point(&outpnt, &pnt1, sip->model_num,
                                       pm->detail[0], &objp->orient,
                                       &objp->pos);
              ...
              fireball_create(&outpnt, fireball_type,
                               FIREBALL_LARGE_EXPLOSION, OBJ_INDEX(objp), rad,
        ...
        
        {
            ...
            
            {
              ...
              vm_vec_rand_vec_quick(&rand_vec);
                ...
                -vm_vec_dotprod(&objp->orient.vec.fvec,
                                &rand_vec) * (0.9f + 0.2f * frand());
        ...
        
        {
          ...
          shipp->pre_death_explosion_happened = 1;      // Mark this event as having occurred
            ...
            
            {
              ...
              model_find_world_point(&outpnt, &tmp, pm->id, pm->detail[0],
                ...
                
                {
                               ...
                               FIREBALL_MEDIUM_EXPLOSION, OBJ_INDEX(objp),
                               rad, 0, &objp->phys_info.vel);
          ...
          pe.max_rad = 1.5f;    // Max radius
            ...
            
            {
              ...
              float big_rad;
                ...
                fireball_create(&objp->pos, fireball_type,
                                FIREBALL_LARGE_EXPLOSION, OBJ_INDEX(objp),
...
 void ship_chase_shield_energy_targets(ship * shipp, object * obj,
                                         float frametime) 
{
    ...
    frametime * ETS_RECHARGE_RATE * shipp->ship_max_shield_strength / 100.0f;
...
void ship_init_thrusters() 
{
    ...
    
    {
        ...
        // Bobboau's extra thruster stuff
      {
        ...
        generic_bitmap_load(&species->thruster_secondary_glow_info.
                             afterburn);
...
void ship_do_thruster_frame(ship * shipp, object * objp, float frametime) 
{
    ...
    
    {
        ...
        fl2i((shipp->thruster_frame * flame_anim->num_frames) /
             flame_anim->total_time);
    ...
    
    {
        ...
        fl2i((shipp->thruster_glow_frame * glow_anim->num_frames) /
             glow_anim->total_time);
                                   ...
                                   float frametime) 
{
    ...
    
    {
        ...
        fl2i((weaponp->thruster_frame * flame_anim->num_frames) /
             flame_anim->total_time);
    ...
    
    {
        ...
        fl2i((weaponp->thruster_glow_frame * glow_anim->num_frames) /
             glow_anim->total_time);
...
void ship_auto_repair_frame(int shipnum, float frametime) 
{
    ...
    
    {
        ...
        
        {
            ...
            ssip->total_hits * real_repair_rate * frametime;
...
void ship_check_player_distance_sub(player * p, int multi_target = -1) 
{
    ...
    vm_vec_dist_quick(&Objects[p->objnum].pos, &vmd_zero_vector);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    // if bad, blow him up
                    ship_check_player_distance_sub(Net_players[idx].m_player,
                                                   idx);
        ...
        
        {
            ...
            
            {
              ...
              int num_turrets_attacking(object * turret_parent,
                ...
                num_turrets_attacking(&Objects[aip->target_objnum],
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                get_max_ammo_count_for_bank(shipp->ship_info_index, i,
                                            shipp->weapons.
                                            secondary_bank_weapons[i]);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    get_max_ammo_count_for_primary_bank(shipp->
                                                        ship_info_index, i,
                                                        shipp->weapons.
  ...
  void engine_wash_ship_process(ship * shipp);
    ...
    
    {
        ...
        shipfx_warpout_frame(obj, frametime);
          ...
          || (Ai_info[shipp->ai_index].mode ==
              AIM_BAY_EMERGE)  ||((sip->warpin_type == WT_IN_PLACE_ANIM)
                                   && (shipp->
                                       flags & SF_ARRIVING_STAGE_2))) 
    ...
    
    {
      ...
      void turret_swarm_maybe_fire_missile(int num);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                       ...
                       (obj->radius +
                        Objects[aip->support_ship_objnum].radius) * 1.25f)
        ...
        if ((Ships[num].ai_index >= 0)
            && (!(obj->flags & OF_PLAYER_SHIP) || Player_use_ai))
...
void ship_set_default_weapons(ship * shipp, ship_info * sip) 
{
    ...
    
    {
        ...
        
        {
            ...
            }  swp->primary_bank_capacity[i] =
            sip->primary_bank_ammo_capacity[i];
...
int ship_check_collision_fast(object * obj, object * other_obj,
                              vec3d * hitpos) 
{
...
//  -1 means failed.
int ship_create(matrix * orient, vec3d * pos, int ship_type,
                char *ship_name) 
{
  ...
  if (strlen(sip->cockpit_pof_file))
    ...
    
    {
      ...
      int idx;
        ...
        
        {
            ...
            {
              Ship_info[idx].model_num =
                model_load(Ship_info[idx].pof_file,
                           Ship_info[idx].n_subsystems,
    ...
    
    {
        ...
        obj_create(OBJ_SHIP, -1, n, orient, pos,
                   model_get_radius(sip->model_num), OF_RENDERS | OF_PHYSICS);
...
void change_ship_type(int n, int ship_type, int by_sexp) 
{
    ...
    
    {
        ...
        
        {
            ...
            shield_get_strength(objp) / sp->ship_max_shield_strength;
        ...
        
        {
            ...
            Ship_info[sp->ship_info_index].max_shield_strength;
    ...
    
    {
      ...
      if ((p_objp->flags2 & P2_OF_FORCE_SHIELDS_ON)
      ...
      else if ((p_objp->flags & P_OF_NO_SHIELDS)
               || (sp->ship_max_shield_strength == 0.0f))
      ...
      else if (!(sip_orig->flags2 & SIF2_INTRINSIC_NO_SHIELDS)
    ...
    
    {
        ...
        
        {
            ...
            (float)
            atoi(Sexp_variables[sp->special_hitpoint_index + HULL_STRENGTH].
                 text);
    ...
    
    {
        ...
        {
          sp->ship_max_shield_strength =
            (float)
            atoi(Sexp_variables[sp->special_hitpoint_index + SHIELD_STRENGTH].
                 text);
    ...
    MAX(0, sip->cmeasure_max - (sip_orig->cmeasure_max - sp->cmeasure_count));
...
int ship_launch_countermeasure(object * objp, int rand_val) 
{
  ...
  if (Weapon_energy_cheat)
        ...
        
        {
            ...
            
            {
                ...
                HUD_sourced_printf(HUD_SOURCE_HIDDEN,
                                   XSTR("Not equipped with countermeasures",
                                        -1));
            ...
            
            {
                ...
                //TODO: multi-lingual support
                HUD_sourced_printf(HUD_SOURCE_HIDDEN,
                                   XSTR("No countermeasures selected", -1));
            ...
            
            {
                                  ...
                                  XSTR("No more countermeasure charges.",
                                       485));
    ...
    cobjnum =
    weapon_create(&pos, &objp->orient, shipp->current_cmeasure,
                  OBJ_INDEX(objp));
    ...
    
    {
        ...
        {
          snd_play_3d(&Snds[Weapon_info[shipp->current_cmeasure].launch_snd],
                       &pos, &View_position);
        ...
        {
          send_NEW_countermeasure_fired_packet(objp, cmeasure_count,
                                                /*arand */
                                                Objects[cobjnum].
                                                net_signature);
...
int ship_fire_primary(object * obj, int stream_weapons, int force) 
{
  ...
  int num_primary_banks;
    ...
    
    {
        ...
        if ((winfo_p->wi_flags & WIF_BEAM) && (winfo_p->tag_level == 3)
      ...
      float next_fire_delay;
        ...
        if (!
            (The_mission.ai_profile->
             flags & AIPF_DISABLE_LINKED_FIRE_PENALTY))
        ...
        
        {
            ...
            
            {
                ...
                timestamp_until(swp->next_primary_fire_stamp[bank_to_fire]);
        ...
        
        {
          ...
           if (winfo_p->wi_flags & WIF_BEAM)  // the big change I made for fighter beams, if there beams fill out the Fire_Info for a targeting laser then fire it, for each point in the weapon bank -Bobboau
            {
                ...
                
                {
                    ...
                    timestamp(swp->next_primary_fire_stamp[bank_to_fire] * 2);
                ...
                (float) cos((winfo_p->field_of_fire != 0.0f) ? winfo_p->
                            field_of_fire : 180);
          ...
          else                  //if this isn't a fighter beam, do it normally -Bobboau
            {
                ...
                
                {
                    ...
                    timestamp(swp->next_primary_fire_stamp[bank_to_fire]);
                    ...
                    
                    {
                      ...
                      if (winfo_p->wi_flags2 & WIF2_CYCLE)
                        ...
                        
                        {
                            ...
                            model_get(winfo_p->external_model_num);
                        ...
                        
                        {
                            ...
                            
                            {
                                   ...
                                   && aip->target_objnum != -1
                                   && Players[Player_num].
                                   lead_indicator_active == 1)
                                
                                {
                                  
                                    // Fire weapon in target direction
                                    vec3d target_position,
                                    target_velocity_vec, predicted_target_pos;
                                  vec3d firing_vec, last_delta_vec,
                                    player_forward_vec, plr_to_target_vec;
                                    ...
                                    {
                                      get_subsystem_world_pos(&Objects
                                                               [aip->
                                                                target_objnum],
                                                               aip->
                                                               targeted_subsys,
                                    ...
                                    Objects[aip->target_objnum].phys_info.vel;
                                  dist_to_target =
                                    vm_vec_dist_quick(&target_position,
                                                      &firing_pos);
                                    ...
                                    
                                    {
                                        ...
                                        dist_to_target / winfo_p->max_speed;
                                    }
                                   vm_vec_scale_add(&predicted_target_pos,
                                                      &target_position,
                                                      &target_velocity_vec,
                                                      time_to_target);
                                  polish_predicted_target_pos(winfo_p,
                                                               &Objects[aip->
                                                                        target_objnum],
                                                               &target_position,
                                                               ...
                                                               &last_delta_vec,
                                                               1);
                                  vm_vec_sub(&plr_to_target_vec,
                                              &predicted_target_pos,
                                              &obj->pos);
                                   
                                    // minimum convergence distance
                                    if (sip->minimum_convergence_distance >
                                        dist_to_target)
                                    
                                    {
                                      float dist_mult;
                                      dist_mult =
                                        sip->minimum_convergence_distance /
                                        dist_to_target;
                                    ...
                                    if (sip->
                                        aiming_flags &
                                        AIM_FLAG_AUTOAIM_CONVERGENCE)
                                    vm_vec_sub(&firing_vec,
                                                &predicted_target_pos,
                                                &firing_pos);
                                    ...
                                    vm_vec_delta_ang(&player_forward_vec,
                                                     &plr_to_target_vec,
                                                     NULL);
                                   if (angle_to_target < sip->autoaim_fov)
                                    
                                    {
                                      vm_vector_2_matrix(&firing_orient,
                                                          &firing_vec, NULL,
                                                          NULL);
                                ...
                                if ((sip->
                                     aiming_flags & AIM_FLAG_AUTO_CONVERGENCE)
                                    && (aip->target_objnum != -1))
                                
                                {
                                  ...
                                  vec3d firing_vec, player_forward_vec,
                                    convergence_offset;
                                    ...
                                    vm_vector_2_matrix(&firing_orient,
                                       ...
                                       aiming_flags &
                                       AIM_FLAG_STD_CONVERGENCE)
                                
                                {
                                  vec3d player_forward_vec, target_vec,
                                    firing_vec, convergence_offset;
                                  player_forward_vec = obj->orient.vec.fvec;
                                  
                                    // make sure vector is of the set length
                                    vm_vec_copy_normalize(&target_vec,
                                                          &player_forward_vec);
                                  vm_vec_scale(&target_vec,
                            ...
                            weapon_create(&firing_pos, &firing_orient, weapon,
                                          OBJ_INDEX(obj), new_group_id);
                           weapon_set_tracking_info(weapon_objnum,
                                                      OBJ_INDEX(obj),
                                                      aip->target_objnum,
                                                      aip->
                            ...
                            
                            {
                                ...
                                {
                                  set_predicted_enemy_pos(&predicted_pos,
                                                           obj, &target->pos,
                                                           &target->phys_info.
                                                           vel, aip);
                                  range_to_target =
                                    vm_vec_dist(&predicted_pos, &obj->pos);
                                ...
                                
                                {
                                    ...
                                    flak_pick_range(&Objects[weapon_objnum],
                                                    &firing_pos,
                            ...
                            
                            {
                                ...
                                shipfx_flash_create(obj, sip->model_num, &pnt,
                                                    &obj->orient.vec.fvec, 1,
                                                    weapon);
                            }
                           
                            // maybe shudder the ship - if its me
                            if ((winfo_p->wi_flags & WIF_SHUDDER)
                                && (obj == Player_obj)
                ...
                
                {
                    ...
                    
                    {
                        ...
                        
                        {
                            ...
                            &Weapon_info[sw_pl->
                                         primary_bank_weapons[sw_pl->
                                                              current_primary_bank]];
                          int force_level =
                            (int) ((wip->armor_factor +
                                    wip->shield_factor * 0.2f) *
                                   (wip->damage * wip->damage -
                                    7.5f) * 0.45f + 0.6f) * 10 + 2000;
    ...
    {
      demo_POST_primary_fired(obj, swp->current_primary_bank,
...
 void ship_start_targeting_laser(ship * shipp) 
{
    ...
    if ((shipp->weapons.primary_bank_weapons[0] >= 0)
        && (Weapon_info[shipp->weapons.primary_bank_weapons[0]].
            wi_flags & WIF_BEAM)
        && (Weapon_info[shipp->weapons.primary_bank_weapons[0]].b_info.
    ...
    
    {
       ...
       && (Weapon_info[shipp->weapons.primary_bank_weapons[1]].
           wi_flags & WIF_BEAM)
       && (Weapon_info[shipp->weapons.primary_bank_weapons[1]].b_info.
           beam_type == BEAM_TYPE_C))
    ...
    
    {
        ...
        
        {
          ...
          fire_info.accuracy = 0.0f;
            ...
            shipp->weapons.primary_bank_weapons[(int) shipp->
                                                targeting_laser_bank];
          ...
          
          {
              ...
              
              {
                  ...
                  
                  {
                         ...
                         [Weapons[mobjp->instance].weapon_info_index].
                         wi_flags & WIF_REMOTE)
...
int ship_fire_secondary(object * obj, int allow_swarm) 
{
    ...
    
    {
        ...
        
        {
            ...
            send_secondary_fired_packet(shipp, 0, starting_bank_count, 1,
                                        allow_swarm);
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                         ...
                         (vm_vec_dist_quick
                          (&obj->pos,
                           &Objects[aip->target_objnum].pos) > max_dist))
        ...
        
        {
            ...
            
            {
                ...
                
                {
                                      ...
                                      NOX
                                      ("Cannot fire %s if target is not tagged"),
                                      wip->name);
      ...
      int num_slots;
        ...
        
        {
            ...
            
            {
                               ...
                               &pm->missile_banks[bank].norm[pnt_index - 1],
                               &obj->orient);
            ...
            // of weapon_create
            weapon_num =
            weapon_create(&firing_pos, &firing_orient, weapon, OBJ_INDEX(obj),
                          -1, aip->current_target_is_locked);
            ...
            // create the muzzle flash effect
            if ((obj != Player_obj) || (sip->flags2 & SIF2_SHOW_SHIP_MODEL)
                || (Viewer_mode))
    ...
    
    {
        ...
        
        {
          ...
          send_secondary_fired_packet(shipp, starting_sig,
                                       starting_bank_count, num_fired,
                                       allow_swarm);
    ...
    
    {
        ...
        if (ship_select_next_valid_secondary_bank(swp)) //DTP here we switch to the next valid bank, but we can't call weapon_info on next fire_wait
        {
            ...
            if (timestamp_elapsed(shipp->weapons.next_secondary_fire_stamp[shipp->weapons.current_secondary_bank]))     //DTP, this is simply a copy of the manual cycle functions
            {
              ...
              shipp->weapons.last_secondary_fire_stamp[shipp->weapons.
                                                       current_secondary_bank]
                = timestamp();
...
int ship_select_next_primary(object * objp, int direction) 
{
  ...
   Assert(direction == CYCLE_PRIMARY_NEXT
            || direction == CYCLE_PRIMARY_PREV);
    ...
    
    {
        ...
        
        {
                              ...
                              ("This ship has only one primary weapon: %s",
                               491),
                              Weapon_info[swp->
                                          primary_bank_weapons[swp->
                                                               current_primary_bank]].
                              name, swp->current_primary_bank + 1);
    ...
    {
      Assert((swp->current_primary_bank >= 0)
    ...
    
    {
        ...
        
        {
                              ...
                              Weapon_info[swp->
                                          secondary_bank_weapons[swp->
                                                                 current_secondary_bank]].
                              name, swp->current_secondary_bank + 1);
...
int get_available_primary_weapons(object * objp, int *outlist,
                                  int *outbanklist) 
{
...
//  Stuff list of weapon indices for object *objp in list *outlist.
//  Return number of weapons in list.
int get_available_secondary_weapons(object * objp, int *outlist,
                                    int *outbanklist) 
{
...
void ship_model_start(object * objp) 
{
    ...
    
    {
        ...
        {
          model_set_instance(model_num, psub->subobj_num,
                              &pss->submodel_info_1);
        ...
        {
          model_set_instance(model_num, psub->turret_gun_sobj,
                              &pss->submodel_info_2);
...
void ship_model_stop(object * objp) 
{
    ...
    model_clear_instance(Ship_info[Ships[objp->instance].ship_info_index].
                         model_num);
...
#define MAX_SUBSYS_ATTACKERS 3
  ship_subsys * ship_get_best_subsys_to_attack(ship * sp, int subsys_type,
                                               vec3d * attacker_pos) 
{
...
float ship_get_subsystem_strength(ship * shipp, int type) 
{
    ...
    shipp->subsys_info[type].current_hits /
...
float ship_calculate_rearm_duration(object * objp) 
{
    ...
    
    {
        ...
        ssp->max_hits * (The_mission.support_ships.max_subsys_repair_val *
                         0.01f);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                if ((swp->primary_bank_start_ammo[i] -
                     swp->primary_bank_ammo[i]) %
                ...
                
                {
                    ...
                    (float) snd_get_duration(Snds[SND_MISSILE_START_LOAD].
                                             id) / 1000.0f;
    ...
    
    {
        ...
        //take into account a fractional reload
        if ((swp->secondary_bank_start_ammo[i] -
             swp->secondary_bank_ammo[i]) % REARM_NUM_MISSILES_PER_BATCH != 0)
        ...
        
        {
            ...
            (float) snd_get_duration(Snds[SND_MISSILE_START_LOAD].id) /
            1000.0f;
...
int ship_do_rearm_frame(object * objp, float frametime) 
{
    ...
    
    {
        ...
        HUD_sourced_printf(HUD_SOURCE_HIDDEN,
                           XSTR("Subspace drive repaired.", -1));
    ...
    
    {
          ...
          shipp->ship_max_hull_strength * frametime *
          sip->sup_subsys_repair_rate;
      
      else if (!(sip->sup_hull_repair_rate == sip->sup_subsys_repair_rate))
        repair_allocated =
          repair_allocated * sip->sup_subsys_repair_rate /
          sip->sup_hull_repair_rate;
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                timestamp(snd_get_duration(Snds[SND_MISSILE_START_LOAD].id));
                ...
                
                {
                    ...
                    
                    {
                      ...
                      int sound_index;
                        ...
                        timestamp(snd_get_duration(Snds[sound_index].id));
                    ...
                    
                    {
                        ...
                        
                        {
                          ...
                           snd_play_3d(&Snds[sound_index], &objp->pos,
                                         &View_position);
    ...
    if ((subsys_all_ok && shields_full
         ...
         && hull_ok) || (subsys_all_ok && shields_full
                         && !(The_mission.
...
void ship_assign_sound(ship * sp) 
{
    ...
    {
      vm_vec_copy_scale(&engine_pos, &objp->orient.vec.fvec,
                         -objp->radius / 2.0f);
    ...
    
    {
        ...
        
        {
            ...
            {
              obj_snd_assign(sp->objnum, moveup->system_info->alive_snd,
                              &moveup->system_info->pnt, 0, OS_SUBSYS_ALIVE,
                              moveup);
            ...
            {
              obj_snd_assign(sp->objnum,
                              moveup->system_info->turret_base_rotation_snd,
                              &moveup->system_info->pnt, 0,
            ...
            
            {
                              ...
                              moveup->system_info->turret_gun_rotation_snd,
                              &moveup->system_info->pnt, 0,
                              OS_TURRET_GUN_ROTATION, moveup);
              moveup->subsys_snd_flags |= SSSF_TURRET_ROTATION;
            }
          if ((moveup->system_info->rotation_snd != -1)
               && (moveup->system_info->flags & MSS_FLAG_ROTATES))
            
            {
              obj_snd_assign(sp->objnum, moveup->system_info->rotation_snd,
                              &moveup->system_info->pnt, 0,
        ...
        
        {
            ...
            {
              obj_snd_assign(sp->objnum, moveup->system_info->dead_snd,
                              &moveup->system_info->pnt, 0, OS_SUBSYS_DEAD,
                              moveup);
...
DCF(set_shield, "Change player ship shield strength") 
{
    ...
    
    {
        ...
        
        {
          ...
          shield_set_strength(Player_obj,
                               Dc_arg_float *
...
DCF(set_hull, "Change player ship hull strength") 
{
    ...
    
    {
        ...
        
        {
            ...
            Dc_arg_float * Player_ship->ship_max_hull_strength;
...
DCF(set_subsys, "Set the strength of a particular subsystem on player ship") 
{
    ...
    
    {
        ...
        
        {
            ...
            {
              ship_set_subsystem_strength(Player_ship,
...
int ship_get_random_player_wing_ship(int flags, float max_dist,
                                     int persona_index, int get_first,
                                     int multi_team) 
{
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                vm_vec_dist_quick(&Objects[Ships[ship_index].objnum].pos,
                                  &Player_obj->pos);
...
// input:   max_dist    =>  OPTIONAL PARAMETER (default value 0.0f) max range ship can be from player
int ship_get_random_ship_in_wing(int wingnum, int flags, float max_dist,
                                 int get_first) 
{
...
int ship_get_random_team_ship(int team_mask, int flags, float max_dist) 
{
    ...
    
    {
        ...
        if (!iff_matches_mask(Ships[objp->instance].team, team_mask))
               ...
               flags & SIF_NOT_FLYABLE)
        continue;
      
      else if ((flags == SHIP_GET_NO_PLAYERS)
...
int ship_engine_ok_to_warp(ship * sp) 
{
    ...
    ship_get_subsystem_strength(sp, SUBSYSTEM_ENGINE);
...
int ship_navigation_ok_to_warp(ship * sp) 
{
    ...
    if (!
        (The_mission.ai_profile->flags & AIPF_NAVIGATION_SUBSYS_GOVERNS_WARP))
...
//
int ship_return_subsys_path_normal(ship * shipp, ship_subsys * ss,
                                   vec3d * gsubpos, vec3d * norm) 
{
...
int ship_subsystem_in_sight(object * objp, ship_subsys * subsys,
                            vec3d * eye_pos, vec3d * subsys_pos,
                            int do_facing_check, float *dot_out,
                            vec3d * vec_out) 
{
...
// not destroyed.  If cannot find one, return NULL.
  ship_subsys * ship_return_next_subsys(ship * shipp, int type,
                                        vec3d * attacker_pos) 
{
...
// Returns null if all subsystems of that type are destroyed or none is in sight.
  ship_subsys * ship_get_closest_subsys_in_sight(ship * sp, int subsys_type,
                                                 vec3d * attacker_pos) 
{
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                vm_vec_dist_quick(&objp->pos, &Objects[shipp->objnum].pos);
...
char *ship_return_orders(char *outbuf, ship * sp) 
{
    ...
    
    {
      ...
      
      {
          ...
          {
            sprintf(outbuf, XSTR("atk %s %s", 496), temp_name,
                     hud_targetbox_truncate_subsys_name(aip->targeted_subsys->
                                                        system_info->
                                                        subobj_name));
...
char *ship_return_time_to_goal(char *outbuf, ship * sp) 
{
    ...
    
    {
        ...
        
        {
            ...
            vm_vec_dist_quick(&objp->pos, &wpl->waypoints[aip->wp_index]);
          for (int i = aip->wp_index; i < wpl->count - 1; i++)
            
            {
              dist +=
                vm_vec_dist_quick(&wpl->waypoints[i], &wpl->waypoints[i + 1]);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                if (Ship_info[ship_sp->ship_info_index].
                    flags & (SIF_SMALL_SHIP | SIF_BIG_SHIP))
                
                {
                    ...
                    dist_squared =
                    vm_vec_dist_squared(&cargo_objp->pos,
                                        &Objects[ship_sp->objnum].pos);
                  limit_squared =
                    (cargo_objp->radius +
                     CARGO_RADIUS_DELTA) * (cargo_objp->radius +
                                            CARGO_RADIUS_DELTA);
...
void ship_maybe_warn_player(ship * enemy_sp, float dist) 
{
  ...
  vec3d vec_to_target;
    ...
    fdot =
    vm_vec_dot(&Objects[enemy_sp->objnum].orient.vec.fvec, &vec_to_target);
    ...
    
    {
        ...
        if ((Game_mode & GM_MULTIPLAYER)
            && (Netgame.type_flags & NG_TYPE_TEAM) && (Net_player != NULL))
        
        {
          ship_index =
            ship_get_random_player_wing_ship(SHIP_GET_UNSILENCED, 0.0f, -1, 0,
        ...
        
        {
            ...
            timestamp(PLAYER_ALLOW_WARN_INTERVAL);
...
void ship_maybe_praise_player(ship * deader_sp) 
{
    ...
    if ((Ship_info[deader_sp->ship_info_index].class_type > 0)
        && !(Ship_types[Ship_info[deader_sp->ship_info_index].class_type].
             message_bools & STI_MSG_PRAISE_DESTRUCTION))
...
 void ship_maybe_praise_self(ship * deader_sp, ship * killer_sp) 
{
    ...
    if (!
        ((iff_x_attacks_y(deader_sp->team, killer_sp->team))
  ...
   message_send_builtin_to_player(MESSAGE_PRAISE_SELF, killer_sp,
                                    MESSAGE_PRIORITY_HIGH, MESSAGE_TIME_SOON,
                                    0, 0, -1, -1);
...
void awacs_maybe_ask_for_help(ship * sp, int multi_team_filter) 
{
    ...
    if (stricmp(Campaign.filename, "freespace2")
        || !(Game_mode & GM_CAMPAIGN_MODE))
         ...
         ((AWACS_HELP_HULL_LOW +
           0.01f * (static_rand(objp - Objects) & 5)) *
          sp->ship_max_hull_strength))
...
void ship_maybe_ask_for_help(ship * sp) 
{
    ...
    if (objp->flags & OF_NO_SHIELDS)
       ...
       (ASK_HELP_SHIELD_PERCENT * sp->ship_max_shield_strength))
    return;
 play_ask_help: Assert(Ship_info[sp->ship_info_index].flags & (SIF_FIGHTER | SIF_BOMBER));
                                                                                // get Alan
...
void ship_maybe_lament() 
{
    ...
    
    {
        ...
        message_send_builtin_to_player(MESSAGE_PLAYER_DIED,
                                        &Ships[ship_index],
                                        MESSAGE_PRIORITY_HIGH,
        ...
        
        {
            ...
            
            {
                ...
                
                {
                       ...
                       swp->primary_bank_start_ammo[i] < 0.3f)
                    
                    {
                      ...
                       message_send_builtin_to_player(MESSAGE_PRIMARIES_LOW,
                                                        sp,
    ...
    
    {
        ...
        
        {
            ...
            
            {
                   ...
                   swp->secondary_bank_start_ammo[i] < 0.5f)
...
void ship_primary_changed(ship * sp) 
{
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    model_anim_get_time_type(sp, TRIGGER_TYPE_PRIMARY_BANK,
                                             i);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        model_anim_get_time_type(sp,
                                                 TRIGGER_TYPE_PRIMARY_BANK,
                                                 i);
            ...
            
            {
                ...
                {
                  model_anim_start_type(sp, TRIGGER_TYPE_PRIMARY_BANK, i,
                                         -1);
    ...
    send_ship_weapon_change(sp, MULTI_PRIMARY_CHANGED,
                             swp->current_primary_bank,
                             (sp->flags & SF_PRIMARY_LINKED) ? 1 : 0);
...
void ship_secondary_changed(ship * sp) 
{
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                {
                  model_anim_start_type(sp, TRIGGER_TYPE_SECONDARY_BANK, i,
                                         -1);
    ...
    send_ship_weapon_change(sp, MULTI_SECONDARY_CHANGED,
                             swp->current_secondary_bank,
                             (sp->flags & SF_SECONDARY_DUAL_FIRE) ? 1 : 0);
...
 void ship_do_cap_subsys_cargo_hidden(ship * shipp, ship_subsys * subsys,
                                        int from_network) 
{
...
int get_max_ammo_count_for_primary_bank(int ship_class, int bank,
                                        int ammo_type) 
{
...
void ship_page_in() 
{
    ...
    
    {
        ...
        
        {
                    ...
                    "Paging in textures for future arrival ship '%s'\n",
                    p_objp->name));
          model_page_in_textures(Ship_info[p_objp->ship_class].model_num,
                                  p_objp->ship_class);
  ...
  int num_ship_types_used = 0;
    ...
    
    {
        ...
        {
          if ((Ship_info[j].model_num > -1)
               && !stricmp(sip->pof_file, Ship_info[j].pof_file))
            
            {
                ...
                test_id =
                model_load(sip->pof_file, sip->n_subsystems,
                           &sip->subsystems[0]);
            ...
            
            {
                ...
                
                {
                    ...
                    if (sip->subsystems[j].model_num != sip->model_num)
                             ...
                             "Ship '%s' does not have subsystem '%s' linked into the model file, '%s'.",
        ...
        
        {
            ...
            
            {
               ...
               && Ship_types[sip->class_type].explosion_bitmap_anims.size() >
               0)
    ...
    
    {
      ...
       bm_page_in_texture(thruster->flames.normal.first_frame,
                            thruster->flames.normal.num_frames);
      bm_page_in_texture(thruster->flames.afterburn.first_frame,
    ...
    
    {
        ...
        
        {
            ...
            {
              bm_page_in_xparent_texture(Net_players[i].m_player->
                                          insignia_texture);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    {
                      bm_page_in_texture(Ships[i].
                                          ship_replacement_textures[j]);
...
void ship_page_in_textures(int ship_index) 
{
    ...
    bm_page_in_texture(sip->thruster_secondary_glow_info.afterburn.
                        bitmap_id);
    ...
    
    {
      ...
      bm_page_in_texture(sip->normal_thruster_particles[i].thruster_bitmap.
                          first_frame);
  }  for (i = 0; i < (int) sip->afterburner_thruster_particles.size();
               i++)
    
    {
      generic_anim_load(&sip->afterburner_thruster_particles[i].
                         thruster_bitmap);
...
void ship_page_out_textures(int ship_index, bool release) 
{
    ...
    // thruster/particle bitmaps
    for (i = 0; i < (int) sip->normal_thruster_particles.size(); i++)
    PAGE_OUT_TEXTURE(sip->normal_thruster_particles[i].thruster_bitmap.
                      first_frame);
   for (i = 0; i < (int) sip->afterburner_thruster_particles.size(); i++)
    PAGE_OUT_TEXTURE(sip->afterburner_thruster_particles[i].thruster_bitmap.
                      first_frame);
...
int is_support_allowed(object * objp) 
{
    ...
    
    {
      ...
      int temp =
        ship_name_lookup(Parse_names
                         [The_mission.support_ships.arrival_anchor]);
    ...
    if ((The_mission.support_ships.ship_class < 0)
        && !(The_mission.support_ships.
              support_available_for_species & (1 <<
                                               Ship_info[shipp->
                                                         ship_info_index].
                                               species)))
    ...
    if (model_find_dock_index
        (Ship_info[shipp->ship_info_index].model_num, DOCK_TYPE_REARM) < 0)
...
int ship_get_random_targetable_ship() 
{
    ...
    
    {
        ...
        if (Ships[Objects[so->objnum].instance].
            flags & TARGET_SHIP_IGNORE_FLAGS)
...
void object_jettison_cargo(object * objp, object * cargo_objp) 
{
    ...
    // Goober5000 - add log
    mission_log_add_entry(LOG_SHIP_UNDOCKED, Ships[objp->instance].ship_name,
                          Ships[cargo_objp->instance].ship_name);
...
}  float ship_get_exp_damage(object * objp) 
{
    ...
    
    {
        ...
        (float) atoi(Sexp_variables[shipp->special_exp_index + DAMAGE].text);
...
 float ship_get_exp_outer_rad(object * ship_objp) 
{
    ...
    
    {
        ...
        Ship_info[Ships[ship_objp->instance].ship_info_index].shockwave.
        outer_rad;
    ...
    
    {
        ...
        (float)
        atoi(Sexp_variables
             [Ships[ship_objp->instance].special_exp_index + OUTER_RAD].text);
...
int ship_get_texture(int bitmap) 
{
    ...
    {
      if ((Ship_info[idx].model_num >= 0)
           && model_find_texture(Ship_info[idx].model_num, bitmap) == 1)
...
} void ship_update_artillery_lock() 
{
    ...
    
    {
        ...
        &Weapon_info[shipp->weapons.
                     primary_bank_weapons[shipp->weapons.
                                          current_primary_bank]];
        ...
        
        {
          ...
           ssm_create(&Objects[aip->artillery_objnum],
                        &cinfo->hit_point_world, 0, NULL, shipp->team);
...
int check_world_pt_in_expanded_ship_bbox(vec3d * world_pt, object * objp,
                                         float delta_box) 
{
    ...
    model_get(Ship_info[Ships[objp->instance].ship_info_index].model_num);
             ...
             && (ship_pt.xyz.x <
                 pm->maxs.xyz.x + delta_box)  &&(ship_pt.xyz.y >
                                                  pm->mins.xyz.y - delta_box)
             && (ship_pt.xyz.y <
                 pm->maxs.xyz.y + delta_box)  &&(ship_pt.xyz.z >
                                                  pm->mins.xyz.z - delta_box)
...
void ship_set_new_ai_class(int ship_num, int new_ai_class) 
{
  ...
  init_aip_from_class_and_profile(aip, &Ai_classes[new_ai_class],
                                   The_mission.ai_profile);
...
// Goober5000
void ship_subsystem_set_new_ai_class(int ship_num, char *subsystem,
                                     int new_ai_class) 
{
...
int ship_get_ship_with_dock_bay(int team) 
{
    ...
    {
      if (ship_has_dock_bay(Objects[so->objnum].instance)
           && (Ships[Objects[so->objnum].instance].team == team))
...
// Goober5000
void ship_do_submodel_rotation(ship * shipp, model_subsystem * psub,
                               ship_subsys * pss) 
{
...
int ship_has_energy_weapons(ship * shipp) 
{
    ...
    return (Ship_info[shipp->ship_info_index].max_weapon_reserve >
  ...
  ArmorType::ArmorType(char *in_name) 
{
    ...
    
    {
               ...
               "Armor name %s is %d characters too long, and will be truncated",
    ...
    
    {
        ...
        
        {
            ...
            
            {
                       ...
                       "Armor '%s': Armor calculation type '%s' is invalid, and has been skipped",
                       Name, buf);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                   ...
                   (ai_tgt_weapon_flags[j].name, temp_strings[i].c_str()))
