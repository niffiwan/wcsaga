...
extern void ssm_create(object * target, vec3d * start, int ssm_index,
                        ssm_firing_info * override, int team);
...
void do_subobj_destroyed_stuff(ship * ship_p, ship_subsys * subsys,
                               vec3d * hitpos) 
{
        ...
        
        {
            ...
            
            {
                ...
                vm_vec_rand_vec_quick(&rand_vec);
                                 ...
                                 -dot /
                                 vm_vec_mag_squared(&center_to_subsys));
          ...
          vm_vec_crossprod(&fb_vel, &objp->phys_info.rotvel,
                            &center_to_subsys);
          ...
          fireball_create(&temp_vec, fireball_type,
  ...
  int display = (psub->type != SUBSYSTEM_ACTIVATION);
    ...
    
    {
        ...
        
        {
            ...
            {
              mission_log_add_entry(LOG_SHIP_DISARMED, ship_p->ship_name,
                                     NULL);
  ...
  int sound_index = -1;
    ...
    {
      obj_snd_delete_type(ship_p->objnum, subsys->system_info->alive_snd,
                           subsys);
    ...
    {
      obj_snd_delete_type(ship_p->objnum,
                           subsys->system_info->turret_base_rotation_snd,
                           subsys);
      obj_snd_delete_type(ship_p->objnum,
                           subsys->system_info->turret_gun_rotation_snd,
                           subsys);
    ...
    {
      obj_snd_delete_type(ship_p->objnum, subsys->system_info->rotation_snd,
                           subsys);
      subsys->subsys_snd_flags &= ~SSSF_ROTATE;
    }
  if ((subsys->system_info->dead_snd != -1)
       && !(subsys->subsys_snd_flags & SSSF_DEAD))
    
    {
      obj_snd_assign(ship_p->objnum, subsys->system_info->dead_snd,
...
float do_subobj_hit_stuff(object * ship_obj, object * other_obj,
    ...
    if ((other_obj != NULL) && (other_obj->type == OBJ_SHOCKWAVE))      // Goober5000 check for NULL
    {
        ...
        if ((Ship_info[ship_p->ship_info_index].flags & (SIF_SMALL_SHIP))
            && !(The_mission.ai_profile->
                 flags & AIPF_SHOCKWAVES_DAMAGE_SMALL_SHIP_SUBSYSTEMS))
  ...
  int count = 0;
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                subsys->current_hits;
              if (ship_p->subsys_info[subsys->system_info->type].
                   current_hits < 0)
                
                {
                  ship_p->subsys_info[subsys->system_info->type].
                    current_hits = 0.0f;
    ...
    
    {
        ...
        
        {
            ...
            Ship_info[Debris[other_obj->instance].ship_info_index].
            debris_damage_type_idx;
        ...
        
        {
            ...
            Ship_info[Ships[other_obj->instance].ship_info_index].
            collision_damage_type_idx;
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                Armor_types[subsys->armor_type_idx].GetDamage(damage,
                                                              dmg_type_idx);
        ...
        
        {
            ...
            
            {
                ...
                The_mission.ai_profile->subsys_damage_scale[Game_skill_level];
            ...
            
            {
                ...
                0.01f * subsys->subsys_guardian_threshold * subsys->max_hits;
              if ((subsys->current_hits - damage_to_apply) <
                   min_subsys_strength)
                
                {
                    ...
                    damage_to_apply =
                    subsys->current_hits - min_subsys_strength;
            ...
            
            {
                   ...
                   ||
                   (!(subsys->system_info->flags & MSS_FLAG_CARRY_SHOCKWAVE)))
                
                {
                    ...
                    
                    {
                        ...
                        Weapon_info[weapon_info_index].subsystem_factor;
                    }
                  if (subsystem_factor > 0.0f)
                    damage -=
                      ((MIN(subsys->current_hits, damage_to_apply)) /
                       subsystem_factor);
            ...
            
            {
                ...
                Armor_types[subsys->armor_type_idx].GetDamage(damage_to_apply,
                                                              dmg_type_idx);
...
void shiphit_record_player_killer(object * killer_objp, player * p) 
{
    ...
    
    {
        ...
        if ((Game_mode & GM_MULTIPLAYER)
            && (Objects[killer_objp->parent].flags & OF_PLAYER_SHIP))
        
        {
          int pnum;
           pnum =
            multi_find_player_by_object(&Objects[killer_objp->parent]);
        ...
        // in multiplayer, record callsign of killer if killed by another player
        if ((Game_mode & GM_MULTIPLAYER)
            && (killer_objp->flags & OF_PLAYER_SHIP))
        ...
        
        {
                    ...
                    Ships[killer_objp->instance].ship_name);
...
void ship_hit_music(object * ship_obj, object * other_obj) 
{
  ...
  int attackee_team, attacker_team;
    ...
    
    {
        ...
        if (!stricmp
            (Ai_class_names
             [Ai_info[Ships[other_obj->instance].ai_index].ai_class],
             NOX("none")))
...
int get_max_sparks(object * ship_obj) 
{
    ...
    
    {
        ...
        ship_obj->hull_strength / ship_p->ship_max_hull_strength;
...
//  Make sparks fly off a ship.
void ship_hit_create_sparks(object * ship_obj, vec3d * hitpos,
                            int submodel_num) 
{
...
void player_died_start(object * killer_objp) 
{
  ...
   vm_vec_add(&Original_vec_to_deader, &Player_obj->orient.vec.fvec,
    ...
    
    {
        ...
        vm_vec_normalized_dir(&vec_from_killer, &Player_obj->pos,
                              &other_objp->pos);
    }
   if (dist > 100.0f)
    dist = 100.0f;
  vm_vec_scale_add(&Dead_camera_pos, &Player_obj->pos, &vec_from_killer,
                    dist);
...
void ship_generic_kill_stuff(object * objp, float percent_killed) 
{
  ...
  float damage = ship_get_exp_damage(objp);
    ...
    sp->death_roll_snd =
    snd_play_3d(&Snds[SND_DEATH_ROLL], &objp->pos, &View_position,
                objp->radius);
  ...
  float logval =
    (float) log10(objp->phys_info.mass / (0.05f * DEATHROLL_MASS_STANDARD));
  float velval =
    ((vm_vec_mag_quick(&objp->phys_info.vel) +
      3.0f) / DEATHROLL_VELOCITY_STANDARD);
    ...
    
    {
      ...
      saturate_fabs(&sp->deathroll_rotvel.xyz.z,
                     0.75f * DEATHROLL_ROTVEL_CAP);
...
void ship_hit_kill(object * ship_obj, object * other_obj,
  ...
  extern void game_tst_mark(object * objp, ship * shipp);
    ...
    
    {
        ...
        
        {
            ...
            (int) (sp->damage_ship[killer_index] / sp->total_damage_received *
                   100.0f);
        ...
        
        {
            ...
            
            {
              ...
               mission_log_add_entry(LOG_SHIP_DESTROYED, name1, name2,
                                       killer_damage_percent);
            ...
            
            {
                ...
                mission_log_add_entry(LOG_SHIP_DESTROYED, sp->ship_name,
                                      killer_ship_name,
                                      killer_damage_percent);
        ...
        
        {
          ...
          else if ((other_obj->parent_type == OBJ_SHIP)
                   || (other_obj->parent_type == OBJ_START))
            
            {
              ship_maybe_praise_self(sp,
                                      &Ships[Objects[other_obj->parent].
                                             instance]);
    ...
    
    {
        ...
        send_ship_kill_packet(ship_obj, other_obj, percent_killed,
                              self_destruct);
...
void ship_self_destruct(object * objp) 
{
    ...
    
    {
        ...
        {
          mission_log_add_entry(LOG_SELF_DESTRUCTED,
                                 Net_players[np_index].m_player->callsign,
                                 NULL);
        ...
        
        {
                                 ...
                                 Ships[objp->instance].ship_name, NULL);
    ...
    
    {
      ...
      int np_index = multi_find_player_by_object(objp);
        ...
        
        {
          ...
          sprintf(msg, "%s %s", Net_players[np_index].m_player->callsign,
                   XSTR("Self destructed", 1476));
           
            // send a message
            send_game_chat_packet(Net_player, msg, MULTI_MSG_ALL, NULL, NULL,
                                  2);
...
void ship_apply_whack(vec3d * force, vec3d * hit_pos, object * objp) 
{
    ...
    
    {
        ...
        // the bracketed code restores Volition's code, but it doesn't calculate the correct torque.
      {
        ...
        // whack it
        physics_apply_whack(force, hit_pos, &objp->phys_info, &objp->orient,
                            overall_mass);
...
int maybe_shockwave_damage_adjust(object * ship_obj, object * other_obj, float *damage) 
{
  ...
  Assert(damage);               // Goober5000
    ...
    
    {
         ...
         (Ship_info[Ships[ship_obj->instance].ship_info_index].
          flags & SIF_HUGE_SHIP))
    ...
    
    {
        ...
        max_damage * (1.0f -
                      0.75f * (nearest_dist - inner_radius) / (outer_radius -
                                                               inner_radius));
...
void ai_update_lethality(object * ship_obj, object * weapon_obj,
                         float damage);
static void ship_do_damage(object * ship_obj, object * other_obj,
                            vec3d * hitpos, float damage, int quadrant,
                            int wash_damage = 0) 
{
  ...
  Assert(hitpos);               // Goober5000
    ...
    {
      other_obj_is_weapon = ((other_obj->type == OBJ_WEAPON)
                              && (other_obj->instance >= 0)
                              && (other_obj->instance < MAX_WEAPONS));
      other_obj_is_beam = ((other_obj->type == OBJ_BEAM)
                            && (other_obj->instance >= 0)
                            && (other_obj->instance < MAX_BEAMS));
      other_obj_is_shockwave = ((other_obj->type == OBJ_SHOCKWAVE)
                                 && (other_obj->instance >= 0)
                                 && (other_obj->instance < MAX_SHOCKWAVES));
      other_obj_is_asteroid = ((other_obj->type == OBJ_ASTEROID)
                                && (other_obj->instance >= 0)
                                && (other_obj->instance < MAX_ASTEROIDS));
      other_obj_is_debris = ((other_obj->type == OBJ_DEBRIS)
                              && (other_obj->instance >= 0)
                              && (other_obj->instance < MAX_DEBRIS_PIECES));
      other_obj_is_ship = ((other_obj->type == OBJ_SHIP)
                            && (other_obj->instance >= 0)
    ...
    if (other_obj_is_weapon)
      ...
      weapon_get_damage_scale(&Weapon_info
                              [Weapons[other_obj->instance].
                               weapon_info_index], other_obj, ship_obj);
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                The_mission.ai_profile->player_damage_scale[Game_skill_level];
    ...
    
    {
      ...
      int special_check = !MULTIPLAYER_CLIENT;
        ...
        {
          Assert((beam_get_weapon_info_index(other_obj) >= 0)
                  && (beam_get_weapon_info_index(other_obj) <
                      Num_weapon_types));
          if (((Weapon_info[beam_get_weapon_info_index(other_obj)].subtype !=
                 WP_LASER) || special_check) && (Player_obj != NULL)
               && (ship_obj == Player_obj))
        ...
        {
          Assert((Weapons[other_obj->instance].weapon_info_index > -1)
                  && (Weapons[other_obj->instance].weapon_info_index <
                      Num_weapon_types));
          if (((Weapon_info[Weapons[other_obj->instance].weapon_info_index].
                 subtype != WP_LASER) || special_check)
               && (Player_obj != NULL) && (ship_obj == Player_obj))
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    Weapon_info[Weapons[other_obj->instance].
                                weapon_info_index].damage_type_idx;
                ...
                
                {
                    ...
                    Asteroid_info[Asteroids[other_obj->instance].
                                  asteroid_type].damage_type_idx;
                ...
                
                {
                    ...
                    Armor_types[shipp->shield_armor_type_idx].
    ...
    
    {
        ...
        do_subobj_hit_stuff(ship_obj, other_obj, hitpos, subsystem_damage,
                            &apply_hull_armor);
        ...
        
        {
            ...
            
            {
                ...
                Armor_types[shipp->armor_type_idx].GetDamage(damage,
                                                             dmg_type_idx);
        ...
        
        {
          ...
          if (weapon_info_index >= 0)
            ...
            
            {
                ...
                0.01f * shipp->ship_guardian_threshold *
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                      ...
                      ship_obj->sim_hull_strength =
                        MAX(0, ship_obj->sim_hull_strength);
                ...
                
                {
                ...
                case OBJ_BEAM:        //give kills for fighter beams-Bobboau
                  {
                      ...
                      
                      {
                             ...
                             (The_mission.ai_profile->
                              flags & AIPF_INCLUDE_BEAMS_IN_STAT_CALCS)
                             &&
                             !(Ship_info
                                [Ships[Objects[bobjn].instance].
                                 ship_info_index].
                      ...
                      {
                        scoring_add_damage(ship_obj, &Objects[bobjn],
                                            damage);
    ...
    
    {
        ...
        
        {
            ...
            (shipp->afterburner_fuel < 0.0f) ? 0.0f : shipp->afterburner_fuel;
...
// Goober5000
void ship_apply_tag(int ship_num, int tag_level, float tag_time,
                    object * target, vec3d * start, int ssm_index,
                    int ssm_team) 
{
...
void ship_apply_local_damage(object * ship_obj, object * other_obj,
                             vec3d * hitpos, float damage, int quadrant,
                             bool create_spark, int submodel_num,
                             vec3d * hit_normal) 
{
  ...
  Assert(other_obj);            // Goober5000
    ...
    // maybe tag the ship
    if (!MULTIPLAYER_CLIENT && (other_obj->type == OBJ_WEAPON)
        && (Weapon_info[Weapons[other_obj->instance].weapon_info_index].
            wi_flags & WIF_TAG))
    
    {
      ...
       ship_apply_tag(ship_obj->instance, wip->tag_level, wip->tag_time,
                        ship_obj, start, ssm_index, wp->team);
                              ...
                              vec3d * force_center, float damage) 
{
    ...
    
    {
      ...
      vm_vec_scale_add(&world_hitpos, &ship_obj->pos, &tmp,
                        ship_obj->radius);
        ...
        if (Cmdline_nohtl && (other_obj != NULL)
            && (other_obj->type == OBJ_SHOCKWAVE)
            && (Ship_info[Ships[ship_obj->instance].ship_info_index].
                flags & SIF_HUGE_SHIP))
        ...
        ship_do_damage(ship_obj, other_obj, &world_hitpos, damage,
                       shield_quad);
    ...
    
    {
        ...
        vm_vec_scale_add(&world_hitpos, &ship_obj->pos,
                         &ship_obj->orient.vec.fvec, ship_obj->radius);
...
 void ship_apply_wash_damage(object * ship_obj, object * other_obj,
                               float damage) 
{
    ...
    // radius of the object
    vm_vec_rand_vec_quick(&rand_vec);
  vm_vec_scale_add(&direction_vec, &ship_obj->orient.vec.fvec, &rand_vec,
                    0.5f);
